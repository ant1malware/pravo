const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-C2UXmZq-.js","assets/react-vendor-DTkXckhQ.js","assets/icons-D7Rqi-Bz.js","assets/VoteWidget-BtJ98VqG.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-DiC3jowU.js","assets/DiffPage-WS1wbSW3.js","assets/LiquidGlassShowcase-C-McA4rk.js","assets/PrintSheet-C5ijjgM-.js","assets/RolePage-DVWq91UJ.js","assets/FavStar-DFI-Hh7R.js","assets/LawPage-kCPdwahw.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-DIbm74N2.js","assets/HomePage-C7pcs2cm.js","assets/ForumPage-Vi1oSGnf.js","assets/forumRemote-D5s3MT8n.js","assets/ForumSubnav-Boylu3th.js","assets/ForumSearch-DiH67qqi.js","assets/ProfilePage-Cx8y2pZo.js","assets/forumHidden-Bfc6fJtN.js","assets/Badge-vaFluK-D.js","assets/ForumMembers-CF9-79XZ.js","assets/SectionPage-DlKCJhdY.js","assets/MarkdownEditor-DHOkR3Oo.js","assets/TopicPage-CZFgo5Mh.js","assets/ReactionBar-DcsGCS0C.js","assets/seo-Dt7ixYh-.js","assets/TagPage-BHq8pS1T.js","assets/QuestionsPage-DYy28g3k.js","assets/AdminPanel3-Dp8Xt4Rn.js","assets/ArchivePage-DKKccpmP.js","assets/SettingsPage-CnRghpZy.js","assets/FavoritesPage-BuNmdUfp.js","assets/ForumFeedsPage-CHpuLtYz.js"])))=>i.map(i=>d[i]);
import{r as ee,a as Nt,u as _t,L as I,R as c,b as J,B as St,c as Et,d as j}from"./react-vendor-DTkXckhQ.js";import{A as zt,E as It,I as Ae,C as Pt,Q as Lt,R as Mt,B as te,S as pe,H as At,U as he,a as fe,X as Re,b as xe,c as ge,L as Ce,G as Rt,M as ve,F as Ct,d as Tt,e as $t,f as Ot,g as Dt,h as Bt,i as Ft}from"./icons-D7Rqi-Bz.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();var Te={exports:{}},re={};/**
 * @license React
 ...
 */var Kt=ee,Vt=Symbol.for("react.element"),Ut=Symbol.for("react.fragment"),qt=Object.prototype.hasOwnProperty,Wt=Kt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Yt={key:!0,ref:!0,__self:!0,__source:!0};function $e(t,n,s){var r,a={},o=null,i=null;s!==void 0&&(o=""+s),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(i=n.ref);for(r in n)qt.call(n,r)&&!Yt.hasOwnProperty(r)&&(a[r]=n[r]);if(t&&t.defaultProps)for(r in n=t.defaultProps,n)a[r]===void 0&&(a[r]=n[r]);return{$$typeof:Vt,type:t,key:o,ref:i,props:a,_owner:Wt.current}}re.Fragment=Ut;re.jsx=$e;re.jsxs=$e;Te.exports=re;var e=Te.exports,me={},we=Nt;me.createRoot=we.createRoot,me.hydrateRoot=we.hydrateRoot;const Gt="modulepreload",Ht=function(t){return"/pravo/"+t},je={},N=function(n,s,r){let a=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));a=Promise.allSettled(s.map(d=>{if(d=Ht(d),d in je)return;je[d]=!0;const m=d.endsWith(".css"),g=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${g}`))return;const f=document.createElement("link");if(f.rel=m?"stylesheet":Gt,m||(f.as="script"),f.crossOrigin="",f.href=d,l&&f.setAttribute("nonce",l),document.head.appendChild(f),m)return new Promise((P,E)=>{f.addEventListener("load",P),f.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return a.then(i=>{for(const l of i||[])l.status==="rejected"&&o(l.reason);return n().catch(o)})},Jt=[{id:"obs",name:"OBS Studio",site:"https://obsproject.com/",platforms:["Windows","macOS","Linux"],pros:["Бесплатный и открытый исходный код","Гибкие сцены и источники, запись + трансляции","Много пресетов и плагинов","Поддержка аппаратного кодирования (NVENC/AMF/QuickSync)"],cons:["Относительно сложный старт без гайда","Может требовать тонкой настройки битрейта/кодека"],tips:['Формат записи: MP4 (H.264 + AAC), опция "Автозавершение записи при сбоях"',"Быстрый старт: Настройки → Вывод → Запись → Качество: Высокое; Кодек: H.264 (NVENC, если доступен)","Горячие клавиши: Настройки → Горячие клавиши → Старт/Стоп записи"]},{id:"xbox",name:"Xbox Game Bar",site:"ms-gamebar://",platforms:["Windows 10/11"],requires:"Встроено в Windows (Win+G)",pros:["Мгновенный старт без установки","Удобно для игр и окон","Минимальные настройки"],cons:["Меньше контроля качества/битрейта","Не всегда корректно пишет рабочий стол"],tips:["Откройте панель: Win+G; Начать запись: Win+Alt+R","Проверьте пути сохранения: Настройки → Захват"]},{id:"shadowplay",name:"NVIDIA ShadowPlay",site:"https://www.nvidia.com/en-us/geforce/geforce-experience/shadowplay/",platforms:["Windows"],requires:"Видеокарта NVIDIA + GeForce Experience",pros:["Малое влияние на FPS (NVENC)","Инстант‑повторы и оверлей","Хорошее качество без сложной настройки"],cons:["Только для карт NVIDIA","Нужна авторизация в GeForce Experience"],tips:["Откройте GeForce Experience → Настройки → Оверлей в игре → Запись","Рекомендуемый формат: MP4 (H.264, 1080p, 30–60 fps)"]},{id:"amd",name:"AMD ReLive (Adrenalin)",site:"https://www.amd.com/en/technologies/software",platforms:["Windows"],requires:"Видеокарта AMD + пакет Adrenalin",pros:["Аппаратное кодирование (AMF)","Инстант‑реплей, оверлей"],cons:["Только для видеокарт AMD"],tips:["Откройте Adrenalin → Захват и трансляция → Запись","Выберите MP4 (H.264) и 1080p 30–60 fps"]},{id:"bandicam",name:"Bandicam",site:"https://www.bandicam.com/downloads/",platforms:["Windows"],pros:["Простой интерфейс, запись области экрана","Поддержка веб‑камеры и наложений"],cons:["Платная лицензия, водяной знак в пробной версии"],tips:["Вывод MP4 (H.264 + AAC), фиксированные горячие клавиши (F12 по умолчанию)"]},{id:"camtasia",name:"Camtasia",site:"https://www.techsmith.com/download/camtasia/",platforms:["Windows","macOS"],pros:["Встроенный редактор видео","Хорош для обучающих роликов"],cons:["Платная, тяжелее по ресурсам"],tips:["Запись в высоком качестве, монтаж и экспорт в MP4"]},{id:"sharex",name:"ShareX (Видео/GIF)",site:"https://getsharex.com/",platforms:["Windows"],pros:["Легкая запись области экрана","Быстрые GIF/отрывки, автоматическая загрузка","Бесплатно"],cons:["Не так стабильно для длинных записей","Нужно установить кодеки (FFmpeg) для видео"],tips:["Настройки → Захват экрана → Установить FFmpeg внутри ShareX","Формат MP4 для длинных видео, GIF для коротких"]}];function Xt(t){return Jt.find(n=>n.id===t)}const oe=({title:t,children:n})=>e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"mb-2 flex items-center justify-between",children:e.jsx("h3",{className:"text-base font-semibold leading-tight",children:t})}),e.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:n})]});function Qt(){const{id:t}=_t(),n=Xt(t||"");return n?e.jsxs("div",{className:"min-h-screen text-zinc-900 dark:text-zinc-100",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:e.jsxs("div",{className:"mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3",children:[e.jsxs(I,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[e.jsx(zt,{className:"h-4 w-4"})," Назад"]}),e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsx("h1",{className:"text-lg font-bold leading-tight",children:n.name}),e.jsx("div",{className:"mt-1 text-xs text-zinc-500 dark:text-zinc-400",children:n.platforms.join(" · ")})]}),e.jsxs("a",{className:"btn",href:n.site,target:"_blank",rel:"noreferrer",children:["Открыть сайт ",e.jsx(It,{className:"h-4 w-4"})]})]})}),e.jsxs("main",{className:"mx-auto grid max-w-3xl grid-cols-1 gap-4 px-4 py-5",children:[n.requires&&e.jsxs("div",{className:"rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900 shadow-sm dark:border-amber-800/60 dark:bg-amber-900/25 dark:text-amber-200",children:["Требования: ",n.requires]}),e.jsx(oe,{title:"Плюсы",children:e.jsx("ul",{className:"ml-4 list-disc",children:n.pros.map((s,r)=>e.jsx("li",{children:s},r))})}),e.jsx(oe,{title:"Минусы",children:e.jsx("ul",{className:"ml-4 list-disc",children:n.cons.map((s,r)=>e.jsx("li",{children:s},r))})}),n.tips&&n.tips.length>0&&e.jsx(oe,{title:"Советы по настройке",children:e.jsx("ul",{className:"ml-4 list-disc",children:n.tips.map((s,r)=>e.jsx("li",{children:s},r))})})]})]}):e.jsxs("div",{className:"p-4",children:["Не найдено."," ",e.jsx(I,{to:"/",className:"text-blue-600 underline",children:"На главную"})]})}function Zt(){const[t,n]=c.useState("");return c.useEffect(()=>{try{n(localStorage.getItem("context_text")||"")}catch{}},[]),t?e.jsx("div",{className:"text-xs text-zinc-500 dark:text-zinc-400 whitespace-pre-line",children:t}):null}const q=({title:t,children:n})=>e.jsxs("div",{className:"card",children:[e.jsx("div",{className:"mb-2 flex items-center justify-between",children:e.jsx("h3",{className:"text-base font-semibold leading-tight",children:t})}),e.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:n})]});function en(){return e.jsxs("div",{className:"min-h-screen text-zinc-900 dark:text-zinc-100",children:[e.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:e.jsxs("div",{className:"mx-auto flex max-w-4xl items-center justify-between gap-3 px-4 py-3",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Ae,{className:"h-5 w-5"}),e.jsx("h1",{className:"text-lg font-bold leading-tight",children:"О нас"})]}),e.jsx(Zt,{}),e.jsx(I,{to:"/?tab=roles",className:"btn",children:"На главную"})]})}),e.jsxs("main",{className:"mx-auto grid max-w-4xl grid-cols-1 gap-4 px-4 py-6",children:[e.jsx(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Pt,{className:"h-4 w-4"}),"Короткий таймлайн"]}),children:e.jsxs("ul",{className:"not-prose grid gap-2 text-sm",children:[e.jsxs("li",{className:"rounded-lg border border-zinc-200 p-2 dark:border-zinc-800",children:[e.jsx("b",{children:"Середина Августа 2025."})," С другом хотели сделать маленькую «подсказку на F1». Получился первый прототип мини-сайта."]}),e.jsxs("li",{className:"rounded-lg border border-zinc-200 p-2 dark:border-zinc-800",children:[e.jsx("b",{children:"Конец Августа 2025."})," Появляется первая полноценная страница — ",e.jsx("i",{children:"«Роли»"}),". Структура начинает расти каждый день."]}),e.jsxs("li",{className:"rounded-lg border border-zinc-200 p-2 dark:border-zinc-800",children:[e.jsx("b",{children:"Сентябрь 2025."})," Расширение превращается в вызов: учимся работать устойчиво, без выгорания. На 14.09.2025 автор — ",e.jsx("i",{children:"начальник ДЗ"})," на SKY."]})]})}),e.jsxs(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(Mt,{className:"h-4 w-4"}),"История одной шпаргалки"]}),children:[e.jsxs("p",{children:["Меня зовут ",e.jsx("b",{children:"Pavel_Bolshoy"}),". На момент 14.09.2025 я — начальник ДЗ на сервере SKY. Когда-то мы с другом хотели сделать крошечную подсказку под ",e.jsx("b",{children:"F1"})," — пару строк, чтобы не лазить каждый раз по форуму. Подсказка не вышла. Вышло то, что вы читаете сейчас."]}),e.jsx("h4",{children:"Пролог. Почему вообще взялся"}),e.jsxs("p",{children:["Я поздно пришёл в РП и быстро понял, что «само разберётся» — не работает. Новичку никто не ведёт руку. Все заняты: у кого-то пост, у кого-то проверка, у кого-то отчёт. Ошибся — получи разнос, и никто не обязан объяснять, где именно свернул не туда. Я начал писать для себя короткие правила и ссылки, чтобы"," ",e.jsx("i",{children:"сначала понять, потом делать"}),". Через пару вечеров список перестал помещаться в заметку. Тогда и родилась мысль: собрать всё аккуратно — в одну страницу, в один стиль, в одну голову."]}),e.jsx("h4",{children:"Глава 1. Подсказка на F1"}),e.jsxs("p",{children:["Мы накинули быстрый набросок. В планах была одна страница — и всё. Но сразу захотелось нормальной структуры: не просто текст, а карточки, чек-листы, значки, источники. Первой полноценной страницей стали ",e.jsx("b",{children:"«Роли»"}),": кто за что отвечает, что проверяют на повышении, где чаще всего промахи. Когда эта страница ожила, стало ясно — одной подсказкой дело не закончится."]}),e.jsx("h4",{children:"Глава 2. Рост"}),e.jsxs("p",{children:["Каждый день появлялось по мелочи: к «Ролям» подтянулись ",e.jsx("b",{children:"процедуры"}),", к ним —",e.jsx("b",{children:"взаимодействия"}),", потом — ",e.jsx("b",{children:"законы и первоисточники"}),", далее — ",e.jsx("b",{children:"лекции, проверки, ВУ"}),". Мне хотелось, чтобы любая карточка решала конкретную задачу: «Я стою у поста. Что делаю каждые десять минут? Какой отчёт? А если выезд? А если конфликт?». Никакой воды — только действие, источник, оговорки, связанное."]}),e.jsx("p",{children:"Друзья увидели первые версии и неожиданно поддержали. Честный фидбек — это топливо. Когда сил мало, но тебе говорят: «Вот здесь стало понятнее», — садишься и дописываешь ещё один абзац. А потом ещё."}),e.jsx("h4",{children:"Глава 3. Цена расширения"}),e.jsx("p",{children:"Расширение оказалось сложнее, чем казалось. Когда разделов много, любое изменение тянет за собой ещё три. Пара вечеров — и ты выжат. Было выгорание: любая новая карточка кажется недописанной, а старая — устаревшей. Я признал очевидное: проект должен жить в устойчивом ритме, без ночных забегов и «сегодня всё перепишем». Лучше регулярно и чуть-чуть, чем рывками и с отвращением к своему коду. Если бы спросили, что изменить, — ничего. Этот путь научил главному: скорость — не самоцель; ценность — в точности и прозрачности."}),e.jsx("h4",{children:"Глава 4. Для кого это всё"}),e.jsxs("p",{children:["Прежде всего — для ",e.jsx("b",{children:"новичков"}),". В начале у человека нет общей карты территории: слова есть, а системы нет. Я делаю так, чтобы за две минуты было понятно, что от тебя хотят, что требуется доказать и где границы полномочий. Когда у новичка есть ясность — у старших меньше «разборов завалов», а у проверок меньше поводов для нервов."]}),e.jsx("h4",{children:"Глава 5. Правила игры и верификация"}),e.jsxs("p",{children:["База проекта — ",e.jsx("b",{children:"форум Amazing RP (сервер SKY)"})," и профильные ветки. Если где-то есть расхождение, приоритет за первоисточником, а на сайте появляется пометка и ссылка на спорное место. Смысл шпаргалки — быть короткой дверью к длинным документам, а не заменять их. Важные обновления помечаются бейджем «обновлено», а в «Что нового» ведётся краткая история изменений."]}),e.jsx("h4",{children:"Глава 6. Дружеский кредит"}),e.jsxs("p",{children:["У меня нет официального наставника, но есть люди, чьи реплики попали в цель. Спасибо"," ",e.jsx("b",{children:"Vladimir_Zmei"}),", ",e.jsx("b",{children:"Katalia_Rose"}),", ",e.jsx("b",{children:"Valeria_Kortezz"})," — за тесты, за цепкие замечания, за «а что если вот так». Ваши «мелочи» превращались в понятные блоки и экономили новичкам часы."]}),e.jsx("h4",{children:"Глава 7. Немного обо мне"}),e.jsx("p",{children:"Раньше я делал читы для CS:GO, CS2, GTA V и кучи одиночных игр. Да, такое было. Это дало понимание движков и систем, но забрало кучу времени и смысла. Сейчас этим не занимаюсь. Переключился на честную работу с правилами: прозрачность, доказуемость, ясные границы. Ирония в том, что опыт «по ту сторону» помогает: я вижу, где система ломается, и где её нужно укрепить текстом, структурой или простым «включи запись заранее»."}),e.jsx("h4",{children:"Глава 8. Что внутри и как этим пользоваться"}),e.jsxs("p",{children:["Сайт разложен по ",e.jsx("b",{children:"ролям"}),", ",e.jsx("b",{children:"процедурам"}),", ",e.jsx("b",{children:"взаимодействиям"}),". Каждая карточка устроена одинаково: смысл в одном предложении; шаги/чек-лист; исключения и оговорки; источник; связанное. Эта повторяемость не ради красоты — она экономит время тем, кому и так его не хватает."]}),e.jsx("h4",{children:"Глава 9. Код и ремесло"}),e.jsxs("p",{children:["Под капотом — ",e.jsx("b",{children:"React + Vite + TypeScript"}),". Меньше зависимости — меньше шансов, что всё развалится в критический момент. Главное требование к интерфейсу — ",e.jsx("b",{children:"два клика до цели"}),". Если нужно больше — значит, я недоработал."]}),e.jsx("h4",{children:"Глава 10. О выгорании и темпе"}),e.jsxs("p",{children:["Я много раз хотел «переписать всё по-взрослому». Каждый раз останавливал себя. Сайт полезен не потому, что идеально написан, а потому, что ",e.jsx("i",{children:"живёт"}),". Я двигаю его вперёд маленькими шагами: новая кнопка, одна строчка в чек-листе, правка формулировки, которая экономит кому-то предупреждение. Это и есть взрослая скорость."]}),e.jsx("h4",{children:"Глава 11. Обратная связь"}),e.jsxs("p",{children:["Самое ценное — короткое «здесь непонятно». Любая такая реплика — будущая карточка. Делитесь обратной связью прямо на форуме: в разделе «Идеи и вопросы» всегда открыта тема для предложений —"," ",e.jsx(I,{to:"/forum?tab=ideas",className:"underline decoration-dotted hover:no-underline",children:"оставьте сообщение"}),". Если критикуете, приложите пример — так правки доходят до релиза быстрее."]}),e.jsx("h4",{children:"Глава 12. Что дальше"}),e.jsxs("p",{children:["Планов много, обещаний мало. Хочу укрепить разделы ",e.jsx("b",{children:"повышений"}),", ",e.jsx("b",{children:"проверок"}),", ",e.jsx("b",{children:"лекций"}),", добавить больше примеров правильных рапортов с живыми ссылками (анонимно), упростить навигацию в «Законах». Идея на вырост — короткие видео до 60 секунд, которые не заменяют текст, а поддерживают его: показал, где нажать, дал чек-лист, ушёл делать."]}),e.jsx("h4",{children:"Глава 13. Чего не будет"}),e.jsx("p",{children:"Не будет «энциклопедии всего» — только то, что помогает принять решение. Не будет «серых схем» и «обходов». Этот проект вырос именно потому, что обходов мне хватило на прошлую жизнь."}),e.jsxs("blockquote",{className:"not-prose mt-4 rounded-lg border border-zinc-200 bg-zinc-50 p-4 text-sm italic dark:border-zinc-800 dark:bg-zinc-900/50",children:[e.jsx(Lt,{className:"mr-2 inline h-4 w-4 opacity-60"}),"Если вы новичок и вам кажется, что все вокруг уже всё знают — не верьте. Разница между «теряюсь» и «действую» — ясная структура и минимум трения. Этот сайт создан, чтобы стереть лишнее трение."]})]}),e.jsxs(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(te,{className:"h-4 w-4"}),"Что внутри — короткая карта разделов"]}),children:[e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("b",{children:"Роли и повышение:"})," требования, чек-листы, источники."]}),e.jsxs("li",{children:[e.jsx("b",{children:"Процедуры и взаимодействия:"})," шаги, нюансы, связанные материалы."]}),e.jsxs("li",{children:[e.jsx("b",{children:"Законы и документы:"})," быстрый поиск, краткие пометки, ссылки на первоисточники."]})]}),e.jsx("p",{children:"Единый визуальный язык: карточки, значки, аккуратные списки и ссылки — чтобы ориентироваться интуитивно."})]}),e.jsxs(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(pe,{className:"h-4 w-4"}),"Источники и обновления"]}),children:[e.jsxs("p",{children:["Базируемся на ",e.jsx("b",{children:"форуме Amazing RP (SKY)"})," и связанных ветках. При расхождениях приоритет за первоисточником. Важные правки помечаются «обновлено», история — в «Что нового»."]}),e.jsx("p",{className:"text-xs opacity-70",children:"Материалы носят справочный характер. Всегда сверяйте с актуальными правилами и регламентами."})]}),e.jsxs(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(At,{className:"h-4 w-4"}),"Спасибо и связь"]}),children:[e.jsxs("p",{children:["За поддержку и тесты: ",e.jsx("b",{children:"Vladimir_Zmei"}),", ",e.jsx("b",{children:"Katalia_Rose"}),", ",e.jsx("b",{children:"Valeria_Kortezz"}),". Официального наставника нет — проект растёт на практике и фидбеке."]}),e.jsx("p",{children:"Связаться с автором проще всего через форум — раздел «Обратная связь» отслеживается ежедневно."})]}),e.jsx(q,{title:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(he,{className:"h-4 w-4"}),"Для кого это"]}),children:e.jsx("p",{children:"Прежде всего — для новичков, которым важны порядок, прозрачность и уверенность в действиях. Если вы хотите быстрее разбираться в ролях и процедурах — вам понравится."})})]})]})}const tn=[{id:"guard",role:"Охранник (1)",salary:"18.000 руб.",duties:["Стоять на постах A1–E2, контролировать поток в здание и безопасность сотрудников","Сопровождать сотрудников (с должности Адвокат) и охранять кабинеты","Докладывать по регламенту (заступил/продолжаю/закончил пост; начал/веду/закончил охрану)"],promotion:["Отстоять на посту А-1/А-2 20 минут (доклад каждые 10 минут)","Отстоять на посту B-1/B-2 20 минут (доклад каждые 10 минут)","Отстоять на посту С-1/С-2 20 минут (доклад каждые 10 минут)","Прослушать лекцию «Субординация»","Прослушать лекцию «Правила пользования рацией»","Прослушать лекцию «Специальные средства»","Сдать базовый экзамен (внутренний устав, охрана правительственного аппарата, спец. средства)"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"chief-guard",role:"Начальник охраны (2)",salary:"20.000 руб.",duties:["Распределяет посты и смены охраны","Контролирует соблюдение уставной формы и дисциплины связи"],promotion:["Отстоять на посту А-1/А-2 20 минут (доклад каждые 10 минут)","Отстоять на посту B-1/B-2 20 минут (доклад каждые 10 минут)","Отстоять на посту Е-1/Е-2 20 минут (доклад каждые 10 минут)","Отстоять на посту D-1/D-2 20 минут (доклад каждые 10 минут)","Охрана любого сотрудника правительства (от должности Ревизор)","Прослушать лекцию «Юридическая деятельность»","Сдать экзамен на адвоката (УК, КоАП, юридическая консультация)"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"lawyer",role:"Адвокат (3)",salary:"23.000 руб.",duties:["Юридическая помощь заключённым; дежурство в комнате свиданий","Доклады: начало/продолжаю/закончил помощь; дежурство в КС","Задания для зачёта: консультации, УДО и др. (см. критерии/отчёт)"],promotion:["Оказать юридическую консультацию 5 заключённым ИК «Кресты»","Дежурство в комнате свиданий 30 минут (доклад каждые 10 минут)","Прослушать лекцию «Правила выдачи лицензий»","Прослушать лекцию «Правила проведения ревизий»","Сдать экзамен «ФЗ о территориях с ограниченным доступом»"],dept:["ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"inspector",role:"Инспектор (4)",salary:"26.000 руб.",duties:["Контроль собеседований; выездные проверки постов ГАИ/УМВД","Дежурство за стойкой регистрации; ведение отчётности","Участие в государственных проверках"],promotion:["Дежурство в холле правительства 60 минут (доклад каждые 20 минут)","Оформить 10 лицензий","Провести две ревизии","Прослушать лекцию «Департаменты правительственного аппарата»","Прослушать лекцию «Правила проведения проверок»","Сдать экзамен «Федеральное постановление»"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"advisor",role:"Советник (5)",salary:"29.000 руб.",duties:["Участие и координация проверок; методическая помощь отделам"],promotionByDept:{ДЗ:["Дежурство в холле ЕСС 60 минут (доклад каждые 20 минут)","Проконтролировать 2 собеседования в ЕСС","Проверка постов ЕСС (доклад на каждом посту)","Опрос 10 сотрудников ЕСС: «Отношение к наркотическим веществам?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ДВД:["Дежурство в холле ГАИ/УМВД 60 минут (доклад каждые 20 минут)","Проконтролировать 2 собеседования в ГАИ/УМВД","Проверка постов ГАИ (доклад на каждом посту)","Проверка постов УМВД (доклад на каждом посту)","Опрос 10 сотрудников ГАИ/УМВД: «Отношение к гражданам, находящимся в розыске?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ДВС:["Дежурство у КПП-1 ВЧ 60 минут (доклад каждые 20 минут)","Дежурство в военкомате 60 минут (доклад каждые 20 минут)","Проконтролировать 2 призыва в ВЧ","Опрос 10 сотрудников ВЧ: «Отношение к нелегальным структурам?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ЮД:["Дежурство в холле правительства 60 минут (доклад каждые 10 минут)","Провести 7 аттестаций сотрудникам","Провести 7 лекций сотрудникам","Проконтролировать 2 собеседования в Правительстве","Помощь/участие в проверке любой гос. организации","Прослушать лекцию «Снятие судимостей»"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"deputy-minister",role:"Заместитель министра (6)",salary:"32.000 руб.",duties:["Снятие судимостей гражданам (право с этой должности)","Организация и приём отчётности подразделений"],promotionByDept:{ДЗ:["Прослушивать рацию ЕСС 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ЕСС 60 минут (доклад каждые 20 минут)","Проконтролировать 3 собеседования в ЕСС","Опрос 15 сотрудников ЕСС: «Отношение к наркотическим веществам?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ДВД:["Прослушивать рацию ГАИ/УМВД/УФСИН 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ГАИ/УМВД 60 минут (доклад каждые 10 минут)","Проконтролировать 3 собеседования в ГАИ/УМВД/УФСИН","Опрос 15 сотрудников ГАИ/УМВД: «Отношение к гражданам, находящимся в розыске?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ДВС:["Прослушивать рацию ВЧ 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ВЧ 60 минут (доклад каждые 20 минут)","Проконтролировать 3 призыва в ВЧ","Опрос 15 сотрудников ВЧ: «Отношение к нелегальным структурам?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ЮД:["Провести 13 аттестаций","Провести 13 лекций","Контролировать рацию Правительства 60 минут (доклад каждые 10 минут)","Провести тренировку охране/начальникам охраны по теме «Задержание/сопровождение/спец. средства»","Помочь в проведении 3 собеседований","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"minister",role:"Министр (7)",salary:"35.000 руб.",duties:["Организует государственные проверки (инициатор)","Распоряжения в пределах департамента"],promotionByDept:{ДЗ:["На усмотрение губернатора"],ДВД:["На усмотрение губернатора"],ДВС:["На усмотрение губернатора"],ЮД:["На усмотрение губернатора"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"admin-chief",role:"Глава администрации (8)",salary:"38.000 руб.",duties:["Операционное управление правительственным аппаратом"],promotionByDept:{ДЗ:["На усмотрение губернатора"],ДВД:["На усмотрение губернатора"],ДВС:["На усмотрение губернатора"],ЮД:["На усмотрение губернатора"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"vice-governor",role:"Вице-губернатор (9)",salary:"41.000 руб.",duties:["Высшее руководство, указы, взаимодействие с ФСБ/ВЧ/ЕСС/МВД"],promotionByDept:{ДЗ:["—"],ДВД:["—"],ДВС:["—"],ЮД:["—"]},source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"governor",role:"Губернатор (10)",salary:"45.000 руб.",duties:["Общее руководство; указы/постановления; награждения по итогам проверок"],source:"https://forum.amazing-online.com/threads/ukazy-postanovlenija-rasporjazhenija-gubernatora-nizhegorodskoj-oblasti.1027740/"}],D="/pravo/",ke=[{slug:"constitution",abbr:"КОНСТ",title:"Конституция Нижегородской области",notes:"Базовые права, устройство власти.",updated:"2025-02-23",content:`# Конституция Нижегородской области
...
![Территория красной зоны воинской части](${D}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${D}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${D}img/cpp2.png)
...
![Территория военного грузового поезда](${D}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${D}img/pravo2.png)
![Правительство](${D}img/pravo.png)
...
`,sn=[{id:"gov",title:"Внутренний устав Правительства",text:nn,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],rn=["#bcd3ff","#6a79ff"],an={pal_ocean:["#bcd3ff","#6a79ff"],pal_sunset:["#ffd7a1","#ff6a88"],pal_void:["#a7b0ff","#5a2cff"],pal_blossom:["#ffb3d2","#ff77a9"],pal_midnight:["#2b2d55","#141729"],pal_aurora:["#7de3ff","#8b5cf6"],pal_candy:["#ffe6f3","#ffc8de"],pal_celestial:["#8ad7ff","#b388ff"],pal_softnight:["#1f2448","#513d8a"]};function on(t){return t?an[t]??null:null}const Oe="ui:density",De="ui:font",cn="ui:features",Be="ui:shadow",Fe="ui:radius",Ke="ui:glass",Ve="ui:readw",Ue="ui:anim",qe="buddy:enabled",We="buddy:skin_a",Ye="buddy:skin_b",ln="buddy:save:v1";function R(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function $(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function dn(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),$(Oe,t)}function un(){return R(Oe)==="compact"?"compact":"standard"}function mn(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),$(De,String(n))}function pn(){const t=R(De),n=parseFloat(t||"1");return isFinite(n)&&n>.6&&n<2?n:1}function hn(t,n=!0){const s=fn();return t in s?!!s[t]:n}function fn(){try{const t=R(cn);return t?JSON.parse(t):{}}catch{return{}}}function xn(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),$(Be,t)}function gn(){const t=R(Be);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function bn(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),$(Fe,t)}function yn(){const t=R(Fe);return t==="subtle"||t==="rounded"?t:"standard"}function vn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),$(Ke,String(n))}function wn(){const t=R(Ke),n=parseInt(t||"6",10);return isFinite(n)?n:6}function jn(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),$(Ve,String(n))}function kn(){const t=R(Ve),n=parseInt(t||"78",10);return isFinite(n)?n:78}function Nn(){try{dn(un()),mn(pn()),xn(gn()),bn(yn()),vn(wn()),jn(kn()),_n(Sn())}catch{}}function _n(t){document.documentElement.classList.toggle("anim-off",!t),$(Ue,t?"1":"0")}function Sn(){try{return R(Ue)!=="0"}catch{return!0}}function En(t){$(qe,t?"1":"0")}function zn(){try{return R(qe)!=="0"}catch{return!0}}function In(t,n){const s=/^#?[0-9a-fA-F]{6}$/.test(t)?t.startsWith("#")?t:"#"+t:"#bcd3ff",r=/^#?[0-9a-fA-F]{6}$/.test(n)?n.startsWith("#")?n:"#"+n:"#6a79ff";$(We,s),$(Ye,r)}function Pn(){const t=Ln();let n=R(We),s=R(Ye);if(t){const[o,i]=t;(!n||!s||n.toLowerCase()!==o.toLowerCase()||s.toLowerCase()!==i.toLowerCase())&&(In(o,i),n=o,s=i)}const[r,a]=rn;return{a:n||r,b:s||a}}function Ln(){var t,n;try{const s=R(ln);if(!s)return null;const r=JSON.parse(s),a=(n=(t=r==null?void 0:r.cosm)==null?void 0:t.equipped)==null?void 0:n.palette,o=on(typeof a=="string"?a:null);return o||null}catch{return null}}const Ge={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},L={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function He(...t){return t.filter(Boolean).join(" ")}function Je(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function Xe(t,n){c.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,o=18;const i=()=>{r=0;const m=t.current;m&&(m.style.setProperty("--lg-x",`${a}%`),m.style.setProperty("--lg-y",`${o}%`))},l=m=>{const g=t.current;if(!g)return;const f=g.getBoundingClientRect(),P=(m.clientX-f.left)/f.width*100,E=(m.clientY-f.top)/f.height*100;a=Math.max(0,Math.min(100,P)),o=Math.max(0,Math.min(100,E)),r||(r=window.requestAnimationFrame(i))},d=()=>{a=72,o=18,r||(r=window.requestAnimationFrame(i))};return s.addEventListener("pointermove",l,{passive:!0}),s.addEventListener("pointerdown",l,{passive:!0}),s.addEventListener("pointerenter",l,{passive:!0}),s.addEventListener("pointerleave",d),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",l),s.removeEventListener("pointerdown",l),s.removeEventListener("pointerenter",l),s.removeEventListener("pointerleave",d)}},[t,n])}function Ne(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function Z(t){return`${t[0]} ${t[1]} ${t[2]}`}function ie(t,n,s){return Math.round(t+(n-t)*s)}function _e(t,n){return[ie(t[0],n>=0?255:0,Math.abs(n)),ie(t[1],n>=0?255:0,Math.abs(n)),ie(t[2],n>=0?255:0,Math.abs(n))]}function Mn(t,n,s){const r=t?Ge[t]:n??L.tint,a=s??L.accent,o=Ne(r),i=Ne(a),l=_e(i,.25),d=_e(i,-.55);return{tintRgb:Z(o),accentRgb:Z(i),accentSoftRgb:Z(l),accentDeepRgb:Z(d)}}function Qe(t,n){const s={...t??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:o,accentDeepRgb:i}=Mn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=o,s["--lg-accent-deep"]=i,s}const Ze=c.forwardRef((t,n)=>{const{blur:s=L.blur,tint:r=L.tint,opacity:a=L.opacity,gloss:o=L.gloss,border:i=L.border,glints:l=L.glints,interactive:d=L.interactive,animate:m=L.animate,elevation:g=L.elevation,tone:f,accent:P=L.accent,className:E,style:y,children:v,..._}=t,h=Je(),w=d&&!h,u=c.useRef(null),b=c.useCallback(x=>{u.current=x,typeof n=="function"?n(x):n&&(n.current=x),x&&(x.style.setProperty("--lg-x","72%"),x.style.setProperty("--lg-y","18%"))},[n]);Xe(u,w);const S=c.useMemo(()=>Qe(y,{blur:s,tint:r,opacity:a,gloss:o,border:i,elevation:g,glints:l,tone:f,accent:P}),[y,s,r,a,o,i,g,l,f,P]),p={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*g}px ${50*g}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:b,className:He("liquid-glass",E),"data-animate":m?"true":"false","data-interactive":w?"true":"false",style:{...p,...S},..._,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),l&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),w&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:v}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:i,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Ze.displayName="LiquidGlass";const et=c.forwardRef((t,n)=>{const{className:s,style:r,children:a,type:o,blur:i,tint:l,opacity:d,gloss:m,border:g,glints:f,interactive:P,animate:E,elevation:y,tone:v,accent:_=L.accent,...h}=t,w=i??L.blur,u=v?Ge[v]:l??L.tint,b=d??.16,S=m??.9,p=g??.6,x=f??!1,W=P??!0,O=y??1,T=Je(),M=W&&!T,A=c.useRef(null),U=c.useCallback(k=>{A.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","70%"),k.style.setProperty("--lg-y","16%"))},[n]);Xe(A,M);const C=c.useMemo(()=>Qe(r,{blur:w,tint:u,opacity:b,gloss:S,border:p,glints:x,elevation:O,tone:v,accent:_}),[r,w,u,b,S,p,x,O,v,_]),K={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*O}px ${18*O}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:U,type:o??"button",className:He("liquid-glass liquid-glass__button",s),style:{...K,...C},...h,onMouseDown:k=>{k.currentTarget.style.transform="scale(0.985)"},onMouseUp:k=>{k.currentTarget.style.transform=""},onMouseLeave:k=>{k.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:a}),e.jsx("style",{children:`
      ...
      `})]})});et.displayName="LiquidGlass.Button";const X=Ze;X.Button=et;const tt="theme",nt="accent",st="accent_custom",rt="bg",An="bg_custom",at="ui:style-mode",ce="ui:liquid:prev-theme",ot="ui:liquid:tone";function F(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function V(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function Rn(t){try{typeof window<"u"&&window.localStorage.removeItem(t)}catch{}}const it={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Le,Me;const le=((Me=(Le=import.meta)==null?void 0:Le.env)==null?void 0:Me.BASE_URL)??"/",G=t=>{const n=t.replace(/^\/+/,"");return(le.endsWith("/")?le:le+"/")+n},ct={bg1:G("img/bg1.png"),bg2:G("img/bg2.png"),bg3:G("img/bg3.png"),bg4:G("img/bg4.png"),bg5:G("img/bg5.png")};function lt(){const t=F(tt);return t==="light"||t==="dark"?t:null}function Cn(){const t=F(nt);return t?t==="custom"?"custom":t in it?t:null:null}function Tn(){return F(st)}function dt(){const t=F(rt);return t&&(t==="none"||t==="custom"||t in ct)?t:null}function $n(){return F(An)}function ut(){const t=F(at);return t==="classic"||t==="liquid"?t:null}function On(){return(F(ot)||"dark")==="light"?"light":"dark"}function Dn(t){V(ot,t);const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{be(t==="light"?"light":"dark")}catch{}}function mt(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.dataset.styleMode=t,t==="liquid"){try{const s=lt()??(pt()?"dark":"light");V(ce,s);const r=On();Dn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=F(ce);(s==="light"||s==="dark")&&be(s),Rn(ce)}catch{}try{const s=dt()??"none";ft(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}V(at,t)}function pt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function be(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),V(tt,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function ht(t){if(t==="custom"){const n=Tn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Fn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=it[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}V(nt,t)}function Cs(t){V(st,xt(t)),ht("custom")}function ft(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const a=$n();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=ct[t];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}V(rt,t)}function Bn(){const n=lt()??(pt()?"dark":"light");be(n);const s=Cn()??"indigo";ht(s);const r=dt()??"none";ft(r);const a=ut()??"classic";mt(a)}function xt(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function Fn(t,n){const s=xt(t).slice(1),r=parseInt(s,16);let a=r>>16&255,o=r>>8&255,i=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n)));const l=d=>d.toString(16).padStart(2,"0");return`#${l(a)}${l(o)}${l(i)}`}function Se(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid")return t}try{return ut()??"classic"}catch{return"classic"}}function ae(){const[t,n]=c.useState(()=>Se());c.useEffect(()=>{const r=()=>{const i=Se();n(l=>l===i?l:i)},a=i=>{const l=i.detail;l==="classic"||l==="liquid"?n(l):r()};window.addEventListener("stylemodechange",a);const o=new MutationObserver(r);return o.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),o.disconnect()}},[]);const s=c.useCallback(r=>{mt(r),n(r)},[]);return[t,s]}function B(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function Kn(){if(!hn("cmd_palette",!0))return null;const[n]=ae(),[s,r]=c.useState(!1),[a,o]=c.useState(""),[i,l]=c.useState(0),[d,m]=c.useState(()=>localStorage.getItem("cp_filter")||"all");c.useEffect(()=>{try{localStorage.setItem("cp_filter",d)}catch{}},[d]);const[g,f]=c.useState(null);c.useEffect(()=>{(async()=>{try{const S=(await(await N(()=>import("./forumRemote-D5s3MT8n.js"),[])).listSections()).find(p=>String(p.title||"").toLowerCase()==="workshop");f((S==null?void 0:S.id)||null)}catch{}})()},[]);const E=c.useMemo(()=>{const u=[];u.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:B("/forum")}),u.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:B("/favorites")}),u.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:B("/settings")});for(const p of tn)u.push({kind:"role",id:p.id,title:p.role,subtitle:"������",url:B(`/roles/${p.id}`)});for(const p of ke)u.push({kind:"law",id:p.slug,title:p.title,subtitle:"�����",url:B(`/laws/${p.slug}`)});for(const p of sn)u.push({kind:"vu",id:p.id,title:p.title,subtitle:"��",url:B(`/vu/${p.id}`)});const b=a.trim().toLowerCase();return b&&u.push(...v(b).slice(0,60)),b?(d==="all"?u:u.filter(p=>p.kind===d)).map(p=>({r:p,score:y(`${p.title} ${p.subtitle||""}`.toLowerCase(),b)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,x)=>x.score-p.score).slice(0,30).map(p=>p.r):u.slice(0,20)},[a,d]);function y(u,b){return b.split(/\s+/).filter(Boolean).reduce((p,x)=>p+(u.includes(x)?1:0),0)}function v(u){const b=[],S=x=>x.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const x of ke){const O=(x.content||"").replace(/\r\n?/g,`
`).split(`
`);let T="",M="";const A=new Set;for(const U of O){const C=U.trim(),K=/^(#{2,6})\s*(.+)$/.exec(C);if(K){T=K[2].trim(),M=S(T)||"";const k=T.toLowerCase();if(M&&k.includes(u)){const Y=`${x.slug}#${M}`;if(!A.has(Y)){const Q={kind:"law",id:Y,title:`${x.title} � ${T}`,subtitle:"���������",url:B(`/laws/${x.slug}?q=${encodeURIComponent(u)}#${M}`)};Q.__boost=k.startsWith(u)?8:6,b.push(Q),A.add(Y)}}continue}if(C&&C.toLowerCase().includes(u)){const k=M?`${x.slug}#${M}`:x.slug;if(!A.has(k)){const Y=C.length>140?C.slice(0,137)+"�":C,Q=M?`${x.title} � ${T}`:x.title,kt=B(M?`/laws/${x.slug}?q=${encodeURIComponent(u)}#${M}`:`/laws/${x.slug}?q=${encodeURIComponent(u)}`),ye={kind:"law",id:k,title:Q,subtitle:Y||"��������",url:kt};ye.__boost=5,b.push(ye),A.add(k)}}}}const p=new Set;return b.filter(x=>p.has(x.id)?!1:(p.add(x.id),!0))}function _(u){r(!1);try{window.location.href=u}catch{location.assign(u)}}function h(u){E.length&&(u.key==="ArrowDown"&&(u.preventDefault(),l(b=>Math.min(b+1,E.length-1))),u.key==="ArrowUp"&&(u.preventDefault(),l(b=>Math.max(b-1,0))),u.key==="Enter"&&(u.preventDefault(),_(E[i].url)))}const w=({children:u})=>n==="liquid"?e.jsx(X,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:u}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:u});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:e.jsxs(w,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(fe,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:a,onChange:u=>{o(u.target.value),l(0)},onKeyDown:h,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:e.jsx(Re,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(u=>e.jsx("button",{onClick:()=>{m(u.k),l(0)},className:`chip ${d===u.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:u.label},u.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!E.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),E.map((u,b)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${b===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>l(b),onClick:()=>_(u.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[u.kind==="law"&&e.jsx(te,{className:"h-4 w-4"}),u.kind==="role"&&e.jsx(he,{className:"h-4 w-4"}),u.kind==="vu"&&e.jsx(pe,{className:"h-4 w-4"}),u.kind==="page"&&(u.id==="settings"?e.jsx(xe,{className:"h-4 w-4"}):e.jsx(ge,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:u.title})]}),u.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:u.subtitle})]},`${u.kind}:${u.id}`))]})]})}):null})}const Vn="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function Un(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function qn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Un()}}function Wn(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:t,...qn(),data:n}),r=`${Vn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}function Yn(){try{const n=new URL(window.location.href),s=n.searchParams.get("api");if(s){localStorage.setItem("forum:api_base",s);try{n.searchParams.delete("api"),history.replaceState({},"",n.toString())}catch{}}const r=localStorage.getItem("forum:api_base");if(r)return r}catch{}return"https://notifications-worker.wizardiowhy.workers.dev/skyapi"}const Gn=Yn(),ne="forum:token",Ee="forum:session";function gt(){return localStorage.getItem(ne)??sessionStorage.getItem(ne)}function Hn(){try{localStorage.removeItem(ne),sessionStorage.removeItem(ne),localStorage.removeItem(Ee),sessionStorage.removeItem(Ee)}finally{window.dispatchEvent(new Event("forum:session"))}}async function z(t,n={}){const s=gt(),r={"Content-Type":"application/json",...n.headers||{}};s&&(r.Authorization=`Bearer ${s}`);const a=await fetch(`${Gn}${t}`,{...n,headers:r}),o=await a.text();let i={};try{i=o?JSON.parse(o):{}}catch{i={error:o||a.statusText}}if(!a.ok)throw new Error((i==null?void 0:i.error)||`${a.status} ${a.statusText}`);return i}async function Jn(){if(!gt())return null;try{const{user:n}=await z("/me");return n}catch{return Hn(),null}}async function Ts(){const{users:t}=await z("/users");return t}async function $s(t,n){const{user:s}=await z(`/users/${t}/role`,{method:"PATCH",body:JSON.stringify({role:n})});return s}async function Os(){const{invites:t}=await z("/invites");return t}async function Ds(t=5,n){const{invites:s}=await z("/invites",{method:"POST",body:JSON.stringify({count:t,note:n})});return s}async function Bs(t,n){const s=JSON.stringify(n?{until:n}:{days:7}),{user:r}=await z("/users/"+encodeURIComponent(t)+"/ban",{method:"POST",body:s});return r}async function Fs(t){const{user:n}=await z("/users/"+encodeURIComponent(t)+"/unban",{method:"POST"});return n}async function Ks(t,n){const s=JSON.stringify(n?{until:n}:{minutes:60}),{user:r}=await z("/users/"+encodeURIComponent(t)+"/mute",{method:"POST",body:s});return r}async function Vs(t){const{user:n}=await z("/users/"+encodeURIComponent(t)+"/unmute",{method:"POST"});return n}async function Us(t){await z(`/invites/${encodeURIComponent(t)}`,{method:"DELETE"})}async function qs(){const{settings:t}=await z("/settings");return t}async function Ws(t){const{settings:n}=await z("/settings",{method:"PATCH",body:JSON.stringify(t)});return n}async function Ys(t){try{const n=await z(`/profiles/by-username/${encodeURIComponent(t)}`);return{user:n.user,profile:n.profile||null,stats:n.stats||null}}catch{return null}}async function Gs(t){const{profile:n}=await z("/profiles/me",{method:"PATCH",body:JSON.stringify(t)});return n}async function Hs(t){try{const{profile:n}=await z(`/profiles/${encodeURIComponent(t)}`);return n}catch{return null}}async function Js(t,n){const s={labels:Array.isArray(n)?n:[]},{profile:r}=await z(`/profiles/${encodeURIComponent(t)}/labels`,{method:"PATCH",body:JSON.stringify(s)});return r}async function Xs(t,n=30){const{user:s}=await z(`/users/${encodeURIComponent(t)}/vip`,{method:"POST",body:JSON.stringify({days:n})});return s}async function Qs(t){const{user:n}=await z(`/users/${encodeURIComponent(t)}/unvip`,{method:"POST"});return n}async function Zs(){const{members:t}=await z("/members");return t}const bt="forum:lastActive:";function Xn(t){try{localStorage.setItem(bt+t,new Date().toISOString())}catch{}}function er(t){try{return localStorage.getItem(bt+t)}catch{return null}}function tr(t){if(!t)return"";const n=new Date(t);if(Number.isNaN(n.getTime()))return"";try{const s=new Intl.RelativeTimeFormat("ru",{numeric:"auto"}),r=n.getTime()-Date.now(),a=1e3,o=60*a,i=60*o,l=24*i,d=30*l,m=365*l;return Math.abs(r)<o?s.format(Math.round(r/a),"second"):Math.abs(r)<i?s.format(Math.round(r/o),"minute"):Math.abs(r)<l?s.format(Math.round(r/i),"hour"):Math.abs(r)<d?s.format(Math.round(r/l),"day"):Math.abs(r)<m?s.format(Math.round(r/d),"month"):s.format(Math.round(r/m),"year")}catch{return n.toLocaleString()}}const ze="recent:items";function Qn(t,n){try{const s=localStorage.getItem(ze),r=s?JSON.parse(s):[],a={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const o=r.filter(d=>d.url!==t);o.unshift(a);const i=[],l=new Set;for(const d of o)l.has(d.url)||(l.add(d.url),i.push(d));for(;i.length>15;)i.pop();localStorage.setItem(ze,JSON.stringify(i))}catch{}}const se="forum:session";function nr(){try{const t=sessionStorage.getItem(se)??localStorage.getItem(se);return t?JSON.parse(t):null}catch{return null}}function sr(t){try{window.dispatchEvent(new Event("forum:session"))}catch{}}function yt(){const t=()=>{try{const r=sessionStorage.getItem(se)??localStorage.getItem(se);return r?JSON.parse(r):null}catch{return null}},[n,s]=ee.useState(t());return ee.useEffect(()=>{const r=()=>s(t());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const vt=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(ve,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(he,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Ct,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(Tt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx($t,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(ve,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(Ot,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(te,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(pe,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(te,{className:"h-4 w-4"}),id:"laws"}];function Zn(){const[t,n]=c.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=J(),[r]=ae(),o=!yt(),i=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=c.useMemo(()=>{const w=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),u=(s.hash||"").replace(/^#/,"").toLowerCase();return w||u||""},[s.search,s.hash]),d=c.useCallback(h=>l===h,[l]);c.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const w=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=w}}},[t]),c.useEffect(()=>{function h(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),c.useEffect(()=>{const h=document.documentElement;t?h.classList.add("has-sidebar"):h.classList.remove("has-sidebar")},[t]);const m=c.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),g=m?"⌘ K":"Ctrl K",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",P=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",E=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",y=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",v=h=>{const w=`?tab=${encodeURIComponent(h)}`;return i?{pathname:"/",search:w}:{pathname:"/",search:w,hash:`#${h}`}},_=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(I,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[vt.map(h=>{const w=h.type==="route"?s.pathname===h.to:d(h.id),u=h.type==="route"?h.to:v(h.id);return e.jsx("li",{children:e.jsxs(I,{to:u,className:[f,w?P:""].filter(Boolean).join(" "),"aria-current":w?"page":void 0,"aria-label":h.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[h.icon,e.jsx("span",{className:"truncate",children:h.label}),h.key==="forum"&&o&&e.jsx(Ce,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},h.key)}),e.jsx("li",{children:e.jsxs(I,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Ae,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(I,{to:"/buddy",className:f,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Rt,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:`${E} space-y-2`,children:[e.jsxs("div",{children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:g}),", чтобы открыть быстрый поиск"]}),e.jsx("div",{className:"text-[10px] uppercase tracking-[0.32em] opacity-60",children:e.jsx(I,{to:"/archive",className:"no-underline hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40",children:"Архив версий"})})]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(h=>!h),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:y,style:{paddingTop:"calc(var(--safe-top) + 1.25rem)",paddingBottom:"calc(var(--safe-bot) + 1.25rem)"},children:r==="liquid"?e.jsx(X,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:_}):_})]})}const es={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц уходят в служебный канал уведомлений.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},wt={entities:es};function ts(t){var s;return((s=wt.entities)==null?void 0:s[t])||null}function rr(t,n=30){const s=ts(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function ar(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,o=r.length,i=Array.from({length:a+1},()=>Array(o+1).fill(0));for(let g=a-1;g>=0;g--)for(let f=o-1;f>=0;f--)i[g][f]=s[g]===r[f]?i[g+1][f+1]+1:Math.max(i[g+1][f],i[g][f+1]);const l=[];let d=0,m=0;for(;d<a&&m<o;)s[d]===r[m]?(l.push(H(s[d])),d++,m++):i[d+1][m]>=i[d][m+1]?(l.push(`<del>${H(s[d])}</del>`),d++):(l.push(`<ins>${H(r[m])}</ins>`),m++);for(;d<a;)l.push(`<del>${H(s[d++])}</del>`);for(;m<o;)l.push(`<ins>${H(r[m++])}</ins>`);return l.join(`
`)}function H(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function ns(){var s;const t=[],n=wt.entities||{};for(const[r,a]of Object.entries(n)){const o=(s=a.changelog)==null?void 0:s[0];o&&t.push({id:r,version:o.version,date:o.date,summary:o.summary,details:o.details})}return t.sort((r,a)=>r.date<a.date?1:-1),t}function ss(){const[t]=ae(),n=J(),s=c.useMemo(()=>{try{const l=ns()[0];if(!l)return!1;const d=new Date(l.date+"T00:00:00Z");return(Date.now()-d.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const l=window.openCommandPalette;if(typeof l=="function")try{l();return}catch{}const d=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!d,metaKey:d}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",o=t==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",i=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var l;return(l=window.openMobileMenu)==null?void 0:l.call(window)},"aria-label":"Меню",children:e.jsx(Dt,{className:"h-4 w-4"})}),e.jsx(Bt,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(fe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(I,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(I,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(I,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(xe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:o,style:{paddingTop:"var(--safe-top)"},children:t==="liquid"?e.jsx(X,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:i}):e.jsx("div",{className:a,children:i})})}const rs="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",de="notif:lastSeen",Ie="notifications-panel";function as(){const[t,n]=c.useState(!1),[s,r]=c.useState([]),[a,o]=c.useState(0),[i,l]=c.useState(!1),[d,m]=c.useState(null),g=c.useRef(null),f=c.useCallback(async()=>{const y=new AbortController;l(!0),m(null);try{const v=await fetch(rs,{cache:"no-store",signal:y.signal});if(!v.ok)throw new Error(`HTTP ${v.status}`);const _=await v.json(),h=Array.isArray(_)?_:_.items||[],w=p=>p?new Date(p).getTime():0;h.sort((p,x)=>w(x.date)-w(p.date)),r(h);const u=typeof localStorage<"u"&&localStorage.getItem(de)||"",b=u?h.findIndex(p=>p.id===u):-1,S=b===-1?h.length:b;o(Math.max(0,S))}catch(v){(v==null?void 0:v.name)!=="AbortError"&&m("Не удалось загрузить уведомления")}finally{l(!1)}return()=>y.abort()},[]);c.useEffect(()=>{f()},[f]),c.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(de,s[0].id),o(0)}catch{}},[t,s]),c.useEffect(()=>{if(!t)return;const y=_=>{g.current&&(g.current.contains(_.target)||n(!1))},v=_=>{_.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",y),document.addEventListener("keydown",v),()=>{document.removeEventListener("mousedown",y),document.removeEventListener("keydown",v)}},[t]);const P=()=>n(y=>!y),E=y=>y?new Date(y).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:g,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:P,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":Ie,children:[e.jsx(Ft,{className:"h-4 w-4"}),a>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),t&&e.jsxs(X,{id:Ie,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),i?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):d?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:d}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(y=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:y.url||"#",target:y.url?"_blank":void 0,rel:y.url?"noreferrer":void 0,onClick:()=>{var v;try{(v=s[0])!=null&&v.id&&localStorage.setItem(de,s[0].id),o(0)}catch{}},children:[y.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:y.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:y.text}),y.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:E(y.date)})]})},y.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function os(){const[t,n]=c.useState(!1),s=J(),a=!yt();c.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),c.useEffect(()=>{if(!t)return;const d=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=d}},[t]);const o=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),i=d=>{const m=new URLSearchParams(s.search||"");m.set("tab",d);const g=`?${m.toString()}`;return o?{pathname:"/",search:g}:{pathname:"/",search:g,hash:`#${d}`}};function l(){const d=window.openCommandPalette;if(typeof d=="function")try{d()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(fe,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(Re,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:vt.map(d=>{const m=d.type==="route"?d.to:i(d.id);return e.jsx("li",{children:e.jsxs(I,{to:m,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[d.icon,e.jsx("span",{className:"truncate",children:d.label}),d.key==="forum"&&a&&e.jsx(Ce,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},d.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(I,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(ge,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(I,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(xe,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]}),e.jsx("div",{className:"px-4 pb-4 text-center text-[11px] uppercase tracking-[0.32em] text-zinc-500/80",children:e.jsx(I,{to:"/archive",className:"no-underline opacity-70 hover:opacity-100",onClick:()=>n(!1),children:"Архив версий"})})]})]}):null}const ue=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!","Я ❤️ Катю"];function is(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function cs(){const[t,n]=c.useState(null),[s,r]=c.useState(!0),a=c.useRef(Math.floor(Math.random()*ue.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches||!s)return null;const o=is(),i=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),l=!o&&!i,d=c.useRef(null),m=c.useRef(null),g=c.useRef(!1);c.useEffect(()=>{const h=d.current;if(!h)return;let w=0,u=performance.now(),b=Math.random()*(window.innerWidth-64)+16,S=Math.random()*(window.innerHeight-120)+60,p=(Math.random()*60+30)*(Math.random()>.5?1:-1),x=(Math.random()*40+20)*(Math.random()>.5?1:-1);const W=T=>{const M=Math.min(.05,(T-u)/1e3);if(u=T,l){b+=p*M,S+=x*M;const A=16,U=window.innerWidth,C=window.innerHeight,K=48,k=48;b<A&&(b=A,p=Math.abs(p)),b>U-K-A&&(b=U-K-A,p=-Math.abs(p)),S<60&&(S=60,x=Math.abs(x)),S>C-k-A&&(S=C-k-A,x=-Math.abs(x)),p+=(Math.random()-.5)*4,x+=(Math.random()-.5)*4}h.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(S)}px, 0)`,w=requestAnimationFrame(W)};w=requestAnimationFrame(W);const O=()=>{u=performance.now()};return window.addEventListener("resize",O),()=>{cancelAnimationFrame(w),window.removeEventListener("resize",O)}},[l]),c.useEffect(()=>()=>{m.current&&window.clearTimeout(m.current)},[]);function f(h){const w=h??ue[a.current++%ue.length];n(w),window.clearTimeout(f._t),f._t=window.setTimeout(()=>n(null),3e3)}function P(h){if(g.current){g.current=!1,h.preventDefault();return}if(h.altKey){h.preventDefault(),E();return}f()}function E(){g.current=!0,n(null),r(!1);try{En(!1)}catch{}}function y(h){m.current&&window.clearTimeout(m.current),!h.altKey&&(m.current=window.setTimeout(()=>{E(),m.current=null},650))}function v(){m.current&&(window.clearTimeout(m.current),m.current=null,g.current=!1)}const _=Pn();return e.jsx("div",{ref:d,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:P,onPointerDown:y,onPointerUp:v,onPointerLeave:v,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:_.a,stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:_.b,stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}function ls(){const[t,n]=c.useState(()=>{try{return localStorage.getItem("site:closure_notice_v1")!=="1"}catch{return!0}});return c.useEffect(()=>{if(!t)return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=s}},[t]),t?e.jsxs("div",{className:"fixed inset-0 z-[120] flex items-start justify-center p-4",children:[e.jsx("div",{className:"absolute inset-0 bg-black/10 backdrop-blur-[2px]","aria-hidden":!0}),e.jsxs("div",{className:"relative z-10 w-[min(720px,96vw)] rounded-2xl border border-white/10 bg-white/80 p-5 text-zinc-900 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/85 dark:text-zinc-100",children:[e.jsx("div",{className:"mb-2 text-xs uppercase tracking-[0.28em] text-zinc-500 dark:text-zinc-400",children:"Важное объявление"}),e.jsx("h2",{className:"mb-2 text-2xl font-bold",children:"Проект закрыт"}),e.jsx("p",{className:"mb-3 text-sm opacity-90",children:"Разработка и поддержка проекта прекращены. Форум остаётся открытым для всех желающих: можно читать и участвовать в обсуждениях в рамках действующих правил."}),e.jsxs("ul",{className:"mb-4 ml-4 list-disc text-sm opacity-90",children:[e.jsx("li",{children:"Если вы готовы продолжить и дорабатывать форум — напишите Екатерине."}),e.jsx("li",{children:"Автор больше не имеет отношения к проекту; на сайте остаётся только одно упоминание его ника."})]}),e.jsx("div",{className:"flex flex-wrap gap-2",children:e.jsx("button",{type:"button",className:"btn btn-primary",onClick:()=>{try{localStorage.setItem("site:closure_notice_v1","1")}catch{}n(!1)},children:"Понятно"})})]})]}):null}const ds=c.lazy(()=>N(()=>import("./GovCheatsheetSky-C2UXmZq-.js"),__vite__mapDeps([0,1,2,3,4]))),us=c.lazy(()=>N(()=>import("./WhatsNew-DiC3jowU.js"),__vite__mapDeps([5,1,2]))),ms=c.lazy(()=>N(()=>import("./DiffPage-WS1wbSW3.js"),__vite__mapDeps([6,1,2]))),ps=c.lazy(()=>N(()=>import("./LiquidGlassShowcase-C-McA4rk.js"),__vite__mapDeps([7,1,2]))),hs=c.lazy(()=>N(()=>import("./PrintSheet-C5ijjgM-.js"),__vite__mapDeps([8,1,2]))),fs=c.lazy(()=>N(()=>import("./RolePage-DVWq91UJ.js"),__vite__mapDeps([9,1,3,2,10]))),xs=c.lazy(()=>N(()=>import("./LawPage-kCPdwahw.js"),__vite__mapDeps([11,1,10,2,12]))),gs=c.lazy(()=>N(()=>import("./VuPage-DIbm74N2.js"),__vite__mapDeps([13,1,2]))),bs=c.lazy(()=>N(()=>import("./HomePage-C7pcs2cm.js"),__vite__mapDeps([14,1,2]))),ys=c.lazy(()=>N(()=>import("./ForumPage-Vi1oSGnf.js"),__vite__mapDeps([15,1,16,17,2,18]))),Pe=c.lazy(()=>N(()=>import("./ProfilePage-Cx8y2pZo.js"),__vite__mapDeps([19,1,20,21,2]))),vs=c.lazy(()=>N(()=>import("./ForumMembers-CF9-79XZ.js"),__vite__mapDeps([22,1,17,16,2,21,20]))),ws=c.lazy(()=>N(()=>import("./SectionPage-DlKCJhdY.js"),__vite__mapDeps([23,1,16,17,2,24,12,10]))),js=c.lazy(()=>N(()=>import("./TopicPage-CZFgo5Mh.js"),__vite__mapDeps([25,1,16,24,12,2,26,27]))),ks=c.lazy(()=>N(()=>import("./TagPage-BHq8pS1T.js"),__vite__mapDeps([28,1,16,17,2]))),Ns=c.lazy(()=>N(()=>import("./QuestionsPage-DYy28g3k.js"),__vite__mapDeps([29,1,16,24,12,2,26]))),_s=c.lazy(()=>N(()=>import("./AdminPanel3-Dp8Xt4Rn.js"),__vite__mapDeps([30,1,20,16,2]))),Ss=c.lazy(()=>N(()=>import("./ArchivePage-DKKccpmP.js"),__vite__mapDeps([31,1,2]))),Es=c.lazy(()=>N(()=>import("./SettingsPage-CnRghpZy.js"),__vite__mapDeps([32,1,4,2]))),zs=c.lazy(()=>N(()=>import("./FavoritesPage-BuNmdUfp.js"),__vite__mapDeps([33,1,10,2])));function Is(){const t=J();return ee.useEffect(()=>{Wn("page_view");try{Qn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}(async()=>{try{const n=await Jn();n&&Xn(n.id)}catch{}})()},[t.pathname,t.search,t.hash]),null}function Ps(){if((J().pathname||"").startsWith("/buddy"))return null;try{if(!zn())return null}catch{}return e.jsx(cs,{})}function Ls(){const[t]=ae();return e.jsxs("div",{className:"min-h-dvh w-full",style:{paddingTop:"var(--safe-top)",paddingBottom:"var(--safe-bot)"},children:[t==="liquid"&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(St,{basename:"/pravo/",children:[e.jsx(Kn,{}),e.jsx(Zn,{}),e.jsx(ss,{}),e.jsx(os,{}),e.jsx(ls,{}),e.jsx(Ps,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(as,{})}),e.jsx(Is,{}),e.jsx(c.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:e.jsxs(Et,{children:[e.jsx(j,{path:"/",element:e.jsx(ds,{})}),e.jsx(j,{path:"/home",element:e.jsx(bs,{})}),e.jsx(j,{path:"/forum/*",element:e.jsx(ys,{})}),e.jsx(j,{path:"/forum/section/:id",element:e.jsx(ws,{})}),e.jsx(j,{path:"/forum/topic/:id",element:e.jsx(js,{})}),e.jsx(j,{path:"/forum/questions",element:e.jsx(Ns,{})}),e.jsx(j,{path:"/forum/members",element:e.jsx(vs,{})}),e.jsx(j,{path:"/forum/profile/:username",element:e.jsx(Pe,{})}),e.jsx(j,{path:"/u/:username",element:e.jsx(Pe,{})}),e.jsx(j,{path:"/forum/tag/:tag",element:e.jsx(ks,{})}),e.jsx(j,{path:"/forum/admin",element:e.jsx(_s,{})}),e.jsx(j,{path:"/whats-new",element:e.jsx(us,{})}),e.jsx(j,{path:"/diff/:id",element:e.jsx(ms,{})}),e.jsx(j,{path:"/print",element:e.jsx(hs,{})}),e.jsx(j,{path:"/roles/:id",element:e.jsx(fs,{})}),e.jsx(j,{path:"/laws/:slug",element:e.jsx(xs,{})}),e.jsx(j,{path:"/vu/:id",element:e.jsx(gs,{})}),e.jsx(j,{path:"/recorders/:id",element:e.jsx(Qt,{})}),e.jsx(j,{path:"/about",element:e.jsx(en,{})}),e.jsx(j,{path:"/style/liquid",element:e.jsx(ps,{})}),e.jsx(j,{path:"/settings",element:e.jsx(Es,{})}),e.jsx(j,{path:"/favorites",element:e.jsx(zs,{})}),e.jsx(j,{path:"/archive",element:e.jsx(Ss,{})}),e.jsx(j,{path:"/forum/feeds",element:e.jsx(Ms,{})})]})})]})]})}const Ms=c.lazy(()=>N(()=>import("./ForumFeedsPage-CHpuLtYz.js"),__vite__mapDeps([34,1,17,16,2,18,27])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1759248870672";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(o=>caches.delete(o)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();Bn();Nn();function jt(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}jt();window.addEventListener("resize",jt,{passive:!0});me.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(Ls,{})}));export{Dn as $,Ds as A,Us as B,Zt as C,Ks as D,Vs as E,Bs as F,Fs as G,nr as H,sr as I,Cn as J,ut as K,X as L,un as M,pn as N,gn as O,yn as P,wn as Q,Sn as R,On as S,it as T,En as U,zn as V,Pn as W,be as X,pt as Y,mt as Z,_n as _,tn as a,ht as a0,Cs as a1,dn as a2,xn as a3,bn as a4,ct as a5,mn as a6,vn as a7,ts as b,Jn as c,ar as d,Hn as e,Zs as f,ns as g,Ys as h,rr as i,e as j,er as k,ke as l,tr as m,Gs as n,Ts as o,Os as p,qs as q,Jt as r,$s as s,Ws as t,ae as u,sn as v,Hs as w,Js as x,Xs as y,Qs as z};
