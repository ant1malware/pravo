const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-LS1wDJAA.js","assets/react-vendor-DTkXckhQ.js","assets/icons-GyIOUIPt.js","assets/VoteWidget-4FxkkydD.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-C3ePgYdR.js","assets/DiffPage-DULCkEXV.js","assets/LiquidGlassShowcase-Clhgk2aM.js","assets/PrintSheet-BYvZmS76.js","assets/RolePage-BmxKbIIk.js","assets/FavStar-B426RlrO.js","assets/LawPage-ClK9zeh9.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-BNMM6Sa7.js","assets/BuddyPlayground-BvF71czz.js","assets/HomePage-D0ZkHRN0.js","assets/ForumPage-GSSRM3XO.js","assets/authRemote-D08Z_Jso.js","assets/forumRemote-D5s3MT8n.js","assets/ForumSubnav-CiuJ-AUk.js","assets/ForumSearch-TiQaaG3P.js","assets/DevSeed-Dt6DUeCZ.js","assets/ProfilePage-A-xAZTVc.js","assets/forumStore-CpZCALPv.js","assets/Badge-Do78EOvq.js","assets/ForumMembers-P8K1giDb.js","assets/SectionPage-rkEACRWk.js","assets/MarkdownEditor-sNELiDyg.js","assets/TopicPage-pYUqityv.js","assets/ReactionBar-CHBxvH4O.js","assets/seo-Dt7ixYh-.js","assets/TagPage-CTh10Sc3.js","assets/QuestionsPage-CXSqL2ja.js","assets/AdminPanel3-U1Asuqz8.js","assets/SettingsPage-JeTv2jY5.js","assets/FavoritesPage-DnbGHuxQ.js","assets/ForumFeedsPage-etlDSfuu.js"])))=>i.map(i=>d[i]);
import{r as Z,a as yt,u as vt,L as M,R as i,b as H,B as wt,c as jt,d as j}from"./react-vendor-DTkXckhQ.js";import{A as kt,E as _t,I as Le,C as Et,Q as Nt,R as St,B as ee,S as me,H as zt,U as pe,a as he,X as Pe,b as fe,c as xe,L as Me,G as It,M as de,F as Lt,d as Pt,e as Mt,f as At,g as Rt,h as Ct,i as Tt}from"./icons-GyIOUIPt.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();var Ae={exports:{}},ne={};/**
 * @license React
...
`,Qt=[{id:"gov",title:"Внутренний устав Правительства",text:Jt,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Zt=["#bcd3ff","#6a79ff"],en={pal_ocean:["#bcd3ff","#6a79ff"],pal_sunset:["#ffd7a1","#ff6a88"],pal_void:["#a7b0ff","#5a2cff"],pal_blossom:["#ffb3d2","#ff77a9"],pal_midnight:["#2b2d55","#141729"],pal_aurora:["#7de3ff","#8b5cf6"],pal_candy:["#ffe6f3","#ffc8de"],pal_celestial:["#8ad7ff","#b388ff"],pal_softnight:["#1f2448","#513d8a"]};function tn(t){return t?en[t]??null:null}const Ce="ui:density",Te="ui:font",nn="ui:features",De="ui:shadow",$e="ui:radius",Be="ui:glass",Fe="ui:readw",Oe="ui:anim",Ve="buddy:enabled",Ke="buddy:skin_a",qe="buddy:skin_b",sn="buddy:save:v1";function A(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function T(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function rn(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),T(Ce,t)}function an(){return A(Ce)==="compact"?"compact":"standard"}function on(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),T(Te,String(n))}function ln(){const t=A(Te),n=parseFloat(t||"1");return isFinite(n)&&n>.6&&n<2?n:1}function cn(t,n=!0){const s=dn();return t in s?!!s[t]:n}function dn(){try{const t=A(nn);return t?JSON.parse(t):{}}catch{return{}}}function un(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),T(De,t)}function mn(){const t=A(De);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function pn(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),T($e,t)}function hn(){const t=A($e);return t==="subtle"||t==="rounded"?t:"standard"}function fn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),T(Be,String(n))}function xn(){const t=A(Be),n=parseInt(t||"6",10);return isFinite(n)?n:6}function gn(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),T(Fe,String(n))}function bn(){const t=A(Fe),n=parseInt(t||"78",10);return isFinite(n)?n:78}function yn(){try{rn(an()),on(ln()),un(mn()),pn(hn()),fn(xn()),gn(bn()),vn(wn())}catch{}}function vn(t){document.documentElement.classList.toggle("anim-off",!t),T(Oe,t?"1":"0")}function wn(){try{return A(Oe)!=="0"}catch{return!0}}function jn(t){T(Ve,t?"1":"0")}function kn(){try{return A(Ve)!=="0"}catch{return!0}}function _n(t,n){const s=/^#?[0-9a-fA-F]{6}$/.test(t)?t.startsWith("#")?t:"#"+t:"#bcd3ff",r=/^#?[0-9a-fA-F]{6}$/.test(n)?n.startsWith("#")?n:"#"+n:"#6a79ff";T(Ke,s),T(qe,r)}function En(){const t=Nn();let n=A(Ke),s=A(qe);if(t){const[o,l]=t;(!n||!s||n.toLowerCase()!==o.toLowerCase()||s.toLowerCase()!==l.toLowerCase())&&(_n(o,l),n=o,s=l)}const[r,a]=Zt;return{a:n||r,b:s||a}}function Nn(){var t,n;try{const s=A(sn);if(!s)return null;const r=JSON.parse(s),a=(n=(t=r==null?void 0:r.cosm)==null?void 0:t.equipped)==null?void 0:n.palette,o=tn(typeof a=="string"?a:null);return o||null}catch{return null}}const We={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},I={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Ge(...t){return t.filter(Boolean).join(" ")}function Ue(){const[t,n]=i.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return i.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function Ye(t,n){i.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,o=18;const l=()=>{r=0;const p=t.current;p&&(p.style.setProperty("--lg-x",`${a}%`),p.style.setProperty("--lg-y",`${o}%`))},c=p=>{const g=t.current;if(!g)return;const f=g.getBoundingClientRect(),z=(p.clientX-f.left)/f.width*100,S=(p.clientY-f.top)/f.height*100;a=Math.max(0,Math.min(100,z)),o=Math.max(0,Math.min(100,S)),r||(r=window.requestAnimationFrame(l))},d=()=>{a=72,o=18,r||(r=window.requestAnimationFrame(l))};return s.addEventListener("pointermove",c,{passive:!0}),s.addEventListener("pointerdown",c,{passive:!0}),s.addEventListener("pointerenter",c,{passive:!0}),s.addEventListener("pointerleave",d),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",c),s.removeEventListener("pointerdown",c),s.removeEventListener("pointerenter",c),s.removeEventListener("pointerleave",d)}},[t,n])}function je(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function Q(t){return`${t[0]} ${t[1]} ${t[2]}`}function ae(t,n,s){return Math.round(t+(n-t)*s)}function ke(t,n){return[ae(t[0],n>=0?255:0,Math.abs(n)),ae(t[1],n>=0?255:0,Math.abs(n)),ae(t[2],n>=0?255:0,Math.abs(n))]}function Sn(t,n,s){const r=t?We[t]:n??I.tint,a=s??I.accent,o=je(r),l=je(a),c=ke(l,.25),d=ke(l,-.55);return{tintRgb:Q(o),accentRgb:Q(l),accentSoftRgb:Q(c),accentDeepRgb:Q(d)}}function He(t,n){const s={...t??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:o,accentDeepRgb:l}=Sn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=o,s["--lg-accent-deep"]=l,s}const Xe=i.forwardRef((t,n)=>{const{blur:s=I.blur,tint:r=I.tint,opacity:a=I.opacity,gloss:o=I.gloss,border:l=I.border,glints:c=I.glints,interactive:d=I.interactive,animate:p=I.animate,elevation:g=I.elevation,tone:f,accent:z=I.accent,className:S,style:y,children:v,...E}=t,h=Ue(),w=d&&!h,u=i.useRef(null),b=i.useCallback(x=>{u.current=x,typeof n=="function"?n(x):n&&(n.current=x),x&&(x.style.setProperty("--lg-x","72%"),x.style.setProperty("--lg-y","18%"))},[n]);Ye(u,w);const N=i.useMemo(()=>He(y,{blur:s,tint:r,opacity:a,gloss:o,border:l,elevation:g,glints:c,tone:f,accent:z}),[y,s,r,a,o,l,g,c,f,z]),m={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*g}px ${50*g}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:b,className:Ge("liquid-glass",S),"data-animate":p?"true":"false","data-interactive":w?"true":"false",style:{...m,...N},...E,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),c&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),w&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:v}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:l,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Xe.displayName="LiquidGlass";const Je=i.forwardRef((t,n)=>{const{className:s,style:r,children:a,type:o,blur:l,tint:c,opacity:d,gloss:p,border:g,glints:f,interactive:z,animate:S,elevation:y,tone:v,accent:E=I.accent,...h}=t,w=l??I.blur,u=v?We[v]:c??I.tint,b=d??.16,N=p??.9,m=g??.6,x=f??!1,W=z??!0,D=y??1,C=Ue(),L=W&&!C,P=i.useRef(null),K=i.useCallback(_=>{P.current=_,typeof n=="function"?n(_):n&&(n.current=_),_&&(_.style.setProperty("--lg-x","70%"),_.style.setProperty("--lg-y","16%"))},[n]);Ye(P,L);const R=i.useMemo(()=>He(r,{blur:w,tint:u,opacity:b,gloss:N,border:m,glints:x,elevation:D,tone:v,accent:E}),[r,w,u,b,N,m,x,D,v,E]),O={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*D}px ${18*D}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:K,type:o??"button",className:Ge("liquid-glass liquid-glass__button",s),style:{...O,...R},...h,onMouseDown:_=>{_.currentTarget.style.transform="scale(0.985)"},onMouseUp:_=>{_.currentTarget.style.transform=""},onMouseLeave:_=>{_.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:a}),e.jsx("style",{children:`
      ...
      `})]})});Je.displayName="LiquidGlass.Button";const X=Xe;X.Button=Je;const Qe="theme",Ze="accent",et="accent_custom",tt="bg",zn="bg_custom",nt="ui:style-mode",ie="ui:liquid:prev-theme",st="ui:liquid:tone";function F(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function V(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function In(t){try{typeof window<"u"&&window.localStorage.removeItem(t)}catch{}}const rt={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var ze,Ie;const oe=((Ie=(ze=import.meta)==null?void 0:ze.env)==null?void 0:Ie.BASE_URL)??"/",U=t=>{const n=t.replace(/^\/+/,"");return(oe.endsWith("/")?oe:oe+"/")+n},at={bg1:U("img/bg1.png"),bg2:U("img/bg2.png"),bg3:U("img/bg3.png"),bg4:U("img/bg4.png"),bg5:U("img/bg5.png")};function it(){const t=F(Qe);return t==="light"||t==="dark"?t:null}function Ln(){const t=F(Ze);return t?t==="custom"?"custom":t in rt?t:null:null}function Pn(){return F(et)}function ot(){const t=F(tt);return t&&(t==="none"||t==="custom"||t in at)?t:null}function Mn(){return F(zn)}function lt(){const t=F(nt);return t==="classic"||t==="liquid"||t==="beta"?t:null}function An(){return(F(st)||"dark")==="light"?"light":"dark"}function Rn(t){V(st,t);const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{ge(t==="light"?"light":"dark")}catch{}}function ct(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=it()??(dt()?"dark":"light");V(ie,s);const r=An();Rn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=F(ie);(s==="light"||s==="dark")&&ge(s),In(ie)}catch{}try{const s=ot()??"none";mt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}V(nt,t)}function dt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function ge(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),V(Qe,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function ut(t){if(t==="custom"){const n=Pn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Tn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=rt[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}V(Ze,t)}function Es(t){V(et,pt(t)),ut("custom")}function mt(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const a=Mn();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=at[t];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}V(tt,t)}function Cn(){const n=it()??(dt()?"dark":"light");ge(n);const s=Ln()??"indigo";ut(s);const r=ot()??"none";mt(r);const a=lt()??"classic";ct(a)}function pt(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function Tn(t,n){const s=pt(t).slice(1),r=parseInt(s,16);let a=r>>16&255,o=r>>8&255,l=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n))),l=Math.max(0,Math.min(255,Math.round(l+255*n)));const c=d=>d.toString(16).padStart(2,"0");return`#${c(a)}${c(o)}${c(l)}`}function _e(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return lt()??"classic"}catch{return"classic"}}function se(){const[t,n]=i.useState(()=>_e());i.useEffect(()=>{const r=()=>{const l=_e();n(c=>c===l?c:l)},a=l=>{const c=l.detail;c==="classic"||c==="liquid"||c==="beta"?n(c):r()};window.addEventListener("stylemodechange",a);const o=new MutationObserver(r);return o.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),o.disconnect()}},[]);const s=i.useCallback(r=>{ct(r),n(r)},[]);return[t,s]}function B(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function Dn(){if(!cn("cmd_palette",!0))return null;const[n]=se(),[s,r]=i.useState(!1),[a,o]=i.useState(""),[l,c]=i.useState(0),[d,p]=i.useState(()=>localStorage.getItem("cp_filter")||"all");i.useEffect(()=>{try{localStorage.setItem("cp_filter",d)}catch{}},[d]);const[g,f]=i.useState(null);i.useEffect(()=>{(async()=>{try{const N=(await(await k(()=>import("./forumRemote-D5s3MT8n.js"),[])).listSections()).find(m=>String(m.title||"").toLowerCase()==="workshop");f((N==null?void 0:N.id)||null)}catch{}})()},[]);const S=i.useMemo(()=>{const u=[];u.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:B("/forum")}),u.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:B("/favorites")}),u.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:B("/settings")});for(const m of Xt)u.push({kind:"role",id:m.id,title:m.role,subtitle:"������",url:B(`/roles/${m.id}`)});for(const m of we)u.push({kind:"law",id:m.slug,title:m.title,subtitle:"�����",url:B(`/laws/${m.slug}`)});for(const m of Qt)u.push({kind:"vu",id:m.id,title:m.title,subtitle:"��",url:B(`/vu/${m.id}`)});const b=a.trim().toLowerCase();return b&&u.push(...v(b).slice(0,60)),b?(d==="all"?u:u.filter(m=>m.kind===d)).map(m=>({r:m,score:y(`${m.title} ${m.subtitle||""}`.toLowerCase(),b)+(m.__boost||0)})).filter(m=>m.score>0).sort((m,x)=>x.score-m.score).slice(0,30).map(m=>m.r):u.slice(0,20)},[a,d]);function y(u,b){return b.split(/\s+/).filter(Boolean).reduce((m,x)=>m+(u.includes(x)?1:0),0)}function v(u){const b=[],N=x=>x.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const x of we){const D=(x.content||"").replace(/\r\n?/g,`
`).split(`
`);let C="",L="";const P=new Set;for(const K of D){const R=K.trim(),O=/^(#{2,6})\s*(.+)$/.exec(R);if(O){C=O[2].trim(),L=N(C)||"";const _=C.toLowerCase();if(L&&_.includes(u)){const G=`${x.slug}#${L}`;if(!P.has(G)){const J={kind:"law",id:G,title:`${x.title} � ${C}`,subtitle:"���������",url:B(`/laws/${x.slug}?q=${encodeURIComponent(u)}#${L}`)};J.__boost=_.startsWith(u)?8:6,b.push(J),P.add(G)}}continue}if(R&&R.toLowerCase().includes(u)){const _=L?`${x.slug}#${L}`:x.slug;if(!P.has(_)){const G=R.length>140?R.slice(0,137)+"�":R,J=L?`${x.title} � ${C}`:x.title,bt=B(L?`/laws/${x.slug}?q=${encodeURIComponent(u)}#${L}`:`/laws/${x.slug}?q=${encodeURIComponent(u)}`),be={kind:"law",id:_,title:J,subtitle:G||"��������",url:bt};be.__boost=5,b.push(be),P.add(_)}}}}const m=new Set;return b.filter(x=>m.has(x.id)?!1:(m.add(x.id),!0))}function E(u){r(!1);try{window.location.href=u}catch{location.assign(u)}}function h(u){S.length&&(u.key==="ArrowDown"&&(u.preventDefault(),c(b=>Math.min(b+1,S.length-1))),u.key==="ArrowUp"&&(u.preventDefault(),c(b=>Math.max(b-1,0))),u.key==="Enter"&&(u.preventDefault(),E(S[l].url)))}const w=({children:u})=>n==="liquid"?e.jsx(X,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:u}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:u});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:e.jsxs(w,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(he,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:a,onChange:u=>{o(u.target.value),c(0)},onKeyDown:h,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:e.jsx(Pe,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(u=>e.jsx("button",{onClick:()=>{p(u.k),c(0)},className:`chip ${d===u.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:u.label},u.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!S.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),S.map((u,b)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${b===l?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>c(b),onClick:()=>E(u.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[u.kind==="law"&&e.jsx(ee,{className:"h-4 w-4"}),u.kind==="role"&&e.jsx(pe,{className:"h-4 w-4"}),u.kind==="vu"&&e.jsx(me,{className:"h-4 w-4"}),u.kind==="page"&&(u.id==="settings"?e.jsx(fe,{className:"h-4 w-4"}):e.jsx(xe,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:u.title})]}),u.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:u.subtitle})]},`${u.kind}:${u.id}`))]})]})}):null})}const $n="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function Bn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function Fn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Bn()}}function On(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:t,...Fn(),data:n}),r=`${$n}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const Ee="recent:items";function Vn(t,n){try{const s=localStorage.getItem(Ee),r=s?JSON.parse(s):[],a={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const o=r.filter(d=>d.url!==t);o.unshift(a);const l=[],c=new Set;for(const d of o)c.has(d.url)||(c.add(d.url),l.push(d));for(;l.length>15;)l.pop();localStorage.setItem(Ee,JSON.stringify(l))}catch{}}const te="forum:session";function Ns(){try{const t=sessionStorage.getItem(te)??localStorage.getItem(te);return t?JSON.parse(t):null}catch{return null}}function Ss(t){try{window.dispatchEvent(new Event("forum:session"))}catch{}}function ht(){const t=()=>{try{const r=sessionStorage.getItem(te)??localStorage.getItem(te);return r?JSON.parse(r):null}catch{return null}},[n,s]=Z.useState(t());return Z.useEffect(()=>{const r=()=>s(t());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const ft=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(de,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(pe,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Lt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(Pt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(Mt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(de,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(At,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(ee,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(me,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(ee,{className:"h-4 w-4"}),id:"laws"}];function Kn(){const[t,n]=i.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=H(),[r]=se(),o=!ht(),l=i.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),c=i.useMemo(()=>{const w=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),u=(s.hash||"").replace(/^#/,"").toLowerCase();return w||u||""},[s.search,s.hash]),d=i.useCallback(h=>c===h,[c]);i.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const w=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=w}}},[t]),i.useEffect(()=>{function h(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),i.useEffect(()=>{const h=document.documentElement;t?h.classList.add("has-sidebar"):h.classList.remove("has-sidebar")},[t]);const p=i.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),g=p?"⌘ K":"Ctrl K",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",z=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",S=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",y=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",v=h=>{const w=`?tab=${encodeURIComponent(h)}`;return l?{pathname:"/",search:w}:{pathname:"/",search:w,hash:`#${h}`}},E=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(M,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[ft.map(h=>{const w=h.type==="route"?s.pathname===h.to:d(h.id),u=h.type==="route"?h.to:v(h.id);return e.jsx("li",{children:e.jsxs(M,{to:u,className:[f,w?z:""].filter(Boolean).join(" "),"aria-current":w?"page":void 0,"aria-label":h.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[h.icon,e.jsx("span",{className:"truncate",children:h.label}),h.key==="forum"&&o&&e.jsx(Me,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},h.key)}),e.jsx("li",{children:e.jsxs(M,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Le,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(M,{to:"/buddy",className:f,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(It,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:S,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:g}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(h=>!h),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:y,children:r==="liquid"?e.jsx(X,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:E}):E})]})}const qn={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},xt={entities:qn};function Wn(t){var s;return((s=xt.entities)==null?void 0:s[t])||null}function zs(t,n=30){const s=Wn(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function Is(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,o=r.length,l=Array.from({length:a+1},()=>Array(o+1).fill(0));for(let g=a-1;g>=0;g--)for(let f=o-1;f>=0;f--)l[g][f]=s[g]===r[f]?l[g+1][f+1]+1:Math.max(l[g+1][f],l[g][f+1]);const c=[];let d=0,p=0;for(;d<a&&p<o;)s[d]===r[p]?(c.push(Y(s[d])),d++,p++):l[d+1][p]>=l[d][p+1]?(c.push(`<del>${Y(s[d])}</del>`),d++):(c.push(`<ins>${Y(r[p])}</ins>`),p++);for(;d<a;)c.push(`<del>${Y(s[d++])}</del>`);for(;p<o;)c.push(`<ins>${Y(r[p++])}</ins>`);return c.join(`
`)}function Y(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Gn(){var s;const t=[],n=xt.entities||{};for(const[r,a]of Object.entries(n)){const o=(s=a.changelog)==null?void 0:s[0];o&&t.push({id:r,version:o.version,date:o.date,summary:o.summary,details:o.details})}return t.sort((r,a)=>r.date<a.date?1:-1),t}function Un(){const[t]=se(),n=H(),s=i.useMemo(()=>{try{const c=Gn()[0];if(!c)return!1;const d=new Date(c.date+"T00:00:00Z");return(Date.now()-d.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const c=window.openCommandPalette;if(typeof c=="function")try{c();return}catch{}const d=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!d,metaKey:d}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",o=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",l=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var c;return(c=window.openMobileMenu)==null?void 0:c.call(window)},"aria-label":"Меню",children:e.jsx(Rt,{className:"h-4 w-4"})}),e.jsx(Ct,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(he,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(xe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(fe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(de,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:o,children:t==="liquid"?e.jsx(X,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:l}):e.jsx("div",{className:a,children:l})})}const Yn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",le="notif:lastSeen",Ne="notifications-panel";function Hn(){const[t,n]=i.useState(!1),[s,r]=i.useState([]),[a,o]=i.useState(0),[l,c]=i.useState(!1),[d,p]=i.useState(null),g=i.useRef(null),f=i.useCallback(async()=>{const y=new AbortController;c(!0),p(null);try{const v=await fetch(Yn,{cache:"no-store",signal:y.signal});if(!v.ok)throw new Error(`HTTP ${v.status}`);const E=await v.json(),h=Array.isArray(E)?E:E.items||[],w=m=>m?new Date(m).getTime():0;h.sort((m,x)=>w(x.date)-w(m.date)),r(h);const u=typeof localStorage<"u"&&localStorage.getItem(le)||"",b=u?h.findIndex(m=>m.id===u):-1,N=b===-1?h.length:b;o(Math.max(0,N))}catch(v){(v==null?void 0:v.name)!=="AbortError"&&p("Не удалось загрузить уведомления")}finally{c(!1)}return()=>y.abort()},[]);i.useEffect(()=>{f()},[f]),i.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(le,s[0].id),o(0)}catch{}},[t,s]),i.useEffect(()=>{if(!t)return;const y=E=>{g.current&&(g.current.contains(E.target)||n(!1))},v=E=>{E.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",y),document.addEventListener("keydown",v),()=>{document.removeEventListener("mousedown",y),document.removeEventListener("keydown",v)}},[t]);const z=()=>n(y=>!y),S=y=>y?new Date(y).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:g,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:z,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":Ne,children:[e.jsx(Tt,{className:"h-4 w-4"}),a>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),t&&e.jsxs(X,{id:Ne,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),l?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):d?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:d}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(y=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:y.url||"#",target:y.url?"_blank":void 0,rel:y.url?"noreferrer":void 0,onClick:()=>{var v;try{(v=s[0])!=null&&v.id&&localStorage.setItem(le,s[0].id),o(0)}catch{}},children:[y.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:y.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:y.text}),y.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:S(y.date)})]})},y.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function Xn(){const[t,n]=i.useState(!1),s=H(),a=!ht();i.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),i.useEffect(()=>{if(!t)return;const d=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=d}},[t]);const o=i.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=d=>{const p=new URLSearchParams(s.search||"");p.set("tab",d);const g=`?${p.toString()}`;return o?{pathname:"/",search:g}:{pathname:"/",search:g,hash:`#${d}`}};function c(){const d=window.openCommandPalette;if(typeof d=="function")try{d()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:c,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(he,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(Pe,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:ft.map(d=>{const p=d.type==="route"?d.to:l(d.id);return e.jsx("li",{children:e.jsxs(M,{to:p,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[d.icon,e.jsx("span",{className:"truncate",children:d.label}),d.key==="forum"&&a&&e.jsx(Me,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},d.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(xe,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(fe,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ce=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!","Я ❤️ Катю"];function Jn(){const[t,n]=i.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return i.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function Qn(){const[t,n]=i.useState(null),[s,r]=i.useState(!0),a=i.useRef(Math.floor(Math.random()*ce.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches||!s)return null;const o=Jn(),l=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),c=!o&&!l,d=i.useRef(null),p=i.useRef(null),g=i.useRef(!1);i.useEffect(()=>{const h=d.current;if(!h)return;let w=0,u=performance.now(),b=Math.random()*(window.innerWidth-64)+16,N=Math.random()*(window.innerHeight-120)+60,m=(Math.random()*60+30)*(Math.random()>.5?1:-1),x=(Math.random()*40+20)*(Math.random()>.5?1:-1);const W=C=>{const L=Math.min(.05,(C-u)/1e3);if(u=C,c){b+=m*L,N+=x*L;const P=16,K=window.innerWidth,R=window.innerHeight,O=48,_=48;b<P&&(b=P,m=Math.abs(m)),b>K-O-P&&(b=K-O-P,m=-Math.abs(m)),N<60&&(N=60,x=Math.abs(x)),N>R-_-P&&(N=R-_-P,x=-Math.abs(x)),m+=(Math.random()-.5)*4,x+=(Math.random()-.5)*4}h.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(N)}px, 0)`,w=requestAnimationFrame(W)};w=requestAnimationFrame(W);const D=()=>{u=performance.now()};return window.addEventListener("resize",D),()=>{cancelAnimationFrame(w),window.removeEventListener("resize",D)}},[c]),i.useEffect(()=>()=>{p.current&&window.clearTimeout(p.current)},[]);function f(h){const w=h??ce[a.current++%ce.length];n(w),window.clearTimeout(f._t),f._t=window.setTimeout(()=>n(null),3e3)}function z(h){if(g.current){g.current=!1,h.preventDefault();return}if(h.altKey){h.preventDefault(),S();return}f()}function S(){g.current=!0,n(null),r(!1);try{jn(!1)}catch{}}function y(h){p.current&&window.clearTimeout(p.current),!h.altKey&&(p.current=window.setTimeout(()=>{S(),p.current=null},650))}function v(){p.current&&(window.clearTimeout(p.current),p.current=null,g.current=!1)}const E=En();return e.jsx("div",{ref:d,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:z,onPointerDown:y,onPointerUp:v,onPointerLeave:v,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:E.a,stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:E.b,stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Zn=i.lazy(()=>k(()=>import("./GovCheatsheetSky-LS1wDJAA.js"),__vite__mapDeps([0,1,2,3,4]))),es=i.lazy(()=>k(()=>import("./WhatsNew-C3ePgYdR.js"),__vite__mapDeps([5,1,2]))),ts=i.lazy(()=>k(()=>import("./DiffPage-DULCkEXV.js"),__vite__mapDeps([6,1,2]))),ns=i.lazy(()=>k(()=>import("./LiquidGlassShowcase-Clhgk2aM.js"),__vite__mapDeps([7,1,2]))),ss=i.lazy(()=>k(()=>import("./PrintSheet-BYvZmS76.js"),__vite__mapDeps([8,1,2]))),rs=i.lazy(()=>k(()=>import("./RolePage-BmxKbIIk.js"),__vite__mapDeps([9,1,3,2,10]))),as=i.lazy(()=>k(()=>import("./LawPage-ClK9zeh9.js"),__vite__mapDeps([11,1,10,2,12]))),is=i.lazy(()=>k(()=>import("./VuPage-BNMM6Sa7.js"),__vite__mapDeps([13,1,2]))),os=i.lazy(()=>k(()=>import("./BuddyPlayground-BvF71czz.js"),__vite__mapDeps([14,1,2]))),ls=i.lazy(()=>k(()=>import("./HomePage-D0ZkHRN0.js"),__vite__mapDeps([15,1,2]))),cs=i.lazy(()=>k(()=>import("./ForumPage-GSSRM3XO.js"),__vite__mapDeps([16,1,17,18,19,2,20]))),ds=i.lazy(()=>k(()=>import("./DevSeed-Dt6DUeCZ.js"),__vite__mapDeps([21,1,17,18,2]))),Se=i.lazy(()=>k(()=>import("./ProfilePage-A-xAZTVc.js"),__vite__mapDeps([22,1,23,17,24,2]))),us=i.lazy(()=>k(()=>import("./ForumMembers-P8K1giDb.js"),__vite__mapDeps([25,1,19,18,2,24,23,17]))),ms=i.lazy(()=>k(()=>import("./SectionPage-rkEACRWk.js"),__vite__mapDeps([26,1,18,19,2,27,12,10]))),ps=i.lazy(()=>k(()=>import("./TopicPage-pYUqityv.js"),__vite__mapDeps([28,1,17,18,27,12,2,29,30]))),hs=i.lazy(()=>k(()=>import("./TagPage-CTh10Sc3.js"),__vite__mapDeps([31,1,18,19,2]))),fs=i.lazy(()=>k(()=>import("./QuestionsPage-CXSqL2ja.js"),__vite__mapDeps([32,1,17,18,27,12,2,29]))),xs=i.lazy(()=>k(()=>import("./AdminPanel3-U1Asuqz8.js"),__vite__mapDeps([33,1,23,18,17,2]))),gs=i.lazy(()=>k(()=>import("./SettingsPage-JeTv2jY5.js"),__vite__mapDeps([34,1,4,2]))),bs=i.lazy(()=>k(()=>import("./FavoritesPage-DnbGHuxQ.js"),__vite__mapDeps([35,1,10,2])));function ys(){const t=H();return Z.useEffect(()=>{On("page_view");try{Vn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function vs(){if((H().pathname||"").startsWith("/buddy"))return null;try{if(!kn())return null}catch{}return e.jsx(Qn,{})}function ws(){const[t]=se();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(wt,{basename:"/pravo/",children:[e.jsx(Dn,{}),e.jsx(Kn,{}),e.jsx(Un,{}),e.jsx(Xn,{}),e.jsx(vs,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(Hn,{})}),e.jsx(ys,{}),e.jsx(i.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:e.jsxs(jt,{children:[e.jsx(j,{path:"/",element:e.jsx(Zn,{})}),e.jsx(j,{path:"/home",element:e.jsx(ls,{})}),e.jsx(j,{path:"/forum/*",element:e.jsx(cs,{})}),e.jsx(j,{path:"/forum/section/:id",element:e.jsx(ms,{})}),e.jsx(j,{path:"/forum/topic/:id",element:e.jsx(ps,{})}),e.jsx(j,{path:"/forum/questions",element:e.jsx(fs,{})}),e.jsx(j,{path:"/forum/members",element:e.jsx(us,{})}),e.jsx(j,{path:"/forum/profile/:username",element:e.jsx(Se,{})}),e.jsx(j,{path:"/u/:username",element:e.jsx(Se,{})}),e.jsx(j,{path:"/forum/tag/:tag",element:e.jsx(hs,{})}),e.jsx(j,{path:"/forum/admin",element:e.jsx(xs,{})}),e.jsx(j,{path:"/whats-new",element:e.jsx(es,{})}),e.jsx(j,{path:"/diff/:id",element:e.jsx(ts,{})}),e.jsx(j,{path:"/print",element:e.jsx(ss,{})}),e.jsx(j,{path:"/roles/:id",element:e.jsx(rs,{})}),e.jsx(j,{path:"/laws/:slug",element:e.jsx(as,{})}),e.jsx(j,{path:"/vu/:id",element:e.jsx(is,{})}),e.jsx(j,{path:"/recorders/:id",element:e.jsx(Ut,{})}),e.jsx(j,{path:"/about",element:e.jsx(Ht,{})}),e.jsx(j,{path:"/style/liquid",element:e.jsx(ns,{})}),e.jsx(j,{path:"/buddy",element:e.jsx(os,{})}),e.jsx(j,{path:"/settings",element:e.jsx(gs,{})}),e.jsx(j,{path:"/favorites",element:e.jsx(bs,{})}),e.jsx(j,{path:"/forum/feeds",element:e.jsx(js,{})}),e.jsx(j,{path:"/dev/seed",element:e.jsx(ds,{})})]})})]})]})}const js=i.lazy(()=>k(()=>import("./ForumFeedsPage-etlDSfuu.js"),__vite__mapDeps([36,1,19,18,2,20,30])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1759161233683";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(o=>caches.delete(o)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();Cn();yn();function gt(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}gt();window.addEventListener("resize",gt,{passive:!0});ue.createRoot(document.getElementById("root")).render(e.jsx(i.StrictMode,{children:e.jsx(ws,{})}));export{rt as A,En as B,Yt as C,ge as D,dt as E,ct as F,vn as G,Rn as H,ut as I,Es as J,rn as K,X as L,un as M,pn as N,at as O,on as P,fn as Q,Xt as a,Wn as b,tn as c,Is as d,Zt as e,Ns as f,Gn as g,Ss as h,zs as i,e as j,Ln as k,we as l,lt as m,an as n,ln as o,mn as p,hn as q,Wt as r,_n as s,xn as t,se as u,Qt as v,wn as w,An as x,jn as y,kn as z};
