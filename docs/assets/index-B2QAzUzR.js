const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-KPQFdMaX.js","assets/react-vendor-DTkXckhQ.js","assets/icons-DET5c9ig.js","assets/VoteWidget-Rl1vXbvh.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-C3QQoSIu.js","assets/DiffPage-BgG5Xq7Z.js","assets/LiquidGlassShowcase-DDWWAlMB.js","assets/PrintSheet-D0Ua7t0B.js","assets/RolePage-BeUg6O_3.js","assets/FavStar-CzWqUjs0.js","assets/LawPage-C7URdVtA.js","assets/VuPage-B-ZPWqSc.js","assets/BuddyPlayground-BczM1-NJ.js","assets/HomePage-B0K5_Lx0.js","assets/ForumPage-C9wpTYaj.js","assets/forumStore-K_YbTGrn.js","assets/forumRemote-CKuh-9l1.js","assets/ProfilePage-C2lc0uUw.js","assets/AdminPanel2-BoYTFZxl.js","assets/SettingsPage-B6MNGzrz.js","assets/FavoritesPage-Bq-rzRIs.js"])))=>i.map(i=>d[i]);
import{r as U,a as ct,u as dt,L as M,R as d,b as K,B as ut,c as mt,d as _}from"./react-vendor-DTkXckhQ.js";import{A as pt,E as ht,I as ke,C as gt,Q as xt,R as ft,B as Y,S as oe,H as bt,U as ie,a as le,X as Ne,b as ce,c as de,L as Se,G as yt,M as re,F as vt,d as wt,e as jt,f as kt,g as Nt,h as St,i as Et}from"./icons-DET5c9ig.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const u of c.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function s(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(o){if(o.ep)return;o.ep=!0;const c=s(o);fetch(o.href,c)}})();var Ee={exports:{}},X={};/**
 * @license React
...
`,qt=[{id:"gov",title:"Внутренний устав Правительства",text:Bt,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],ze="ui:density",Ie="ui:font",Kt="ui:features",Le="ui:shadow",Me="ui:radius",Pe="ui:glass",Re="ui:readw",Ae="ui:anim";function Vt(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),localStorage.setItem(ze,t)}function Wt(){return localStorage.getItem(ze)==="compact"?"compact":"standard"}function Gt(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(Ie,String(n))}function Ut(){const t=parseFloat(localStorage.getItem(Ie)||"1");return isFinite(t)&&t>.6&&t<2?t:1}function Yt(t,n=!0){const s=Ht();return t in s?!!s[t]:n}function Ht(){try{const t=localStorage.getItem(Kt);return t?JSON.parse(t):{}}catch{return{}}}function Xt(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),localStorage.setItem(Le,t)}function Jt(){const t=localStorage.getItem(Le);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function Qt(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),localStorage.setItem(Me,t)}function Zt(){const t=localStorage.getItem(Me);return t==="subtle"||t==="rounded"?t:"standard"}function en(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),localStorage.setItem(Pe,String(n))}function tn(){const t=parseInt(localStorage.getItem(Pe)||"6",10);return isFinite(t)?t:6}function nn(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),localStorage.setItem(Re,String(n))}function sn(){const t=parseInt(localStorage.getItem(Re)||"78",10);return isFinite(t)?t:78}function rn(){try{Vt(Wt()),Gt(Ut()),Xt(Jt()),Qt(Zt()),en(tn()),nn(sn()),an(on())}catch{}}function an(t){document.documentElement.classList.toggle("anim-off",!t);try{localStorage.setItem(Ae,t?"1":"0")}catch{}}function on(){try{return localStorage.getItem(Ae)!=="0"}catch{return!0}}const Ce={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},I={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function $e(...t){return t.filter(Boolean).join(" ")}function Te(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=o=>n(o.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function De(t,n){d.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,o=72,c=18;const u=()=>{r=0;const h=t.current;h&&(h.style.setProperty("--lg-x",`${o}%`),h.style.setProperty("--lg-y",`${c}%`))},i=h=>{const f=t.current;if(!f)return;const p=f.getBoundingClientRect(),w=(h.clientX-p.left)/p.width*100,N=(h.clientY-p.top)/p.height*100;o=Math.max(0,Math.min(100,w)),c=Math.max(0,Math.min(100,N)),r||(r=window.requestAnimationFrame(u))},l=()=>{o=72,c=18,r||(r=window.requestAnimationFrame(u))};return s.addEventListener("pointermove",i,{passive:!0}),s.addEventListener("pointerdown",i,{passive:!0}),s.addEventListener("pointerenter",i,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",i),s.removeEventListener("pointerdown",i),s.removeEventListener("pointerenter",i),s.removeEventListener("pointerleave",l)}},[t,n])}function xe(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function G(t){return`${t[0]} ${t[1]} ${t[2]}`}function Z(t,n,s){return Math.round(t+(n-t)*s)}function fe(t,n){return[Z(t[0],n>=0?255:0,Math.abs(n)),Z(t[1],n>=0?255:0,Math.abs(n)),Z(t[2],n>=0?255:0,Math.abs(n))]}function ln(t,n,s){const r=t?Ce[t]:n??I.tint,o=s??I.accent,c=xe(r),u=xe(o),i=fe(u,.25),l=fe(u,-.55);return{tintRgb:G(c),accentRgb:G(u),accentSoftRgb:G(i),accentDeepRgb:G(l)}}function Fe(t,n){const s={...t??{}},{tintRgb:r,accentRgb:o,accentSoftRgb:c,accentDeepRgb:u}=ln(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=o,s["--lg-accent-soft"]=c,s["--lg-accent-deep"]=u,s}const Oe=d.forwardRef((t,n)=>{const{blur:s=I.blur,tint:r=I.tint,opacity:o=I.opacity,gloss:c=I.gloss,border:u=I.border,glints:i=I.glints,interactive:l=I.interactive,animate:h=I.animate,elevation:f=I.elevation,tone:p,accent:w=I.accent,className:N,style:x,children:b,...v}=t,a=Te(),m=l&&!a,j=d.useRef(null),g=d.useCallback(k=>{j.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","72%"),k.style.setProperty("--lg-y","18%"))},[n]);De(j,m);const y=d.useMemo(()=>Fe(x,{blur:s,tint:r,opacity:o,gloss:c,border:u,elevation:f,glints:i,tone:p,accent:w}),[x,s,r,o,c,u,f,i,p,w]),z={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*f}px ${50*f}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:g,className:$e("liquid-glass",N),"data-animate":h?"true":"false","data-interactive":m?"true":"false",style:{...z,...y},...v,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),i&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),m&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:b}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:u,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Oe.displayName="LiquidGlass";const Be=d.forwardRef((t,n)=>{const{className:s,style:r,children:o,type:c,blur:u,tint:i,opacity:l,gloss:h,border:f,glints:p,interactive:w,animate:N,elevation:x,tone:b,accent:v=I.accent,...a}=t,m=u??I.blur,j=b?Ce[b]:i??I.tint,g=l??.16,y=h??.9,z=f??.6,k=p??!1,P=w??!0,S=x??1,R=Te(),F=P&&!R,A=d.useRef(null),W=d.useCallback(E=>{A.current=E,typeof n=="function"?n(E):n&&(n.current=E),E&&(E.style.setProperty("--lg-x","70%"),E.style.setProperty("--lg-y","16%"))},[n]);De(A,F);const $=d.useMemo(()=>Fe(r,{blur:m,tint:j,opacity:g,gloss:y,border:z,glints:k,elevation:S,tone:b,accent:v}),[r,m,j,g,y,z,k,S,b,v]),D={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*S}px ${18*S}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:W,type:c??"button",className:$e("liquid-glass liquid-glass__button",s),style:{...D,...$},...a,onMouseDown:E=>{E.currentTarget.style.transform="scale(0.985)"},onMouseUp:E=>{E.currentTarget.style.transform=""},onMouseLeave:E=>{E.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:o}),e.jsx("style",{children:`
      ...
      `})]})});Be.displayName="LiquidGlass.Button";const V=Oe;V.Button=Be;const qe="theme",Ke="accent",Ve="accent_custom",We="bg",cn="bg_custom",Ge="ui:style-mode",ee="ui:liquid:prev-theme",Ue="ui:liquid:tone",Ye={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var we,je;const te=((je=(we=import.meta)==null?void 0:we.env)==null?void 0:je.BASE_URL)??"/",B=t=>{const n=t.replace(/^\/+/,"");return(te.endsWith("/")?te:te+"/")+n},He={bg1:B("img/bg1.png"),bg2:B("img/bg2.png"),bg3:B("img/bg3.png"),bg4:B("img/bg4.png"),bg5:B("img/bg5.png")};function Xe(){const t=localStorage.getItem(qe);return t==="light"||t==="dark"?t:null}function dn(){const t=localStorage.getItem(Ke);return t?t==="custom"?"custom":t in Ye?t:null:null}function un(){return localStorage.getItem(Ve)}function Je(){const t=localStorage.getItem(We);return t&&(t==="none"||t==="custom"||t in He)?t:null}function mn(){return localStorage.getItem(cn)}function Qe(){const t=localStorage.getItem(Ge);return t==="classic"||t==="liquid"||t==="beta"?t:null}function pn(){return(localStorage.getItem(Ue)||"dark")==="light"?"light":"dark"}function hn(t){try{localStorage.setItem(Ue,t)}catch{}const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{ue(t==="light"?"light":"dark")}catch{}}function Ze(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=Xe()??(et()?"dark":"light");localStorage.setItem(ee,s);const r=pn();hn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=localStorage.getItem(ee);(s==="light"||s==="dark")&&ue(s),localStorage.removeItem(ee)}catch{}try{const s=Je()??"none";nt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}try{localStorage.setItem(Ge,t)}catch{}}function et(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function ue(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),localStorage.setItem(qe,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function tt(t){if(t==="custom"){const n=un()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=xn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=Ye[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}localStorage.setItem(Ke,t)}function Zn(t){localStorage.setItem(Ve,st(t)),tt("custom")}function nt(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const o=mn();o?(n.style.backgroundImage=`url(${o})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const o=He[t];n.style.backgroundImage=`url(${o})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}localStorage.setItem(We,t)}function gn(){const n=Xe()??(et()?"dark":"light");ue(n);const s=dn()??"indigo";tt(s);const r=Je()??"none";nt(r);const o=Qe()??"classic";Ze(o)}function st(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],o=n[3];n=`#${s}${s}${r}${r}${o}${o}`}return n}function xn(t,n){const s=st(t).slice(1),r=parseInt(s,16);let o=r>>16&255,c=r>>8&255,u=r&255;o=Math.max(0,Math.min(255,Math.round(o+255*n))),c=Math.max(0,Math.min(255,Math.round(c+255*n))),u=Math.max(0,Math.min(255,Math.round(u+255*n)));const i=l=>l.toString(16).padStart(2,"0");return`#${i(o)}${i(c)}${i(u)}`}function be(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return Qe()??"classic"}catch{return"classic"}}function J(){const[t,n]=d.useState(()=>be());d.useEffect(()=>{const r=()=>{const u=be();n(i=>i===u?i:u)},o=u=>{const i=u.detail;i==="classic"||i==="liquid"||i==="beta"?n(i):r()};window.addEventListener("stylemodechange",o);const c=new MutationObserver(r);return c.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",o),c.disconnect()}},[]);const s=d.useCallback(r=>{Ze(r),n(r)},[]);return[t,s]}function T(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function fn(){if(!Yt("cmd_palette",!0))return null;const[n]=J(),[s,r]=d.useState(!1),[o,c]=d.useState(""),[u,i]=d.useState(0),[l,h]=d.useState(()=>localStorage.getItem("cp_filter")||"all");d.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]),d.useEffect(()=>{function a(m){(m.ctrlKey||m.metaKey)&&m.key.toLowerCase()==="k"&&(m.preventDefault(),r(!0),c(""),i(0)),s&&m.key==="Escape"&&r(!1)}return window.addEventListener("keydown",a),window.openCommandPalette=()=>{r(!0),c(""),i(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",a)}},[s]);const p=d.useMemo(()=>{const a=[];a.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:T("/favorites")}),a.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:T("/settings")});for(const g of Ot)a.push({kind:"role",id:g.id,title:g.role,subtitle:"Раздел",url:T(`/roles/${g.id}`)});for(const g of ge)a.push({kind:"law",id:g.slug,title:g.title,subtitle:"Закон",url:T(`/laws/${g.slug}`)});for(const g of qt)a.push({kind:"vu",id:g.id,title:g.title,subtitle:"ВУ",url:T(`/vu/${g.id}`)});const m=o.trim().toLowerCase();return m&&a.push(...N(m).slice(0,60)),m?(l==="all"?a:a.filter(g=>g.kind===l)).map(g=>({r:g,score:w(`${g.title} ${g.subtitle||""}`.toLowerCase(),m)+(g.__boost||0)})).filter(g=>g.score>0).sort((g,y)=>y.score-g.score).slice(0,30).map(g=>g.r):a.slice(0,20)},[o,l]);function w(a,m){return m.split(/\s+/).filter(Boolean).reduce((g,y)=>g+(a.includes(y)?1:0),0)}function N(a){const m=[],j=y=>y.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const y of ge){const k=(y.content||"").replace(/\r\n?/g,`
`).split(`
`);let P="",S="";const R=new Set;for(const F of k){const A=F.trim(),W=/^(#{2,6})\s*(.+)$/.exec(A);if(W){P=W[2].trim(),S=j(P)||"";const $=P.toLowerCase();if(S&&$.includes(a)){const D=`${y.slug}#${S}`;if(!R.has(D)){const E={kind:"law",id:D,title:`${y.title} — ${P}`,subtitle:"Заголовок",url:T(`/laws/${y.slug}?q=${encodeURIComponent(a)}#${S}`)};E.__boost=$.startsWith(a)?8:6,m.push(E),R.add(D)}}continue}if(A&&A.toLowerCase().includes(a)){const $=S?`${y.slug}#${S}`:y.slug;if(!R.has($)){const D=A.length>140?A.slice(0,137)+"…":A,E=S?`${y.title} — ${P}`:y.title,lt=T(S?`/laws/${y.slug}?q=${encodeURIComponent(a)}#${S}`:`/laws/${y.slug}?q=${encodeURIComponent(a)}`),me={kind:"law",id:$,title:E,subtitle:D||"Контекст",url:lt};me.__boost=5,m.push(me),R.add($)}}}}const g=new Set;return m.filter(y=>g.has(y.id)?!1:(g.add(y.id),!0))}function x(a){r(!1);try{window.location.href=a}catch{location.assign(a)}}function b(a){p.length&&(a.key==="ArrowDown"&&(a.preventDefault(),i(m=>Math.min(m+1,p.length-1))),a.key==="ArrowUp"&&(a.preventDefault(),i(m=>Math.max(m-1,0))),a.key==="Enter"&&(a.preventDefault(),x(p[u].url)))}const v=({children:a})=>n==="liquid"?e.jsx(V,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:a}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:a});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(v,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(le,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:o,onChange:a=>{c(a.target.value),i(0)},onKeyDown:b,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"Закрыть",children:e.jsx(Ne,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(a=>e.jsx("button",{onClick:()=>{h(a.k),i(0)},className:`chip ${l===a.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:a.label},a.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!p.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),p.map((a,m)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${m===u?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>i(m),onClick:()=>x(a.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[a.kind==="law"&&e.jsx(Y,{className:"h-4 w-4"}),a.kind==="role"&&e.jsx(ie,{className:"h-4 w-4"}),a.kind==="vu"&&e.jsx(oe,{className:"h-4 w-4"}),a.kind==="page"&&(a.id==="settings"?e.jsx(ce,{className:"h-4 w-4"}):e.jsx(de,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:a.title})]}),a.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:a.subtitle})]},`${a.kind}:${a.id}`))]})]})}):null})}const bn="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function yn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function vn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:yn()}}function wn(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const o=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(o)==="1"||String(o)==="yes")return}catch{}const s=JSON.stringify({event:t,...vn(),data:n}),r=`${bn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const o=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,o))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const ye="recent:items";function jn(t,n){try{const s=localStorage.getItem(ye),r=s?JSON.parse(s):[],o={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const c=r.filter(l=>l.url!==t);c.unshift(o);const u=[],i=new Set;for(const l of c)i.has(l.url)||(i.add(l.url),u.push(l));for(;u.length>15;)u.pop();localStorage.setItem(ye,JSON.stringify(u))}catch{}}const H="forum:session";function es(){try{const t=sessionStorage.getItem(H)??localStorage.getItem(H);return t?JSON.parse(t):null}catch{return null}}function ts(t){try{window.dispatchEvent(new Event("forum:session"))}catch{}}function rt(){const t=()=>{try{const r=sessionStorage.getItem(H)??localStorage.getItem(H);return r?JSON.parse(r):null}catch{return null}},[n,s]=U.useState(t());return U.useEffect(()=>{const r=()=>s(t());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const at=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(re,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(ie,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(vt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(wt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(jt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(re,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(kt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(oe,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(Y,{className:"h-4 w-4"}),id:"laws"}];function kn(){const[t,n]=d.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=K(),[r]=J(),c=!rt(),u=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),i=d.useMemo(()=>{const m=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),j=(s.hash||"").replace(/^#/,"").toLowerCase();return m||j||""},[s.search,s.hash]),l=d.useCallback(a=>i===a,[i]);d.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[t]),d.useEffect(()=>{function a(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]),d.useEffect(()=>{const a=document.documentElement;t?a.classList.add("has-sidebar"):a.classList.remove("has-sidebar")},[t]);const h=d.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),f=h?"⌘ K":"Ctrl K",p=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",w=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",N=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",x=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",b=a=>{const m=`?tab=${encodeURIComponent(a)}`;return u?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${a}`}},v=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(M,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[at.map(a=>{const m=a.type==="route"?s.pathname===a.to:l(a.id),j=a.type==="route"?a.to:b(a.id);return e.jsx("li",{children:e.jsxs(M,{to:j,className:[p,m?w:""].filter(Boolean).join(" "),"aria-current":m?"page":void 0,"aria-label":a.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[a.icon,e.jsx("span",{className:"truncate",children:a.label}),a.key==="forum"&&c&&e.jsx(Se,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},a.key)}),e.jsx("li",{children:e.jsxs(M,{to:"/about",className:p,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(ke,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(M,{to:"/buddy",className:p,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(yt,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:N,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:f}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(a=>!a),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:x,children:r==="liquid"?e.jsx(V,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:v}):v})]})}const Nn={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},ot={entities:Nn};function Sn(t){var s;return((s=ot.entities)==null?void 0:s[t])||null}function ns(t,n=30){const s=Sn(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function ss(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),o=s.length,c=r.length,u=Array.from({length:o+1},()=>Array(c+1).fill(0));for(let f=o-1;f>=0;f--)for(let p=c-1;p>=0;p--)u[f][p]=s[f]===r[p]?u[f+1][p+1]+1:Math.max(u[f+1][p],u[f][p+1]);const i=[];let l=0,h=0;for(;l<o&&h<c;)s[l]===r[h]?(i.push(q(s[l])),l++,h++):u[l+1][h]>=u[l][h+1]?(i.push(`<del>${q(s[l])}</del>`),l++):(i.push(`<ins>${q(r[h])}</ins>`),h++);for(;l<o;)i.push(`<del>${q(s[l++])}</del>`);for(;h<c;)i.push(`<ins>${q(r[h++])}</ins>`);return i.join(`
`)}function q(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function En(){var s;const t=[],n=ot.entities||{};for(const[r,o]of Object.entries(n)){const c=(s=o.changelog)==null?void 0:s[0];c&&t.push({id:r,version:c.version,date:c.date,summary:c.summary,details:c.details})}return t.sort((r,o)=>r.date<o.date?1:-1),t}function _n(){const[t]=J(),n=K(),s=d.useMemo(()=>{try{const i=En()[0];if(!i)return!1;const l=new Date(i.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const i=window.openCommandPalette;if(typeof i=="function")try{i();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const o="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",c=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",u=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var i;return(i=window.openMobileMenu)==null?void 0:i.call(window)},"aria-label":"Меню",children:e.jsx(Nt,{className:"h-4 w-4"})}),e.jsx(St,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(de,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(ce,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(re,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:c,children:t==="liquid"?e.jsx(V,{className:`${o} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:u}):e.jsx("div",{className:o,children:u})})}const zn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",ne="notif:lastSeen",ve="notifications-panel";function In(){const[t,n]=d.useState(!1),[s,r]=d.useState([]),[o,c]=d.useState(0),[u,i]=d.useState(!1),[l,h]=d.useState(null),f=d.useRef(null),p=d.useCallback(async()=>{const x=new AbortController;i(!0),h(null);try{const b=await fetch(zn,{cache:"no-store",signal:x.signal});if(!b.ok)throw new Error(`HTTP ${b.status}`);const v=await b.json(),a=Array.isArray(v)?v:v.items||[],m=z=>z?new Date(z).getTime():0;a.sort((z,k)=>m(k.date)-m(z.date)),r(a);const j=typeof localStorage<"u"&&localStorage.getItem(ne)||"",g=j?a.findIndex(z=>z.id===j):-1,y=g===-1?a.length:g;c(Math.max(0,y))}catch(b){(b==null?void 0:b.name)!=="AbortError"&&h("Не удалось загрузить уведомления")}finally{i(!1)}return()=>x.abort()},[]);d.useEffect(()=>{p()},[p]),d.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(ne,s[0].id),c(0)}catch{}},[t,s]),d.useEffect(()=>{if(!t)return;const x=v=>{f.current&&(f.current.contains(v.target)||n(!1))},b=v=>{v.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",x),document.addEventListener("keydown",b),()=>{document.removeEventListener("mousedown",x),document.removeEventListener("keydown",b)}},[t]);const w=()=>n(x=>!x),N=x=>x?new Date(x).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:f,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:w,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":ve,children:[e.jsx(Et,{className:"h-4 w-4"}),o>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:o})]}),t&&e.jsxs(V,{id:ve,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),u?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):l?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:l}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(x=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:x.url||"#",target:x.url?"_blank":void 0,rel:x.url?"noreferrer":void 0,onClick:()=>{var b;try{(b=s[0])!=null&&b.id&&localStorage.setItem(ne,s[0].id),c(0)}catch{}},children:[x.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:x.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:x.text}),x.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:N(x.date)})]})},x.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function Ln(){const[t,n]=d.useState(!1),s=K(),o=!rt();d.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),d.useEffect(()=>{if(!t)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[t]);const c=d.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),u=l=>{const h=new URLSearchParams(s.search||"");h.set("tab",l);const f=`?${h.toString()}`;return c?{pathname:"/",search:f}:{pathname:"/",search:f,hash:`#${l}`}};function i(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:i,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(le,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(Ne,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:at.map(l=>{const h=l.type==="route"?l.to:u(l.id);return e.jsx("li",{children:e.jsxs(M,{to:h,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,e.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&o&&e.jsx(Se,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(de,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(ce,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const se=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function Mn(){const[t,n]=d.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return d.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=o=>n(o.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function Pn(){const[t,n]=d.useState(null),s=d.useRef(Math.floor(Math.random()*se.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const r=Mn(),o=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),c=!r&&!o,u=d.useRef(null),i=d.useRef(null);d.useEffect(()=>{const w=u.current;if(!w)return;let N=0,x=performance.now(),b=Math.random()*(window.innerWidth-64)+16,v=Math.random()*(window.innerHeight-120)+60,a=(Math.random()*60+30)*(Math.random()>.5?1:-1),m=(Math.random()*40+20)*(Math.random()>.5?1:-1);const j=y=>{const z=Math.min(.05,(y-x)/1e3);if(x=y,c){b+=a*z,v+=m*z;const k=16,P=window.innerWidth,S=window.innerHeight,R=48,F=48;b<k&&(b=k,a=Math.abs(a)),b>P-R-k&&(b=P-R-k,a=-Math.abs(a)),v<60&&(v=60,m=Math.abs(m)),v>S-F-k&&(v=S-F-k,m=-Math.abs(m)),a+=(Math.random()-.5)*4,m+=(Math.random()-.5)*4}w.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(v)}px, 0)`,N=requestAnimationFrame(j)};N=requestAnimationFrame(j);const g=()=>{x=performance.now()};return window.addEventListener("resize",g),()=>{cancelAnimationFrame(N),window.removeEventListener("resize",g)}},[c]);function l(w){const N=w??se[s.current++%se.length];n(N),window.clearTimeout(l._t),l._t=window.setTimeout(()=>n(null),3e3)}function h(w){l()}function f(){i.current&&window.clearTimeout(i.current),i.current=window.setTimeout(()=>l("Просто нажми, чтобы я говорил!"),600)}function p(){i.current&&(window.clearTimeout(i.current),i.current=null)}return e.jsx("div",{ref:u,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:h,onPointerDown:f,onPointerUp:p,onPointerLeave:p,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Rn=d.lazy(()=>L(()=>import("./GovCheatsheetSky-KPQFdMaX.js"),__vite__mapDeps([0,1,2,3,4]))),An=d.lazy(()=>L(()=>import("./WhatsNew-C3QQoSIu.js"),__vite__mapDeps([5,1,2]))),Cn=d.lazy(()=>L(()=>import("./DiffPage-BgG5Xq7Z.js"),__vite__mapDeps([6,1,2]))),$n=d.lazy(()=>L(()=>import("./LiquidGlassShowcase-DDWWAlMB.js"),__vite__mapDeps([7,1,2]))),Tn=d.lazy(()=>L(()=>import("./PrintSheet-D0Ua7t0B.js"),__vite__mapDeps([8,1,2]))),Dn=d.lazy(()=>L(()=>import("./RolePage-BeUg6O_3.js"),__vite__mapDeps([9,1,3,2,10]))),Fn=d.lazy(()=>L(()=>import("./LawPage-C7URdVtA.js"),__vite__mapDeps([11,1,10,2]))),On=d.lazy(()=>L(()=>import("./VuPage-B-ZPWqSc.js"),__vite__mapDeps([12,1,2]))),Bn=d.lazy(()=>L(()=>import("./BuddyPlayground-BczM1-NJ.js"),__vite__mapDeps([13,1,2]))),qn=d.lazy(()=>L(()=>import("./HomePage-B0K5_Lx0.js"),__vite__mapDeps([14,1,2]))),Kn=d.lazy(()=>L(()=>import("./ForumPage-C9wpTYaj.js"),__vite__mapDeps([15,1,16,17,2]))),Vn=d.lazy(()=>L(()=>import("./ProfilePage-C2lc0uUw.js"),__vite__mapDeps([18,1,16,2]))),Wn=d.lazy(()=>L(()=>import("./AdminPanel2-BoYTFZxl.js"),__vite__mapDeps([19,1,16,17,2]))),Gn=d.lazy(()=>L(()=>import("./SettingsPage-B6MNGzrz.js"),__vite__mapDeps([20,1,4,2]))),Un=d.lazy(()=>L(()=>import("./FavoritesPage-Bq-rzRIs.js"),__vite__mapDeps([21,1,10,2])));function Yn(){const t=K();return U.useEffect(()=>{wn("page_view");try{jn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function Hn(){return(K().pathname||"").startsWith("/buddy")?null:e.jsx(Pn,{})}function Xn(){const[t]=J();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(ut,{basename:"/pravo/",children:[e.jsx(fn,{}),e.jsx(kn,{}),e.jsx(_n,{}),e.jsx(Ln,{}),e.jsx(Hn,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(In,{})}),e.jsx(Yn,{}),e.jsx(d.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(mt,{children:[e.jsx(_,{path:"/",element:e.jsx(Rn,{})}),e.jsx(_,{path:"/home",element:e.jsx(qn,{})}),e.jsx(_,{path:"/forum/*",element:e.jsx(Kn,{})}),e.jsx(_,{path:"/forum/profile/:username",element:e.jsx(Vn,{})}),e.jsx(_,{path:"/forum/admin",element:e.jsx(Wn,{})}),e.jsx(_,{path:"/whats-new",element:e.jsx(An,{})}),e.jsx(_,{path:"/diff/:id",element:e.jsx(Cn,{})}),e.jsx(_,{path:"/print",element:e.jsx(Tn,{})}),e.jsx(_,{path:"/roles/:id",element:e.jsx(Dn,{})}),e.jsx(_,{path:"/laws/:slug",element:e.jsx(Fn,{})}),e.jsx(_,{path:"/vu/:id",element:e.jsx(On,{})}),e.jsx(_,{path:"/recorders/:id",element:e.jsx(Tt,{})}),e.jsx(_,{path:"/about",element:e.jsx(Ft,{})}),e.jsx(_,{path:"/style/liquid",element:e.jsx($n,{})}),e.jsx(_,{path:"/buddy",element:e.jsx(Bn,{})}),e.jsx(_,{path:"/settings",element:e.jsx(Gn,{})}),e.jsx(_,{path:"/favorites",element:e.jsx(Un,{})})]})})]})]})}(function(){try{const n="app:version",s=localStorage.getItem(n),r="1758884470134";if(s&&s!==r){"caches"in window?caches.keys().then(o=>Promise.all(o.map(c=>caches.delete(c)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();gn();rn();function it(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}it();window.addEventListener("resize",it,{passive:!0});ae.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Xn,{})}));export{Ye as A,tt as B,Dt as C,Zn as D,Vt as E,Xt as F,Qt as G,He as H,Gt as I,en as J,V as L,Ot as a,Sn as b,es as c,ss as d,ts as e,dn as f,En as g,Qe as h,ns as i,e as j,Wt as k,ge as l,Ut as m,Jt as n,Zt as o,tn as p,on as q,Ct as r,pn as s,ue as t,J as u,qt as v,et as w,Ze as x,an as y,hn as z};
