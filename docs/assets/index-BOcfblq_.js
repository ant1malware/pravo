const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DlpI655f.js","assets/react-vendor-DStf8yZ1.js","assets/icons-CWwV2OkG.js","assets/VoteWidget-aaS1HJ00.js","assets/ContextText-BEzC_uoa.js","assets/WhatsNew-C03CG8Ud.js","assets/DiffPage-1-nF9s2v.js","assets/PrintSheet-mstcfY8n.js","assets/RolePage-D0AGH7M_.js","assets/FavStar-DnjuaHVG.js","assets/LawPage-CGKipYBb.js","assets/VuPage-oa7wI1hg.js","assets/SettingsPage-DP54uJlP.js","assets/FavoritesPage-DyZe7vHl.js"])))=>i.map(i=>d[i]);
...
`);let _="",x="";const L=new Set;for(const we of ye){const I=we.trim(),B=/^(#{2,6})\s*(.+)$/.exec(I);if(B){_=B[2].trim(),x=C(_)||"";const j=_.toLowerCase();if(x&&(j.includes(r)||h&&j.match(new RegExp(`(^|s)ст(атья|.)?s*${h}\b`)))){const P=`${b.slug}#${x}`;if(!L.has(P)){const R={kind:"law",id:P,title:`${b.title} — ${_}`,subtitle:"Раздел закона",url:k(`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`)};R.__boost=j.startsWith(r)?8:6,f.push(R),L.add(P)}}continue}if(I&&I.toLowerCase().includes(r)){const j=x?`${b.slug}#${x}`:b.slug;if(!L.has(j)){const K=I.length>140?I.slice(0,137)+"…":I,P=x?`${b.title} — ${_}`:b.title,R=k(x?`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`:`/laws/${b.slug}?q=${encodeURIComponent(r)}`),F={kind:"law",id:j,title:P,subtitle:K||"Совпадение в тексте",url:R};F.__boost=5,f.push(F),L.add(j)}}}}const S=new Set;return f.filter(b=>S.has(b.id)?!1:(S.add(b.id),!0))}function z(r){o(!1);try{window.location.href=r}catch{location.assign(r)}}function N(r){d.length&&(r.key==="ArrowDown"&&(r.preventDefault(),l(f=>Math.min(f+1,d.length-1))),r.key==="ArrowUp"&&(r.preventDefault(),l(f=>Math.max(f-1,0))),r.key==="Enter"&&(r.preventDefault(),z(d[i].url)))}return n.jsx(n.Fragment,{children:t?n.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:n.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[n.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[n.jsx(J,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),n.jsx("input",{autoFocus:!0,value:s,onChange:r=>{a(r.target.value),l(0)},onKeyDown:N,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),n.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>o(!1),"aria-label":"Закрыть палитру",children:n.jsx(ze,{className:"h-4 w-4"})})]}),n.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(r=>n.jsx("button",{onClick:()=>{c(r.k),l(0)},className:`chip ${u===r.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:r.label},r.k))}),n.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!d.length&&n.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),d.map((r,f)=>n.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${f===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>l(f),onClick:()=>z(r.url),children:[n.jsxs("span",{className:"inline-flex items-center gap-2",children:[r.kind==="law"&&n.jsx(T,{className:"h-4 w-4"}),r.kind==="role"&&n.jsx(q,{className:"h-4 w-4"}),r.kind==="vu"&&n.jsx(Q,{className:"h-4 w-4"}),r.kind==="page"&&(r.id==="settings"?n.jsx(Z,{className:"h-4 w-4"}):n.jsx(ee,{className:"h-4 w-4"})),n.jsx("span",{className:"font-medium",children:r.title})]}),r.subtitle&&n.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:r.subtitle})]},`${r.kind}:${r.id}`))]})]})}):null})}const E={},at=(E==null?void 0:E.VITE_API_BASE)||(E==null?void 0:E.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function rt(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function it(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:rt()}}function ct(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const o=JSON.stringify({event:e,...it(),data:t}),s=`${at}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([o],{type:"application/json"});if(navigator.sendBeacon(s,a))return}catch{}try{fetch(s,{method:"POST",headers:{"content-type":"application/json"},body:o})}catch{}}const Y="recent:items";function lt(e,t){try{const o=localStorage.getItem(Y),s=o?JSON.parse(o):[],a={url:e,title:t,ts:Date.now()};if(s.length&&s[0].url===e)return;const i=s.filter(c=>c.url!==e);i.unshift(a);const l=[],u=new Set;for(const c of i)u.has(c.url)||(u.add(c.url),l.push(c));for(;l.length>15;)l.pop();localStorage.setItem(Y,JSON.stringify(l))}catch{}}const dt=[{label:"Роли",icon:n.jsx(q,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:n.jsx(Se,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:n.jsx(Ie,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:n.jsx(Ee,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:n.jsx(te,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:n.jsx(Ne,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:n.jsx(T,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:n.jsx(Q,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:n.jsx(T,{className:"h-4 w-4"}),id:"laws"}];function ut(){const[e,t]=p.useState(()=>typeof window<"u"?window.innerWidth>=1024:!1),o=X(),s=p.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=p.useMemo(()=>{const m=(new URLSearchParams(o.search||"").get("tab")||"").toLowerCase(),v=(o.hash||"").replace(/^#/,"").toLowerCase();return m||v||""},[o.search,o.hash]),i=d=>a===d;p.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[e]),p.useEffect(()=>{function d(){typeof window<"u"&&t(window.innerWidth>=1024)}return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),p.useEffect(()=>{const d=document.documentElement;e?d.classList.add("has-sidebar"):d.classList.remove("has-sidebar")},[e]);const u=p.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",c="inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-medium shadow-sm border-zinc-300 bg-white/90 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",g=d=>{const m=`?tab=${encodeURIComponent(d)}`;return s?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${d}`}};return n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>t(d=>!d),"aria-label":"Открыть меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),e&&n.jsx("div",{className:"fixed inset-0 z-30 bg-black/40 lg:hidden",onClick:()=>t(!1),"aria-hidden":"true"}),n.jsxs("aside",{id:"app-sidebar","aria-label":"Навигация",className:`app-sidebar fixed inset-y-0 left-0 z-40 w-[240px] transform border-r border-zinc-200
              ...
              ${e?"translate-x-0":"-translate-x-full lg:translate-x-0"}`,children:[n.jsx("div",{className:"mb-3 flex items-center justify-start",children:n.jsx($,{to:"/",className:`rounded font-semibold no-underline focus:outline-none focus:ring-2 focus:ring-zinc-400\r
