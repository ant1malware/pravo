const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DM_zUN6q.js","assets/react-vendor-DTkXckhQ.js","assets/icons-vKdVo13Z.js","assets/VoteWidget-orPYzeSn.js","assets/WhatsNew-DDYkyo51.js","assets/DiffPage-DTfTi69k.js","assets/LiquidGlassShowcase-BOFwwr6j.js","assets/PrintSheet-HCEdgrqR.js","assets/RolePage-BrwwjZr4.js","assets/FavStar-c2xh3Wno.js","assets/LawPage-D8PADj2U.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-Bx8XEpJE.js","assets/HomePage-CiDUoiIr.js","assets/ForumPage-Cpbg0eTJ.js","assets/forumStore-BmAAT3KU.js","assets/forumRemote-D5s3MT8n.js","assets/ForumSubnav-Brr4iN2v.js","assets/ForumSearch-DxL5oXcH.js","assets/ProfilePage-MpX76Y3P.js","assets/ForumMembers-B60Bn3tB.js","assets/SectionPage-Bw5K6eL_.js","assets/MarkdownEditor-D2DK_Jvw.js","assets/TopicPage2-BEGTGTKL.js","assets/ReactionBar-CREamPcP.js","assets/seo-CUoHaANs.js","assets/TagPage-D5bCDcWY.js","assets/QuestionsPage-gPhyv7e6.js","assets/AdminPanel3-CKQiiefQ.js","assets/SettingsPage-rirMsEG5.js","assets/FavoritesPage-BDdzkEJ1.js","assets/ForumFeedsPage-CCW_NH9q.js"])))=>i.map(i=>d[i]);
import{r as X,a as wt,u as jt,L as E,R as u,b as ne,B as kt,c as St,d as y}from"./react-vendor-DTkXckhQ.js";import{A as Nt,E as _t,I as ue,Q as Et,B as Q,S as pe,U as he,a as fe,X as Ae,b as ge,c as be,L as Me,M as je,F as zt,d as It,C as Pt,e as Lt,f as Rt,g as At}from"./icons-vKdVo13Z.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();var Ce={exports:{}},se={};/**
 * @license React
...
![Территория красной зоны воинской части](${R}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${R}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${R}img/cpp2.png)
...
![Территория военного грузового поезда](${R}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${R}img/pravo2.png)
![Правительство](${R}img/pravo.png)
...
`,Jt=[{id:"gov",title:"Внутренний устав Правительства",text:Yt,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Oe="ui:density",$e="ui:font",Ht="ui:features",De="ui:shadow",Fe="ui:radius",Be="ui:glass",Ue="ui:readw",Ve="ui:anim";function T(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function B(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function Xt(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),B(Oe,e)}function Qt(){return T(Oe)==="compact"?"compact":"standard"}function Zt(e){const n=Math.max(.9,Math.min(1.3,e)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),B($e,String(n))}function en(){const e=T($e),n=parseFloat(e||"1");return isFinite(n)&&n>.6&&n<2?n:1}function tn(e,n=!0){const s=nn();return e in s?!!s[e]:n}function nn(){try{const e=T(Ht);return e?JSON.parse(e):{}}catch{return{}}}function sn(e){let n="none";e==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),B(De,e)}function rn(){const e=T(De);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function an(e){let n=8,s=16,r=20;e==="subtle"&&(n=6,s=10,r=14),e==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),B(Fe,e)}function on(){const e=T(Fe);return e==="subtle"||e==="rounded"?e:"standard"}function cn(e){const n=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",n+"px"),B(Be,String(n))}function ln(){const e=T(Be),n=parseInt(e||"6",10);return isFinite(n)?n:6}function dn(e){const n=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",n+"ch"),B(Ue,String(n))}function un(){const e=T(Ue),n=parseInt(e||"78",10);return isFinite(n)?n:78}function mn(){try{Xt(Qt()),Zt(en()),sn(rn()),an(on()),cn(ln()),dn(un()),pn(hn())}catch{}}function pn(e){document.documentElement.classList.toggle("anim-off",!e),B(Ve,e?"1":"0")}function hn(){try{return T(Ve)!=="0"}catch{return!0}}const qe={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},S={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Ke(...e){return e.filter(Boolean).join(" ")}function We(){const[e,n]=u.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return u.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),e}function Ge(e,n){u.useEffect(()=>{const s=e.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,i=18;const o=()=>{r=0;const m=e.current;m&&(m.style.setProperty("--lg-x",`${a}%`),m.style.setProperty("--lg-y",`${i}%`))},c=m=>{const b=e.current;if(!b)return;const f=b.getBoundingClientRect(),z=(m.clientX-f.left)/f.width*100,N=(m.clientY-f.top)/f.height*100;a=Math.max(0,Math.min(100,z)),i=Math.max(0,Math.min(100,N)),r||(r=window.requestAnimationFrame(o))},l=()=>{a=72,i=18,r||(r=window.requestAnimationFrame(o))};return s.addEventListener("pointermove",c,{passive:!0}),s.addEventListener("pointerdown",c,{passive:!0}),s.addEventListener("pointerenter",c,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",c),s.removeEventListener("pointerdown",c),s.removeEventListener("pointerenter",c),s.removeEventListener("pointerleave",l)}},[e,n])}function _e(e){if(!e)return[255,255,255];const n=e.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function H(e){return`${e[0]} ${e[1]} ${e[2]}`}function ce(e,n,s){return Math.round(e+(n-e)*s)}function Ee(e,n){return[ce(e[0],n>=0?255:0,Math.abs(n)),ce(e[1],n>=0?255:0,Math.abs(n)),ce(e[2],n>=0?255:0,Math.abs(n))]}function fn(e,n,s){const r=e?qe[e]:n??S.tint,a=s??S.accent,i=_e(r),o=_e(a),c=Ee(o,.25),l=Ee(o,-.55);return{tintRgb:H(i),accentRgb:H(o),accentSoftRgb:H(c),accentDeepRgb:H(l)}}function Ye(e,n){const s={...e??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:i,accentDeepRgb:o}=fn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=i,s["--lg-accent-deep"]=o,s}const Je=u.forwardRef((e,n)=>{const{blur:s=S.blur,tint:r=S.tint,opacity:a=S.opacity,gloss:i=S.gloss,border:o=S.border,glints:c=S.glints,interactive:l=S.interactive,animate:m=S.animate,elevation:b=S.elevation,tone:f,accent:z=S.accent,className:N,style:M,children:P,...L}=e,h=We(),k=l&&!h,d=u.useRef(null),x=u.useCallback(g=>{d.current=g,typeof n=="function"?n(g):n&&(n.current=g),g&&(g.style.setProperty("--lg-x","72%"),g.style.setProperty("--lg-y","18%"))},[n]);Ge(d,k);const _=u.useMemo(()=>Ye(M,{blur:s,tint:r,opacity:a,gloss:i,border:o,elevation:b,glints:c,tone:f,accent:z}),[M,s,r,a,i,o,b,c,f,z]),p={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*b}px ${50*b}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return t.jsxs("div",{ref:x,className:Ke("liquid-glass",N),"data-animate":m?"true":"false","data-interactive":k?"true":"false",style:{...p,..._},...L,children:[t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),c&&t.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[t.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),t.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),k&&t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),t.jsx("div",{style:{position:"relative",zIndex:10},children:P}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:o,pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Je.displayName="LiquidGlass";const He=u.forwardRef((e,n)=>{const{className:s,style:r,children:a,type:i,blur:o,tint:c,opacity:l,gloss:m,border:b,glints:f,interactive:z,animate:N,elevation:M,tone:P,accent:L=S.accent,...h}=e,k=o??S.blur,d=P?qe[P]:c??S.tint,x=l??.16,_=m??.9,p=b??.6,g=f??!1,ve=z??!0,U=M??1,$=We(),I=ve&&!$,D=u.useRef(null),oe=u.useCallback(j=>{D.current=j,typeof n=="function"?n(j):n&&(n.current=j),j&&(j.style.setProperty("--lg-x","70%"),j.style.setProperty("--lg-y","16%"))},[n]);Ge(D,I);const C=u.useMemo(()=>Ye(r,{blur:k,tint:d,opacity:x,gloss:_,border:p,glints:g,elevation:U,tone:P,accent:L}),[r,k,d,x,_,p,g,U,P,L]),Y={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*U}px ${18*U}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return t.jsxs("button",{ref:oe,type:i??"button",className:Ke("liquid-glass liquid-glass__button",s),style:{...Y,...C},...h,onMouseDown:j=>{j.currentTarget.style.transform="scale(0.985)"},onMouseUp:j=>{j.currentTarget.style.transform=""},onMouseLeave:j=>{j.currentTarget.style.transform=""},children:[t.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[t.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),t.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),t.jsx("span",{style:{position:"relative",zIndex:1},children:a}),t.jsx("style",{children:`
      ...
      `})]})});He.displayName="LiquidGlass.Button";const re=Je;re.Button=He;const Xe="theme",Qe="accent",Ze="accent_custom",et="bg",gn="bg_custom",tt="ui:style-mode",le="ui:liquid:prev-theme",nt="ui:liquid:tone";function O(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function F(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function bn(e){try{typeof window<"u"&&window.localStorage.removeItem(e)}catch{}}const st={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Le,Re;const de=((Re=(Le=import.meta)==null?void 0:Le.env)==null?void 0:Re.BASE_URL)??"/",K=e=>{const n=e.replace(/^\/+/,"");return(de.endsWith("/")?de:de+"/")+n},rt={bg1:K("img/bg1.png"),bg2:K("img/bg2.png"),bg3:K("img/bg3.png"),bg4:K("img/bg4.png"),bg5:K("img/bg5.png")};function at(){const e=O(Xe);return e==="light"||e==="dark"?e:null}function xn(){const e=O(Qe);return e?e==="custom"?"custom":e in st?e:null:null}function yn(){return O(Ze)}function ot(){const e=O(et);return e&&(e==="none"||e==="custom"||e in rt)?e:null}function vn(){return O(gn)}function it(){const e=O(tt);return e==="classic"||e==="liquid"?e:null}function wn(){return(O(nt)||"dark")==="light"?"light":"dark"}function jn(e){F(nt,e);const n=document.documentElement;if(n.classList.toggle("liquid-light",e==="light"),n.classList.toggle("liquid-dark",e!=="light"),n.classList.contains("theme-liquid"))try{xe(e==="light"?"light":"dark")}catch{}}function ct(e){const n=document.documentElement;if(n.classList.toggle("theme-liquid",e==="liquid"),n.dataset.styleMode=e,e==="liquid"){try{const s=at()??(lt()?"dark":"light");F(le,s);const r=wn();jn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=O(le);(s==="light"||s==="dark")&&xe(s),bn(le)}catch{}try{const s=ot()??"none";ut(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:e}))}catch{}F(tt,e)}function lt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function xe(e){const n=document.documentElement;e==="dark"?n.classList.add("dark"):n.classList.remove("dark"),F(Xe,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function dt(e){if(e==="custom"){const n=yn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Sn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=st[e];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}F(Qe,e)}function us(e){F(Ze,mt(e)),dt("custom")}function ut(e){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(e==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(e==="custom"){const a=vn();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=rt[e];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}F(et,e)}function kn(){const n=at()??(lt()?"dark":"light");xe(n);const s=xn()??"indigo";dt(s);const r=ot()??"none";ut(r);const a=it()??"classic";ct(a)}function mt(e){let n=e.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function Sn(e,n){const s=mt(e).slice(1),r=parseInt(s,16);let a=r>>16&255,i=r>>8&255,o=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n)));const c=l=>l.toString(16).padStart(2,"0");return`#${c(a)}${c(i)}${c(o)}`}function ze(){if(typeof document<"u"){const e=document.documentElement.dataset.styleMode;if(e==="classic"||e==="liquid")return e}try{return it()??"classic"}catch{return"classic"}}function ae(){const[e,n]=u.useState(()=>ze());u.useEffect(()=>{const r=()=>{const o=ze();n(c=>c===o?c:o)},a=o=>{const c=o.detail;c==="classic"||c==="liquid"?n(c):r()};window.addEventListener("stylemodechange",a);const i=new MutationObserver(r);return i.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),i.disconnect()}},[]);const s=u.useCallback(r=>{ct(r),n(r)},[]);return[e,s]}function A(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function Nn(){if(!tn("cmd_palette",!0))return null;const[n]=ae(),[s,r]=u.useState(!1),[a,i]=u.useState(""),[o,c]=u.useState(0),[l,m]=u.useState(()=>localStorage.getItem("cp_filter")||"all");u.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]);const[b,f]=u.useState(null);u.useEffect(()=>{(async()=>{try{const _=(await(await v(()=>import("./forumRemote-D5s3MT8n.js"),[])).listSections()).find(p=>String(p.title||"").toLowerCase()==="workshop");f((_==null?void 0:_.id)||null)}catch{}})()},[]);const N=u.useMemo(()=>{const d=[];d.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:A("/forum")}),d.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:A("/favorites")}),d.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:A("/settings")});for(const p of Gt)d.push({kind:"role",id:p.id,title:p.role,subtitle:"������",url:A(`/roles/${p.id}`)});for(const p of Ne)d.push({kind:"law",id:p.slug,title:p.title,subtitle:"�����",url:A(`/laws/${p.slug}`)});for(const p of Jt)d.push({kind:"vu",id:p.id,title:p.title,subtitle:"��",url:A(`/vu/${p.id}`)});const x=a.trim().toLowerCase();return x&&d.push(...P(x).slice(0,60)),x?(l==="all"?d:d.filter(p=>p.kind===l)).map(p=>({r:p,score:M(`${p.title} ${p.subtitle||""}`.toLowerCase(),x)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,g)=>g.score-p.score).slice(0,30).map(p=>p.r):d.slice(0,20)},[a,l]);function M(d,x){return x.split(/\s+/).filter(Boolean).reduce((p,g)=>p+(d.includes(g)?1:0),0)}function P(d){const x=[],_=g=>g.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const g of Ne){const U=(g.content||"").replace(/\r\n?/g,`
`).split(`
`);let $="",I="";const D=new Set;for(const oe of U){const C=oe.trim(),Y=/^(#{2,6})\s*(.+)$/.exec(C);if(Y){$=Y[2].trim(),I=_($)||"";const j=$.toLowerCase();if(I&&j.includes(d)){const V=`${g.slug}#${I}`;if(!D.has(V)){const J={kind:"law",id:V,title:`${g.title} � ${$}`,subtitle:"���������",url:A(`/laws/${g.slug}?q=${encodeURIComponent(d)}#${I}`)};J.__boost=j.startsWith(d)?8:6,x.push(J),D.add(V)}}continue}if(C&&C.toLowerCase().includes(d)){const j=I?`${g.slug}#${I}`:g.slug;if(!D.has(j)){const V=C.length>140?C.slice(0,137)+"�":C,J=I?`${g.title} � ${$}`:g.title,vt=A(I?`/laws/${g.slug}?q=${encodeURIComponent(d)}#${I}`:`/laws/${g.slug}?q=${encodeURIComponent(d)}`),we={kind:"law",id:j,title:J,subtitle:V||"��������",url:vt};we.__boost=5,x.push(we),D.add(j)}}}}const p=new Set;return x.filter(g=>p.has(g.id)?!1:(p.add(g.id),!0))}function L(d){r(!1);try{window.location.href=d}catch{location.assign(d)}}function h(d){N.length&&(d.key==="ArrowDown"&&(d.preventDefault(),c(x=>Math.min(x+1,N.length-1))),d.key==="ArrowUp"&&(d.preventDefault(),c(x=>Math.max(x-1,0))),d.key==="Enter"&&(d.preventDefault(),L(N[o].url)))}const k=({children:d})=>n==="liquid"?t.jsx(re,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:d}):t.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:d});return t.jsx(t.Fragment,{children:s?t.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:t.jsxs(k,{children:[t.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[t.jsx(fe,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),t.jsx("input",{autoFocus:!0,value:a,onChange:d=>{i(d.target.value),c(0)},onKeyDown:h,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),t.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:t.jsx(Ae,{className:"h-4 w-4"})})]}),t.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(d=>t.jsx("button",{onClick:()=>{m(d.k),c(0)},className:`chip ${l===d.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:d.label},d.k))}),t.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!N.length&&t.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),N.map((d,x)=>t.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${x===o?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>c(x),onClick:()=>L(d.url),children:[t.jsxs("span",{className:"inline-flex items-center gap-2",children:[d.kind==="law"&&t.jsx(Q,{className:"h-4 w-4"}),d.kind==="role"&&t.jsx(he,{className:"h-4 w-4"}),d.kind==="vu"&&t.jsx(pe,{className:"h-4 w-4"}),d.kind==="page"&&(d.id==="settings"?t.jsx(ge,{className:"h-4 w-4"}):t.jsx(be,{className:"h-4 w-4"})),t.jsx("span",{className:"font-medium",children:d.title})]}),d.subtitle&&t.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:d.subtitle})]},`${d.kind}:${d.id}`))]})]})}):null})}const _n="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function En(){try{const e="anon_uid";let n=localStorage.getItem(e);return n||(n=crypto.randomUUID(),localStorage.setItem(e,n)),n}catch{return"na"}}function zn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:En()}}function In(e,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...zn(),data:n}),r=`${_n}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}function Pn(){try{const n=new URL(window.location.href),s=n.searchParams.get("api");if(s){localStorage.setItem("forum:api_base",s);try{n.searchParams.delete("api"),history.replaceState({},"",n.toString())}catch{}}const r=localStorage.getItem("forum:api_base");if(r)return r}catch{}return"https://notifications-worker.wizardiowhy.workers.dev/skyapi"}const Ln=Pn(),G="forum:token",Z="forum:session";function pt(e,n=!0){(n?localStorage:sessionStorage).setItem(G,e)}function ht(){return localStorage.getItem(G)??sessionStorage.getItem(G)}function ee(){try{localStorage.removeItem(G),sessionStorage.removeItem(G),localStorage.removeItem(Z),sessionStorage.removeItem(Z)}finally{window.dispatchEvent(new Event("forum:session"))}}function ye(e){try{const n={until:e||null,setAt:new Date().toISOString()};localStorage.setItem("forum:ban_lock",JSON.stringify(n))}catch{}}async function w(e,n={}){const s=ht(),r={"Content-Type":"application/json",...n.headers||{}};s&&(r.Authorization=`Bearer ${s}`);const a=await fetch(`${Ln}${e}`,{...n,headers:r}),i=await a.text();let o={};try{o=i?JSON.parse(i):{}}catch{o={error:i||a.statusText}}if(!a.ok){try{(a.status===401||a.status===403)&&(typeof(o==null?void 0:o.error)=="string"&&/ban/i.test(o.error)&&ye(null),ee())}catch{}throw new Error((o==null?void 0:o.error)||`${a.status} ${a.statusText}`)}return o}async function ms(e){const n=JSON.stringify({username:e.username,email:e.email,password:e.password||"1234",inviteCode:e.inviteCode||"",captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await w("/register",{method:"POST",body:n});pt(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};localStorage.setItem(Z,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session"));const i=r;try{if(i!=null&&i.bannedUntil&&new Date(i.bannedUntil).getTime()>Date.now())throw ye(i.bannedUntil),ee(),new Error("banned")}catch{}return i}async function ps(e){const n=JSON.stringify({usernameOrEmail:e.usernameOrEmail,password:e.password||"1234",otp:e.otp||void 0,captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await w("/login",{method:"POST",body:n});pt(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};return localStorage.setItem(Z,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session")),r}async function Rn(){if(!ht())return null;try{const{user:n}=await w("/me"),s=n;return s!=null&&s.bannedUntil&&new Date(s.bannedUntil).getTime()>Date.now()?(ye(s.bannedUntil),ee(),null):s}catch{return ee(),null}}async function hs(){const{users:e}=await w("/users");return e}async function fs(e,n){const{user:s}=await w(`/users/${e}/role`,{method:"PATCH",body:JSON.stringify({role:n})});return s}async function gs(){const{invites:e}=await w("/invites");return e}async function bs(e=5,n){const{invites:s}=await w("/invites",{method:"POST",body:JSON.stringify({count:e,note:n})});return s}async function xs(e,n){const s=JSON.stringify(n?{until:n}:{days:7}),{user:r}=await w("/users/"+encodeURIComponent(e)+"/ban",{method:"POST",body:s});return r}async function ys(e){const{user:n}=await w("/users/"+encodeURIComponent(e)+"/unban",{method:"POST"});return n}async function vs(e,n){const s=JSON.stringify(n?{until:n}:{minutes:60}),{user:r}=await w("/users/"+encodeURIComponent(e)+"/mute",{method:"POST",body:s});return r}async function ws(e){const{user:n}=await w("/users/"+encodeURIComponent(e)+"/unmute",{method:"POST"});return n}async function js(e){await w(`/invites/${encodeURIComponent(e)}`,{method:"DELETE"})}async function ks(){const{settings:e}=await w("/settings");return e}async function Ss(e){const{settings:n}=await w("/settings",{method:"PATCH",body:JSON.stringify(e)});return n}async function Ns(e){try{const n=await w(`/profiles/by-username/${encodeURIComponent(e)}`);return{user:n.user,profile:n.profile||null,stats:n.stats||null}}catch{return null}}async function _s(e){const{profile:n}=await w("/profiles/me",{method:"PATCH",body:JSON.stringify(e)});return n}async function Es(e){try{const{profile:n}=await w(`/profiles/${encodeURIComponent(e)}`);return n}catch{return null}}async function zs(e,n){const s={labels:Array.isArray(n)?n:[]},{profile:r}=await w(`/profiles/${encodeURIComponent(e)}/labels`,{method:"PATCH",body:JSON.stringify(s)});return r}async function Is(e,n=30){const{user:s}=await w(`/users/${encodeURIComponent(e)}/vip`,{method:"POST",body:JSON.stringify({days:n})});return s}async function Ps(e){const{user:n}=await w(`/users/${encodeURIComponent(e)}/unvip`,{method:"POST"});return n}async function Ls(){const{members:e}=await w("/members");return e}const ft="forum:lastActive:";function An(e){try{localStorage.setItem(ft+e,new Date().toISOString())}catch{}}function Rs(e){try{return localStorage.getItem(ft+e)}catch{return null}}function As(e){if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";try{const s=new Intl.RelativeTimeFormat("ru",{numeric:"auto"}),r=n.getTime()-Date.now(),a=1e3,i=60*a,o=60*i,c=24*o,l=30*c,m=365*c;return Math.abs(r)<i?s.format(Math.round(r/a),"second"):Math.abs(r)<o?s.format(Math.round(r/i),"minute"):Math.abs(r)<c?s.format(Math.round(r/o),"hour"):Math.abs(r)<l?s.format(Math.round(r/c),"day"):Math.abs(r)<m?s.format(Math.round(r/l),"month"):s.format(Math.round(r/m),"year")}catch{return n.toLocaleString()}}const Ie="recent:items";function Mn(e,n){try{const s=localStorage.getItem(Ie),r=s?JSON.parse(s):[],a={url:e,title:n,ts:Date.now()};if(r.length&&r[0].url===e)return;const i=r.filter(l=>l.url!==e);i.unshift(a);const o=[],c=new Set;for(const l of i)c.has(l.url)||(c.add(l.url),o.push(l));for(;o.length>15;)o.pop();localStorage.setItem(Ie,JSON.stringify(o))}catch{}}const te="forum:session";function Ms(){try{const e=sessionStorage.getItem(te)??localStorage.getItem(te);return e?JSON.parse(e):null}catch{return null}}function gt(){const e=()=>{try{const r=sessionStorage.getItem(te)??localStorage.getItem(te);return r?JSON.parse(r):null}catch{return null}},[n,s]=X.useState(e());return X.useEffect(()=>{const r=()=>s(e());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const bt=[{key:"forum",type:"route",label:"Форум",icon:t.jsx(je,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:t.jsx(he,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:t.jsx(zt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:t.jsx(It,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:t.jsx(Pt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:t.jsx(je,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:t.jsx(Lt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:t.jsx(Q,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:t.jsx(pe,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:t.jsx(Q,{className:"h-4 w-4"}),id:"laws"}];function Cn(){const[e,n]=u.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=ne(),[r]=ae(),i=!gt(),o=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),c=u.useMemo(()=>{const k=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),d=(s.hash||"").replace(/^#/,"").toLowerCase();return k||d||""},[s.search,s.hash]),l=u.useCallback(h=>c===h,[c]);u.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const k=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=k}}},[e]),u.useEffect(()=>{function h(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),u.useEffect(()=>{const h=document.documentElement;e?h.classList.add("has-sidebar"):h.classList.remove("has-sidebar")},[e]);const m=u.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),b=m?"⌘ K":"Ctrl K",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",z=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",N=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",M=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",P=h=>{const k=`?tab=${encodeURIComponent(h)}`;return o?{pathname:"/",search:k}:{pathname:"/",search:k,hash:`#${h}`}},L=t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"mb-4 flex items-center justify-start",children:t.jsx(E,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),t.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:t.jsxs("ul",{className:"flex flex-col gap-1",children:[bt.map(h=>{const k=h.type==="route"?s.pathname===h.to:l(h.id),d=h.type==="route"?h.to:P(h.id);return t.jsx("li",{children:t.jsxs(E,{to:d,className:[f,k?z:""].filter(Boolean).join(" "),"aria-current":k?"page":void 0,"aria-label":h.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[h.icon,t.jsx("span",{className:"truncate",children:h.label}),h.key==="forum"&&i&&t.jsx(Me,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},h.key)}),t.jsx("li",{children:t.jsxs(E,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[t.jsx(ue,{className:"h-4 w-4"}),t.jsx("span",{className:"truncate",children:"О нас"})]})})]})}),t.jsxs("div",{className:N,children:["Подсказка: нажмите ",t.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:b}),", чтобы открыть быстрый поиск"]})]});return t.jsxs(t.Fragment,{children:[t.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(h=>!h),"aria-label":"Меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),t.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:M,children:r==="liquid"?t.jsx(re,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:L}):L})]})}const Tn={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},xt={entities:Tn};function On(e){var s;return((s=xt.entities)==null?void 0:s[e])||null}function Cs(e,n=30){const s=On(e);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function Ts(e,n){const s=e.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,i=r.length,o=Array.from({length:a+1},()=>Array(i+1).fill(0));for(let b=a-1;b>=0;b--)for(let f=i-1;f>=0;f--)o[b][f]=s[b]===r[f]?o[b+1][f+1]+1:Math.max(o[b+1][f],o[b][f+1]);const c=[];let l=0,m=0;for(;l<a&&m<i;)s[l]===r[m]?(c.push(W(s[l])),l++,m++):o[l+1][m]>=o[l][m+1]?(c.push(`<del>${W(s[l])}</del>`),l++):(c.push(`<ins>${W(r[m])}</ins>`),m++);for(;l<a;)c.push(`<del>${W(s[l++])}</del>`);for(;m<i;)c.push(`<ins>${W(r[m++])}</ins>`);return c.join(`
`)}function W(e){return e.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function $n(){var s;const e=[],n=xt.entities||{};for(const[r,a]of Object.entries(n)){const i=(s=a.changelog)==null?void 0:s[0];i&&e.push({id:r,version:i.version,date:i.date,summary:i.summary,details:i.details})}return e.sort((r,a)=>r.date<a.date?1:-1),e}function Dn(){const[e]=ae(),n=ne(),s=u.useMemo(()=>{try{const c=$n()[0];if(!c)return!1;const l=new Date(c.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const c=window.openCommandPalette;if(typeof c=="function")try{c();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",i=e==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",o=t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[t.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var c;return(c=window.openMobileMenu)==null?void 0:c.call(window)},"aria-label":"Меню",children:t.jsx(Rt,{className:"h-4 w-4"})}),t.jsx(At,{className:"h-6 w-6 shrink-0"}),t.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),t.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[t.jsx(fe,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),t.jsxs(E,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[t.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&t.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),t.jsxs(E,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[t.jsx(be,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),t.jsxs(E,{to:"/settings",className:"btn","aria-label":"Настройки",children:[t.jsx(ge,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]})]})]});return n.pathname.startsWith("/forum")?null:t.jsx("div",{className:i,children:e==="liquid"?t.jsx(re,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:o}):t.jsx("div",{className:a,children:o})})}function Fn(){const[e,n]=u.useState(!1),s=ne(),a=!gt();u.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),u.useEffect(()=>{if(!e)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[e]);const i=u.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),o=l=>{const m=new URLSearchParams(s.search||"");m.set("tab",l);const b=`?${m.toString()}`;return i?{pathname:"/",search:b}:{pathname:"/",search:b,hash:`#${l}`}};function c(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return e?t.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[t.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),t.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[t.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:c,"aria-label":"РџРѕРёСЃРє",children:[t.jsx(fe,{className:"h-4 w-4"})," ",t.jsx("span",{children:"РџРѕРёСЃРє"})]}),t.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),t.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:t.jsx(Ae,{className:"h-4 w-4"})})]}),t.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[t.jsx("ul",{className:"grid gap-2",children:bt.map(l=>{const m=l.type==="route"?l.to:o(l.id);return t.jsx("li",{children:t.jsxs(E,{to:m,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,t.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&a&&t.jsx(Me,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),t.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[t.jsxs(E,{to:"/favorites",className:"btn btn-secondary",children:[t.jsx(be,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),t.jsxs(E,{to:"/settings",className:"btn btn-secondary",children:[t.jsx(ge,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}function Bn(){const[e,n]=u.useState(()=>{try{return localStorage.getItem("site:closure_notice_v1")!=="1"}catch{return!0}});return u.useEffect(()=>{if(!e)return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=s}},[e]),e?t.jsxs("div",{className:"fixed inset-0 z-[120] flex items-start justify-center p-4",children:[t.jsx("div",{className:"absolute inset-0 bg-black/10 backdrop-blur-[2px]","aria-hidden":!0}),t.jsxs("div",{className:"relative z-10 w-[min(720px,96vw)] rounded-2xl border border-white/10 bg-white/80 p-5 text-zinc-900 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/85 dark:text-zinc-100",children:[t.jsx("div",{className:"mb-2 text-xs uppercase tracking-[0.28em] text-zinc-500 dark:text-zinc-400",children:"Важное объявление"}),t.jsx("h2",{className:"mb-2 text-2xl font-bold",children:"Проект закрыт"}),t.jsx("p",{className:"mb-3 text-sm opacity-90",children:"Разработка и поддержка проекта прекращены. Форум остаётся открытым для всех желающих: можно читать и участвовать в обсуждениях в рамках действующих правил."}),t.jsxs("ul",{className:"mb-4 ml-4 list-disc text-sm opacity-90",children:[t.jsx("li",{children:"Если вы готовы продолжить и дорабатывать форум — напишите Екатерине."}),t.jsx("li",{children:"Автор больше не имеет отношения к проекту; на сайте остаётся только одно упоминание его ника."})]}),t.jsx("div",{className:"flex flex-wrap gap-2",children:t.jsx("button",{type:"button",className:"btn btn-primary",onClick:()=>{try{localStorage.setItem("site:closure_notice_v1","1")}catch{}n(!1)},children:"Понятно"})})]})]}):null}const Un=u.lazy(()=>v(()=>import("./GovCheatsheetSky-DM_zUN6q.js"),__vite__mapDeps([0,1,2,3]))),Vn=u.lazy(()=>v(()=>import("./WhatsNew-DDYkyo51.js"),__vite__mapDeps([4,2,1]))),qn=u.lazy(()=>v(()=>import("./DiffPage-DTfTi69k.js"),__vite__mapDeps([5,1,2]))),Kn=u.lazy(()=>v(()=>import("./LiquidGlassShowcase-BOFwwr6j.js"),__vite__mapDeps([6,1,2]))),Wn=u.lazy(()=>v(()=>import("./PrintSheet-HCEdgrqR.js"),__vite__mapDeps([7,1,2]))),Gn=u.lazy(()=>v(()=>import("./RolePage-BrwwjZr4.js"),__vite__mapDeps([8,1,3,2,9]))),Yn=u.lazy(()=>v(()=>import("./LawPage-D8PADj2U.js"),__vite__mapDeps([10,1,9,2,11]))),Jn=u.lazy(()=>v(()=>import("./VuPage-Bx8XEpJE.js"),__vite__mapDeps([12,1,2]))),Hn=u.lazy(()=>v(()=>import("./HomePage-CiDUoiIr.js"),__vite__mapDeps([13,1,2]))),Xn=u.lazy(()=>v(()=>import("./ForumPage-Cpbg0eTJ.js"),__vite__mapDeps([14,1,15,16,17,2,18]))),Pe=u.lazy(()=>v(()=>import("./ProfilePage-MpX76Y3P.js"),__vite__mapDeps([19,1,15,2]))),Qn=u.lazy(()=>v(()=>import("./ForumMembers-B60Bn3tB.js"),__vite__mapDeps([20,1,17,16,2,15]))),Zn=u.lazy(()=>v(()=>import("./SectionPage-Bw5K6eL_.js"),__vite__mapDeps([21,1,16,17,2,22,11,9]))),es=u.lazy(()=>v(()=>import("./TopicPage2-BEGTGTKL.js"),__vite__mapDeps([23,1,16,22,11,2,24,25]))),ts=u.lazy(()=>v(()=>import("./TagPage-D5bCDcWY.js"),__vite__mapDeps([26,1,16,17,2]))),ns=u.lazy(()=>v(()=>import("./QuestionsPage-gPhyv7e6.js"),__vite__mapDeps([27,1,16,22,11,2,24]))),ss=u.lazy(()=>v(()=>import("./AdminPanel3-CKQiiefQ.js"),__vite__mapDeps([28,1,16,2]))),rs=u.lazy(()=>v(()=>import("./SettingsPage-rirMsEG5.js"),__vite__mapDeps([29,1,2]))),as=u.lazy(()=>v(()=>import("./FavoritesPage-BDdzkEJ1.js"),__vite__mapDeps([30,1,9,2])));function os(){const e=ne();return X.useEffect(()=>{In("page_view");try{Mn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}(async()=>{try{const n=await Rn();n&&An(n.id)}catch{}})()},[e.pathname,e.search,e.hash]),null}function is(){const[e]=ae();return t.jsxs("div",{className:"min-h-dvh w-full",children:[e==="liquid"&&t.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[t.jsx("div",{className:"absolute inset-0",style:{background:"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),t.jsx("div",{className:"absolute inset-0",style:{opacity:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),t.jsxs(kt,{basename:"/pravo/",children:[t.jsx(Nn,{}),t.jsx(Cn,{}),t.jsx(Dn,{}),t.jsx(Fn,{}),t.jsx(Bn,{}),t.jsx(os,{}),t.jsx(u.Suspense,{fallback:t.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:t.jsxs(St,{children:[t.jsx(y,{path:"/",element:t.jsx(Un,{})}),t.jsx(y,{path:"/home",element:t.jsx(Hn,{})}),t.jsx(y,{path:"/forum/*",element:t.jsx(Xn,{})}),t.jsx(y,{path:"/forum/section/:id",element:t.jsx(Zn,{})}),t.jsx(y,{path:"/forum/topic/:id",element:t.jsx(es,{})}),t.jsx(y,{path:"/forum/questions",element:t.jsx(ns,{})}),t.jsx(y,{path:"/forum/members",element:t.jsx(Qn,{})}),t.jsx(y,{path:"/forum/profile/:username",element:t.jsx(Pe,{})}),t.jsx(y,{path:"/u/:username",element:t.jsx(Pe,{})}),t.jsx(y,{path:"/forum/tag/:tag",element:t.jsx(ts,{})}),t.jsx(y,{path:"/forum/admin",element:t.jsx(ss,{})}),t.jsx(y,{path:"/whats-new",element:t.jsx(Vn,{})}),t.jsx(y,{path:"/diff/:id",element:t.jsx(qn,{})}),t.jsx(y,{path:"/print",element:t.jsx(Wn,{})}),t.jsx(y,{path:"/roles/:id",element:t.jsx(Gn,{})}),t.jsx(y,{path:"/laws/:slug",element:t.jsx(Yn,{})}),t.jsx(y,{path:"/vu/:id",element:t.jsx(Jn,{})}),t.jsx(y,{path:"/recorders/:id",element:t.jsx(qt,{})}),t.jsx(y,{path:"/about",element:t.jsx(Wt,{})}),t.jsx(y,{path:"/style/liquid",element:t.jsx(Kn,{})}),t.jsx(y,{path:"/settings",element:t.jsx(rs,{})}),t.jsx(y,{path:"/favorites",element:t.jsx(as,{})}),t.jsx(y,{path:"/forum/feeds",element:t.jsx(cs,{})})]})})]})]})}const cs=u.lazy(()=>v(()=>import("./ForumFeedsPage-CCW_NH9q.js"),__vite__mapDeps([31,1,17,16,2,18,25])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1760817125998";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(i=>caches.delete(i)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();kn();mn();function yt(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}yt();window.addEventListener("resize",yt,{passive:!0});me.createRoot(document.getElementById("root")).render(t.jsx(u.StrictMode,{children:t.jsx(is,{})}));export{Xt as $,Is as A,Ps as B,Kt as C,bs as D,js as E,vs as F,ws as G,xs as H,ys as I,xn as J,it as K,re as L,Qt as M,en as N,rn as O,on as P,ln as Q,hn as R,wn as S,st as T,xe as U,lt as V,ct as W,pn as X,jn as Y,dt as Z,us as _,Gt as a,sn as a0,an as a1,Zt as a2,cn as a3,Rn as b,Ns as c,Ts as d,ee as e,ps as f,On as g,ms as h,Cs as i,t as j,Ls as k,Ne as l,As as m,_s as n,Rs as o,Ms as p,hs as q,Ut as r,gs as s,Es as t,ae as u,Jt as v,ks as w,Ss as x,fs as y,zs as z};
