const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-B8lJf7Kq.js","assets/react-vendor-DTkXckhQ.js","assets/icons-o7Kow7Pv.js","assets/VoteWidget-KTcxI05l.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-BhRQvHX1.js","assets/DiffPage-CbxiQ8Pb.js","assets/LiquidGlassShowcase-DoauM9SY.js","assets/PrintSheet-BibRqVqP.js","assets/RolePage-RSn-jC3R.js","assets/FavStar-Bu704ubO.js","assets/LawPage-DVovAhEA.js","assets/VuPage-CC6jrSFd.js","assets/BuddyPlayground-BUf1vc9x.js","assets/HomePage-zx___bgt.js","assets/ForumPage-B8424UAz.js","assets/forumStore-DbNMpWYD.js","assets/authRemote-C-nH5NY4.js","assets/forumRemote-Dzz5sNcO.js","assets/ProfilePage-DKDvUgyx.js","assets/ForumMembers-Boi0lceb.js","assets/SectionPage-D-7rXB6c.js","assets/AdminPanel3-BQUzJnvG.js","assets/SettingsPage-B1MFuvxI.js","assets/FavoritesPage-DCCTUgK6.js"])))=>i.map(i=>d[i]);
import{r as J,a as pt,u as ht,L as M,R as c,b as U,B as ft,c as xt,d as N}from"./react-vendor-DTkXckhQ.js";import{A as gt,E as bt,I as Se,C as yt,Q as vt,R as wt,B as Q,S as de,H as jt,U as ue,a as me,X as ze,b as pe,c as he,L as Ie,G as kt,M as le,F as Nt,d as Et,e as _t,f as St,g as zt,h as It,i as Lt}from"./icons-o7Kow7Pv.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const d of i)if(d.type==="childList")for(const u of d.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&r(u)}).observe(document,{childList:!0,subtree:!0});function s(i){const d={};return i.integrity&&(d.integrity=i.integrity),i.referrerPolicy&&(d.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?d.credentials="include":i.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(i){if(i.ep)return;i.ep=!0;const d=s(i);fetch(i.href,d)}})();var Le={exports:{}},ee={};/**
 * @license React
...
![Территория красной зоны воинской части](${C}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${C}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${C}img/cpp2.png)
...
![Территория военного грузового поезда](${C}img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${C}img/pravo2.png)
![Правительство](${C}img/pravo.png)
...
`,Gt=[{id:"gov",title:"Внутренний устав Правительства",text:Wt,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],Pe="ui:density",Re="ui:font",Ut="ui:features",Ae="ui:shadow",Ce="ui:radius",$e="ui:glass",Te="ui:readw",De="ui:anim";function D(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function q(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function Yt(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),q(Pe,t)}function Ht(){return D(Pe)==="compact"?"compact":"standard"}function Xt(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),q(Re,String(n))}function Jt(){const t=D(Re),n=parseFloat(t||"1");return isFinite(n)&&n>.6&&n<2?n:1}function Qt(t,n=!0){const s=Zt();return t in s?!!s[t]:n}function Zt(){try{const t=D(Ut);return t?JSON.parse(t):{}}catch{return{}}}function en(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),q(Ae,t)}function tn(){const t=D(Ae);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function nn(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),q(Ce,t)}function sn(){const t=D(Ce);return t==="subtle"||t==="rounded"?t:"standard"}function rn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),q($e,String(n))}function an(){const t=D($e),n=parseInt(t||"6",10);return isFinite(n)?n:6}function on(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),q(Te,String(n))}function ln(){const t=D(Te),n=parseInt(t||"78",10);return isFinite(n)?n:78}function cn(){try{Yt(Ht()),Xt(Jt()),en(tn()),nn(sn()),rn(an()),on(ln()),dn(un())}catch{}}function dn(t){document.documentElement.classList.toggle("anim-off",!t),q(De,t?"1":"0")}function un(){try{return D(De)!=="0"}catch{return!0}}const Fe={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},L={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function Oe(...t){return t.filter(Boolean).join(" ")}function Be(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=i=>n(i.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function qe(t,n){c.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,i=72,d=18;const u=()=>{r=0;const h=t.current;h&&(h.style.setProperty("--lg-x",`${i}%`),h.style.setProperty("--lg-y",`${d}%`))},o=h=>{const g=t.current;if(!g)return;const p=g.getBoundingClientRect(),w=(h.clientX-p.left)/p.width*100,E=(h.clientY-p.top)/p.height*100;i=Math.max(0,Math.min(100,w)),d=Math.max(0,Math.min(100,E)),r||(r=window.requestAnimationFrame(u))},l=()=>{i=72,d=18,r||(r=window.requestAnimationFrame(u))};return s.addEventListener("pointermove",o,{passive:!0}),s.addEventListener("pointerdown",o,{passive:!0}),s.addEventListener("pointerenter",o,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",o),s.removeEventListener("pointerdown",o),s.removeEventListener("pointerenter",o),s.removeEventListener("pointerleave",l)}},[t,n])}function ve(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function X(t){return`${t[0]} ${t[1]} ${t[2]}`}function se(t,n,s){return Math.round(t+(n-t)*s)}function we(t,n){return[se(t[0],n>=0?255:0,Math.abs(n)),se(t[1],n>=0?255:0,Math.abs(n)),se(t[2],n>=0?255:0,Math.abs(n))]}function mn(t,n,s){const r=t?Fe[t]:n??L.tint,i=s??L.accent,d=ve(r),u=ve(i),o=we(u,.25),l=we(u,-.55);return{tintRgb:X(d),accentRgb:X(u),accentSoftRgb:X(o),accentDeepRgb:X(l)}}function Ke(t,n){const s={...t??{}},{tintRgb:r,accentRgb:i,accentSoftRgb:d,accentDeepRgb:u}=mn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=i,s["--lg-accent-soft"]=d,s["--lg-accent-deep"]=u,s}const Ve=c.forwardRef((t,n)=>{const{blur:s=L.blur,tint:r=L.tint,opacity:i=L.opacity,gloss:d=L.gloss,border:u=L.border,glints:o=L.glints,interactive:l=L.interactive,animate:h=L.animate,elevation:g=L.elevation,tone:p,accent:w=L.accent,className:E,style:x,children:b,...v}=t,a=Be(),m=l&&!a,j=c.useRef(null),f=c.useCallback(k=>{j.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","72%"),k.style.setProperty("--lg-y","18%"))},[n]);qe(j,m);const y=c.useMemo(()=>Ke(x,{blur:s,tint:r,opacity:i,gloss:d,border:u,elevation:g,glints:o,tone:p,accent:w}),[x,s,r,i,d,u,g,o,p,w]),I={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*g}px ${50*g}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:f,className:Oe("liquid-glass",E),"data-animate":h?"true":"false","data-interactive":m?"true":"false",style:{...I,...y},...v,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),o&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),m&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:b}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:u,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Ve.displayName="LiquidGlass";const We=c.forwardRef((t,n)=>{const{className:s,style:r,children:i,type:d,blur:u,tint:o,opacity:l,gloss:h,border:g,glints:p,interactive:w,animate:E,elevation:x,tone:b,accent:v=L.accent,...a}=t,m=u??L.blur,j=b?Fe[b]:o??L.tint,f=l??.16,y=h??.9,I=g??.6,k=p??!1,P=w??!0,_=x??1,R=Be(),K=P&&!R,A=c.useRef(null),H=c.useCallback(S=>{A.current=S,typeof n=="function"?n(S):n&&(n.current=S),S&&(S.style.setProperty("--lg-x","70%"),S.style.setProperty("--lg-y","16%"))},[n]);qe(A,K);const $=c.useMemo(()=>Ke(r,{blur:m,tint:j,opacity:f,gloss:y,border:I,glints:k,elevation:_,tone:b,accent:v}),[r,m,j,f,y,I,k,_,b,v]),O={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*_}px ${18*_}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:H,type:d??"button",className:Oe("liquid-glass liquid-glass__button",s),style:{...O,...$},...a,onMouseDown:S=>{S.currentTarget.style.transform="scale(0.985)"},onMouseUp:S=>{S.currentTarget.style.transform=""},onMouseLeave:S=>{S.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:i}),e.jsx("style",{children:`
      ...
      `})]})});We.displayName="LiquidGlass.Button";const Y=Ve;Y.Button=We;const Ge="theme",Ue="accent",Ye="accent_custom",He="bg",pn="bg_custom",Xe="ui:style-mode",re="ui:liquid:prev-theme",Je="ui:liquid:tone";function F(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function B(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function hn(t){try{typeof window<"u"&&window.localStorage.removeItem(t)}catch{}}const Qe={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Ee,_e;const ae=((_e=(Ee=import.meta)==null?void 0:Ee.env)==null?void 0:_e.BASE_URL)??"/",W=t=>{const n=t.replace(/^\/+/,"");return(ae.endsWith("/")?ae:ae+"/")+n},Ze={bg1:W("img/bg1.png"),bg2:W("img/bg2.png"),bg3:W("img/bg3.png"),bg4:W("img/bg4.png"),bg5:W("img/bg5.png")};function et(){const t=F(Ge);return t==="light"||t==="dark"?t:null}function fn(){const t=F(Ue);return t?t==="custom"?"custom":t in Qe?t:null:null}function xn(){return F(Ye)}function tt(){const t=F(He);return t&&(t==="none"||t==="custom"||t in Ze)?t:null}function gn(){return F(pn)}function nt(){const t=F(Xe);return t==="classic"||t==="liquid"||t==="beta"?t:null}function bn(){return(F(Je)||"dark")==="light"?"light":"dark"}function yn(t){B(Je,t);const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{fe(t==="light"?"light":"dark")}catch{}}function st(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.classList.toggle("theme-beta",t==="beta"),n.dataset.styleMode=t,t==="liquid"||t==="beta"){try{const s=et()??(rt()?"dark":"light");B(re,s);const r=bn();yn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=F(re);(s==="light"||s==="dark")&&fe(s),hn(re)}catch{}try{const s=tt()??"none";it(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}B(Xe,t)}function rt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function fe(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),B(Ge,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function at(t){if(t==="custom"){const n=xn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=wn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=Qe[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}B(Ue,t)}function is(t){B(Ye,ot(t)),at("custom")}function it(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const i=gn();i?(n.style.backgroundImage=`url(${i})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const i=Ze[t];n.style.backgroundImage=`url(${i})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}B(He,t)}function vn(){const n=et()??(rt()?"dark":"light");fe(n);const s=fn()??"indigo";at(s);const r=tt()??"none";it(r);const i=nt()??"classic";st(i)}function ot(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],i=n[3];n=`#${s}${s}${r}${r}${i}${i}`}return n}function wn(t,n){const s=ot(t).slice(1),r=parseInt(s,16);let i=r>>16&255,d=r>>8&255,u=r&255;i=Math.max(0,Math.min(255,Math.round(i+255*n))),d=Math.max(0,Math.min(255,Math.round(d+255*n))),u=Math.max(0,Math.min(255,Math.round(u+255*n)));const o=l=>l.toString(16).padStart(2,"0");return`#${o(i)}${o(d)}${o(u)}`}function je(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid"||t==="beta")return t}try{return nt()??"classic"}catch{return"classic"}}function te(){const[t,n]=c.useState(()=>je());c.useEffect(()=>{const r=()=>{const u=je();n(o=>o===u?o:u)},i=u=>{const o=u.detail;o==="classic"||o==="liquid"||o==="beta"?n(o):r()};window.addEventListener("stylemodechange",i);const d=new MutationObserver(r);return d.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",i),d.disconnect()}},[]);const s=c.useCallback(r=>{st(r),n(r)},[]);return[t,s]}function T(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function jn(){if(!Qt("cmd_palette",!0))return null;const[n]=te(),[s,r]=c.useState(!1),[i,d]=c.useState(""),[u,o]=c.useState(0),[l,h]=c.useState(()=>localStorage.getItem("cp_filter")||"all");c.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]),c.useEffect(()=>{function a(m){(m.ctrlKey||m.metaKey)&&m.key.toLowerCase()==="k"&&(m.preventDefault(),r(!0),d(""),o(0)),s&&m.key==="Escape"&&r(!1)}return window.addEventListener("keydown",a),window.openCommandPalette=()=>{r(!0),d(""),o(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",a)}},[s]);const p=c.useMemo(()=>{const a=[];a.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:T("/favorites")}),a.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:T("/settings")});for(const f of Vt)a.push({kind:"role",id:f.id,title:f.role,subtitle:"Раздел",url:T(`/roles/${f.id}`)});for(const f of ye)a.push({kind:"law",id:f.slug,title:f.title,subtitle:"Закон",url:T(`/laws/${f.slug}`)});for(const f of Gt)a.push({kind:"vu",id:f.id,title:f.title,subtitle:"ВУ",url:T(`/vu/${f.id}`)});const m=i.trim().toLowerCase();return m&&a.push(...E(m).slice(0,60)),m?(l==="all"?a:a.filter(f=>f.kind===l)).map(f=>({r:f,score:w(`${f.title} ${f.subtitle||""}`.toLowerCase(),m)+(f.__boost||0)})).filter(f=>f.score>0).sort((f,y)=>y.score-f.score).slice(0,30).map(f=>f.r):a.slice(0,20)},[i,l]);function w(a,m){return m.split(/\s+/).filter(Boolean).reduce((f,y)=>f+(a.includes(y)?1:0),0)}function E(a){const m=[],j=y=>y.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const y of ye){const k=(y.content||"").replace(/\r\n?/g,`
`).split(`
`);let P="",_="";const R=new Set;for(const K of k){const A=K.trim(),H=/^(#{2,6})\s*(.+)$/.exec(A);if(H){P=H[2].trim(),_=j(P)||"";const $=P.toLowerCase();if(_&&$.includes(a)){const O=`${y.slug}#${_}`;if(!R.has(O)){const S={kind:"law",id:O,title:`${y.title} — ${P}`,subtitle:"Заголовок",url:T(`/laws/${y.slug}?q=${encodeURIComponent(a)}#${_}`)};S.__boost=$.startsWith(a)?8:6,m.push(S),R.add(O)}}continue}if(A&&A.toLowerCase().includes(a)){const $=_?`${y.slug}#${_}`:y.slug;if(!R.has($)){const O=A.length>140?A.slice(0,137)+"…":A,S=_?`${y.title} — ${P}`:y.title,mt=T(_?`/laws/${y.slug}?q=${encodeURIComponent(a)}#${_}`:`/laws/${y.slug}?q=${encodeURIComponent(a)}`),xe={kind:"law",id:$,title:S,subtitle:O||"Контекст",url:mt};xe.__boost=5,m.push(xe),R.add($)}}}}const f=new Set;return m.filter(y=>f.has(y.id)?!1:(f.add(y.id),!0))}function x(a){r(!1);try{window.location.href=a}catch{location.assign(a)}}function b(a){p.length&&(a.key==="ArrowDown"&&(a.preventDefault(),o(m=>Math.min(m+1,p.length-1))),a.key==="ArrowUp"&&(a.preventDefault(),o(m=>Math.max(m-1,0))),a.key==="Enter"&&(a.preventDefault(),x(p[u].url)))}const v=({children:a})=>n==="liquid"?e.jsx(Y,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:a}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:a});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Поиск",children:e.jsxs(v,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(me,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:i,onChange:a=>{d(a.target.value),o(0)},onKeyDown:b,placeholder:"Поиск: закон, роль, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"Закрыть",children:e.jsx(ze,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(a=>e.jsx("button",{onClick:()=>{h(a.k),o(0)},className:`chip ${l===a.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:a.label},a.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!p.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),p.map((a,m)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${m===u?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>o(m),onClick:()=>x(a.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[a.kind==="law"&&e.jsx(Q,{className:"h-4 w-4"}),a.kind==="role"&&e.jsx(ue,{className:"h-4 w-4"}),a.kind==="vu"&&e.jsx(de,{className:"h-4 w-4"}),a.kind==="page"&&(a.id==="settings"?e.jsx(pe,{className:"h-4 w-4"}):e.jsx(he,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:a.title})]}),a.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:a.subtitle})]},`${a.kind}:${a.id}`))]})]})}):null})}const kn="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function Nn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function En(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Nn()}}function _n(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const i=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(i)==="1"||String(i)==="yes")return}catch{}const s=JSON.stringify({event:t,...En(),data:n}),r=`${kn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const i=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,i))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const ke="recent:items";function Sn(t,n){try{const s=localStorage.getItem(ke),r=s?JSON.parse(s):[],i={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const d=r.filter(l=>l.url!==t);d.unshift(i);const u=[],o=new Set;for(const l of d)o.has(l.url)||(o.add(l.url),u.push(l));for(;u.length>15;)u.pop();localStorage.setItem(ke,JSON.stringify(u))}catch{}}const Z="forum:session";function os(){try{const t=sessionStorage.getItem(Z)??localStorage.getItem(Z);return t?JSON.parse(t):null}catch{return null}}function ls(t){try{window.dispatchEvent(new Event("forum:session"))}catch{}}function lt(){const t=()=>{try{const r=sessionStorage.getItem(Z)??localStorage.getItem(Z);return r?JSON.parse(r):null}catch{return null}},[n,s]=J.useState(t());return J.useEffect(()=>{const r=()=>s(t());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const ct=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(le,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(ue,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Nt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(Et,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx(_t,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(le,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(St,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(Q,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(de,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(Q,{className:"h-4 w-4"}),id:"laws"}];function zn(){const[t,n]=c.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=U(),[r]=te(),d=!lt(),u=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),o=c.useMemo(()=>{const m=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),j=(s.hash||"").replace(/^#/,"").toLowerCase();return m||j||""},[s.search,s.hash]),l=c.useCallback(a=>o===a,[o]);c.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[t]),c.useEffect(()=>{function a(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]),c.useEffect(()=>{const a=document.documentElement;t?a.classList.add("has-sidebar"):a.classList.remove("has-sidebar")},[t]);const h=c.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),g=h?"⌘ K":"Ctrl K",p=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",w=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",E=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",x=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",b=a=>{const m=`?tab=${encodeURIComponent(a)}`;return u?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${a}`}},v=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(M,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[ct.map(a=>{const m=a.type==="route"?s.pathname===a.to:l(a.id),j=a.type==="route"?a.to:b(a.id);return e.jsx("li",{children:e.jsxs(M,{to:j,className:[p,m?w:""].filter(Boolean).join(" "),"aria-current":m?"page":void 0,"aria-label":a.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[a.icon,e.jsx("span",{className:"truncate",children:a.label}),a.key==="forum"&&d&&e.jsx(Ie,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},a.key)}),e.jsx("li",{children:e.jsxs(M,{to:"/about",className:p,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Se,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(M,{to:"/buddy",className:p,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(kt,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:E,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:g}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(a=>!a),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:x,children:r==="liquid"?e.jsx(Y,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:v}):v})]})}const In={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},dt={entities:In};function Ln(t){var s;return((s=dt.entities)==null?void 0:s[t])||null}function cs(t,n=30){const s=Ln(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function ds(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),i=s.length,d=r.length,u=Array.from({length:i+1},()=>Array(d+1).fill(0));for(let g=i-1;g>=0;g--)for(let p=d-1;p>=0;p--)u[g][p]=s[g]===r[p]?u[g+1][p+1]+1:Math.max(u[g+1][p],u[g][p+1]);const o=[];let l=0,h=0;for(;l<i&&h<d;)s[l]===r[h]?(o.push(G(s[l])),l++,h++):u[l+1][h]>=u[l][h+1]?(o.push(`<del>${G(s[l])}</del>`),l++):(o.push(`<ins>${G(r[h])}</ins>`),h++);for(;l<i;)o.push(`<del>${G(s[l++])}</del>`);for(;h<d;)o.push(`<ins>${G(r[h++])}</ins>`);return o.join(`
`)}function G(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function Mn(){var s;const t=[],n=dt.entities||{};for(const[r,i]of Object.entries(n)){const d=(s=i.changelog)==null?void 0:s[0];d&&t.push({id:r,version:d.version,date:d.date,summary:d.summary,details:d.details})}return t.sort((r,i)=>r.date<i.date?1:-1),t}function Pn(){const[t]=te(),n=U(),s=c.useMemo(()=>{try{const o=Mn()[0];if(!o)return!1;const l=new Date(o.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const o=window.openCommandPalette;if(typeof o=="function")try{o();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const i="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",d=t==="liquid"||t==="beta"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",u=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var o;return(o=window.openMobileMenu)==null?void 0:o.call(window)},"aria-label":"Меню",children:e.jsx(zt,{className:"h-4 w-4"})}),e.jsx(It,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(me,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(he,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(pe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),e.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:d,children:t==="liquid"?e.jsx(Y,{className:`${i} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:u}):e.jsx("div",{className:i,children:u})})}const Rn="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",ie="notif:lastSeen",Ne="notifications-panel";function An(){const[t,n]=c.useState(!1),[s,r]=c.useState([]),[i,d]=c.useState(0),[u,o]=c.useState(!1),[l,h]=c.useState(null),g=c.useRef(null),p=c.useCallback(async()=>{const x=new AbortController;o(!0),h(null);try{const b=await fetch(Rn,{cache:"no-store",signal:x.signal});if(!b.ok)throw new Error(`HTTP ${b.status}`);const v=await b.json(),a=Array.isArray(v)?v:v.items||[],m=I=>I?new Date(I).getTime():0;a.sort((I,k)=>m(k.date)-m(I.date)),r(a);const j=typeof localStorage<"u"&&localStorage.getItem(ie)||"",f=j?a.findIndex(I=>I.id===j):-1,y=f===-1?a.length:f;d(Math.max(0,y))}catch(b){(b==null?void 0:b.name)!=="AbortError"&&h("Не удалось загрузить уведомления")}finally{o(!1)}return()=>x.abort()},[]);c.useEffect(()=>{p()},[p]),c.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(ie,s[0].id),d(0)}catch{}},[t,s]),c.useEffect(()=>{if(!t)return;const x=v=>{g.current&&(g.current.contains(v.target)||n(!1))},b=v=>{v.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",x),document.addEventListener("keydown",b),()=>{document.removeEventListener("mousedown",x),document.removeEventListener("keydown",b)}},[t]);const w=()=>n(x=>!x),E=x=>x?new Date(x).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:g,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:w,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":Ne,children:[e.jsx(Lt,{className:"h-4 w-4"}),i>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:i})]}),t&&e.jsxs(Y,{id:Ne,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),u?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):l?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:l}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(x=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:x.url||"#",target:x.url?"_blank":void 0,rel:x.url?"noreferrer":void 0,onClick:()=>{var b;try{(b=s[0])!=null&&b.id&&localStorage.setItem(ie,s[0].id),d(0)}catch{}},children:[x.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:x.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:x.text}),x.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:E(x.date)})]})},x.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function Cn(){const[t,n]=c.useState(!1),s=U(),i=!lt();c.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),c.useEffect(()=>{if(!t)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[t]);const d=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),u=l=>{const h=new URLSearchParams(s.search||"");h.set("tab",l);const g=`?${h.toString()}`;return d?{pathname:"/",search:g}:{pathname:"/",search:g,hash:`#${l}`}};function o(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:o,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(me,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(ze,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:ct.map(l=>{const h=l.type==="route"?l.to:u(l.id);return e.jsx("li",{children:e.jsxs(M,{to:h,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,e.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&i&&e.jsx(Ie,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(he,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(pe,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const oe=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!"];function $n(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=i=>n(i.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function Tn(){const[t,n]=c.useState(null),s=c.useRef(Math.floor(Math.random()*oe.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches)return null;const r=$n(),i=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),d=!r&&!i,u=c.useRef(null),o=c.useRef(null);c.useEffect(()=>{const w=u.current;if(!w)return;let E=0,x=performance.now(),b=Math.random()*(window.innerWidth-64)+16,v=Math.random()*(window.innerHeight-120)+60,a=(Math.random()*60+30)*(Math.random()>.5?1:-1),m=(Math.random()*40+20)*(Math.random()>.5?1:-1);const j=y=>{const I=Math.min(.05,(y-x)/1e3);if(x=y,d){b+=a*I,v+=m*I;const k=16,P=window.innerWidth,_=window.innerHeight,R=48,K=48;b<k&&(b=k,a=Math.abs(a)),b>P-R-k&&(b=P-R-k,a=-Math.abs(a)),v<60&&(v=60,m=Math.abs(m)),v>_-K-k&&(v=_-K-k,m=-Math.abs(m)),a+=(Math.random()-.5)*4,m+=(Math.random()-.5)*4}w.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(v)}px, 0)`,E=requestAnimationFrame(j)};E=requestAnimationFrame(j);const f=()=>{x=performance.now()};return window.addEventListener("resize",f),()=>{cancelAnimationFrame(E),window.removeEventListener("resize",f)}},[d]);function l(w){const E=w??oe[s.current++%oe.length];n(E),window.clearTimeout(l._t),l._t=window.setTimeout(()=>n(null),3e3)}function h(w){l()}function g(){o.current&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>l("Просто нажми, чтобы я говорил!"),600)}function p(){o.current&&(window.clearTimeout(o.current),o.current=null)}return e.jsx("div",{ref:u,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:h,onPointerDown:g,onPointerUp:p,onPointerLeave:p,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:"#bcd3ff",stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:"#6a79ff",stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}const Dn=c.lazy(()=>z(()=>import("./GovCheatsheetSky-B8lJf7Kq.js"),__vite__mapDeps([0,1,2,3,4]))),Fn=c.lazy(()=>z(()=>import("./WhatsNew-BhRQvHX1.js"),__vite__mapDeps([5,1,2]))),On=c.lazy(()=>z(()=>import("./DiffPage-CbxiQ8Pb.js"),__vite__mapDeps([6,1,2]))),Bn=c.lazy(()=>z(()=>import("./LiquidGlassShowcase-DoauM9SY.js"),__vite__mapDeps([7,1,2]))),qn=c.lazy(()=>z(()=>import("./PrintSheet-BibRqVqP.js"),__vite__mapDeps([8,1,2]))),Kn=c.lazy(()=>z(()=>import("./RolePage-RSn-jC3R.js"),__vite__mapDeps([9,1,3,2,10]))),Vn=c.lazy(()=>z(()=>import("./LawPage-DVovAhEA.js"),__vite__mapDeps([11,1,10,2]))),Wn=c.lazy(()=>z(()=>import("./VuPage-CC6jrSFd.js"),__vite__mapDeps([12,1,2]))),Gn=c.lazy(()=>z(()=>import("./BuddyPlayground-BUf1vc9x.js"),__vite__mapDeps([13,1,2]))),Un=c.lazy(()=>z(()=>import("./HomePage-zx___bgt.js"),__vite__mapDeps([14,1,2]))),Yn=c.lazy(()=>z(()=>import("./ForumPage-B8424UAz.js"),__vite__mapDeps([15,1,16,17,18,2]))),Hn=c.lazy(()=>z(()=>import("./ProfilePage-DKDvUgyx.js"),__vite__mapDeps([19,1,16,2]))),Xn=c.lazy(()=>z(()=>import("./ForumMembers-Boi0lceb.js"),__vite__mapDeps([20,1,16,2]))),Jn=c.lazy(()=>z(()=>import("./SectionPage-D-7rXB6c.js"),__vite__mapDeps([21,1,18,2]))),Qn=c.lazy(()=>z(()=>import("./AdminPanel3-BQUzJnvG.js"),__vite__mapDeps([22,1,16,18,17,2]))),Zn=c.lazy(()=>z(()=>import("./SettingsPage-B1MFuvxI.js"),__vite__mapDeps([23,1,4,2]))),es=c.lazy(()=>z(()=>import("./FavoritesPage-DCCTUgK6.js"),__vite__mapDeps([24,1,10,2])));function ts(){const t=U();return J.useEffect(()=>{_n("page_view");try{Sn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[t.pathname,t.search,t.hash]),null}function ns(){return(U().pathname||"").startsWith("/buddy")?null:e.jsx(Tn,{})}function ss(){const[t]=te();return e.jsxs("div",{className:"min-h-dvh w-full",children:[(t==="liquid"||t==="beta")&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:t==="beta"?"radial-gradient(900px 600px at 10% -5%, rgba(0,255,240,.16), transparent 60%),radial-gradient(1100px 780px at 92% 8%, rgba(168,85,247,.18), transparent 65%),linear-gradient(180deg, rgba(255,255,255,.03), rgba(0,0,0,.45))":"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:t==="beta"?.02:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(ft,{basename:"/pravo/",children:[e.jsx(jn,{}),e.jsx(zn,{}),e.jsx(Pn,{}),e.jsx(Cn,{}),e.jsx(ns,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(An,{})}),e.jsx(ts,{}),e.jsx(c.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Загрузка…"}),children:e.jsxs(xt,{children:[e.jsx(N,{path:"/",element:e.jsx(Dn,{})}),e.jsx(N,{path:"/home",element:e.jsx(Un,{})}),e.jsx(N,{path:"/forum/*",element:e.jsx(Yn,{})}),e.jsx(N,{path:"/forum/section/:id",element:e.jsx(Jn,{})}),e.jsx(N,{path:"/forum/members",element:e.jsx(Xn,{})}),e.jsx(N,{path:"/forum/profile/:username",element:e.jsx(Hn,{})}),e.jsx(N,{path:"/forum/admin",element:e.jsx(Qn,{})}),e.jsx(N,{path:"/whats-new",element:e.jsx(Fn,{})}),e.jsx(N,{path:"/diff/:id",element:e.jsx(On,{})}),e.jsx(N,{path:"/print",element:e.jsx(qn,{})}),e.jsx(N,{path:"/roles/:id",element:e.jsx(Kn,{})}),e.jsx(N,{path:"/laws/:slug",element:e.jsx(Vn,{})}),e.jsx(N,{path:"/vu/:id",element:e.jsx(Wn,{})}),e.jsx(N,{path:"/recorders/:id",element:e.jsx(Bt,{})}),e.jsx(N,{path:"/about",element:e.jsx(Kt,{})}),e.jsx(N,{path:"/style/liquid",element:e.jsx(Bn,{})}),e.jsx(N,{path:"/buddy",element:e.jsx(Gn,{})}),e.jsx(N,{path:"/settings",element:e.jsx(Zn,{})}),e.jsx(N,{path:"/favorites",element:e.jsx(es,{})})]})})]})]})}(function(){try{const n="app:version",s=localStorage.getItem(n),r="1758981098271";if(s&&s!==r){"caches"in window?caches.keys().then(i=>Promise.all(i.map(d=>caches.delete(d)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();vn();cn();function ut(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}ut();window.addEventListener("resize",ut,{passive:!0});ce.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(ss,{})}));export{Qe as A,at as B,qt as C,is as D,Yt as E,en as F,nn as G,Ze as H,Xt as I,rn as J,Y as L,Vt as a,Ln as b,os as c,ds as d,ls as e,fn as f,Mn as g,nt as h,cs as i,e as j,Ht as k,ye as l,Jt as m,tn as n,sn as o,an as p,un as q,Ft as r,bn as s,fe as t,te as u,Gt as v,rt as w,st as x,dn as y,yn as z};
