...
`,Cl=[{id:"gov",title:"Внутренний устав Правительства",text:Th,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
наказывается выговором`}],Mh=String.raw`
...
`).trim();r.push({id:Ih(u)||`sec-${r.length+1}`,title:u,text:d||u,source:"https://forum.amazing-online.com/threads/uchebnye-materialy-dlja-sotrudnikov-pravitelstvennogo-apparata.1065800/"})}l=null,i=[]},a=/^(##\s+.+|Лекция\s*(на\s+тему)?\s*[:«"].+|Тема[\.:]\s*.+|Раздел[\.:]\s*.+|Глава[\.:]\s*.+|Инструкция[\.:]\s*.+|Порядок[\.:]\s*.+)$/i;for(const u of n){const d=u.trim();if(!d)continue;const h=(d.match(/^[^\n]+/)||[""])[0].trim();if(a.test(h)){o(),l=h.replace(/^##\s+/,"").trim();const c=d.slice(h.length).trim();c&&i.push(c)}else if(!l&&r.length===0){l=h;const f=d.slice(h.length).trim();f&&i.push(f)}else i.push(d)}return o(),r.length===0?[{id:"lectures",title:"Учебные материалы",text:t,source:"https://forum.amazing-online.com/threads/uchebnye-materialy-dlja-sotrudnikov-pravitelstvennogo-apparata.1065800/"}]:r}const $h=Rh(Mh);function Ja(e){return String(e).toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80)}function qa(e){return String(e).replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function Oh(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Dh(e){let t=String(e).trim().toLowerCase();return t=t.replace(/\bст\.?\s*/g,"статья ").replace(/\bук\b/g,"уголовный кодекс").replace(/\bкоап\b/g,"коап").replace(/\s+/g," "),t}function eu(e){return String(e).trim().toLowerCase().replace(/\s+/g," ").split(" ").filter(Boolean)}function Fh(){return new Promise((e,t)=>{if(window.FlexSearch)return e();const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/flexsearch@0.7.31/dist/flexsearch.bundle.js",n.onload=()=>e(),n.onerror=()=>t(),document.head.appendChild(n)})}function Ah(){const[e,t]=A.useState(!1),[n,r]=A.useState(""),[l,i]=A.useState([]);A.useEffect(()=>{(async()=>{await Fh();const{Document:h}=window.FlexSearch,f=new h({cache:!0,tokenize:"forward",document:{id:"id",index:[{field:"abbr"},{field:"title"},{field:"text"}],store:["slug","title","excerpt","abbr"]}}),c=[];wn.forEach(v=>{const x=v.content.split(/\n(?=##\s+)/g);x.length===1?c.push({id:v.slug,slug:v.slug,title:v.title,abbr:v.abbr,text:v.content,excerpt:v.notes||""}):x.forEach(y=>{var p;const j=((p=y.match(/^##\s+(.+)$/m))==null?void 0:p[1])||v.title,m=Ja(j);c.push({id:`${v.slug}#${m}`,slug:`${v.slug}#${m}`,title:`${v.title} — ${j}`,abbr:v.abbr,text:y,excerpt:j})})}),c.forEach(v=>f.add(v)),window.__LAW_INDEX2__=f,window.__LAW_DOCS2__=c,t(!0)})()},[]);function o(h,f){let c=qa(h);const v=eu(f);for(const x of v)c=c.replace(new RegExp(`(${Oh(x)})`,"gi"),"<mark>$1</mark>");return c}function a(h,f,c=140){const v=h.replace(/\s+/g," ").trim();if(!f.trim())return qa(v.slice(0,c))+(v.length>c?"…":"");const x=eu(f);let y=-1;for(const g of x){const w=v.toLowerCase().indexOf(g.toLowerCase());w!==-1&&(y===-1||w<y)&&(y=w)}const j=Math.max(0,y>30?y-30:0),m=Math.min(v.length,j+c),p=(j>0?"…":"")+v.slice(j,m)+(m<v.length?"…":"");return o(p,f)}function u(h){var w;const f=h.toLowerCase().replace(/\s+/g," ").trim(),c=f.match(/(?:ст\.?\s*)?(\d{1,3}(?:\.\d+)?)(?:\s*ст\.?\s*)?\s*(ук|коап)/i)||f.match(/(ук|коап)\s*(\d{1,3}(?:\.\d+)?)/i);if(!c)return null;const v=c[1]==="ук"||c[2]==="ук"?"uk":"koap",x=c[1]==="ук"||c[1]==="коап"?c[2]:c[1],y=wn.find(N=>N.slug===v);if(!y)return null;const j=new RegExp(`^###\\s*Статья\\s*${x}\\b`,"mi"),m=y.content.split(/\n(?=###\s+)/g).find(N=>j.test(N));if(!m)return`/laws/${y.slug}`;const p=((w=m.match(/^###\s*(.+)$/m))==null?void 0:w[1])||`Статья ${x}`,g=Ja(p);return`/laws/${y.slug}#${g}`}async function d(h){const f=window.__LAW_INDEX2__,c=window.__LAW_DOCS2__;if(!f||!c)return;const v=u(h);if(v){i([{url:v,title:"Прямой переход",excerpt:h.toUpperCase()}]);return}const x=f.search(Dh(h),{enrich:!0,limit:30}),y=new Set,j=[];for(const m of x)for(const p of m.result){if(y.has(p.id))continue;y.add(p.id);const g=c.find(C=>C.id===p.id);if(!g)continue;const w=g.excerpt||g.title,N=a(g.text||w,n);j.push({url:`/laws/${g.slug}`,title:g.title,excerpt:N,abbr:g.abbr})}i(j)}return A.useEffect(()=>{if(!e)return;if(!n.trim()){i([]);return}const h=setTimeout(()=>d(n),120);return()=>clearTimeout(h)},[n,e]),s.jsxs("div",{className:"rounded-2xl border border-zinc-200 bg-white/80 p-3 dark:border-zinc-800 dark:bg-zinc-900/50",children:[s.jsxs("div",{className:"mb-2 text-xs text-zinc-600",children:["Примеры: ",s.jsx("code",{children:"ук 105"}),", ",s.jsx("code",{children:"коап 12.8"}),", ",s.jsx("code",{children:"дорожные знаки"})]}),s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(El,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),s.jsx("input",{value:n,onChange:h=>r(h.target.value),placeholder:"Поиск по всем законам (статьи, названия, аббревиатуры)…",className:"w-full rounded-xl border border-zinc-200 px-3 py-1.5 text-sm focus:outline-none focus:ring dark:border-zinc-700 dark:bg-zinc-900/50"})]}),!!l.length&&s.jsx("div",{className:"mt-3 grid gap-2",children:l.map((h,f)=>s.jsxs(te,{to:h.url,className:"block rounded-xl border border-zinc-200 p-3 hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800",children:[s.jsxs("div",{className:"flex items-center justify-between gap-2",children:[s.jsx("div",{className:"text-sm font-semibold",dangerouslySetInnerHTML:{__html:o(h.title,n)}}),h.abbr&&s.jsx("span",{className:"rounded-full border px-2 py-0.5 text-[10px]",children:h.abbr})]}),s.jsx("div",{className:"mt-1 line-clamp-2 text-xs text-zinc-500 dark:text-zinc-400",dangerouslySetInnerHTML:{__html:o(h.excerpt||"",n)}})]},f))})]})}const Fd=[{id:"lawyer",role:"Адвокат",tips:["Всегда выходи через рацию департамента: представление по форме «Адвокат Фамилия».","Перед визитом в ИК — запросить допуск и сопровождение КПП: «/d [ПР/УФСИН] Адвокат *Фамилия*. Разрешите прибыть для оказания юридической помощи заключенным ИК?»","Вход и передвижение на территории ИК — только с удостоверением и под сопровождением сотрудника ИК.","Работай в установленные окна посещений ИК","Запрещена передача денежных средств заключенным без согласования с сотрудником ФСИН"],source:"Учебные материалы: порядок работы адвоката в ИК, формы общения и запреты в рации."},{id:"inspector",role:"Инспектор",tips:["Проверки/ревизии — только с разрешения руководства и составом ≥ 2 чел.","На объекте представиться старшему, запросить режимный допуск (архив, склад, КПП).","Старт/продолжение/завершение — докладывай в /d: «/d [ПР/Орг] Инспектор Петров. Прибыл на проверку, приступаю».","Нарушения фиксируй фактами; решения — через руководителя департамента.","Плановые/внеплановые проверки — по основаниям и регламенту; итог — оценка (1–5) и доклад в /d."],source:"Порядок плановых/внеплановых проверок; инфо-раздел Правительства."},{id:"advisor",role:"Советник",tips:["Координируй собеседования и методическую помощь отделам; план согласовывай с руководством.","На совместных выездах — будь точкой коммуникации: «/d [ПР/Орг] Советник Сидоров. Координирую проверку, состав N».","В рации — только по делу, кратко, без оффтопа; спорные вопросы поднимай руководителю.","Собирай сводку и передавай руководителю департамента."]},{id:"deputy-minister",role:"Заместитель министра",tips:["Организует и принимает отчётность подразделений; назначает ответственных за связь.","Снятие судимостей — строго в здании Правительства и по регламенту, доклад в /d о факте оказания услуги.","Для гос-волны /gov: предварительно уточни в /d свободный слот и забронируй (пример ниже).","Шаблон брони гос-волны: «/d [ПР/Орг] Волна гос. новостей свободна на 18:10?», затем «Занимаю волну на 18:10»."],source:"Правила бронирования гос-волны; учебные материалы Правительства."},{id:"minister",role:"Министр",tips:["Утверждает плановые проверки/маршруты; формирует состав комиссии.","Связь: единый стандарт докладов, короткие формулы, дисциплина рации.","Совместные мероприятия с МВД/ВЧ/ЕСС согласовывает с руководителями организаций.","Итоги проверок — сводный доклад Губернатору/Вице-губернатору."]},{id:"admin-chief",role:"Глава администрации",tips:["Операционное управление аппаратом: расписания, приоритеты, контроль исполнения.","Объединяет коммуникацию департаментов при сложных кейсах.","Принимает сводные отчёты по проверкам/ревизиям и направляет резолюции.","Требует строгого соблюдения субординации и форм радиодокладов."]},{id:"vice-governor",role:"Вице-губернатор",tips:["Межведомственное взаимодействие на уровне руководителей: ФСБ/ВЧ/ЕСС/МВД.","Утверждает внеплановые проверки по установленным основаниям.","Назначает кураторов и сроки устранения нарушений; в экстренных случаях формирует единый штаб связи.","Итоги докладывает Губернатору и доводит решения до департаментов."],source:"Основания внеплановых проверок; общие регламенты взаимодействия."},{id:"governor",role:"Губернатор",tips:["Общее руководство, постановления, указы; стратегические решения.","Утверждает графики проверок и составы комиссий (не менее 3 членов для аттестаций).","Решает межведомственные споры и принимает финальные отчёты.","Награждения и меры воздействия — по итогам проверок/ревизий."],source:"Областной закон о Правительстве: порядок проверок и аттестаций."},{id:"templates-regimes",role:"Шаблоны: режимные объекты (ИК, ВЧ)",tips:["ИК (въезд/допуск): «/d [УФСИН] Должность Фамилия. Прибыл к КПП-1 ИК для [цель]. Просьба о допуске/сопровождении».","ВЧ (проезд через КПП при отсутствии дежурного): короткий доклад авто и цель въезда; дождись подтверждения и следуй указаниям КПП.","Всегда имей при себе служебное удостоверение; на территории действуй только по законным требованиям дежурного персонала."],source:"Правила КПП ВЧ, федеральный закон о режимных территориях; лекционные материалы."}],Ad="theme";function Uh(){const e=localStorage.getItem(Ad);return e==="light"||e==="dark"?e:null}function Bh(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Ud(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(Ad,e);const n=e==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",n)}function Vh(){const t=Uh()??(Bh()?"dark":"light");Ud(t)}function Hh(){const e=document.documentElement.classList.contains("dark")?"light":"dark";return Ud(e),e}function Eo(){const[e,t]=A.useState(()=>document.documentElement.classList.contains("dark"));function n(){const r=Hh();t(r==="dark")}return s.jsx("button",{onClick:n,"aria-label":"Toggle theme",className:"btn",children:e?s.jsx(Sh,{className:"h-4 w-4"}):s.jsx(oh,{className:"h-4 w-4"})})}function Vr(e,t){return t.some(n=>e.includes(n))}function Co(e){const t=e.toLowerCase();return Vr(t,["охран","пост","security"])?s.jsx(xt,{className:"h-4 w-4"}):Vr(t,["адвокат","юрист","прав"])?s.jsx(dh,{className:"h-4 w-4"}):Vr(t,["инспектор","советник","секрет","контрол"])?s.jsx(V0,{className:"h-4 w-4"}):Vr(t,["министр","губернатор","админ","руковод"])?s.jsx(xh,{className:"h-4 w-4"}):s.jsx(xt,{className:"h-4 w-4"})}const Kl=[];var lu,iu,ou;for(const e of Ut){const t=Array.isArray(e.dept)?e.dept.includes("ЮД")?"юридический":e.dept.includes("ДВД")||e.dept.includes("охрана")?"охрана":e.dept.includes("АДМ")?"админ":void 0:void 0;Kl.push({id:`role:${e.id}`,type:"role",title:e.role,tags:[e.role.split(" ")[0].toLowerCase(),...(((lu=e.duties)==null?void 0:lu.slice(0,3))||[]).map(n=>n.split(" ")[0].toLowerCase())],dept:t||"неизвестно",level:parseInt(((iu=String(e.role).match(/\((\d+)\)/))==null?void 0:iu[1])||"0",10),description:((ou=e.duties)==null?void 0:ou[0])||void 0})}var su,au;for(const e of Fd)Kl.push({id:`procedure:${e.id}`,type:"procedure",title:e.role,tags:[e.role.split(" ")[0].toLowerCase(),...(((su=e.tips)==null?void 0:su.slice(0,3))||[]).map(t=>t.split(" ")[0].toLowerCase())],dept:"админ",description:((au=e.tips)==null?void 0:au[0])||void 0});function Wh(e){return Kl.find(t=>t.id===e)}function bh(e,t){if(e=e.toLowerCase(),t=t.toLowerCase(),e.includes(t))return 2;const n=new Set(e.split(/[^\p{L}\p{N}]+/u).filter(Boolean)),r=new Set(t.split(/[^\p{L}\p{N}]+/u).filter(Boolean));let l=0;for(const i of r)n.has(i)&&l++;return l>0?1:0}function Qh(e,t=6){const n=a=>e.dept&&a?e.dept===a:!0,r=new Set((e.tags||[]).map(a=>a.toLowerCase()));function l(a){if(a.id===e.id)return-1;let u=0;n(a.dept)&&(u+=2);const d=(a.tags||[]).reduce((h,f)=>h+(r.has(String(f).toLowerCase())?1:0),0);return u+=Math.min(d,3),u+=bh(a.title,e.title),u}const i=Kl.filter(a=>a.type!==e.type).map(a=>({m:a,s:l(a)})).filter(a=>a.s>0).sort((a,u)=>u.s-a.s).slice(0,t*2).map(a=>a.m),o={procedures:[],templates:[],roles:[]};for(const a of i)a.type==="procedure"&&o.procedures.length<t?o.procedures.push(a):a.type==="template"&&o.templates.length<t?o.templates.push(a):a.type==="role"&&o.roles.length<t&&o.roles.push(a);return o}function zi({title:e,items:t}){return t.length?s.jsxs("div",{className:"mt-2 text-xs",children:[s.jsx("div",{className:"mb-1 font-semibold opacity-70",children:e}),s.jsx("div",{className:"flex flex-wrap gap-1.5",children:t.slice(0,6).map(n=>s.jsx("span",{title:n.description||n.title,className:"inline-flex max-w-[14rem] items-center gap-1 truncate rounded-full border px-2 py-0.5 hover:bg-zinc-100 dark:hover:bg-zinc-800",children:s.jsx("span",{className:"truncate",children:n.title})},n.id))})]}):null}function _o({itemId:e,itemType:t}){const n=Wh(e);if(!n)return s.jsx("div",{className:"mt-2 text-xs italic opacity-60",children:"Пока без связей"});const r=Qh(n),l=r.procedures.length+r.templates.length+r.roles.length;return s.jsxs("div",{className:"mt-3 rounded-xl border border-zinc-200 p-2 dark:border-zinc-800",children:[s.jsxs("div",{className:"mb-1 text-xs font-semibold",children:["Связано с этим: ",l]}),s.jsx(zi,{title:"Процедуры",items:r.procedures}),s.jsx(zi,{title:"Шаблоны",items:r.templates}),s.jsx(zi,{title:"Роли",items:r.roles}),!l&&s.jsx("div",{className:"text-xs opacity-60",children:"Пока без связей"})]})}const bt={},Bd=(bt==null?void 0:bt.VITE_VOTE_API_BASE)||(bt==null?void 0:bt.VITE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev",Ei=new Set;let Ci=null;const _s=new Map;function Kh(e,t){_s.set(e,t)}function Xh(e){_s.delete(e)}function Yh(e){Ei.add(e),!Ci&&(Ci=setTimeout(async()=>{var t;try{const n=[...Ei];Ei.clear(),Ci=null;const l=await(await fetch(`${Bd}/api/stats?ids=${encodeURIComponent(n.join(","))}`)).json(),i=(l==null?void 0:l.stats)||{};for(const[o,a]of Object.entries(i))(t=_s.get(o))==null||t(a)}catch{}},120))}function Gh(){const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}async function Zh(e,t){if(localStorage.getItem("telemetry_disabled")==="1")return null;const n=`voted:${e}`;if(localStorage.getItem(n))return null;localStorage.setItem(n,"1");try{const l=await(await fetch(`${Bd}/api/vote`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({card_id:e,vote:t,anon_uid:Gh()})})).json();if(l!=null&&l.ok&&l.totals)return l.totals}catch{}return null}function Po({cardId:e}){const[t,n]=A.useState({up:0,down:0}),[r,l]=A.useState(!1),i=typeof window<"u"&&!!localStorage.getItem(`voted:${e}`),o=r||i||localStorage.getItem("telemetry_disabled")==="1";A.useEffect(()=>(Yh(e),Kh(e,n),()=>Xh(e)),[e]);async function a(u){if(o)return;l(!0),n(h=>({up:h.up+(u===1?1:0),down:h.down+(u===-1?1:0)}));const d=await Zh(e,u);d&&n(d),l(!1)}return localStorage.getItem("telemetry_disabled")==="1"?null:s.jsxs("div",{className:"mt-2 flex items-center gap-2 text-xs",children:[s.jsxs("button",{className:"btn",onClick:()=>a(1),disabled:o,children:[s.jsx(Ch,{className:"h-4 w-4"})," ",t.up]}),s.jsxs("button",{className:"btn",onClick:()=>a(-1),disabled:o,children:[s.jsx(zh,{className:"h-4 w-4"})," ",t.down]})]})}const Jh={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]}},Vd={entities:Jh};function Hd(e){var n;return((n=Vd.entities)==null?void 0:n[e])||null}function Wd(e,t=30){const n=Hd(e);if(!(n!=null&&n.updated_at))return{recent:!1};const r=new Date(n.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=t,date:n.updated_at}}function qh(e,t){const n=e.split(/\r?\n/),r=t.split(/\r?\n/),l=n.length,i=r.length,o=Array.from({length:l+1},()=>Array(i+1).fill(0));for(let h=l-1;h>=0;h--)for(let f=i-1;f>=0;f--)o[h][f]=n[h]===r[f]?o[h+1][f+1]+1:Math.max(o[h+1][f],o[h][f+1]);const a=[];let u=0,d=0;for(;u<l&&d<i;)n[u]===r[d]?(a.push(On(n[u])),u++,d++):o[u+1][d]>=o[u][d+1]?(a.push(`<del>${On(n[u])}</del>`),u++):(a.push(`<ins>${On(r[d])}</ins>`),d++);for(;u<l;)a.push(`<del>${On(n[u++])}</del>`);for(;d<i;)a.push(`<ins>${On(r[d++])}</ins>`);return a.join(`
`)}function On(e){return e.replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function em(){var n;const e=[],t=Vd.entities||{};for(const[r,l]of Object.entries(t)){const i=(n=l.changelog)==null?void 0:n[0];i&&e.push({id:r,version:i.version,date:i.date,summary:i.summary,details:i.details})}return e.sort((r,l)=>r.date<l.date?1:-1),e}const tm=e=>`/pravo/${e.replace(/^\/+/,"")}`,nm=({text:e})=>s.jsxs("button",{onClick:()=>navigator.clipboard.writeText(e),className:"flex items-center gap-2 rounded-xl border border-zinc-200 px-3 py-1 text-sm hover:bg-zinc-100 active:scale-[0.98] dark:border-zinc-700 dark:hover:bg-zinc-800",title:"Скопировать",children:[s.jsx(b0,{className:"h-4 w-4"})," Копировать"]}),Ue=({title:e,children:t,footer:n})=>s.jsxs("div",{className:"card shadow-softLg glass",children:[s.jsx("div",{className:"mb-2 flex items-center justify-between",children:s.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}),s.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:t}),n&&s.jsx("div",{className:"mt-3 border-t border-zinc-200 pt-3 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400",children:n})]}),Qt=({href:e,label:t})=>s.jsx("a",{href:e,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 underline decoration-dotted hover:no-underline",children:t||e}),tu=({children:e})=>s.jsx("span",{className:"inline-flex items-center whitespace-nowrap rounded-full border px-2 py-0.5 text-[11px] font-medium leading-none align-middle",children:e}),rm=()=>{const[e,t]=k.useState(!1);return A.useEffect(()=>{function n(r){var i,o;const l=r.target;!((i=l.closest)!=null&&i.call(l,"#fb-pop"))&&!((o=l.closest)!=null&&o.call(l,"#fb-btn"))&&t(!1)}return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[]),s.jsxs("div",{className:"relative",children:[s.jsxs("button",{id:"fb-btn",className:"btn",onClick:()=>t(n=>!n),children:[s.jsx(lh,{className:"h-4 w-4"}),s.jsx("span",{className:"hidden sm:inline",children:"Фидбек"})]}),e&&s.jsxs("div",{id:"fb-pop",className:"absolute right-0 z-30 mt-2 w-72 card p-3 text-sm bg-white dark:bg-zinc-900 shadow-softLg",children:[s.jsxs("div",{className:"mb-2 flex items-center gap-2 font-semibold",children:[s.jsx(U0,{className:"h-4 w-4"}),"Поделитесь обратной связью"]}),s.jsxs("ul",{className:"mb-2 ml-4 list-disc space-y-1",children:[s.jsxs("li",{className:"flex items-center gap-2",children:[s.jsx(R0,{className:"h-3.5 w-3.5"})," Баг интерфейса"]}),s.jsxs("li",{className:"flex items-center gap-2",children:[s.jsx(J0,{className:"h-3.5 w-3.5"})," Идея по улучшению"]}),s.jsxs("li",{className:"flex items-center gap-2",children:[s.jsx(Cs,{className:"h-3.5 w-3.5"})," Ошибка/опечатка в тексте"]})]}),s.jsxs("a",{className:"btn w-full justify-center no-underline",href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",children:[s.jsx(hh,{className:"h-4 w-4"})," Написать в Telegram"]}),s.jsx("div",{className:"mt-2 flex items-center justify-between text-xs",children:s.jsxs("label",{className:"flex items-center gap-2",children:[s.jsx("input",{type:"checkbox",defaultChecked:localStorage.getItem("telemetry_disabled")==="1",onChange:n=>localStorage.setItem("telemetry_disabled",n.currentTarget.checked?"1":"0")}),"Отключить анонимную телеметрию"]})})]})]})},lm=({roleId:e,dept:t,items:n})=>{const r=k.useMemo(()=>`promo:${e}:${encodeURIComponent(t)}`,[e,t]),[l,i]=k.useState(()=>{try{const a=localStorage.getItem(r),u=a?JSON.parse(a):[];return new Set(u)}catch{return new Set}});k.useEffect(()=>{try{localStorage.setItem(r,JSON.stringify([...l]))}catch{}},[l,r]);function o(a){i(u=>{const d=new Set(u);return d.has(a)?d.delete(a):d.add(a),d})}return s.jsx("ol",{className:"ml-4 list-decimal",children:n.map((a,u)=>s.jsxs("li",{className:"flex items-start gap-2",children:[s.jsx("input",{type:"checkbox",className:"mt-0.5 h-4 w-4 accent-indigo-600 dark:accent-indigo-400",checked:l.has(u),onChange:()=>o(u)}),s.jsx("span",{className:l.has(u)?"opacity-60 line-through":void 0,children:a})]},u))})},nu=[{id:"roles",label:"Роли",icon:s.jsx(Dd,{className:"h-4 w-4"})},{id:"templates",label:"Доклады",icon:s.jsx($d,{className:"h-4 w-4"})},{id:"posts",label:"Посты",icon:s.jsx(nh,{className:"h-4 w-4"})},{id:"procedures",label:"Процедуры",icon:s.jsx(Ga,{className:"h-4 w-4"})},{id:"interactions",label:"Взаимодействие",icon:s.jsx(xt,{className:"h-4 w-4"})},{id:"lectures",label:"Лекции",icon:s.jsx(Cs,{className:"h-4 w-4"})},{id:"vu",label:"ВУ",icon:s.jsx(Ga,{className:"h-4 w-4"})},{id:"laws",label:"Законы",icon:s.jsx(Ql,{className:"h-4 w-4"})}],im={Охрана:["/r Докладывает: (Фамилия). Заступил на пост (номер поста).","/r Докладывает: (Фамилия). Продолжаю дежурство на посту (номер поста).","/r Докладывает: (Фамилия). Покинул пост (номер поста)."],"Начальник охраны":["/r Докладывает: (Фамилия). Заступил на пост (номер поста).","/r Докладывает: (Фамилия). Продолжаю дежурство на посту (номер поста).","/r Докладывает: (Фамилия). Покинул пост (номер поста).","/r Докладывает: (Фамилия). Начал охранять (Должность) (Фамилия).","/r Докладывает: (Фамилия). Продолжаю охранять (Должность) (Фамилия).","/r Докладывает: (Фамилия). Закончил охранять (Должность) (Фамилия)."],Адвокат:["/d [ПР/УФСИН] Адвокат *Фамилия*. На связь.","/d [ПР/УФСИН] Адвокат *Фамилия*. Разрешите прибыть для оказания юридической помощи заключенным ИК?","/d [ПР/УФСИН] Адвокат *Фамилия*. Прибыл на КПП-1, пропустите на территорию ИК.","/r Докладывает: (Фамилия), начал дежурство в комнате свиданий.","/r Докладывает: (Фамилия), продолжаю дежурство в комнате свиданий.","/r Докладывает: (Фамилия), закончил дежурство в комнате свиданий."],Инспектор:["Докладывает (Фамилия). Выехал на проведение ревизии (орган)","Докладывает (Фамилия). Прибыл для проведения ревизии (орган)","Докладывает (Фамилия). Закончил проведение ревизии (орган). Итог: x/x.","Докладывает (Фамилия). Начал дежурство за стойкой регистрации.","Докладывает (Фамилия). Продолжаю дежурство за стойкой регистрации.","Докладывает (Фамилия). Закончил дежурство за стойкой регистрации.","Докладывает (фамилия). Выехал на проверку постов (орган)","Докладывает (фамилия). Прибыл на пост (название посат). Сотрудники присутствуют/отсутствуют."],Советник:["Докладывает (фамилия). Начал дежурство (место). ","Докладывает (фамилия). Продолжил дежурство (место).","Докладывает (фамилия). Закончил дежурство (место).","Докладывает (Фамилия). Начал контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (Фамилия). Продолжил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (Фамилия). Закончил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (фамилия). Выехал на помощь проведения плановой/внеплановой проверки (орган).","Докладывает (фамилия). Начал оказывать помощь на проведении плановой/внеплановой проверки (орган).","Докладывает (фамилия). Начал проверку жетона x-x-x.","Докладывает (фамилия). Закончил проверку жетона x-x-x. Итог: x/x.","Докладывает (фамилия). Закончил оказывать помощь на плановой/внеплановой проверке (орган)."],"Зам. Министра":["Докладывает (фамилия). Начал прослушивать рацию (орган).","Докладывает (фамилия). Продолжаю прослушивать рацию (орган).","Докладывает (фамилия). Закончил прослушивать рацию (орган).","Докладывает (Фамилия). Начал контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (Фамилия). Продолжил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (Фамилия). Закончил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает (Фамилия). Начал контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС.","Докладывает (Фамилия). Продолжил контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС.","Докладывает (Фамилия). Закончил контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС."]},om=[{code:"A1-A2",where:"Вход в здание Правительства",img:"/img/a1.png"},{code:"B1-B2",where:"Холл здания Правительства",img:"/img/b1.png"},{code:"C1-C2",where:"Задний вход, парковка",img:"/img/c1.png"},{code:"D1-D2",where:"Ворота на парковку",img:"/img/d1.png"},{code:"E1-E2",where:"Возле кабинета Губернатора",img:"/img/e1.png"}];function sm(){var f;const[e,t]=k.useState(nu[0].id),[n,r]=k.useState("roles"),[l,i]=k.useState("Все"),o=["Все","ДЗ","ДВД","ДВС","ЮД"],a=["Все","УК","КоАП","ПДД","ФП","ФЗоП","ФЗоТОД","ФЗоВС","ФЗоФСБ","УПК","КАС","Гостайна"],[u,d]=k.useState("Все"),h=k.useMemo(()=>wn.filter(c=>u==="Все"||c.abbr.toLowerCase()===u.toLowerCase()),[u]);return s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3",children:[s.jsxs("div",{className:"flex items-center gap-3",children:[s.jsx(O0,{className:"h-6 w-6"}),s.jsxs("div",{children:[s.jsx("div",{className:"text-lg font-bold leading-tight",children:"Правительство — Памятка (SKY)"}),s.jsx("div",{className:"text-xs text-zinc-500",children:"Локальные тексты • быстрый поиск • мобильный UI"})]})]}),s.jsx("nav",{className:"flex w-full gap-2 overflow-x-auto md:w-auto",children:nu.map(c=>s.jsxs("button",{onClick:()=>t(c.id),className:`flex items-center gap-2 rounded-xl border px-3 py-1.5 text-sm ${e===c.id?"border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100":"border-zinc-200 bg-white hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"}`,children:[c.icon," ",c.label]},c.id))}),s.jsxs("div",{className:"flex items-center gap-2 md:ml-auto",children:[s.jsx(te,{to:"/whats-new",className:"btn",children:"Что нового"}),s.jsxs(te,{to:"/favorites",className:"btn",children:[s.jsx("span",{className:"inline-block h-4 w-4",children:"★"})," Избранное"]}),s.jsx(rm,{}),s.jsx(Eo,{})]})]})}),s.jsxs("main",{className:"mx-auto max-w-6xl px-4 py-6",children:[e==="roles"&&s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:"mb-3 flex flex-col gap-2 md:flex-row md:items-center md:justify-between",children:[s.jsx("h2",{className:"text-lg font-bold",children:"Роли"}),s.jsxs("div",{className:"flex flex-wrap gap-2",children:[s.jsxs("div",{className:"inline-flex rounded-full border border-zinc-200 bg-white/70 p-0.5 text-sm backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/50",children:[s.jsx("button",{onClick:()=>r("roles"),className:"px-3 py-1 rounded-full transition "+(n==="roles"?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"hover:bg-zinc-100 dark:hover:bg-zinc-800"),children:"Роли"}),s.jsx("button",{onClick:()=>r("promotion"),className:"px-3 py-1 rounded-full transition "+(n==="promotion"?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"hover:bg-zinc-100 dark:hover:bg-zinc-800"),children:"Повышение"})]}),s.jsx("div",{className:"inline-flex rounded-full border border-zinc-200 bg-white/70 p-0.5 text-sm backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/50",children:o.map(c=>s.jsx("button",{onClick:()=>i(c),className:"px-3 py-1 rounded-full transition "+(l===c?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white hover:bg-zinc-100 dark:bg-zinc-900 dark:hover:bg-zinc-800"),children:c},c))})]})]}),n==="roles"&&s.jsxs("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:[Ut.filter(c=>{if(l==="Все")return!0;const v=c.dept;return Array.isArray(v)?v.includes(l):v===l}).map(c=>s.jsxs(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[Co(c.role),s.jsx("span",{children:c.role}),s.jsxs(tu,{children:[s.jsx("span",{className:"opacity-70",children:"Зарплата:"})," ",c.salary]}),(()=>{const v=Wd(`role:${c.id}`);return v.recent?s.jsx("span",{className:"rounded-full bg-yellow-100 px-2 py-0.5 text-[10px] text-yellow-800",title:`Обновлено ${v.date}`,children:"обновлено"}):null})()]}),footer:s.jsxs("div",{children:["Источник: ",s.jsx(Qt,{href:c.source||"#"})]}),children:[s.jsx("ul",{className:"ml-4 list-disc",children:c.duties.map((v,x)=>s.jsx("li",{children:v},x))}),s.jsx(_o,{itemId:`role:${c.id}`,itemType:"role"}),s.jsx(Po,{cardId:`role:${c.id}`})]},c.id)),!1]}),n==="promotion"&&s.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:Ut.filter(c=>{if(l==="Все")return!0;const v=c.dept;return Array.isArray(v)?v.includes(l):v===l}).map(c=>{var x;const v=c.promotionByDept&&l!=="Все"?((x=c.promotionByDept)==null?void 0:x[l])??[]:c.promotion??[];return s.jsx(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[Co(c.role),s.jsx("span",{children:c.role}),s.jsxs(tu,{children:[s.jsx("span",{className:"opacity-70",children:"Зарплата:"})," ",c.salary]})]}),footer:s.jsxs("div",{children:["Источник: ",s.jsx(Qt,{href:c.sourcePromotion||c.source||"#"})]}),children:v.length?s.jsx(lm,{roleId:c.id,dept:l,items:v}):s.jsx("p",{children:"Критерии повышения для этой роли пока не добавлены."})},c.id)})})]}),e==="templates"&&s.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:Object.entries(im).map(([c,v])=>s.jsx(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx($d,{className:"h-4 w-4"}),"Доклады — ",c]}),children:s.jsx("div",{className:"flex flex-col gap-2",children:v.map((x,y)=>s.jsxs("div",{className:"flex items-center justify-between gap-2 rounded-xl border px-3 py-2",children:[s.jsx("div",{className:"text-sm",children:x}),s.jsx(nm,{text:x})]},y))})},c))}),e==="posts"&&s.jsx("section",{className:"grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5",children:om.map(c=>s.jsxs("div",{className:"flex flex-col items-center gap-2 rounded-2xl border border-zinc-200 bg-white p-3 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900",children:[s.jsx("img",{src:tm(c.img),alt:c.code,className:"h-24 w-full rounded-xl border border-zinc-200 object-cover dark:border-zinc-700",onError:v=>{v.currentTarget.style.display="none"}}),s.jsx("div",{className:"text-2xl font-extrabold leading-none",children:c.code}),s.jsx("div",{className:"text-xs text-zinc-500 dark:text-zinc-400",children:c.where})]},c.code))}),!1,e==="posts"&&s.jsx("section",{className:"grid gap-4",children:s.jsx(Ue,{title:s.jsx("div",{className:"w-full text-center",children:"В разработке"}),children:s.jsxs("p",{className:"text-sm",children:["Данный раздел находится в ",s.jsx("b",{children:"Разработке"})]})})}),!1,e==="procedures"&&s.jsx("section",{className:"grid gap-4",children:s.jsx(Ue,{title:s.jsx("div",{className:"w-full text-center",children:"В разработке"}),children:s.jsxs("p",{className:"text-sm",children:["Данный раздел находится в ",s.jsx("b",{children:"Разработке"})]})})}),e==="interactions"&&s.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:Fd.map(c=>s.jsxs(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(xt,{className:"h-4 w-4"}),c.role]}),footer:c.source?s.jsxs("div",{className:"text-xs",children:["Источник: ",s.jsx(Qt,{href:c.source})]}):void 0,children:[s.jsx("ul",{className:"ml-4 list-disc",children:c.tips.map((v,x)=>s.jsx("li",{children:v},x))}),s.jsx(_o,{itemId:`procedure:${c.id}`,itemType:"procedure"}),s.jsx(Po,{cardId:`procedure:${c.id}`})]},c.id))}),e==="lectures"&&s.jsx("section",{className:"grid gap-4",children:s.jsx("div",{className:"grid grid-cols-1 gap-4",children:$h.map(c=>s.jsx(Ue,{title:s.jsx("div",{id:`lec-${c.id}`,className:"w-full scroll-mt-24",children:s.jsxs("div",{className:"flex items-center justify-center gap-2 text-center font-bold",children:[s.jsx(Cs,{className:"h-4 w-4"}),s.jsx("span",{children:c.title})]})}),footer:s.jsxs("div",{className:"flex justify-between text-xs text-zinc-500",children:[s.jsx("div",{children:c.updated?`Актуально: ${c.updated}`:""}),c.source&&s.jsxs(s.Fragment,{children:["Источник: ",s.jsx(Qt,{href:c.source})]})]}),children:s.jsx("div",{className:"not-prose whitespace-pre-wrap text-sm leading-relaxed",children:c.text})},c.id))})}),e==="vu"&&s.jsxs("section",{className:"grid gap-4",children:[s.jsx("div",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:Cl.map(c=>s.jsx(te,{to:`/vu/${c.id}`,className:"block",children:s.jsx(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(xt,{className:"h-4 w-4"})," ",c.title]}),footer:s.jsxs("div",{className:"text-xs text-zinc-500",children:[c.updated?`Обновлено: ${c.updated}`:""," ",c.source&&s.jsxs(s.Fragment,{children:[" • Источник: ",s.jsx(Qt,{href:c.source})]})]}),children:s.jsx("p",{className:"text-sm line-clamp-2",children:(c.text||"").split(`
`).find(Boolean)||"Текст ещё не добавлен."})})},c.id))}),s.jsx("div",{className:"hidden",children:s.jsx(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(xt,{className:"h-4 w-4"}),"Внутренний устав Правительства"]}),footer:s.jsxs("div",{children:["Источник:"," ",s.jsx(Qt,{href:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"})]}),children:s.jsx("pre",{className:"whitespace-pre-wrap text-sm leading-relaxed rounded-xl border border-zinc-200 bg-white p-3 text-zinc-900 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-100",children:(f=Cl[0])==null?void 0:f.text})})})]}),e==="laws"&&s.jsxs("section",{className:"grid gap-4",children:[s.jsx(Ah,{}),s.jsx("div",{className:"flex flex-wrap gap-2",children:a.map(c=>s.jsx("button",{onClick:()=>d(c),className:`rounded-full border px-3 py-1 text-sm ${u===c?"border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100":"border-zinc-200 bg-white hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"}`,children:c},c))}),s.jsx("div",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:h.map(c=>s.jsx(te,{to:`/laws/${c.slug}`,className:"block",children:s.jsx(Ue,{title:s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(Ql,{className:"h-4 w-4"}),c.title]}),footer:s.jsx("div",{children:c.updated?`Актуально: ${c.updated}`:""}),children:s.jsx("p",{className:"text-sm",children:c.notes||"Открыть →"})})},c.slug))})]}),s.jsx("div",{className:"mt-8 grid gap-3 rounded-2xl border border-zinc-200 bg-white/70 p-4 text-xs text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900/50 dark:text-zinc-400",children:s.jsx("div",{children:"UI для ПК и телефонов • Создатель: Pavel_Bolshoy. Донаты не нужно делать! "})})]})]})}function am(){const e=em();return s.jsxs("div",{className:"mx-auto max-w-3xl px-4 py-6",children:[s.jsxs("div",{className:"mb-4 flex items-center justify-between",children:[s.jsxs("h1",{className:"flex items-center gap-2 text-xl font-bold",children:[s.jsx(G0,{className:"h-5 w-5"})," Что нового"]}),s.jsx(te,{to:"/",className:"btn",children:"На главную"})]}),s.jsxs("div",{className:"grid gap-4",children:[e.map(t=>s.jsxs("article",{className:"card transition hover:shadow-softLg",children:[s.jsxs("header",{className:"mb-1 flex items-center justify-between",children:[s.jsx("div",{className:"flex items-center gap-2",children:s.jsxs("span",{className:"inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[11px] font-medium",children:[s.jsx(Za,{className:"h-3.5 w-3.5"})," ",t.id]})}),s.jsxs(te,{to:`/diff/${encodeURIComponent(t.id)}`,className:"btn",children:["Сравнить версии ",s.jsx(T0,{className:"h-4 w-4"})]})]}),s.jsx("p",{className:"text-sm leading-relaxed text-zinc-800 dark:text-zinc-200",children:t.summary}),Array.isArray(t.details)&&t.details.length>0&&s.jsx("ul",{className:"mt-2 ml-4 list-disc text-sm text-zinc-700 dark:text-zinc-300",children:t.details.map((n,r)=>s.jsx("li",{children:n},r))}),s.jsxs("footer",{className:"mt-3 flex items-center gap-3 text-xs text-zinc-500",children:[s.jsxs("span",{className:"inline-flex items-center gap-1",children:[s.jsx(Za,{className:"h-3.5 w-3.5"})," Версия ",t.version]}),s.jsxs("span",{className:"inline-flex items-center gap-1",children:[s.jsx(F0,{className:"h-3.5 w-3.5"})," ",t.date]})]})]},`${t.id}-${t.version}`)),!e.length&&s.jsx("div",{className:"card text-sm text-zinc-600 dark:text-zinc-300",children:"Пока нет обновлений."})]})]})}function um(){var i,o,a,u;const{id:e}=bl(),t=e?Hd(e):null,n=((o=(i=t==null?void 0:t.changelog)==null?void 0:i[1])==null?void 0:o.summary)||"",r=((u=(a=t==null?void 0:t.changelog)==null?void 0:a[0])==null?void 0:u.summary)||"",l=qh(n,r);return s.jsxs("div",{className:"mx-auto max-w-3xl px-4 py-6",children:[s.jsxs("div",{className:"mb-4 flex items-center justify-between",children:[s.jsx("h1",{className:"text-xl font-bold",children:"Сравнение версий"}),s.jsx(te,{to:"/whats-new",className:"btn",children:"Что нового"})]}),!t&&s.jsxs("div",{children:["Не найдено для ",e]}),t&&s.jsxs("div",{className:"card",children:[s.jsxs("div",{className:"mb-2 text-sm",children:[e," • ",t.version]}),s.jsx("pre",{className:"overflow-x-auto rounded-xl bg-zinc-100 p-3 text-sm text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100",dangerouslySetInnerHTML:{__html:l}})]}),s.jsx("style",{children:`
      ...
      `})]})}function cm(){const[e]=z0(),t=e.get("role")||"",n=k.useMemo(()=>Ut.find(r=>r.id===t),[t]);return k.useEffect(()=>{document.title="Памятка на смену"},[]),s.jsxs("div",{className:"mx-auto max-w-3xl p-6 print:p-0",children:[s.jsxs("div",{className:"mb-4 flex items-center justify-between print:hidden",children:[s.jsx("h1",{className:"text-xl font-bold",children:"Памятка на смену"}),s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx("button",{className:"btn",onClick:()=>window.print(),children:"Печать / PDF"}),s.jsx(te,{to:"/",className:"btn",children:"Назад"})]})]}),s.jsx("div",{className:"prose prose-zinc max-w-none dark:prose-invert",children:n?s.jsxs(s.Fragment,{children:[s.jsxs("h2",{children:[n.role," ",s.jsxs("small",{children:["• ",n.salary]})]}),s.jsx("h3",{children:"Обязанности"}),s.jsx("ul",{children:n.duties.map((r,l)=>s.jsx("li",{children:r},l))}),Array.isArray(n.promotion)&&s.jsxs(s.Fragment,{children:[s.jsx("h3",{children:"Чек-лист (повышение)"}),s.jsx("ol",{children:n.promotion.map((r,l)=>s.jsx("li",{children:r},l))})]})]}):s.jsx("p",{children:"Роль не выбрана. Передайте ?role=ID в адресной строке."})}),s.jsx("style",{children:`
        @media print {
          @page { size: A4; margin: 14mm; }
          body { background: white !important; }
          .print\\:hidden { display: none !important; }
        }
      `})]})}const dm="fav:",fm="fav:item:";function Xl(){try{return typeof window<"u"&&!!window.localStorage}catch{return!1}}function Ps(e,t){return`${dm}${e}:${t}`}function Ls(e,t){return`${fm}${e}:${t}`}function gr(e,t){if(!Xl())return!1;try{return!!localStorage.getItem(Ps(e,t))}catch{return!1}}function Ts(e,t,n){if(!Xl())return!1;const r=Ps(e,t),l=Ls(e,t);try{return localStorage.getItem(r)?(localStorage.removeItem(r),localStorage.removeItem(l),!1):(localStorage.setItem(r,"1"),n&&(n.title||n.url)&&localStorage.setItem(l,JSON.stringify(n)),!0)}catch{return!1}}function pm(e,t){if(!Xl())return!1;const n=Ps(e,t);try{return localStorage.getItem(n)?(localStorage.removeItem(n),localStorage.removeItem(Ls(e,t)),!1):(localStorage.setItem(n,"1"),!0)}catch{return!1}}function hm(e){const t=[];if(!Xl())return t;try{for(let n=0;n<localStorage.length;n++){const r=localStorage.key(n)||"",l=/^fav:(role|law|vu|lawsec):(.+)$/.exec(r);if(!l)continue;const i=l[1],o=l[2];let a=null;try{const u=localStorage.getItem(Ls(i,o));a=u?JSON.parse(u):null}catch{a=null}t.push({kind:i,id:o,title:a==null?void 0:a.title,url:a==null?void 0:a.url})}}catch{}return t}function mm(e){return hm(e)}function gm(e,t){gr(e,t)&&Ts(e,t)}const vm=({title:e,children:t,footer:n})=>s.jsxs("div",{className:"card shadow-softLg glass",children:[s.jsx("div",{className:"mb-2 flex items-center justify-between",children:s.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}),s.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:t}),n&&s.jsx("div",{className:"mt-3 border-t border-zinc-200 pt-3 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400",children:n})]}),ym=({href:e,label:t})=>s.jsxs("a",{href:e,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 underline decoration-dotted hover:no-underline",children:[t||e," ",s.jsx(K0,{className:"h-3.5 w-3.5"})]}),xm=({children:e})=>s.jsx("span",{className:"inline-flex items-center whitespace-nowrap rounded-full border px-2 py-0.5 text-[11px] font-medium leading-none align-middle",children:e});function wm(){const{id:e}=bl(),t=Ut.find(l=>l.id===e),[n,r]=A.useState(()=>t?gr("role",t.id):!1);return t?s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-3xl items-center gap-3 px-4 py-3",children:[s.jsxs(te,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[s.jsx(Es,{className:"h-4 w-4"})," Назад"]}),s.jsxs("div",{className:"flex items-center gap-2",children:[Co(t.role),s.jsx("h1",{className:"text-lg font-bold leading-tight",children:t.role}),s.jsxs(xm,{children:[s.jsx("span",{className:"opacity-70",children:"Зарплата:"})," ",t.salary]}),(()=>{const l=Wd(`role:${t.id}`);return l.recent?s.jsx("span",{className:"rounded-full bg-yellow-100 px-2 py-0.5 text-[10px] text-yellow-800",title:`Обновлено ${l.date}`,children:"обновлено"}):null})()]})]})}),s.jsxs("main",{className:"mx-auto max-w-3xl px-4 py-6",children:[s.jsxs("div",{className:"mb-3 flex items-center gap-2",children:[s.jsxs("a",{className:"btn",href:`/print?role=${t.id}`,children:[s.jsx(ah,{className:"h-4 w-4"})," Export: PDF"]}),s.jsx("button",{className:"btn",onClick:()=>{var i,o;const l=pm("role",t.id);r(l);try{(o=(i=document.activeElement)==null?void 0:i.blur)==null||o.call(i)}catch{}},"aria-label":n?"Удалить из избранного":"Добавить в избранное",title:n?"В избранном":"В закладки",children:n?"В избранном":"В закладки"})]}),s.jsxs(vm,{title:"Обязанности",footer:s.jsxs("div",{children:["Источник: ",s.jsx(ym,{href:t.source})]}),children:[s.jsx("ul",{className:"ml-4 list-disc",children:t.duties.map((l,i)=>s.jsx("li",{children:l},i))}),s.jsx(_o,{itemId:`role:${t.id}`,itemType:"role"}),s.jsx(Po,{cardId:`role:${t.id}`})]})]})]}):s.jsxs("div",{className:"p-4",children:["Роль не найдена."," ",s.jsx(te,{to:"/",className:"text-blue-600 underline",children:"На главную"})]})}function bd({kind:e,id:t,title:n,url:r,size:l="md"}){const[i,o]=A.useState(()=>gr(e,t));A.useEffect(()=>{o(gr(e,t))},[e,t]);function a(h){h.preventDefault(),h.stopPropagation();const f=Ts(e,t,{title:n,url:r});o(f)}const u=l==="sm"?"h-7 w-7":"h-8 w-8",d=l==="sm"?"h-4 w-4":"h-5 w-5";return s.jsx("button",{onClick:a,title:i?"В избранном":"В закладки","aria-label":i?"Удалить из избранного":"Добавить в избранное",className:`fav-star-btn ${u} ${i?"is-active":""}`,children:s.jsx(Od,{className:`fav-star-icon ${d}`})})}function ru(e){return new Promise((t,n)=>{const r=document.createElement("script");r.src=e,r.async=!0,r.onload=()=>t(),r.onerror=()=>n(),document.head.appendChild(r)})}async function km(){window.marked||await ru("https://cdn.jsdelivr.net/npm/marked@12.0.2/marked.min.js"),window.DOMPurify||await ru("https://cdn.jsdelivr.net/npm/dompurify@3.1.6/dist/purify.min.js")}function Sm(e){const t=new DOMParser().parseFromString(e,"text/html"),n=Array.from(t.querySelectorAll("h2, h3, h4")),r=[],l=i=>i.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);return n.forEach((i,o)=>{const a=i.textContent||"",u=l(a)||`h-${o+1}`;i.id=u;const d=i.tagName==="H2"?2:i.tagName==="H3"?3:4;r.push({id:u,text:a,level:d});const h=t.createElement("button");h.className="anchor-fav",h.setAttribute("data-id",u),h.setAttribute("data-title",a),h.setAttribute("title","В закладки"),i.appendChild(h)}),{html:t.body.innerHTML,toc:r}}function jm(e){let t=e.replace(/\r\n?/g,`
`);return t=t.replace(/^(#{2,6})([^\s#])/gm,"$1 $2"),t=t.replace(/^\s*(\d+)\)\s+/gm,"$1. "),t}function Nm(){const{slug:e}=bl(),t=wn.find(f=>f.slug===e),[n,r]=k.useState(""),[l,i]=k.useState([]),[o,a]=k.useState(""),u=k.useRef(null);if(k.useEffect(()=>{(async()=>{if(!t)return;await km();const f=jm(t.content),c=window.marked.parse(f,{gfm:!0,breaks:!0}),v=window.DOMPurify.sanitize(c,{USE_PROFILES:{html:!0}}),{html:x,toc:y}=Sm(v);r(x),i(y)})()},[e]),k.useEffect(()=>{const f=u.current;if(!f)return;f.querySelectorAll(".anchor-fav").forEach(v=>{const x=v.getAttribute("data-id")||"",y=`${(t==null?void 0:t.slug)||""}#${x}`;gr("lawsec",y)&&v.classList.add("active")});function c(v){const x=v.target;if(x&&x.classList.contains("anchor-fav")){v.preventDefault();const y=x.getAttribute("data-id")||"",j=x.getAttribute("data-title")||"";if(!t)return;const m=`${t.slug}#${y}`,p=`${location.pathname}#${y}`;Ts("lawsec",m,{title:`${t.title} — ${j}`,url:p})?x.classList.add("active"):x.classList.remove("active")}}return f.addEventListener("click",c),()=>f.removeEventListener("click",c)},[u,n,t==null?void 0:t.slug]),!t)return s.jsxs("div",{className:"p-4",children:["Закон не найден. ",s.jsx(te,{to:"/",className:"text-blue-600 underline",children:"На главную"})]});const d=k.useMemo(()=>{if(!o.trim()||!n)return n;const f=new RegExp(`(${o.replace(/[.*+?^${}()|[\\]\\\\]/g,"\\$&")})`,"gi");return n.replace(f,"<mark>$1</mark>")},[o,n]),h=f=>f===2?"pl-0":f===3?"pl-3":"pl-6";return s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3",children:[s.jsxs(te,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[s.jsx(Es,{className:"h-4 w-4"})," Назад"]}),s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(Ql,{className:"h-5 w-5"}),s.jsx("h1",{className:"text-lg font-bold leading-tight",children:t.title})]}),s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(bd,{kind:"law",id:t.slug,title:t.title,url:`/laws/${t.slug}`}),s.jsx("div",{className:"text-xs text-zinc-500",children:t.updated?`Обновлено: ${t.updated}`:""})]})]})}),s.jsxs("main",{className:"mx-auto grid max-w-6xl grid-cols-1 gap-5 px-4 py-5 md:grid-cols-[260px,1fr]",children:[s.jsx("aside",{className:"hidden md:block",children:s.jsxs("div",{className:"sticky top-16 rounded-2xl border border-zinc-200 bg-white/70 p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900/50",children:[s.jsxs("div",{className:"mb-2 flex items-center gap-2 font-semibold",children:[s.jsx(eh,{className:"h-4 w-4"})," Оглавление"]}),l.length?s.jsx("ul",{className:"space-y-1",children:l.map(f=>s.jsx("li",{className:h(f.level),children:s.jsx("a",{className:"underline decoration-dotted hover:no-underline",href:`#${f.id}`,children:f.text})},f.id))}):s.jsx("div",{className:"text-xs text-zinc-500",children:"Добавьте заголовки (##/###) в исходный Markdown для оглавления."})]})}),s.jsxs("section",{children:[s.jsxs("div",{className:"mb-4 flex items-center gap-2",children:[s.jsx(El,{className:"h-4 w-4 text-zinc-500"}),s.jsx("input",{className:"w-full rounded-xl border px-3 py-1.5 text-sm focus:outline-none focus:ring",placeholder:"Быстрый поиск по тексту закона",value:o,onChange:f=>a(f.target.value)})]}),s.jsx("div",{className:"law prose prose-zinc max-w-none rounded-2xl border border-zinc-200 bg-white p-4 list-inside dark:prose-invert dark:border-zinc-800 dark:bg-zinc-900",ref:u,dangerouslySetInnerHTML:{__html:d}})]})]})]})}function zm(){const{id:e}=bl(),t=Cl.find(r=>r.id===e);if(!t)return s.jsxs("div",{className:"p-4",children:["Не найдено. ",s.jsx(te,{to:"/",className:"text-blue-600 underline",children:"На главную"})]});const n=k.useMemo(()=>Cm(t.text||""),[t==null?void 0:t.text]);return s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3",children:[s.jsxs(te,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[s.jsx(Es,{className:"h-4 w-4"})," Назад"]}),s.jsxs("div",{className:"flex items-center gap-2",children:[s.jsx(xt,{className:"h-5 w-5"}),s.jsx("h1",{className:"text-lg font-bold leading-tight",children:t.title})]}),s.jsx("div",{className:"text-xs text-zinc-500",children:t.updated?`Обновлено: ${t.updated}`:""})]})}),s.jsxs("main",{className:"mx-auto grid max-w-6xl grid-cols-1 gap-5 px-4 py-5 md:grid-cols-[260px,1fr]",children:[s.jsx("aside",{className:"hidden md:block",children:s.jsxs("div",{className:"sticky top-16 rounded-2xl border border-zinc-200 bg-white/70 p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900/50",children:[s.jsx("div",{className:"mb-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400",children:"Оглавление"}),n.toc.length?s.jsx("ul",{className:"space-y-1",children:n.toc.map(r=>s.jsx("li",{children:s.jsx("a",{className:"underline decoration-dotted hover:no-underline",href:`#${r.id}`,children:r.text})},r.id))}):s.jsx("div",{className:"text-xs text-zinc-500",children:"Заголовки не найдены."})]})}),s.jsx("section",{children:s.jsx("div",{className:"rounded-2xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900",children:s.jsx("div",{className:"vu prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:n.nodes})})})]})]})}function Em(e){return e.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80)}function Cm(e){const t=e.replace(/\r\n?/g,`
`).split(`
`),n=[],r=[];let l=0;const i=/^\s*(Глава|Раздел)\s+(\d+[\.:)]?)\s*(.*)$/i,o=/^\s*(\d+(?:\.\d+)+)\.?\s+(.*)$/,a=/^\s*(\d+)\.\s+(.*)$/;for(const u of t){const d=u.trim();if(!d){n.push(s.jsx("div",{className:"h-3"},l++));continue}let h=d.match(i);if(h){const f=`${h[1]} ${h[2]}${h[3]?" — "+h[3]:""}`,c=Em(f);r.push({id:c,text:f}),n.push(s.jsx("h2",{id:c,children:f},l++));continue}if(h=d.match(o)||d.match(a),h){n.push(s.jsxs("p",{className:"flex",children:[s.jsx("span",{className:"num",children:h[1]}),s.jsx("span",{children:h[2]})]},l++));continue}n.push(s.jsx("p",{children:d},l++))}return{nodes:n,toc:r}}function Dn(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function _m(){const[e,t]=A.useState(!1),[n,r]=A.useState(""),[l,i]=A.useState(0),[o,a]=A.useState(()=>localStorage.getItem("cp_filter")||"all");A.useEffect(()=>{try{localStorage.setItem("cp_filter",o)}catch{}},[o]),A.useEffect(()=>{function c(v){(v.ctrlKey||v.metaKey)&&v.key.toLowerCase()==="k"&&(v.preventDefault(),t(!0),r(""),i(0)),e&&v.key==="Escape"&&t(!1)}return window.addEventListener("keydown",c),()=>window.removeEventListener("keydown",c)},[e]);const u=A.useMemo(()=>{const c=[];c.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Страница",url:Dn("/favorites")}),c.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Страница",url:Dn("/settings")});for(const y of Ut)c.push({kind:"role",id:y.id,title:y.role,subtitle:"Роль",url:Dn(`/roles/${y.id}`)});for(const y of wn)c.push({kind:"law",id:y.slug,title:y.title,subtitle:"Закон",url:Dn(`/laws/${y.slug}`)});for(const y of Cl)c.push({kind:"vu",id:y.id,title:y.title,subtitle:"ВУ",url:Dn(`/vu/${y.id}`)});const v=n.trim().toLowerCase();return v?(o==="all"?c:c.filter(y=>y.kind===o)).map(y=>({r:y,score:d(`${y.title} ${y.subtitle||""}`.toLowerCase(),v)})).filter(y=>y.score>0).sort((y,j)=>j.score-y.score).slice(0,30).map(y=>y.r):c.slice(0,20)},[n,o]);function d(c,v){return v.split(/\s+/).filter(Boolean).reduce((y,j)=>y+(c.includes(j)?1:0),0)}function h(c){t(!1),window.location.href=c}function f(c){u.length&&(c.key==="ArrowDown"&&(c.preventDefault(),i(v=>Math.min(v+1,u.length-1))),c.key==="ArrowUp"&&(c.preventDefault(),i(v=>Math.max(v-1,0))),c.key==="Enter"&&(c.preventDefault(),h(u[l].url)))}return s.jsxs(s.Fragment,{children:[s.jsxs("button",{className:"fixed bottom-4 right-4 z-40 inline-flex items-center gap-2 rounded-full border border-zinc-300 bg-white/80 px-3 py-2 text-sm shadow-sm backdrop-blur hover:bg-white text-zinc-900 dark:border-zinc-700 dark:bg-zinc-900/70 dark:text-zinc-100",onClick:()=>t(!0),title:"Поиск (Ctrl/Cmd + K)","aria-label":"Открыть поиск",children:[s.jsx(El,{className:"h-4 w-4 text-zinc-600 dark:text-zinc-300"}),s.jsx("span",{className:"hidden sm:inline",children:"Поиск"}),s.jsx("kbd",{className:"ml-1 hidden sm:inline-flex items-center whitespace-nowrap font-mono rounded-md border border-zinc-400 bg-white px-1.5 py-0.5 text-[11px] font-medium text-zinc-900 shadow",children:navigator.platform.includes("Mac")?"⌘K":"Ctrl K"})]}),e?s.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Командная палитра",children:s.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[s.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[s.jsx(El,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),s.jsx("input",{autoFocus:!0,value:n,onChange:c=>{r(c.target.value),i(0)},onKeyDown:f,placeholder:"Роли, законы, уставы...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),s.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>t(!1),"aria-label":"Закрыть поиск",children:s.jsx(Lh,{className:"h-4 w-4"})})]}),s.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(c=>s.jsx("button",{onClick:()=>{a(c.k),i(0)},className:`chip ${o===c.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:c.label},c.k))}),s.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!u.length&&s.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),u.map((c,v)=>s.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${v===l?"bg-indigo-50 ring-1 ring-indigo-500/30 dark:bg-indigo-900/30":""}`,onMouseEnter:()=>i(v),onClick:()=>h(c.url),children:[s.jsxs("span",{className:"inline-flex items-center gap-2",children:[c.kind==="law"&&s.jsx(Ql,{className:"h-4 w-4"}),c.kind==="role"&&s.jsx(Dd,{className:"h-4 w-4"}),c.kind==="vu"&&s.jsx(xt,{className:"h-4 w-4"}),c.kind==="page"&&(c.id==="settings"?s.jsx(gh,{className:"h-4 w-4"}):s.jsx(Od,{className:"h-4 w-4"})),s.jsx("span",{className:"font-medium",children:c.title})]}),s.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:c.subtitle})]},`${c.kind}:${c.id}`))]})]})}):null]})}const Kt={},Pm=(Kt==null?void 0:Kt.VITE_API_BASE)||(Kt==null?void 0:Kt.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function Lm(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function Tm(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Lm()}}function Mm(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const l=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(l)==="1"||String(l)==="yes")return}catch{}const n=JSON.stringify({event:e,...Tm(),data:t}),r=`${Pm}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const l=new Blob([n],{type:"application/json"});if(navigator.sendBeacon(r,l))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:n})}catch{}}function Im(){const[e,t]=A.useState(()=>{try{return localStorage.getItem("telemetry_disabled")==="1"}catch{return!1}});function n(){const r=!e;t(r);try{r?localStorage.setItem("telemetry_disabled","1"):localStorage.removeItem("telemetry_disabled")}catch{}}return s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3",children:[s.jsx(te,{to:"/",className:"text-sm underline decoration-dotted hover:no-underline",children:"На главную"}),s.jsx("h1",{className:"text-lg font-bold",children:"Настройки"}),s.jsx(Eo,{})]})}),s.jsx("main",{className:"mx-auto max-w-3xl px-4 py-6",children:s.jsxs("div",{className:"grid gap-4",children:[s.jsxs("section",{className:"card",children:[s.jsx("h2",{className:"mb-2 text-base font-semibold",children:"Приватность"}),s.jsxs("label",{className:"flex items-center gap-2 text-sm",children:[s.jsx("input",{type:"checkbox",className:"h-4 w-4",checked:e,onChange:n}),s.jsx("span",{children:"Отключить телеметрию (анонимальные события и голоса)"})]}),s.jsx("p",{className:"mt-2 text-xs text-zinc-600 dark:text-zinc-400",children:"Учитываем Do-Not-Track браузера. Данные не содержат PII и отправляются на ваш бекенд."})]}),s.jsxs("section",{className:"card",children:[s.jsx("h2",{className:"mb-2 text-base font-semibold",children:"Тема"}),s.jsx("div",{className:"text-sm",children:"Переключите тему интерфейса:"}),s.jsx("div",{className:"mt-2",children:s.jsx(Eo,{})})]})]})})]})}function Rm(){const[e,t]=A.useState(()=>mm()),n=A.useMemo(()=>e.map(l=>{if(l.kind==="role"){const i=Ut.find(o=>o.id===l.id);return i?{title:l.title??i.role,url:l.url??`/roles/${i.id}`,kindLabel:"Роль"}:null}if(l.kind==="law"){const i=wn.find(o=>o.slug===l.id);return i?{title:l.title??i.title,url:l.url??`/laws/${i.slug}`,kindLabel:"Закон"}:null}return l.kind==="lawsec"?{title:l.title??l.id,url:l.url??"#",kindLabel:"Раздел закона"}:l.kind==="vu"?{title:l.title??l.id,url:l.url??`/vu/${l.id}`,kindLabel:"Документ ВУ"}:null}).filter(Boolean),[e]);function r(l,i){gm(l,i),t(o=>o.filter(a=>!(a.kind===l&&a.id===i)))}return s.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[s.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:s.jsxs("div",{className:"mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3",children:[s.jsx(te,{to:"/",className:"text-sm underline decoration-dotted hover:no-underline",children:"На главную"}),s.jsx("h1",{className:"text-lg font-bold",children:"Избранное"}),s.jsx("span",{})]})}),s.jsx("main",{className:"mx-auto max-w-3xl px-4 py-6",children:n.length?s.jsx("div",{className:"grid gap-2",children:n.map((l,i)=>{const o=e[i];return o?s.jsxs("div",{className:"flex items-center justify-between rounded-xl border border-zinc-200 bg-white p-3 dark:border-zinc-700 dark:bg-zinc-900",children:[s.jsxs(te,{to:l.url,className:"min-w-0",children:[s.jsx("div",{className:"truncate text-sm font-semibold",children:l.title}),s.jsx("div",{className:"text-xs text-zinc-500",children:l.kindLabel})]}),s.jsxs("div",{className:"ml-3 flex items-center gap-2",children:[s.jsx(bd,{kind:o.kind,id:o.id,title:l.title,url:l.url,size:"sm"}),s.jsx("button",{className:"btn",onClick:()=>r(o.kind,o.id),title:"Удалить",children:"Удалить"})]})]},`${o.kind}:${o.id}`):null})}):s.jsx("div",{className:"card text-sm text-zinc-600 dark:text-zinc-300",children:"Пока пусто. Добавляйте роли и законы в закладки."})})]})}function $m(){const e=zn();return k.useEffect(()=>{Mm("page_view")},[e.pathname,e.search,e.hash]),null}function Om(){return s.jsxs(k0,{basename:"/pravo/",children:[s.jsx(_m,{}),s.jsx($m,{}),s.jsxs(p0,{children:[s.jsx(Be,{path:"/",element:s.jsx(sm,{})}),s.jsx(Be,{path:"/whats-new",element:s.jsx(am,{})}),s.jsx(Be,{path:"/diff/:id",element:s.jsx(um,{})}),s.jsx(Be,{path:"/print",element:s.jsx(cm,{})}),s.jsx(Be,{path:"/roles/:id",element:s.jsx(wm,{})}),s.jsx(Be,{path:"/laws/:slug",element:s.jsx(Nm,{})}),s.jsx(Be,{path:"/vu/:id",element:s.jsx(zm,{})}),s.jsx(Be,{path:"/settings",element:s.jsx(Im,{})}),s.jsx(Be,{path:"/favorites",element:s.jsx(Rm,{})})]})]})}Vh();_i.createRoot(document.getElementById("root")).render(s.jsx(A.StrictMode,{children:s.jsx(Om,{})}));
