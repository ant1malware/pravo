...
`;s(m,""),p(m)},o.readAsDataURL(n)}function E(){if(!d)return;const t=r.indexOf(d);t>=0&&b(r.slice(0,t)+r.slice(t+d.length)),p(null)}const T=u.useMemo(()=>{try{return O.sanitize(P.parse(r||""))}catch{return""}},[r]);return e.jsxs("div",{className:"w-full",onDragOver:S,onDrop:A,children:[e.jsxs("div",{className:"mb-2 flex flex-wrap items-center gap-2",children:[e.jsx("button",{type:"button",className:"btn",onClick:()=>s("**","**"),title:"Bold",children:e.jsx($,{size:14})}),e.jsx("button",{type:"button",className:"btn",onClick:()=>s("_","_"),title:"Italic",children:e.jsx(M,{size:14})}),e.jsx("button",{type:"button",className:"btn",onClick:()=>s("[text](",")"),title:"Link",children:e.jsx(Q,{size:14})}),e.jsx("button",{type:"button",className:"btn",onClick:()=>s("`","`"),title:"Inline code",children:e.jsx(g,{size:14})}),e.jsxs("button",{type:"button",className:"btn",onClick:()=>s("\n\n````\n","\n````\n"),title:"Code block",children:[e.jsx(g,{size:14})," ",e.jsx("span",{className:"ml-1",children:"{}"})]}),e.jsx("button",{type:"button",className:"btn",onClick:()=>s(`
