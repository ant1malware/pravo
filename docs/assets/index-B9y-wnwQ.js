const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-Dkl6RS95.js","assets/react-vendor-DStf8yZ1.js","assets/icons-CWwV2OkG.js","assets/VoteWidget-CwOJFiG1.js","assets/ContextText-DxOTSmKp.js","assets/WhatsNew-DQTrU8hn.js","assets/DiffPage-D6_Nrny6.js","assets/PrintSheet-W78ZDQrT.js","assets/RolePage-DI5htNGj.js","assets/FavStar-Cup-elN4.js","assets/LawPage-r7aWJTph.js","assets/VuPage-8IMrQH7y.js","assets/SettingsPage-CrJE69bh.js","assets/FavoritesPage-CrCjMCjp.js"])))=>i.map(i=>d[i]);
import{r as X,a as ke,R as p,u as J,L as C,B as je,b as ze,c as y}from"./react-vendor-DStf8yZ1.js";import{S as q,X as Se,B as O,U as Q,a as Z,b as ee,c as te,F as Ie,L as Ee,C as Ne,M as ne,d as _e,e as Pe,f as Ae}from"./icons-CWwV2OkG.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function s(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(a){if(a.ep)return;a.ep=!0;const l=s(a);fetch(a.href,l)}})();var se={exports:{}},D={};/**
 * @license React
...
`,Ke=[{id:"gov",title:"Внутренний устав Правительства",text:Fe,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],ae="ui:density",re="ui:font",Ve="ui:features",ie="ui:shadow",ce="ui:radius",le="ui:glass",de="ui:readw";function Ue(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),localStorage.setItem(ae,e)}function We(){return localStorage.getItem(ae)==="compact"?"compact":"standard"}function Ye(e){const t=Math.max(.9,Math.min(1.3,e)),s=16*t;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(re,String(t))}function Ge(){const e=parseFloat(localStorage.getItem(re)||"1");return isFinite(e)&&e>.6&&e<2?e:1}function He(e,t=!0){const s=Xe();return e in s?!!s[e]:t}function Xe(){try{const e=localStorage.getItem(Ve);return e?JSON.parse(e):{}}catch{return{}}}function Je(e){let t="none";e==="soft"&&(t="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(t="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",t),localStorage.setItem(ie,e)}function qe(){const e=localStorage.getItem(ie);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function Qe(e){let t=8,s=16,o=20;e==="subtle"&&(t=6,s=10,o=14),e==="rounded"&&(t=12,s=18,o=24),document.documentElement.style.setProperty("--radius-lg",t+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",o+"px"),localStorage.setItem(ce,e)}function Ze(){const e=localStorage.getItem(ce);return e==="subtle"||e==="rounded"?e:"standard"}function et(e){const t=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",t+"px"),localStorage.setItem(le,String(t))}function tt(){const e=parseInt(localStorage.getItem(le)||"6",10);return isFinite(e)?e:6}function nt(e){const t=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",t+"ch"),localStorage.setItem(de,String(t))}function st(){const e=parseInt(localStorage.getItem(de)||"78",10);return isFinite(e)?e:78}function ot(){try{Ue(We()),Ye(Ge()),Je(qe()),Qe(Ze()),et(tt()),nt(st())}catch{}}function k(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function at(){if(!He("cmd_palette",!0))return null;const[t,s]=p.useState(!1),[o,a]=p.useState(""),[l,c]=p.useState(0),[u,i]=p.useState(()=>localStorage.getItem("cp_filter")||"all");p.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),p.useEffect(()=>{function r(f){(f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="k"&&(f.preventDefault(),s(!0),a(""),c(0)),t&&f.key==="Escape"&&s(!1)}return window.addEventListener("keydown",r),window.openCommandPalette=()=>{s(!0),a(""),c(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",r)}},[t]);const d=p.useMemo(()=>{const r=[];r.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:k("/favorites")}),r.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:k("/settings")});for(const h of Be)r.push({kind:"role",id:h.id,title:h.role,subtitle:"Роль",url:k(`/roles/${h.id}`)});for(const h of Y)r.push({kind:"law",id:h.slug,title:h.title,subtitle:"Закон",url:k(`/laws/${h.slug}`)});for(const h of Ke)r.push({kind:"vu",id:h.id,title:h.title,subtitle:"ВУ",url:k(`/vu/${h.id}`)});const f=o.trim().toLowerCase();return f&&r.push(...v(f).slice(0,60)),f?(u==="all"?r:r.filter(h=>h.kind===u)).map(h=>({r:h,score:m(`${h.title} ${h.subtitle||""}`.toLowerCase(),f)+(h.__boost||0)})).filter(h=>h.score>0).sort((h,S)=>S.score-h.score).slice(0,30).map(h=>h.r):r.slice(0,20)},[o,u]);function m(r,f){return f.split(/\s+/).filter(Boolean).reduce((h,S)=>h+(r.includes(S)?1:0),0)}function v(r){const f=[],L=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),h=(()=>{const b=r.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return b?b[2]:null})();for(const b of Y){const we=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let _="",x="";const R=new Set;for(const ve of we){const I=ve.trim(),F=/^(#{2,6})\s*(.+)$/.exec(I);if(F){_=F[2].trim(),x=L(_)||"";const j=_.toLowerCase();if(x&&(j.includes(r)||h&&j.match(new RegExp(`(^|s)ст(атья|.)?s*${h}\b`)))){const P=`${b.slug}#${x}`;if(!R.has(P)){const $={kind:"law",id:P,title:`${b.title} — ${_}`,subtitle:"Раздел закона",url:k(`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`)};$.__boost=j.startsWith(r)?8:6,f.push($),R.add(P)}}continue}if(I&&I.toLowerCase().includes(r)){const j=x?`${b.slug}#${x}`:b.slug;if(!R.has(j)){const K=I.length>140?I.slice(0,137)+"…":I,P=x?`${b.title} — ${_}`:b.title,$=k(x?`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`:`/laws/${b.slug}?q=${encodeURIComponent(r)}`),V={kind:"law",id:j,title:P,subtitle:K||"Совпадение в тексте",url:$};V.__boost=5,f.push(V),R.add(j)}}}}const S=new Set;return f.filter(b=>S.has(b.id)?!1:(S.add(b.id),!0))}function z(r){s(!1);try{window.location.href=r}catch{location.assign(r)}}function N(r){d.length&&(r.key==="ArrowDown"&&(r.preventDefault(),c(f=>Math.min(f+1,d.length-1))),r.key==="ArrowUp"&&(r.preventDefault(),c(f=>Math.max(f-1,0))),r.key==="Enter"&&(r.preventDefault(),z(d[l].url)))}return n.jsx(n.Fragment,{children:t?n.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:n.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[n.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[n.jsx(q,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),n.jsx("input",{autoFocus:!0,value:o,onChange:r=>{a(r.target.value),c(0)},onKeyDown:N,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),n.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>s(!1),"aria-label":"Закрыть палитру",children:n.jsx(Se,{className:"h-4 w-4"})})]}),n.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(r=>n.jsx("button",{onClick:()=>{i(r.k),c(0)},className:`chip ${u===r.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:r.label},r.k))}),n.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!d.length&&n.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),d.map((r,f)=>n.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${f===l?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>c(f),onClick:()=>z(r.url),children:[n.jsxs("span",{className:"inline-flex items-center gap-2",children:[r.kind==="law"&&n.jsx(O,{className:"h-4 w-4"}),r.kind==="role"&&n.jsx(Q,{className:"h-4 w-4"}),r.kind==="vu"&&n.jsx(Z,{className:"h-4 w-4"}),r.kind==="page"&&(r.id==="settings"?n.jsx(ee,{className:"h-4 w-4"}):n.jsx(te,{className:"h-4 w-4"})),n.jsx("span",{className:"font-medium",children:r.title})]}),r.subtitle&&n.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:r.subtitle})]},`${r.kind}:${r.id}`))]})]})}):null})}const E={},rt=(E==null?void 0:E.VITE_API_BASE)||(E==null?void 0:E.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function it(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function ct(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:it()}}function lt(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...ct(),data:t}),o=`${rt}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(o,a))return}catch{}try{fetch(o,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const G="recent:items";function dt(e,t){try{const s=localStorage.getItem(G),o=s?JSON.parse(s):[],a={url:e,title:t,ts:Date.now()};if(o.length&&o[0].url===e)return;const l=o.filter(i=>i.url!==e);l.unshift(a);const c=[],u=new Set;for(const i of l)u.has(i.url)||(u.add(i.url),c.push(i));for(;c.length>15;)c.pop();localStorage.setItem(G,JSON.stringify(c))}catch{}}const ut=[{label:"Роли",icon:n.jsx(Q,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:n.jsx(Ie,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:n.jsx(Ee,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:n.jsx(Ne,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:n.jsx(ne,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:n.jsx(_e,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:n.jsx(O,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:n.jsx(Z,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:n.jsx(O,{className:"h-4 w-4"}),id:"laws"}];function mt(){const[e,t]=p.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=J(),o=p.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=p.useMemo(()=>{const m=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),v=(s.hash||"").replace(/^#/,"").toLowerCase();return m||v||""},[s.search,s.hash]),l=d=>a===d;p.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[e]),p.useEffect(()=>{function d(){typeof window<"u"&&t(window.innerWidth>=1024)}return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),p.useEffect(()=>{const d=document.documentElement;e?d.classList.add("has-sidebar"):d.classList.remove("has-sidebar")},[e]);const u=p.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",i="inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-medium shadow-sm border-zinc-300 bg-white/90 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",g=d=>{const m=`?tab=${encodeURIComponent(d)}`;return o?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${d}`}};return n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>t(d=>!d),"aria-label":"Открыть меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),e&&n.jsx("div",{className:"fixed inset-0 z-30 bg-black/40 lg:hidden",onClick:()=>t(!1),"aria-hidden":"true"}),n.jsxs("aside",{id:"app-sidebar","aria-label":"Навигация",className:`app-sidebar fixed inset-y-0 left-0 z-40 w-[240px] transform border-r border-zinc-200
              ...
              ${e?"translate-x-0":"-translate-x-full lg:translate-x-0"}`,children:[n.jsx("div",{className:"mb-3 flex items-center justify-start",children:n.jsx(C,{to:"/",className:`rounded font-semibold no-underline focus:outline-none focus:ring-2 focus:ring-zinc-400
                       text-zinc-900 hover:underline hover:text-zinc-900
                       dark:text-zinc-100 dark:hover:text-white`,"aria-label":"Главная",children:"Главная"})}),n.jsx("nav",{role:"navigation",className:"grid max-h[calc(100vh-140px)] gap-1 overflow-y-auto pr-1",children:n.jsx("ul",{className:"flex flex-col gap-1",children:ut.map(d=>{const m=l(d.id);return n.jsx("li",{children:n.jsxs(C,{to:g(d.id),className:["flex items-center gap-2 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-zinc-400","text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",m?"bg-zinc-100 dark:bg-zinc-800":""].join(" "),"aria-current":m?"page":void 0,"aria-label":d.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&t(!1)},children:[d.icon,n.jsx("span",{className:"truncate",children:d.label})]})},d.id)})})}),n.jsxs("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:["Подсказка: нажмите ",n.jsx("kbd",{className:i,children:u})," для быстрого поиска"]})]})]})}const pt={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},ue={entities:pt};function ht(e){var s;return((s=ue.entities)==null?void 0:s[e])||null}function Ut(e,t=30){const s=ht(e);if(!(s!=null&&s.updated_at))return{recent:!1};const o=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-o.getTime())/(1e3*60*60*24)<=t,date:s.updated_at}}function Wt(e,t){const s=e.split(/\r?\n/),o=t.split(/\r?\n/),a=s.length,l=o.length,c=Array.from({length:a+1},()=>Array(l+1).fill(0));for(let d=a-1;d>=0;d--)for(let m=l-1;m>=0;m--)c[d][m]=s[d]===o[m]?c[d+1][m+1]+1:Math.max(c[d+1][m],c[d][m+1]);const u=[];let i=0,g=0;for(;i<a&&g<l;)s[i]===o[g]?(u.push(A(s[i])),i++,g++):c[i+1][g]>=c[i][g+1]?(u.push(`<del>${A(s[i])}</del>`),i++):(u.push(`<ins>${A(o[g])}</ins>`),g++);for(;i<a;)u.push(`<del>${A(s[i++])}</del>`);for(;g<l;)u.push(`<ins>${A(o[g++])}</ins>`);return u.join(`
`)}function A(e){return e.replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function ft(){var s;const e=[],t=ue.entities||{};for(const[o,a]of Object.entries(t)){const l=(s=a.changelog)==null?void 0:s[0];l&&e.push({id:o,version:l.version,date:l.date,summary:l.summary,details:l.details})}return e.sort((o,a)=>o.date<a.date?1:-1),e}function gt(){const e=p.useMemo(()=>{try{const s=ft()[0];if(!s)return!1;const o=new Date(s.date+"T00:00:00Z");return(Date.now()-o.getTime())/864e5<=14}catch{return!1}},[]);function t(){const s=window.openCommandPalette;if(typeof s=="function")try{s();return}catch{}const o=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!o,metaKey:o}))}return n.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:n.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 sm:gap-3 px-4 py-3",children:[n.jsxs("div",{className:"flex items-center gap-3",children:[n.jsx(Pe,{className:"h-6 w-6"}),n.jsx("div",{className:"text-base sm:text-lg font-bold truncate leading-tight",children:"Правительство — Памятка (SKY)"})]}),n.jsxs("div",{className:"flex items-center gap-1 sm:gap-2",children:[n.jsxs("button",{className:"btn btn-secondary",onClick:t,children:[n.jsx(q,{className:"h-4 w-4"})," Поиск"]}),n.jsxs(C,{to:"/whats-new",className:"btn",children:["Что нового",e&&n.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),n.jsxs(C,{to:"/favorites",className:"btn",children:[n.jsx(te,{className:"h-4 w-4"})," Избранное"]}),n.jsxs(C,{to:"/settings",className:"btn",children:[n.jsx(ee,{className:"h-4 w-4"})," Настройки"]}),n.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn",children:[n.jsx(ne,{className:"h-4 w-4"})," Фидбек"]})]})]})})}const T={},bt=(T==null?void 0:T.VITE_NOTIF_URL)||void 0||"/api/notifications",H="notif:lastSeen";function xt(){const[e,t]=p.useState(!1),[s,o]=p.useState([]),[a,l]=p.useState(0);async function c(){try{const i=await fetch(bt,{cache:"no-store"});if(!i.ok)return;const g=await i.json(),d=Array.isArray(g)?g:g.items||[];d.sort((N,r)=>new Date(r.date||0).getTime()-new Date(N.date||0).getTime()),o(d);const m=localStorage.getItem(H)||"",v=m?d.findIndex(N=>N.id===m):-1,z=v===-1?d.length:v;l(Math.max(0,z))}catch{}}p.useEffect(()=>{c()},[]);function u(){if(t(i=>!i),!e&&s.length)try{localStorage.setItem(H,s[0].id),l(0)}catch{}}return n.jsxs("div",{className:"relative",children:[n.jsxs("button",{className:"btn btn-secondary relative",onClick:u,"aria-label":"Уведомления",children:[n.jsx(Ae,{className:"h-4 w-4"}),a>0&&n.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&n.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[n.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),s.length?n.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(i=>n.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:n.jsxs("a",{className:"block",href:i.url||"#",target:i.url?"_blank":void 0,rel:i.url?"noreferrer":void 0,children:[i.title&&n.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:i.title}),n.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:i.text}),i.date&&n.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(i.date).toLocaleString()})]})},i.id))}):n.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}const yt=p.lazy(()=>w(()=>import("./GovCheatsheetSky-Dkl6RS95.js"),__vite__mapDeps([0,1,2,3,4]))),wt=p.lazy(()=>w(()=>import("./WhatsNew-DQTrU8hn.js"),__vite__mapDeps([5,1,2]))),vt=p.lazy(()=>w(()=>import("./DiffPage-D6_Nrny6.js"),__vite__mapDeps([6,1,2]))),kt=p.lazy(()=>w(()=>import("./PrintSheet-W78ZDQrT.js"),__vite__mapDeps([7,1,2]))),jt=p.lazy(()=>w(()=>import("./RolePage-DI5htNGj.js"),__vite__mapDeps([8,1,3,2,9,4]))),zt=p.lazy(()=>w(()=>import("./LawPage-r7aWJTph.js"),__vite__mapDeps([10,1,9,2,4]))),St=p.lazy(()=>w(()=>import("./VuPage-8IMrQH7y.js"),__vite__mapDeps([11,1,4,2]))),It=p.lazy(()=>w(()=>import("./SettingsPage-CrJE69bh.js"),__vite__mapDeps([12,1,2]))),Et=p.lazy(()=>w(()=>import("./FavoritesPage-CrCjMCjp.js"),__vite__mapDeps([13,1,9,2,4])));function Nt(){const e=J();return X.useEffect(()=>{lt("page_view");try{dt(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[e.pathname,e.search,e.hash]),null}function _t(){return n.jsxs(je,{basename:"/pravo/",children:[n.jsx(at,{}),n.jsx(mt,{}),n.jsx(gt,{}),n.jsx("div",{className:"fixed right-2 top-2 z-50",children:n.jsx(xt,{})}),n.jsx(Nt,{}),n.jsx(p.Suspense,{fallback:n.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:n.jsxs(ze,{children:[n.jsx(y,{path:"/",element:n.jsx(yt,{})}),n.jsx(y,{path:"/whats-new",element:n.jsx(wt,{})}),n.jsx(y,{path:"/diff/:id",element:n.jsx(vt,{})}),n.jsx(y,{path:"/print",element:n.jsx(kt,{})}),n.jsx(y,{path:"/roles/:id",element:n.jsx(jt,{})}),n.jsx(y,{path:"/laws/:slug",element:n.jsx(zt,{})}),n.jsx(y,{path:"/vu/:id",element:n.jsx(St,{})}),n.jsx(y,{path:"/settings",element:n.jsx(It,{})}),n.jsx(y,{path:"/favorites",element:n.jsx(Et,{})})]})})]})}const me="theme",pe="accent",he="accent_custom",B="bg",Pt="bg_custom",fe={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}},ge={bg1:"img/bg1.png",bg2:"img/bg2.png",bg3:"img/bg3.png",bg4:"img/bg4.png",bg5:"img/bg5.png"};function At(){const e=localStorage.getItem(me);return e==="light"||e==="dark"?e:null}function Ct(){const e=localStorage.getItem(pe);return e?e==="custom"?"custom":e in fe?e:null:null}function Lt(){return localStorage.getItem(he)}function Rt(){const e=localStorage.getItem(B);return e&&(e==="none"||e==="custom"||e in ge)?e:null}function $t(){return localStorage.getItem(Pt)}function Dt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Tt(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(me,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let o=document.querySelector('meta[name="theme-color"]');o||(o=document.createElement("meta"),o.name="theme-color",document.head.appendChild(o)),o.setAttribute("content",s);try{t.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function be(e){if(e==="custom"){const t=Lt()||"#6366F1";document.documentElement.style.setProperty("--accent",t);const s=Bt(t,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const t=fe[e];document.documentElement.style.setProperty("--accent",t[500]),document.documentElement.style.setProperty("--accent-600",t[600])}localStorage.setItem(pe,e)}function Yt(e){localStorage.setItem(he,xe(e)),be("custom")}function Ot(e){const t=document.body;if(document.documentElement.classList.contains("dark")){t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="",localStorage.setItem(B,e);return}if(e==="none")t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="";else if(e==="custom"){const o=$t();o?(t.style.backgroundImage=`url(${o})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"):t.style.backgroundImage=""}else{const o=`/pravo/${ge[e]}`;t.style.backgroundImage=`url(${o})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"}localStorage.setItem(B,e)}function Mt(){const t=At()??(Dt()?"dark":"light");Tt(t);const s=Ct()??"indigo";be(s);const o=Rt()??"none";Ot(o)}function xe(e){let t=e.trim();if(t.startsWith("#")||(t=`#${t}`),t.length===4){const s=t[1],o=t[2],a=t[3];t=`#${s}${s}${o}${o}${a}${a}`}return t}function Bt(e,t){const s=xe(e).slice(1),o=parseInt(s,16);let a=o>>16&255,l=o>>8&255,c=o&255;a=Math.max(0,Math.min(255,Math.round(a+255*t))),l=Math.max(0,Math.min(255,Math.round(l+255*t))),c=Math.max(0,Math.min(255,Math.round(c+255*t)));const u=i=>i.toString(16).padStart(2,"0");return`#${u(a)}${u(l)}${u(c)}`}Mt();ot();function ye(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}ye();window.addEventListener("resize",ye,{passive:!0});M.createRoot(document.getElementById("root")).render(n.jsx(p.StrictMode,{children:n.jsx(_t,{})}));export{fe as A,ht as a,Ct as b,We as c,Wt as d,Ge as e,qe as f,ft as g,Ze as h,Ut as i,n as j,tt as k,Y as l,Tt as m,be as n,Yt as o,Je as p,Qe as q,Be as r,Dt as s,et as t,Ue as u,Ke as v,Ye as w};
