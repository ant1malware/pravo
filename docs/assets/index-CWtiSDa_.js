const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DK-155pu.js","assets/react-vendor-DStf8yZ1.js","assets/icons-CWwV2OkG.js","assets/VoteWidget-CyoKsH0w.js","assets/ContextText-Ct8qHLJE.js","assets/WhatsNew-CrHFbmQY.js","assets/DiffPage-pzA2GHgu.js","assets/PrintSheet-nHf32Jqr.js","assets/RolePage-14xpOdmw.js","assets/FavStar-shs6W5gj.js","assets/LawPage-Cs9UzyNn.js","assets/VuPage-DDhY4Cuz.js","assets/SettingsPage-D3725gRX.js","assets/FavoritesPage-BQehF9Uk.js"])))=>i.map(i=>d[i]);
import{r as Q,a as Ie,R as p,u as Z,L,B as Ee,b as Ne,c as w}from"./react-vendor-DStf8yZ1.js";import{S as ee,X as _e,B,U as te,a as ne,b as se,c as oe,F as $e,L as Pe,C as Ae,M as ae,d as Ce,e as Le,f as Re}from"./icons-CWwV2OkG.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();var re={exports:{}},O={};/**
 * @license React
...
`,Ye=[{id:"gov",title:"Внутренний устав Правительства",text:We,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],ce="ui:density",le="ui:font",Ge="ui:features",de="ui:shadow",ue="ui:radius",me="ui:glass",pe="ui:readw";function He(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),localStorage.setItem(ce,e)}function Xe(){return localStorage.getItem(ce)==="compact"?"compact":"standard"}function Je(e){const t=Math.max(.9,Math.min(1.3,e)),s=16*t;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(le,String(t))}function qe(){const e=parseFloat(localStorage.getItem(le)||"1");return isFinite(e)&&e>.6&&e<2?e:1}function Qe(e,t=!0){const s=Ze();return e in s?!!s[e]:t}function Ze(){try{const e=localStorage.getItem(Ge);return e?JSON.parse(e):{}}catch{return{}}}function et(e){let t="none";e==="soft"&&(t="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(t="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",t),localStorage.setItem(de,e)}function tt(){const e=localStorage.getItem(de);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function nt(e){let t=8,s=16,o=20;e==="subtle"&&(t=6,s=10,o=14),e==="rounded"&&(t=12,s=18,o=24),document.documentElement.style.setProperty("--radius-lg",t+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",o+"px"),localStorage.setItem(ue,e)}function st(){const e=localStorage.getItem(ue);return e==="subtle"||e==="rounded"?e:"standard"}function ot(e){const t=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",t+"px"),localStorage.setItem(me,String(t))}function at(){const e=parseInt(localStorage.getItem(me)||"6",10);return isFinite(e)?e:6}function rt(e){const t=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",t+"ch"),localStorage.setItem(pe,String(t))}function it(){const e=parseInt(localStorage.getItem(pe)||"78",10);return isFinite(e)?e:78}function ct(){try{He(Xe()),Je(qe()),et(tt()),nt(st()),ot(at()),rt(it())}catch{}}function j(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function lt(){if(!Qe("cmd_palette",!0))return null;const[t,s]=p.useState(!1),[o,a]=p.useState(""),[i,l]=p.useState(0),[u,c]=p.useState(()=>localStorage.getItem("cp_filter")||"all");p.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),p.useEffect(()=>{function r(g){(g.ctrlKey||g.metaKey)&&g.key.toLowerCase()==="k"&&(g.preventDefault(),s(!0),a(""),l(0)),t&&g.key==="Escape"&&s(!1)}return window.addEventListener("keydown",r),window.openCommandPalette=()=>{s(!0),a(""),l(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",r)}},[t]);const d=p.useMemo(()=>{const r=[];r.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:j("/favorites")}),r.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:j("/settings")});for(const h of Ue)r.push({kind:"role",id:h.id,title:h.role,subtitle:"Роль",url:j(`/roles/${h.id}`)});for(const h of G)r.push({kind:"law",id:h.slug,title:h.title,subtitle:"Закон",url:j(`/laws/${h.slug}`)});for(const h of Ye)r.push({kind:"vu",id:h.id,title:h.title,subtitle:"ВУ",url:j(`/vu/${h.id}`)});const g=o.trim().toLowerCase();return g&&r.push(...k(g).slice(0,60)),g?(u==="all"?r:r.filter(h=>h.kind===u)).map(h=>({r:h,score:m(`${h.title} ${h.subtitle||""}`.toLowerCase(),g)+(h.__boost||0)})).filter(h=>h.score>0).sort((h,I)=>I.score-h.score).slice(0,30).map(h=>h.r):r.slice(0,20)},[o,u]);function m(r,g){return g.split(/\s+/).filter(Boolean).reduce((h,I)=>h+(r.includes(I)?1:0),0)}function k(r){const g=[],R=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),h=(()=>{const b=r.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return b?b[2]:null})();for(const b of G){const ze=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let $="",y="";const D=new Set;for(const Se of ze){const E=Se.trim(),F=/^(#{2,6})\s*(.+)$/.exec(E);if(F){$=F[2].trim(),y=R($)||"";const z=$.toLowerCase();if(y&&(z.includes(r)||h&&z.match(new RegExp(`(^|s)ст(атья|.)?s*${h}\b`)))){const P=`${b.slug}#${y}`;if(!D.has(P)){const T={kind:"law",id:P,title:`${b.title} — ${$}`,subtitle:"Раздел закона",url:j(`/laws/${b.slug}?q=${encodeURIComponent(r)}#${y}`)};T.__boost=z.startsWith(r)?8:6,g.push(T),D.add(P)}}continue}if(E&&E.toLowerCase().includes(r)){const z=y?`${b.slug}#${y}`:b.slug;if(!D.has(z)){const V=E.length>140?E.slice(0,137)+"…":E,P=y?`${b.title} — ${$}`:b.title,T=j(y?`/laws/${b.slug}?q=${encodeURIComponent(r)}#${y}`:`/laws/${b.slug}?q=${encodeURIComponent(r)}`),U={kind:"law",id:z,title:P,subtitle:V||"Совпадение в тексте",url:T};U.__boost=5,g.push(U),D.add(z)}}}}const I=new Set;return g.filter(b=>I.has(b.id)?!1:(I.add(b.id),!0))}function S(r){s(!1);try{window.location.href=r}catch{location.assign(r)}}function _(r){d.length&&(r.key==="ArrowDown"&&(r.preventDefault(),l(g=>Math.min(g+1,d.length-1))),r.key==="ArrowUp"&&(r.preventDefault(),l(g=>Math.max(g-1,0))),r.key==="Enter"&&(r.preventDefault(),S(d[i].url)))}return n.jsx(n.Fragment,{children:t?n.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:n.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[n.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[n.jsx(ee,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),n.jsx("input",{autoFocus:!0,value:o,onChange:r=>{a(r.target.value),l(0)},onKeyDown:_,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),n.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>s(!1),"aria-label":"Закрыть палитру",children:n.jsx(_e,{className:"h-4 w-4"})})]}),n.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(r=>n.jsx("button",{onClick:()=>{c(r.k),l(0)},className:`chip ${u===r.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:r.label},r.k))}),n.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!d.length&&n.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),d.map((r,g)=>n.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${g===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>l(g),onClick:()=>S(r.url),children:[n.jsxs("span",{className:"inline-flex items-center gap-2",children:[r.kind==="law"&&n.jsx(B,{className:"h-4 w-4"}),r.kind==="role"&&n.jsx(te,{className:"h-4 w-4"}),r.kind==="vu"&&n.jsx(ne,{className:"h-4 w-4"}),r.kind==="page"&&(r.id==="settings"?n.jsx(se,{className:"h-4 w-4"}):n.jsx(oe,{className:"h-4 w-4"})),n.jsx("span",{className:"font-medium",children:r.title})]}),r.subtitle&&n.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:r.subtitle})]},`${r.kind}:${r.id}`))]})]})}):null})}const N={},dt=(N==null?void 0:N.VITE_API_BASE)||(N==null?void 0:N.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function ut(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function mt(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:ut()}}function pt(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...mt(),data:t}),o=`${dt}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(o,a))return}catch{}try{fetch(o,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const H="recent:items";function ht(e,t){try{const s=localStorage.getItem(H),o=s?JSON.parse(s):[],a={url:e,title:t,ts:Date.now()};if(o.length&&o[0].url===e)return;const i=o.filter(c=>c.url!==e);i.unshift(a);const l=[],u=new Set;for(const c of i)u.has(c.url)||(u.add(c.url),l.push(c));for(;l.length>15;)l.pop();localStorage.setItem(H,JSON.stringify(l))}catch{}}const gt=[{label:"Роли",icon:n.jsx(te,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:n.jsx($e,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:n.jsx(Pe,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:n.jsx(Ae,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:n.jsx(ae,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:n.jsx(Ce,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:n.jsx(B,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:n.jsx(ne,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:n.jsx(B,{className:"h-4 w-4"}),id:"laws"}];function ft(){const[e,t]=p.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=Z(),o=p.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=p.useMemo(()=>{const m=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),k=(s.hash||"").replace(/^#/,"").toLowerCase();return m||k||""},[s.search,s.hash]),i=d=>a===d;p.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const m=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=m}}},[e]),p.useEffect(()=>{function d(){typeof window<"u"&&t(window.innerWidth>=1024)}return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),p.useEffect(()=>{const d=document.documentElement;e?d.classList.add("has-sidebar"):d.classList.remove("has-sidebar")},[e]);const u=p.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",c="inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-medium shadow-sm border-zinc-300 bg-white/90 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",f=d=>{const m=`?tab=${encodeURIComponent(d)}`;return o?{pathname:"/",search:m}:{pathname:"/",search:m,hash:`#${d}`}};return n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>t(d=>!d),"aria-label":"Открыть меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),e&&n.jsx("div",{className:"fixed inset-0 z-50 bg-black/40 lg:hidden",onClick:()=>t(!1),"aria-hidden":"true"}),n.jsxs("aside",{id:"app-sidebar","aria-label":"Навигация",className:`app-sidebar fixed inset-y-0 left-0 z-[60] w-[240px] transform border-r border-zinc-200
              ...
              ${e?"translate-x-0":"-translate-x-full lg:translate-x-0"}`,children:[n.jsx("div",{className:"mb-3 flex items-center justify-start",children:n.jsx(L,{to:"/",className:`rounded font-semibold no-underline focus:outline-none focus:ring-2 focus:ring-zinc-400\r
                       text-zinc-900 hover:underline hover:text-zinc-900\r
                       dark:text-zinc-100 dark:hover:text-white`,"aria-label":"Главная",children:"Главная"})}),n.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-140px)] gap-1 overflow-y-auto pr-1",children:n.jsx("ul",{className:"flex flex-col gap-1",children:gt.map(d=>{const m=i(d.id);return n.jsx("li",{children:n.jsxs(L,{to:f(d.id),className:["flex items-center gap-2 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-zinc-400","text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",m?"bg-zinc-100 dark:bg-zinc-800":""].join(" "),"aria-current":m?"page":void 0,"aria-label":d.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&t(!1)},children:[d.icon,n.jsx("span",{className:"truncate",children:d.label})]})},d.id)})})}),n.jsxs("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:["Подсказка: нажмите ",n.jsx("kbd",{className:c,children:u})," для быстрого поиска"]})]})]})}const bt={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},he={entities:bt};function xt(e){var s;return((s=he.entities)==null?void 0:s[e])||null}function Ht(e,t=30){const s=xt(e);if(!(s!=null&&s.updated_at))return{recent:!1};const o=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-o.getTime())/(1e3*60*60*24)<=t,date:s.updated_at}}function Xt(e,t){const s=e.split(/\r?\n/),o=t.split(/\r?\n/),a=s.length,i=o.length,l=Array.from({length:a+1},()=>Array(i+1).fill(0));for(let d=a-1;d>=0;d--)for(let m=i-1;m>=0;m--)l[d][m]=s[d]===o[m]?l[d+1][m+1]+1:Math.max(l[d+1][m],l[d][m+1]);const u=[];let c=0,f=0;for(;c<a&&f<i;)s[c]===o[f]?(u.push(A(s[c])),c++,f++):l[c+1][f]>=l[c][f+1]?(u.push(`<del>${A(s[c])}</del>`),c++):(u.push(`<ins>${A(o[f])}</ins>`),f++);for(;c<a;)u.push(`<del>${A(s[c++])}</del>`);for(;f<i;)u.push(`<ins>${A(o[f++])}</ins>`);return u.join(`
`)}function A(e){return e.replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function yt(){var s;const e=[],t=he.entities||{};for(const[o,a]of Object.entries(t)){const i=(s=a.changelog)==null?void 0:s[0];i&&e.push({id:o,version:i.version,date:i.date,summary:i.summary,details:i.details})}return e.sort((o,a)=>o.date<a.date?1:-1),e}function wt(){const e=p.useMemo(()=>{try{const s=yt()[0];if(!s)return!1;const o=new Date(s.date+"T00:00:00Z");return(Date.now()-o.getTime())/864e5<=14}catch{return!1}},[]);function t(){const s=window.openCommandPalette;if(typeof s=="function")try{s();return}catch{}const o=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!o,metaKey:o}))}return n.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:n.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",children:[n.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[n.jsx(Le,{className:"h-6 w-6 shrink-0"}),n.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),n.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[n.jsxs("button",{className:"btn btn-secondary",onClick:t,"aria-label":"Поиск",children:[n.jsx(ee,{className:"h-4 w-4"}),n.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),n.jsxs(L,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[n.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),e&&n.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),n.jsxs(L,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[n.jsx(oe,{className:"h-4 w-4"}),n.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),n.jsxs(L,{to:"/settings",className:"btn","aria-label":"Настройки",children:[n.jsx(se,{className:"h-4 w-4"}),n.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),n.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[n.jsx(ae,{className:"h-4 w-4"}),n.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]})})}const vt="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",X="notif:lastSeen";function kt(){const[e,t]=p.useState(!1),[s,o]=p.useState([]),[a,i]=p.useState(0);async function l(){try{const c=await fetch(vt,{cache:"no-store"});if(!c.ok)return;const f=await c.json(),d=Array.isArray(f)?f:f.items||[];d.sort((_,r)=>new Date(r.date||0).getTime()-new Date(_.date||0).getTime()),o(d);const m=localStorage.getItem(X)||"",k=m?d.findIndex(_=>_.id===m):-1,S=k===-1?d.length:k;i(Math.max(0,S))}catch{}}p.useEffect(()=>{l()},[]);function u(){if(t(c=>!c),!e&&s.length)try{localStorage.setItem(X,s[0].id),i(0)}catch{}}return n.jsxs("div",{className:"relative",children:[n.jsxs("button",{className:"btn btn-secondary relative",onClick:u,"aria-label":"Уведомления",children:[n.jsx(Re,{className:"h-4 w-4"}),a>0&&n.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&n.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[n.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),s.length?n.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(c=>n.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:n.jsxs("a",{className:"block",href:c.url||"#",target:c.url?"_blank":void 0,rel:c.url?"noreferrer":void 0,children:[c.title&&n.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:c.title}),n.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:c.text}),c.date&&n.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(c.date).toLocaleString()})]})},c.id))}):n.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}const jt=p.lazy(()=>v(()=>import("./GovCheatsheetSky-DK-155pu.js"),__vite__mapDeps([0,1,2,3,4]))),zt=p.lazy(()=>v(()=>import("./WhatsNew-CrHFbmQY.js"),__vite__mapDeps([5,1,2]))),St=p.lazy(()=>v(()=>import("./DiffPage-pzA2GHgu.js"),__vite__mapDeps([6,1,2]))),It=p.lazy(()=>v(()=>import("./PrintSheet-nHf32Jqr.js"),__vite__mapDeps([7,1,2]))),Et=p.lazy(()=>v(()=>import("./RolePage-14xpOdmw.js"),__vite__mapDeps([8,1,3,2,9,4]))),Nt=p.lazy(()=>v(()=>import("./LawPage-Cs9UzyNn.js"),__vite__mapDeps([10,1,9,2,4]))),_t=p.lazy(()=>v(()=>import("./VuPage-DDhY4Cuz.js"),__vite__mapDeps([11,1,4,2]))),$t=p.lazy(()=>v(()=>import("./SettingsPage-D3725gRX.js"),__vite__mapDeps([12,1,2]))),Pt=p.lazy(()=>v(()=>import("./FavoritesPage-BQehF9Uk.js"),__vite__mapDeps([13,1,9,2,4])));function At(){const e=Z();return Q.useEffect(()=>{pt("page_view");try{ht(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[e.pathname,e.search,e.hash]),null}function Ct(){return n.jsxs(Ee,{basename:"/pravo/",children:[n.jsx(lt,{}),n.jsx(ft,{}),n.jsx(wt,{}),n.jsx("div",{className:"fixed right-2 top-16 z-40 sm:top-2",children:n.jsx(kt,{})}),n.jsx(At,{}),n.jsx(p.Suspense,{fallback:n.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:n.jsxs(Ne,{children:[n.jsx(w,{path:"/",element:n.jsx(jt,{})}),n.jsx(w,{path:"/whats-new",element:n.jsx(zt,{})}),n.jsx(w,{path:"/diff/:id",element:n.jsx(St,{})}),n.jsx(w,{path:"/print",element:n.jsx(It,{})}),n.jsx(w,{path:"/roles/:id",element:n.jsx(Et,{})}),n.jsx(w,{path:"/laws/:slug",element:n.jsx(Nt,{})}),n.jsx(w,{path:"/vu/:id",element:n.jsx(_t,{})}),n.jsx(w,{path:"/settings",element:n.jsx($t,{})}),n.jsx(w,{path:"/favorites",element:n.jsx(Pt,{})})]})})]})}const ge="theme",fe="accent",be="accent_custom",xe="bg",Lt="bg_custom",ye={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var J,q;const M=((q=(J=import.meta)==null?void 0:J.env)==null?void 0:q.BASE_URL)??"/",C=e=>{const t=e.replace(/^\/+/,"");return(M.endsWith("/")?M:M+"/")+t},we={bg1:C("img/bg1.png"),bg2:C("img/bg2.png"),bg3:C("img/bg3.png"),bg4:C("img/bg4.png"),bg5:C("img/bg5.png")};function Rt(){const e=localStorage.getItem(ge);return e==="light"||e==="dark"?e:null}function Dt(){const e=localStorage.getItem(fe);return e?e==="custom"?"custom":e in ye?e:null:null}function Tt(){return localStorage.getItem(be)}function Ot(){const e=localStorage.getItem(xe);return e&&(e==="none"||e==="custom"||e in we)?e:null}function Mt(){return localStorage.getItem(Lt)}function Bt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Kt(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(ge,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let o=document.querySelector('meta[name="theme-color"]');o||(o=document.createElement("meta"),o.name="theme-color",document.head.appendChild(o)),o.setAttribute("content",s);try{t.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function ve(e){if(e==="custom"){const t=Tt()||"#6366F1";document.documentElement.style.setProperty("--accent",t);const s=Ut(t,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const t=ye[e];document.documentElement.style.setProperty("--accent",t[500]),document.documentElement.style.setProperty("--accent-600",t[600])}localStorage.setItem(fe,e)}function Jt(e){localStorage.setItem(be,ke(e)),ve("custom")}function Ft(e){const t=document.body,o=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(e==="none")t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="";else if(e==="custom"){const a=Mt();a?(t.style.backgroundImage=`url(${a})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment=o,t.style.backgroundPosition="center"):t.style.backgroundImage=""}else{const a=we[e];t.style.backgroundImage=`url(${a})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment=o,t.style.backgroundPosition="center"}localStorage.setItem(xe,e)}function Vt(){const t=Rt()??(Bt()?"dark":"light");Kt(t);const s=Dt()??"indigo";ve(s);const o=Ot()??"none";Ft(o)}function ke(e){let t=e.trim();if(t.startsWith("#")||(t=`#${t}`),t.length===4){const s=t[1],o=t[2],a=t[3];t=`#${s}${s}${o}${o}${a}${a}`}return t}function Ut(e,t){const s=ke(e).slice(1),o=parseInt(s,16);let a=o>>16&255,i=o>>8&255,l=o&255;a=Math.max(0,Math.min(255,Math.round(a+255*t))),i=Math.max(0,Math.min(255,Math.round(i+255*t))),l=Math.max(0,Math.min(255,Math.round(l+255*t)));const u=c=>c.toString(16).padStart(2,"0");return`#${u(a)}${u(i)}${u(l)}`}(function(){try{const t="app:version",s=localStorage.getItem(t),o="1757654004138";if(s&&s!==o){"caches"in window?caches.keys().then(a=>Promise.all(a.map(i=>caches.delete(i)))).finally(()=>{localStorage.setItem(t,o),location.reload()}):(localStorage.setItem(t,o),location.reload());return}localStorage.setItem(t,o)}catch{}})();Vt();ct();function je(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}je();window.addEventListener("resize",je,{passive:!0});K.createRoot(document.getElementById("root")).render(n.jsx(p.StrictMode,{children:n.jsx(Ct,{})}));export{ye as A,we as B,xt as a,Dt as b,Xe as c,Xt as d,qe as e,tt as f,yt as g,st as h,Ht as i,n as j,at as k,G as l,Kt as m,ve as n,Jt as o,et as p,nt as q,Ue as r,Bt as s,ot as t,He as u,Ye as v,Je as w};
