const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DrE2v8FX.js","assets/react-vendor-DTkXckhQ.js","assets/icons-Bbe7SUOu.js","assets/VoteWidget-C2NmPcAG.js","assets/WhatsNew-BK_5jbK-.js","assets/DiffPage-CeOWF2yX.js","assets/LiquidGlassShowcase-DsV5ofTZ.js","assets/PrintSheet-BVOIg9oe.js","assets/RolePage-Can_doOz.js","assets/FavStar-DkUXsqV9.js","assets/LawPage-BwCfNunZ.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-wYwRsums.js","assets/HomePage-DejSP9YN.js","assets/ForumPage-BCoa6OAb.js","assets/forumStore-C4eL2Xpj.js","assets/forumRemote-D5s3MT8n.js","assets/ForumSubnav-0d47UtZh.js","assets/ForumSearch-DEi3ndYk.js","assets/ProfilePage-BYbZx8m0.js","assets/Badge-CPmGruli.js","assets/ForumMembers-BLijhiUl.js","assets/SectionPage-CJ6LzrOy.js","assets/MarkdownEditor-DctOV1zZ.js","assets/TopicPage-DPktsxXy.js","assets/ReactionBar-DfxiRsYi.js","assets/seo-Dt7ixYh-.js","assets/TagPage-6CcA4Mq5.js","assets/QuestionsPage-Be4MGVVO.js","assets/AdminPanel3-CzVF8Lka.js","assets/SettingsPage-Bm2krAaV.js","assets/FavoritesPage-CUVenhP1.js","assets/ForumFeedsPage-BHKosiq8.js"])))=>i.map(i=>d[i]);
import{r as re,a as Ct,u as Rt,L as M,R as c,b as ee,B as Tt,c as Ot,d as j}from"./react-vendor-DTkXckhQ.js";import{A as $t,E as Dt,I as be,Q as Bt,B as ae,S as we,U as ve,a as je,X as Fe,b as ke,c as Se,L as Ue,G as Ft,M as ze,F as Ut,d as Kt,C as Vt,e as qt,f as Wt,g as Yt,h as Gt}from"./icons-Bbe7SUOu.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();var Ke={exports:{}},le={};/**
 * @license React
 ...
 */var Ht=re,Jt=Symbol.for("react.element"),Xt=Symbol.for("react.fragment"),Qt=Object.prototype.hasOwnProperty,Zt=Ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,en={key:!0,ref:!0,__self:!0,__source:!0};function Ve(e,n,s){var r,a={},o=null,i=null;s!==void 0&&(o=""+s),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(i=n.ref);for(r in n)Qt.call(n,r)&&!en.hasOwnProperty(r)&&(a[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)a[r]===void 0&&(a[r]=n[r]);return{$$typeof:Jt,type:e,key:o,ref:i,props:a,_owner:Zt.current}}le.Fragment=Xt;le.jsx=Ve;le.jsxs=Ve;Ke.exports=le;var t=Ke.exports,xe={},Ie=Ct;xe.createRoot=Ie.createRoot,xe.hydrateRoot=Ie.hydrateRoot;const tn="modulepreload",nn=function(e){return"/pravo/"+e},Le={},E=function(n,s,r){let a=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));a=Promise.allSettled(s.map(l=>{if(l=nn(l),l in Le)return;Le[l]=!0;const m=l.endsWith(".css"),x=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${x}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":tn,m||(g.as="script"),g.crossOrigin="",g.href=l,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((I,z)=>{g.addEventListener("load",I),g.addEventListener("error",()=>z(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return a.then(i=>{for(const d of i||[])d.status==="rejected"&&o(d.reason);return n().catch(o)})},sn=[{id:"obs",name:"OBS Studio",site:"https://obsproject.com/",platforms:["Windows","macOS","Linux"],pros:["Бесплатный и открытый исходный код","Гибкие сцены и источники, запись + трансляции","Много пресетов и плагинов","Поддержка аппаратного кодирования (NVENC/AMF/QuickSync)"],cons:["Относительно сложный старт без гайда","Может требовать тонкой настройки битрейта/кодека"],tips:['Формат записи: MP4 (H.264 + AAC), опция "Автозавершение записи при сбоях"',"Быстрый старт: Настройки → Вывод → Запись → Качество: Высокое; Кодек: H.264 (NVENC, если доступен)","Горячие клавиши: Настройки → Горячие клавиши → Старт/Стоп записи"]},{id:"xbox",name:"Xbox Game Bar",site:"ms-gamebar://",platforms:["Windows 10/11"],requires:"Встроено в Windows (Win+G)",pros:["Мгновенный старт без установки","Удобно для игр и окон","Минимальные настройки"],cons:["Меньше контроля качества/битрейта","Не всегда корректно пишет рабочий стол"],tips:["Откройте панель: Win+G; Начать запись: Win+Alt+R","Проверьте пути сохранения: Настройки → Захват"]},{id:"shadowplay",name:"NVIDIA ShadowPlay",site:"https://www.nvidia.com/en-us/geforce/geforce-experience/shadowplay/",platforms:["Windows"],requires:"Видеокарта NVIDIA + GeForce Experience",pros:["Малое влияние на FPS (NVENC)","Инстант‑повторы и оверлей","Хорошее качество без сложной настройки"],cons:["Только для карт NVIDIA","Нужна авторизация в GeForce Experience"],tips:["Откройте GeForce Experience → Настройки → Оверлей в игре → Запись","Рекомендуемый формат: MP4 (H.264, 1080p, 30–60 fps)"]},{id:"amd",name:"AMD ReLive (Adrenalin)",site:"https://www.amd.com/en/technologies/software",platforms:["Windows"],requires:"Видеокарта AMD + пакет Adrenalin",pros:["Аппаратное кодирование (AMF)","Инстант‑реплей, оверлей"],cons:["Только для видеокарт AMD"],tips:["Откройте Adrenalin → Захват и трансляция → Запись","Выберите MP4 (H.264) и 1080p 30–60 fps"]},{id:"bandicam",name:"Bandicam",site:"https://www.bandicam.com/downloads/",platforms:["Windows"],pros:["Простой интерфейс, запись области экрана","Поддержка веб‑камеры и наложений"],cons:["Платная лицензия, водяной знак в пробной версии"],tips:["Вывод MP4 (H.264 + AAC), фиксированные горячие клавиши (F12 по умолчанию)"]},{id:"camtasia",name:"Camtasia",site:"https://www.techsmith.com/download/camtasia/",platforms:["Windows","macOS"],pros:["Встроенный редактор видео","Хорош для обучающих роликов"],cons:["Платная, тяжелее по ресурсам"],tips:["Запись в высоком качестве, монтаж и экспорт в MP4"]},{id:"sharex",name:"ShareX (Видео/GIF)",site:"https://getsharex.com/",platforms:["Windows"],pros:["Легкая запись области экрана","Быстрые GIF/отрывки, автоматическая загрузка","Бесплатно"],cons:["Не так стабильно для длинных записей","Нужно установить кодеки (FFmpeg) для видео"],tips:["Настройки → Захват экрана → Установить FFmpeg внутри ShareX","Формат MP4 для длинных видео, GIF для коротких"]}];function rn(e){return sn.find(n=>n.id===e)}const ue=({title:e,children:n})=>t.jsxs("div",{className:"card",children:[t.jsx("div",{className:"mb-2 flex items-center justify-between",children:t.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}),t.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:n})]});function an(){const{id:e}=Rt(),n=rn(e||"");return n?t.jsxs("div",{className:"min-h-screen text-zinc-900 dark:text-zinc-100",children:[t.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:t.jsxs("div",{className:"mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3",children:[t.jsxs(M,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[t.jsx($t,{className:"h-4 w-4"})," Назад"]}),t.jsxs("div",{className:"flex flex-col items-center",children:[t.jsx("h1",{className:"text-lg font-bold leading-tight",children:n.name}),t.jsx("div",{className:"mt-1 text-xs text-zinc-500 dark:text-zinc-400",children:n.platforms.join(" · ")})]}),t.jsxs("a",{className:"btn",href:n.site,target:"_blank",rel:"noreferrer",children:["Открыть сайт ",t.jsx(Dt,{className:"h-4 w-4"})]})]})}),t.jsxs("main",{className:"mx-auto grid max-w-3xl grid-cols-1 gap-4 px-4 py-5",children:[n.requires&&t.jsxs("div",{className:"rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm text-amber-900 shadow-sm dark:border-amber-800/60 dark:bg-amber-900/25 dark:text-amber-200",children:["Требования: ",n.requires]}),t.jsx(ue,{title:"Плюсы",children:t.jsx("ul",{className:"ml-4 list-disc",children:n.pros.map((s,r)=>t.jsx("li",{children:s},r))})}),t.jsx(ue,{title:"Минусы",children:t.jsx("ul",{className:"ml-4 list-disc",children:n.cons.map((s,r)=>t.jsx("li",{children:s},r))})}),n.tips&&n.tips.length>0&&t.jsx(ue,{title:"Советы по настройке",children:t.jsx("ul",{className:"ml-4 list-disc",children:n.tips.map((s,r)=>t.jsx("li",{children:s},r))})})]})]}):t.jsxs("div",{className:"p-4",children:["Не найдено."," ",t.jsx(M,{to:"/",className:"text-blue-600 underline",children:"На главную"})]})}function on(){const[e,n]=c.useState("");return c.useEffect(()=>{try{n(localStorage.getItem("context_text")||"")}catch{}},[]),e?t.jsx("div",{className:"text-xs text-zinc-500 dark:text-zinc-400 whitespace-pre-line",children:e}):null}const G=({title:e,children:n})=>t.jsxs("section",{className:"card",children:[e?t.jsx("header",{className:"mb-2 flex items-center gap-2",children:t.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}):null,t.jsx("div",{className:"prose prose-zinc max-w-none text-[0.95rem] leading-relaxed dark:prose-invert",children:n})]});function cn(){return t.jsxs("div",{className:"min-h-screen text-zinc-900 dark:text-zinc-100",children:[t.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:t.jsxs("div",{className:"mx-auto flex max-w-4xl items-center justify-between gap-3 px-4 py-3",children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx(be,{className:"h-5 w-5"}),t.jsx("h1",{className:"text-lg font-bold leading-tight",children:"О нас"})]}),t.jsx(on,{}),t.jsx(M,{to:"/?tab=roles",className:"btn",children:"На главную"})]})}),t.jsxs("main",{className:"mx-auto grid max-w-4xl grid-cols-1 gap-4 px-4 py-6",children:[t.jsxs(G,{title:t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(be,{className:"h-4 w-4"}),"Кто мы и зачем это нужно"]}),children:[t.jsx("p",{children:"Этот сайт — рабочая справка по SKY. Здесь собраны роли, процедуры, взаимодействия и короткие пояснения к правилам с прямыми ссылками на первоисточники. Задача простая: быстро найти ответ и спокойно действовать — без переписок «а где это написано?» и бесконечного перелистывания форума."}),t.jsxs("p",{children:["Автор — ",t.jsx("b",{children:"Pavel_Bolshoy"}),". Профиль — ",t.jsx("i",{children:"кодер читов"}),". Такой опыт заставляет смотреть на систему целиком: где рождаются данные, где узкие места, какие инварианты не должны ломаться и как формулировать правила так, чтобы ими реально пользовались каждый день, а не только в отчётах."]}),t.jsxs("aside",{className:"not-prose mt-3 rounded-xl border border-zinc-200 bg-zinc-50/80 p-4 text-sm dark:border-zinc-800 dark:bg-zinc-900/60",children:[t.jsx(Bt,{className:"mb-2 h-4 w-4 opacity-60"}),t.jsx("p",{className:"italic m-0",children:"«все, что мне совесть оставит, я бы заел зубами»"}),t.jsx("p",{className:"m-0 opacity-70",children:"Коротко про подход: берусь только за то, за что готов отвечать, и довожу до рабочего состояния."})]})]}),t.jsxs(G,{title:t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(ae,{className:"h-4 w-4"}),"Как устроено и как этим пользоваться"]}),children:[t.jsxs("p",{children:["Вся структура построена вокруг понятной схемы карточек: ",t.jsx("b",{children:"смысл → шаги → оговорки → источник → связанное"}),". Одинаковые задачи оформлены одинаково — это экономит время и снижает количество ошибок. Если для ответа нужно больше двух кликов, значит, карточка требует упрощения."]}),t.jsxs("ul",{children:[t.jsxs("li",{children:[t.jsx("b",{children:"Роли и повышение."})," Требования, чек-листы, частые ошибки и контрольные вопросы."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Процедуры и взаимодействия."})," Пошаговое «как делать» для штатных и пограничных ситуаций (спор, выезд, конфликт)."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Законы и документы."})," Короткие пояснения и прямые ссылки на профильные ветки форума."]})]}),t.jsx("p",{children:"Как пользоваться: откройте нужный раздел, сверьте чек-лист под свою ситуацию, проверьте оговорки и при необходимости перейдите к первоисточнику. Если карточки нет — значит, её ещё не добавили; сообщите по контакту ниже, и она появится в ближайших обновлениях."})]}),t.jsxs(G,{title:t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(we,{className:"h-4 w-4"}),"Принципы работы"]}),children:[t.jsxs("ul",{children:[t.jsxs("li",{children:[t.jsx("b",{children:"Два клика до ответа."})," Любая лишняя итерация — сигнал к упрощению текста или интерфейса."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Один источник правды."})," Приоритет у форума Amazing RP (SKY). При расхождениях — пометка в карточке и ссылка на первоисточник."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Минимум магии."})," Технологии: React + Vite + TypeScript. Меньше зависимостей — меньше сюрпризов в критический момент."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Итеративные обновления."})," Небольшие правки регулярно. Существенные изменения помечаются «обновлено» и отражаются в «Что нового»."]}),t.jsxs("li",{children:[t.jsx("b",{children:"Без «серых схем»."})," Здесь нет обходов и инструкций по «как выкрутиться». Только рабочие правила и проверяемые ссылки."]})]}),t.jsx("p",{className:"text-xs opacity-70",children:"Материалы носят справочный характер. Перед действием сверяйтесь с актуальными регламентами."})]}),t.jsxs(G,{children:[t.jsx("p",{className:"m-0",children:"Иногда, чтобы система поехала, нужен «неудобный» взгляд. Этот абзац — не мотивация, а напоминание, почему мы держим структуру и аккуратность:"}),t.jsxs("blockquote",{className:"not-prose mt-3 rounded-xl border border-zinc-200 bg-zinc-50/80 p-4 text-[0.92rem] leading-relaxed italic dark:border-zinc-800 dark:bg-zinc-900/60",children:["«Хвала безумцам. Бунтарям. Белым воронам. Неудачникам. Тем, кто всегда некстати и невпопад. Тем, кто видит мир иначе. Они не соблюдают правила. Они смеются над устоями. Их можно цитировать, спорить с ними, прославлять или проклинать их. Но только игнорировать их — невозможно. Ведь они несут перемены. Они толкают человечество вперед. И пусть кто-то говорит: «безумцы», мы говорим: «гении». Ведь лишь безумец верит, что он в состоянии изменить мир, — и потому меняет его.»",t.jsx("footer",{className:"mt-2 text-xs not-italic opacity-70",children:"(с) Стив Джобс"})]})]}),t.jsxs(G,{title:t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(ve,{className:"h-4 w-4"}),"Для кого и как связаться"]}),children:[t.jsx("p",{children:"Справка полезна тем, кто хочет меньше спорить о формулировках и быстрее переходить к делу: новичкам — чтобы не теряться в терминах, старшим — чтобы держать единый стандарт действий."}),t.jsxs("p",{className:"m-0",children:["По делу — Telegram: ",t.jsx("a",{href:"https://t.me/fatality_boy",target:"_blank",rel:"noreferrer",className:"underline decoration-dotted hover:no-underline",children:"fatality_boy"}),"."]})]})]})]})}const ln=[{id:"guard",role:"Охранник (1)",salary:"18.000 руб.",duties:["Стоять на постах A1–E2, контролировать поток в здание и безопасность сотрудников","Сопровождать сотрудников (с должности Адвокат) и охранять кабинеты","Докладывать по регламенту (заступил/продолжаю/закончил пост; начал/веду/закончил охрану)"],promotion:["Отстоять на посту А-1/А-2 20 минут (доклад каждые 10 минут)","Отстоять на посту B-1/B-2 20 минут (доклад каждые 10 минут)","Отстоять на посту С-1/С-2 20 минут (доклад каждые 10 минут)","Прослушать лекцию «Субординация»","Прослушать лекцию «Правила пользования рацией»","Прослушать лекцию «Специальные средства»","Сдать базовый экзамен (внутренний устав, охрана правительственного аппарата, спец. средства)"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"chief-guard",role:"Начальник охраны (2)",salary:"20.000 руб.",duties:["Распределяет посты и смены охраны","Контролирует соблюдение уставной формы и дисциплины связи"],promotion:["Отстоять на посту А-1/А-2 20 минут (доклад каждые 10 минут)","Отстоять на посту B-1/B-2 20 минут (доклад каждые 10 минут)","Отстоять на посту Е-1/Е-2 20 минут (доклад каждые 10 минут)","Отстоять на посту D-1/D-2 20 минут (доклад каждые 10 минут)","Охрана любого сотрудника правительства (от должности Ревизор)","Прослушать лекцию «Юридическая деятельность»","Сдать экзамен на адвоката (УК, КоАП, юридическая консультация)"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"lawyer",role:"Адвокат (3)",salary:"23.000 руб.",duties:["Юридическая помощь заключённым; дежурство в комнате свиданий","Доклады: начало/продолжаю/закончил помощь; дежурство в КС","Задания для зачёта: консультации, УДО и др. (см. критерии/отчёт)"],promotion:["Оказать юридическую консультацию 5 заключённым ИК «Кресты»","Дежурство в комнате свиданий 30 минут (доклад каждые 10 минут)","Прослушать лекцию «Правила выдачи лицензий»","Прослушать лекцию «Правила проведения ревизий»","Сдать экзамен «ФЗ о территориях с ограниченным доступом»"],dept:["ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"inspector",role:"Инспектор (4)",salary:"26.000 руб.",duties:["Контроль собеседований; выездные проверки постов ГАИ/УМВД","Дежурство за стойкой регистрации; ведение отчётности","Участие в государственных проверках"],promotion:["Дежурство в холле правительства 60 минут (доклад каждые 20 минут)","Оформить 10 лицензий","Провести две ревизии","Прослушать лекцию «Департаменты правительственного аппарата»","Прослушать лекцию «Правила проведения проверок»","Сдать экзамен «Федеральное постановление»"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"advisor",role:"Советник (5)",salary:"29.000 руб.",duties:["Участие и координация проверок; методическая помощь отделам"],promotionByDept:{ДЗ:["Дежурство в холле ЕСС 60 минут (доклад каждые 20 минут)","Проконтролировать 2 собеседования в ЕСС","Проверка постов ЕСС (доклад на каждом посту)","Опрос 10 сотрудников ЕСС: «Отношение к наркотическим веществам?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ДВД:["Дежурство в холле ГАИ/УМВД 60 минут (доклад каждые 20 минут)","Проконтролировать 2 собеседования в ГАИ/УМВД","Проверка постов ГАИ (доклад на каждом посту)","Проверка постов УМВД (доклад на каждом посту)","Опрос 10 сотрудников ГАИ/УМВД: «Отношение к гражданам, находящимся в розыске?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ДВС:["Дежурство у КПП-1 ВЧ 60 минут (доклад каждые 20 минут)","Дежурство в военкомате 60 минут (доклад каждые 20 минут)","Проконтролировать 2 призыва в ВЧ","Опрос 10 сотрудников ВЧ: «Отношение к нелегальным структурам?»","Помощь/участие в плановой или внеплановой проверке","Прослушать лекцию «Снятие судимостей»"],ЮД:["Дежурство в холле правительства 60 минут (доклад каждые 10 минут)","Провести 7 аттестаций сотрудникам","Провести 7 лекций сотрудникам","Проконтролировать 2 собеседования в Правительстве","Помощь/участие в проверке любой гос. организации","Прослушать лекцию «Снятие судимостей»"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"deputy-minister",role:"Заместитель министра (6)",salary:"32.000 руб.",duties:["Снятие судимостей гражданам (право с этой должности)","Организация и приём отчётности подразделений"],promotionByDept:{ДЗ:["Прослушивать рацию ЕСС 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ЕСС 60 минут (доклад каждые 20 минут)","Проконтролировать 3 собеседования в ЕСС","Опрос 15 сотрудников ЕСС: «Отношение к наркотическим веществам?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ДВД:["Прослушивать рацию ГАИ/УМВД/УФСИН 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ГАИ/УМВД 60 минут (доклад каждые 10 минут)","Проконтролировать 3 собеседования в ГАИ/УМВД/УФСИН","Опрос 15 сотрудников ГАИ/УМВД: «Отношение к гражданам, находящимся в розыске?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ДВС:["Прослушивать рацию ВЧ 60 минут (доклад каждые 20 минут)","Вести надзор за сотрудниками ВЧ 60 минут (доклад каждые 20 минут)","Проконтролировать 3 призыва в ВЧ","Опрос 15 сотрудников ВЧ: «Отношение к нелегальным структурам?»","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"],ЮД:["Провести 13 аттестаций","Провести 13 лекций","Контролировать рацию Правительства 60 минут (доклад каждые 10 минут)","Провести тренировку охране/начальникам охраны по теме «Задержание/сопровождение/спец. средства»","Помочь в проведении 3 собеседований","Помощь/участие в плановой или внеплановой проверке","Сдать экзамен на министра Губернатору/Вице-губернатору (УК, КоАП, ФП, ФЗоВВ, ФЗоТОД, Конституция)"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"minister",role:"Министр (7)",salary:"35.000 руб.",duties:["Организует государственные проверки (инициатор)","Распоряжения в пределах департамента"],promotionByDept:{ДЗ:["На усмотрение губернатора"],ДВД:["На усмотрение губернатора"],ДВС:["На усмотрение губернатора"],ЮД:["На усмотрение губернатора"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"admin-chief",role:"Глава администрации (8)",salary:"38.000 руб.",duties:["Операционное управление правительственным аппаратом"],promotionByDept:{ДЗ:["На усмотрение губернатора"],ДВД:["На усмотрение губернатора"],ДВС:["На усмотрение губернатора"],ЮД:["На усмотрение губернатора"]},dept:["ДЗ","ДВД","ДВС","ЮД"],source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"vice-governor",role:"Вице-губернатор (9)",salary:"41.000 руб.",duties:["Высшее руководство, указы, взаимодействие с ФСБ/ВЧ/ЕСС/МВД"],promotionByDept:{ДЗ:["—"],ДВД:["—"],ДВС:["—"],ЮД:["—"]},source:"https://forum.amazing-online.com/threads/kriterii-dlja-povyshenija-v-dolzhnosti.1029606/"},{id:"governor",role:"Губернатор (10)",salary:"45.000 руб.",duties:["Общее руководство; указы/постановления; награждения по итогам проверок"],source:"https://forum.amazing-online.com/threads/ukazy-postanovlenija-rasporjazhenija-gubernatora-nizhegorodskoj-oblasti.1027740/"}],D="/pravo/",Pe=[{slug:"constitution",abbr:"КОНСТ",title:"Конституция Нижегородской области",notes:"Базовые права, устройство власти.",updated:"2025-02-23",content:`# Конституция Нижегородской области
...
`,un=[{id:"gov",title:"Внутренний устав Правительства",text:dn,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],mn=["#bcd3ff","#6a79ff"],pn={pal_ocean:["#bcd3ff","#6a79ff"],pal_sunset:["#ffd7a1","#ff6a88"],pal_void:["#a7b0ff","#5a2cff"],pal_blossom:["#ffb3d2","#ff77a9"],pal_midnight:["#2b2d55","#141729"],pal_aurora:["#7de3ff","#8b5cf6"],pal_candy:["#ffe6f3","#ffc8de"],pal_celestial:["#8ad7ff","#b388ff"],pal_softnight:["#1f2448","#513d8a"]};function fn(e){return e?pn[e]??null:null}const qe="ui:density",We="ui:font",hn="ui:features",Ye="ui:shadow",Ge="ui:radius",He="ui:glass",Je="ui:readw",Xe="ui:anim",Qe="buddy:enabled",Ze="buddy:skin_a",et="buddy:skin_b",gn="buddy:save:v1";function C(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function O(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function bn(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),O(qe,e)}function xn(){return C(qe)==="compact"?"compact":"standard"}function yn(e){const n=Math.max(.9,Math.min(1.3,e)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),O(We,String(n))}function wn(){const e=C(We),n=parseFloat(e||"1");return isFinite(n)&&n>.6&&n<2?n:1}function vn(e,n=!0){const s=jn();return e in s?!!s[e]:n}function jn(){try{const e=C(hn);return e?JSON.parse(e):{}}catch{return{}}}function kn(e){let n="none";e==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),O(Ye,e)}function Sn(){const e=C(Ye);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function En(e){let n=8,s=16,r=20;e==="subtle"&&(n=6,s=10,r=14),e==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),O(Ge,e)}function Nn(){const e=C(Ge);return e==="subtle"||e==="rounded"?e:"standard"}function _n(e){const n=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",n+"px"),O(He,String(n))}function zn(){const e=C(He),n=parseInt(e||"6",10);return isFinite(n)?n:6}function In(e){const n=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",n+"ch"),O(Je,String(n))}function Ln(){const e=C(Je),n=parseInt(e||"78",10);return isFinite(n)?n:78}function Pn(){try{bn(xn()),yn(wn()),kn(Sn()),En(Nn()),_n(zn()),In(Ln()),An(Mn())}catch{}}function An(e){document.documentElement.classList.toggle("anim-off",!e),O(Xe,e?"1":"0")}function Mn(){try{return C(Xe)!=="0"}catch{return!0}}function Cn(e){O(Qe,"0")}function Rn(){try{return C(Qe)!=="0"}catch{return!0}}function Tn(e,n){const s=/^#?[0-9a-fA-F]{6}$/.test(e)?e.startsWith("#")?e:"#"+e:"#bcd3ff",r=/^#?[0-9a-fA-F]{6}$/.test(n)?n.startsWith("#")?n:"#"+n:"#6a79ff";O(Ze,s),O(et,r)}function On(){const e=$n();let n=C(Ze),s=C(et);if(e){const[o,i]=e;(!n||!s||n.toLowerCase()!==o.toLowerCase()||s.toLowerCase()!==i.toLowerCase())&&(Tn(o,i),n=o,s=i)}const[r,a]=mn;return{a:n||r,b:s||a}}function $n(){var e,n;try{const s=C(gn);if(!s)return null;const r=JSON.parse(s),a=(n=(e=r==null?void 0:r.cosm)==null?void 0:e.equipped)==null?void 0:n.palette,o=fn(typeof a=="string"?a:null);return o||null}catch{return null}}const tt={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},L={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function nt(...e){return e.filter(Boolean).join(" ")}function st(){const[e,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),e}function rt(e,n){c.useEffect(()=>{const s=e.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,o=18;const i=()=>{r=0;const m=e.current;m&&(m.style.setProperty("--lg-x",`${a}%`),m.style.setProperty("--lg-y",`${o}%`))},d=m=>{const x=e.current;if(!x)return;const g=x.getBoundingClientRect(),I=(m.clientX-g.left)/g.width*100,z=(m.clientY-g.top)/g.height*100;a=Math.max(0,Math.min(100,I)),o=Math.max(0,Math.min(100,z)),r||(r=window.requestAnimationFrame(i))},l=()=>{a=72,o=18,r||(r=window.requestAnimationFrame(i))};return s.addEventListener("pointermove",d,{passive:!0}),s.addEventListener("pointerdown",d,{passive:!0}),s.addEventListener("pointerenter",d,{passive:!0}),s.addEventListener("pointerleave",l),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",d),s.removeEventListener("pointerdown",d),s.removeEventListener("pointerenter",d),s.removeEventListener("pointerleave",l)}},[e,n])}function Ae(e){if(!e)return[255,255,255];const n=e.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function se(e){return`${e[0]} ${e[1]} ${e[2]}`}function me(e,n,s){return Math.round(e+(n-e)*s)}function Me(e,n){return[me(e[0],n>=0?255:0,Math.abs(n)),me(e[1],n>=0?255:0,Math.abs(n)),me(e[2],n>=0?255:0,Math.abs(n))]}function Dn(e,n,s){const r=e?tt[e]:n??L.tint,a=s??L.accent,o=Ae(r),i=Ae(a),d=Me(i,.25),l=Me(i,-.55);return{tintRgb:se(o),accentRgb:se(i),accentSoftRgb:se(d),accentDeepRgb:se(l)}}function at(e,n){const s={...e??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:o,accentDeepRgb:i}=Dn(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=o,s["--lg-accent-deep"]=i,s}const ot=c.forwardRef((e,n)=>{const{blur:s=L.blur,tint:r=L.tint,opacity:a=L.opacity,gloss:o=L.gloss,border:i=L.border,glints:d=L.glints,interactive:l=L.interactive,animate:m=L.animate,elevation:x=L.elevation,tone:g,accent:I=L.accent,className:z,style:y,children:w,..._}=e,v=st(),f=l&&!v,u=c.useRef(null),b=c.useCallback(h=>{u.current=h,typeof n=="function"?n(h):n&&(n.current=h),h&&(h.style.setProperty("--lg-x","72%"),h.style.setProperty("--lg-y","18%"))},[n]);rt(u,f);const S=c.useMemo(()=>at(y,{blur:s,tint:r,opacity:a,gloss:o,border:i,elevation:x,glints:d,tone:g,accent:I}),[y,s,r,a,o,i,x,d,g,I]),p={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*x}px ${50*x}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return t.jsxs("div",{ref:b,className:nt("liquid-glass",z),"data-animate":m?"true":"false","data-interactive":f?"true":"false",style:{...p,...S},..._,children:[t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),d&&t.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[t.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),t.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),f&&t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),t.jsx("div",{style:{position:"relative",zIndex:10},children:w}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:i,pointerEvents:"none"}}),t.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});ot.displayName="LiquidGlass";const it=c.forwardRef((e,n)=>{const{className:s,style:r,children:a,type:o,blur:i,tint:d,opacity:l,gloss:m,border:x,glints:g,interactive:I,animate:z,elevation:y,tone:w,accent:_=L.accent,...v}=e,f=i??L.blur,u=w?tt[w]:d??L.tint,b=l??.16,S=m??.9,p=x??.6,h=g??!1,W=I??!0,$=y??1,T=st(),P=W&&!T,A=c.useRef(null),q=c.useCallback(k=>{A.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","70%"),k.style.setProperty("--lg-y","16%"))},[n]);rt(A,P);const R=c.useMemo(()=>at(r,{blur:f,tint:u,opacity:b,gloss:S,border:p,glints:h,elevation:$,tone:w,accent:_}),[r,f,u,b,S,p,h,$,w,_]),K={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*$}px ${18*$}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return t.jsxs("button",{ref:q,type:o??"button",className:nt("liquid-glass liquid-glass__button",s),style:{...K,...R},...v,onMouseDown:k=>{k.currentTarget.style.transform="scale(0.985)"},onMouseUp:k=>{k.currentTarget.style.transform=""},onMouseLeave:k=>{k.currentTarget.style.transform=""},children:[t.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[t.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),t.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),t.jsx("span",{style:{position:"relative",zIndex:1},children:a}),t.jsx("style",{children:`
      ...
      `})]})});it.displayName="LiquidGlass.Button";const te=ot;te.Button=it;const ct="theme",lt="accent",dt="accent_custom",ut="bg",Bn="bg_custom",mt="ui:style-mode",pe="ui:liquid:prev-theme",pt="ui:liquid:tone";function U(e){try{return typeof window<"u"?window.localStorage.getItem(e):null}catch{return null}}function V(e,n){try{typeof window<"u"&&window.localStorage.setItem(e,n)}catch{}}function Fn(e){try{typeof window<"u"&&window.localStorage.removeItem(e)}catch{}}const ft={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var De,Be;const fe=((Be=(De=import.meta)==null?void 0:De.env)==null?void 0:Be.BASE_URL)??"/",H=e=>{const n=e.replace(/^\/+/,"");return(fe.endsWith("/")?fe:fe+"/")+n},ht={bg1:H("img/bg1.png"),bg2:H("img/bg2.png"),bg3:H("img/bg3.png"),bg4:H("img/bg4.png"),bg5:H("img/bg5.png")};function gt(){const e=U(ct);return e==="light"||e==="dark"?e:null}function Un(){const e=U(lt);return e?e==="custom"?"custom":e in ft?e:null:null}function Kn(){return U(dt)}function bt(){const e=U(ut);return e&&(e==="none"||e==="custom"||e in ht)?e:null}function Vn(){return U(Bn)}function xt(){const e=U(mt);return e==="classic"||e==="liquid"?e:null}function qn(){return(U(pt)||"dark")==="light"?"light":"dark"}function Wn(e){V(pt,e);const n=document.documentElement;if(n.classList.toggle("liquid-light",e==="light"),n.classList.toggle("liquid-dark",e!=="light"),n.classList.contains("theme-liquid"))try{Ee(e==="light"?"light":"dark")}catch{}}function yt(e){const n=document.documentElement;if(n.classList.toggle("theme-liquid",e==="liquid"),n.dataset.styleMode=e,e==="liquid"){try{const s=gt()??(wt()?"dark":"light");V(pe,s);const r=qn();Wn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=U(pe);(s==="light"||s==="dark")&&Ee(s),Fn(pe)}catch{}try{const s=bt()??"none";jt(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:e}))}catch{}V(mt,e)}function wt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function Ee(e){const n=document.documentElement;e==="dark"?n.classList.add("dark"):n.classList.remove("dark"),V(ct,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function vt(e){if(e==="custom"){const n=Kn()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Gn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=ft[e];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}V(lt,e)}function Ws(e){V(dt,kt(e)),vt("custom")}function jt(e){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(e==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(e==="custom"){const a=Vn();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=ht[e];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}V(ut,e)}function Yn(){const n=gt()??(wt()?"dark":"light");Ee(n);const s=Un()??"indigo";vt(s);const r=bt()??"none";jt(r);const a=xt()??"classic";yt(a)}function kt(e){let n=e.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function Gn(e,n){const s=kt(e).slice(1),r=parseInt(s,16);let a=r>>16&255,o=r>>8&255,i=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n)));const d=l=>l.toString(16).padStart(2,"0");return`#${d(a)}${d(o)}${d(i)}`}function Ce(){if(typeof document<"u"){const e=document.documentElement.dataset.styleMode;if(e==="classic"||e==="liquid")return e}try{return xt()??"classic"}catch{return"classic"}}function de(){const[e,n]=c.useState(()=>Ce());c.useEffect(()=>{const r=()=>{const i=Ce();n(d=>d===i?d:i)},a=i=>{const d=i.detail;d==="classic"||d==="liquid"?n(d):r()};window.addEventListener("stylemodechange",a);const o=new MutationObserver(r);return o.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),o.disconnect()}},[]);const s=c.useCallback(r=>{yt(r),n(r)},[]);return[e,s]}function B(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function Hn(){if(!vn("cmd_palette",!0))return null;const[n]=de(),[s,r]=c.useState(!1),[a,o]=c.useState(""),[i,d]=c.useState(0),[l,m]=c.useState(()=>localStorage.getItem("cp_filter")||"all");c.useEffect(()=>{try{localStorage.setItem("cp_filter",l)}catch{}},[l]);const[x,g]=c.useState(null);c.useEffect(()=>{(async()=>{try{const S=(await(await E(()=>import("./forumRemote-D5s3MT8n.js"),[])).listSections()).find(p=>String(p.title||"").toLowerCase()==="workshop");g((S==null?void 0:S.id)||null)}catch{}})()},[]);const z=c.useMemo(()=>{const u=[];u.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:B("/forum")}),u.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:B("/favorites")}),u.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:B("/settings")});for(const p of ln)u.push({kind:"role",id:p.id,title:p.role,subtitle:"������",url:B(`/roles/${p.id}`)});for(const p of Pe)u.push({kind:"law",id:p.slug,title:p.title,subtitle:"�����",url:B(`/laws/${p.slug}`)});for(const p of un)u.push({kind:"vu",id:p.id,title:p.title,subtitle:"��",url:B(`/vu/${p.id}`)});const b=a.trim().toLowerCase();return b&&u.push(...w(b).slice(0,60)),b?(l==="all"?u:u.filter(p=>p.kind===l)).map(p=>({r:p,score:y(`${p.title} ${p.subtitle||""}`.toLowerCase(),b)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,h)=>h.score-p.score).slice(0,30).map(p=>p.r):u.slice(0,20)},[a,l]);function y(u,b){return b.split(/\s+/).filter(Boolean).reduce((p,h)=>p+(u.includes(h)?1:0),0)}function w(u){const b=[],S=h=>h.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const h of Pe){const $=(h.content||"").replace(/\r\n?/g,`
`).split(`
`);let T="",P="";const A=new Set;for(const q of $){const R=q.trim(),K=/^(#{2,6})\s*(.+)$/.exec(R);if(K){T=K[2].trim(),P=S(T)||"";const k=T.toLowerCase();if(P&&k.includes(u)){const Y=`${h.slug}#${P}`;if(!A.has(Y)){const ne={kind:"law",id:Y,title:`${h.title} � ${T}`,subtitle:"���������",url:B(`/laws/${h.slug}?q=${encodeURIComponent(u)}#${P}`)};ne.__boost=k.startsWith(u)?8:6,b.push(ne),A.add(Y)}}continue}if(R&&R.toLowerCase().includes(u)){const k=P?`${h.slug}#${P}`:h.slug;if(!A.has(k)){const Y=R.length>140?R.slice(0,137)+"�":R,ne=P?`${h.title} � ${T}`:h.title,Mt=B(P?`/laws/${h.slug}?q=${encodeURIComponent(u)}#${P}`:`/laws/${h.slug}?q=${encodeURIComponent(u)}`),_e={kind:"law",id:k,title:ne,subtitle:Y||"��������",url:Mt};_e.__boost=5,b.push(_e),A.add(k)}}}}const p=new Set;return b.filter(h=>p.has(h.id)?!1:(p.add(h.id),!0))}function _(u){r(!1);try{window.location.href=u}catch{location.assign(u)}}function v(u){z.length&&(u.key==="ArrowDown"&&(u.preventDefault(),d(b=>Math.min(b+1,z.length-1))),u.key==="ArrowUp"&&(u.preventDefault(),d(b=>Math.max(b-1,0))),u.key==="Enter"&&(u.preventDefault(),_(z[i].url)))}const f=({children:u})=>n==="liquid"?t.jsx(te,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:u}):t.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:u});return t.jsx(t.Fragment,{children:s?t.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:t.jsxs(f,{children:[t.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[t.jsx(je,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),t.jsx("input",{autoFocus:!0,value:a,onChange:u=>{o(u.target.value),d(0)},onKeyDown:v,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),t.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:t.jsx(Fe,{className:"h-4 w-4"})})]}),t.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(u=>t.jsx("button",{onClick:()=>{m(u.k),d(0)},className:`chip ${l===u.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:u.label},u.k))}),t.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!z.length&&t.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),z.map((u,b)=>t.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${b===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>d(b),onClick:()=>_(u.url),children:[t.jsxs("span",{className:"inline-flex items-center gap-2",children:[u.kind==="law"&&t.jsx(ae,{className:"h-4 w-4"}),u.kind==="role"&&t.jsx(ve,{className:"h-4 w-4"}),u.kind==="vu"&&t.jsx(we,{className:"h-4 w-4"}),u.kind==="page"&&(u.id==="settings"?t.jsx(ke,{className:"h-4 w-4"}):t.jsx(Se,{className:"h-4 w-4"})),t.jsx("span",{className:"font-medium",children:u.title})]}),u.subtitle&&t.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:u.subtitle})]},`${u.kind}:${u.id}`))]})]})}):null})}const Jn="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function Xn(){try{const e="anon_uid";let n=localStorage.getItem(e);return n||(n=crypto.randomUUID(),localStorage.setItem(e,n)),n}catch{return"na"}}function Qn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:Xn()}}function Zn(e,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...Qn(),data:n}),r=`${Jn}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}function es(){try{const n=new URL(window.location.href),s=n.searchParams.get("api");if(s){localStorage.setItem("forum:api_base",s);try{n.searchParams.delete("api"),history.replaceState({},"",n.toString())}catch{}}const r=localStorage.getItem("forum:api_base");if(r)return r}catch{}return"https://notifications-worker.wizardiowhy.workers.dev/skyapi"}const ts=es(),Z="forum:token",oe="forum:session";function St(e,n=!0){(n?localStorage:sessionStorage).setItem(Z,e)}function Et(){return localStorage.getItem(Z)??sessionStorage.getItem(Z)}function ie(){try{localStorage.removeItem(Z),sessionStorage.removeItem(Z),localStorage.removeItem(oe),sessionStorage.removeItem(oe)}finally{window.dispatchEvent(new Event("forum:session"))}}function Ne(e){try{const n={until:e||null,setAt:new Date().toISOString()};localStorage.setItem("forum:ban_lock",JSON.stringify(n))}catch{}}async function N(e,n={}){const s=Et(),r={"Content-Type":"application/json",...n.headers||{}};s&&(r.Authorization=`Bearer ${s}`);const a=await fetch(`${ts}${e}`,{...n,headers:r}),o=await a.text();let i={};try{i=o?JSON.parse(o):{}}catch{i={error:o||a.statusText}}if(!a.ok){try{(a.status===401||a.status===403)&&(typeof(i==null?void 0:i.error)=="string"&&/ban/i.test(i.error)&&Ne(null),ie())}catch{}throw new Error((i==null?void 0:i.error)||`${a.status} ${a.statusText}`)}return i}async function Ys(e){const n=JSON.stringify({username:e.username,email:e.email,password:e.password||"1234",inviteCode:e.inviteCode||"",captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await N("/register",{method:"POST",body:n});St(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};localStorage.setItem(oe,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session"));const o=r;try{if(o!=null&&o.bannedUntil&&new Date(o.bannedUntil).getTime()>Date.now())throw Ne(o.bannedUntil),ie(),new Error("banned")}catch{}return o}async function Gs(e){const n=JSON.stringify({usernameOrEmail:e.usernameOrEmail,password:e.password||"1234",otp:e.otp||void 0,captchaToken:e.captchaToken||void 0}),{token:s,user:r}=await N("/login",{method:"POST",body:n});St(s,e.remember!==!1);const a={userId:r.id,remember:e.remember!==!1,lastLogin:new Date().toISOString()};return localStorage.setItem(oe,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session")),r}async function Nt(){if(!Et())return null;try{const{user:n}=await N("/me"),s=n;return s!=null&&s.bannedUntil&&new Date(s.bannedUntil).getTime()>Date.now()?(Ne(s.bannedUntil),ie(),null):s}catch{return ie(),null}}async function Hs(){const{users:e}=await N("/users");return e}async function Js(e,n){const{user:s}=await N(`/users/${e}/role`,{method:"PATCH",body:JSON.stringify({role:n})});return s}async function Xs(){const{invites:e}=await N("/invites");return e}async function Qs(e=5,n){const{invites:s}=await N("/invites",{method:"POST",body:JSON.stringify({count:e,note:n})});return s}async function Zs(e,n){const s=JSON.stringify(n?{until:n}:{days:7}),{user:r}=await N("/users/"+encodeURIComponent(e)+"/ban",{method:"POST",body:s});return r}async function er(e){const{user:n}=await N("/users/"+encodeURIComponent(e)+"/unban",{method:"POST"});return n}async function tr(e,n){const s=JSON.stringify(n?{until:n}:{minutes:60}),{user:r}=await N("/users/"+encodeURIComponent(e)+"/mute",{method:"POST",body:s});return r}async function nr(e){const{user:n}=await N("/users/"+encodeURIComponent(e)+"/unmute",{method:"POST"});return n}async function sr(e){await N(`/invites/${encodeURIComponent(e)}`,{method:"DELETE"})}async function rr(){const{settings:e}=await N("/settings");return e}async function ar(e){const{settings:n}=await N("/settings",{method:"PATCH",body:JSON.stringify(e)});return n}async function or(e){try{const n=await N(`/profiles/by-username/${encodeURIComponent(e)}`);return{user:n.user,profile:n.profile||null,stats:n.stats||null}}catch{return null}}async function ir(e){const{profile:n}=await N("/profiles/me",{method:"PATCH",body:JSON.stringify(e)});return n}async function ns(e){try{const{profile:n}=await N(`/profiles/${encodeURIComponent(e)}`);return n}catch{return null}}async function cr(e,n){const s={labels:Array.isArray(n)?n:[]},{profile:r}=await N(`/profiles/${encodeURIComponent(e)}/labels`,{method:"PATCH",body:JSON.stringify(s)});return r}async function lr(e,n=30){const{user:s}=await N(`/users/${encodeURIComponent(e)}/vip`,{method:"POST",body:JSON.stringify({days:n})});return s}async function dr(e){const{user:n}=await N(`/users/${encodeURIComponent(e)}/unvip`,{method:"POST"});return n}async function ur(){const{members:e}=await N("/members");return e}const _t="forum:lastActive:";function ss(e){try{localStorage.setItem(_t+e,new Date().toISOString())}catch{}}function mr(e){try{return localStorage.getItem(_t+e)}catch{return null}}function pr(e){if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";try{const s=new Intl.RelativeTimeFormat("ru",{numeric:"auto"}),r=n.getTime()-Date.now(),a=1e3,o=60*a,i=60*o,d=24*i,l=30*d,m=365*d;return Math.abs(r)<o?s.format(Math.round(r/a),"second"):Math.abs(r)<i?s.format(Math.round(r/o),"minute"):Math.abs(r)<d?s.format(Math.round(r/i),"hour"):Math.abs(r)<l?s.format(Math.round(r/d),"day"):Math.abs(r)<m?s.format(Math.round(r/l),"month"):s.format(Math.round(r/m),"year")}catch{return n.toLocaleString()}}const Re="recent:items";function rs(e,n){try{const s=localStorage.getItem(Re),r=s?JSON.parse(s):[],a={url:e,title:n,ts:Date.now()};if(r.length&&r[0].url===e)return;const o=r.filter(l=>l.url!==e);o.unshift(a);const i=[],d=new Set;for(const l of o)d.has(l.url)||(d.add(l.url),i.push(l));for(;i.length>15;)i.pop();localStorage.setItem(Re,JSON.stringify(i))}catch{}}const ce="forum:session";function fr(){try{const e=sessionStorage.getItem(ce)??localStorage.getItem(ce);return e?JSON.parse(e):null}catch{return null}}function zt(){const e=()=>{try{const r=sessionStorage.getItem(ce)??localStorage.getItem(ce);return r?JSON.parse(r):null}catch{return null}},[n,s]=re.useState(e());return re.useEffect(()=>{const r=()=>s(e());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const as=["cheb","cheb-access","chebzik"];let F={allowed:!1,loading:!0},J=null;const ye=new Set;function Q(){for(const e of ye)try{e()}catch{}}function os(e){return((e==null?void 0:e.labels)||[]).map(n=>n.trim().toLowerCase()).filter(Boolean)}function is(e){return e.some(n=>as.includes(n))}async function cs(){try{const e=await Nt();if(!e)return F={allowed:!1,loading:!1},Q(),!1;const n=!!(e!=null&&e.owner)||(e.userNumber||0)===1;if(e.role==="developer"||n)return F={allowed:!0,loading:!1},Q(),!0;let s=!1;try{const r=await ns(e.id);s=is(os(r))}catch{s=!1}return F={allowed:s,loading:!1},Q(),s}catch{return F={allowed:!1,loading:!1},Q(),!1}}function Te(){return F}function ls(e){return ye.add(e),()=>ye.delete(e)}async function It(e=!1){return!e&&!F.loading?F.allowed:J||(F={...F,loading:!0},Q(),J=cs().finally(()=>{J=null}),J)}typeof window<"u"&&window.addEventListener("forum:session",()=>{It(!0).catch(()=>{})});function ds(){const[e,n]=c.useState(()=>Te());return c.useEffect(()=>{const r=ls(()=>n(Te()));return It(!0).catch(()=>{}),r},[]),e}const Lt=[{key:"forum",type:"route",label:"Форум",icon:t.jsx(ze,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:t.jsx(ve,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:t.jsx(Ut,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:t.jsx(Kt,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:t.jsx(Vt,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:t.jsx(ze,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:t.jsx(qt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:t.jsx(ae,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:t.jsx(we,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:t.jsx(ae,{className:"h-4 w-4"}),id:"laws"}];function us(){const[e,n]=c.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=ee(),[r]=de(),o=!zt(),{allowed:i}=ds(),d=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=c.useMemo(()=>{const u=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),b=(s.hash||"").replace(/^#/,"").toLowerCase();return u||b||""},[s.search,s.hash]),m=c.useCallback(f=>l===f,[l]);c.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const u=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=u}}},[e]),c.useEffect(()=>{function f(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),c.useEffect(()=>{const f=document.documentElement;e?f.classList.add("has-sidebar"):f.classList.remove("has-sidebar")},[e]);const x=c.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),g=x?"⌘ K":"Ctrl K",I=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",z=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",y=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",w=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",_=f=>{const u=`?tab=${encodeURIComponent(f)}`;return d?{pathname:"/",search:u}:{pathname:"/",search:u,hash:`#${f}`}},v=t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"mb-4 flex items-center justify-start",children:t.jsx(M,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),t.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:t.jsxs("ul",{className:"flex flex-col gap-1",children:[Lt.map(f=>{const u=f.type==="route"?s.pathname===f.to:m(f.id),b=f.type==="route"?f.to:_(f.id);return t.jsx("li",{children:t.jsxs(M,{to:b,className:[I,u?z:""].filter(Boolean).join(" "),"aria-current":u?"page":void 0,"aria-label":f.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[f.icon,t.jsx("span",{className:"truncate",children:f.label}),f.key==="forum"&&o&&t.jsx(Ue,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},f.key)}),t.jsx("li",{children:t.jsxs(M,{to:"/about",className:I,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[t.jsx(be,{className:"h-4 w-4"}),t.jsx("span",{className:"truncate",children:"О нас"})]})}),i&&t.jsx("li",{children:t.jsxs(M,{to:"/buddy",className:I,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[t.jsx(Ft,{className:"h-4 w-4"}),t.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),t.jsxs("div",{className:y,children:["Подсказка: нажмите ",t.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:g}),", чтобы открыть быстрый поиск"]})]});return t.jsxs(t.Fragment,{children:[t.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(f=>!f),"aria-label":"Меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),t.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:w,children:r==="liquid"?t.jsx(te,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:v}):v})]})}const ms={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},Pt={entities:ms};function ps(e){var s;return((s=Pt.entities)==null?void 0:s[e])||null}function hr(e,n=30){const s=ps(e);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function gr(e,n){const s=e.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,o=r.length,i=Array.from({length:a+1},()=>Array(o+1).fill(0));for(let x=a-1;x>=0;x--)for(let g=o-1;g>=0;g--)i[x][g]=s[x]===r[g]?i[x+1][g+1]+1:Math.max(i[x+1][g],i[x][g+1]);const d=[];let l=0,m=0;for(;l<a&&m<o;)s[l]===r[m]?(d.push(X(s[l])),l++,m++):i[l+1][m]>=i[l][m+1]?(d.push(`<del>${X(s[l])}</del>`),l++):(d.push(`<ins>${X(r[m])}</ins>`),m++);for(;l<a;)d.push(`<del>${X(s[l++])}</del>`);for(;m<o;)d.push(`<ins>${X(r[m++])}</ins>`);return d.join(`
`)}function X(e){return e.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function fs(){var s;const e=[],n=Pt.entities||{};for(const[r,a]of Object.entries(n)){const o=(s=a.changelog)==null?void 0:s[0];o&&e.push({id:r,version:o.version,date:o.date,summary:o.summary,details:o.details})}return e.sort((r,a)=>r.date<a.date?1:-1),e}function hs(){const[e]=de(),n=ee(),s=c.useMemo(()=>{try{const d=fs()[0];if(!d)return!1;const l=new Date(d.date+"T00:00:00Z");return(Date.now()-l.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const d=window.openCommandPalette;if(typeof d=="function")try{d();return}catch{}const l=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!l,metaKey:l}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",o=e==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",i=t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[t.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var d;return(d=window.openMobileMenu)==null?void 0:d.call(window)},"aria-label":"Меню",children:t.jsx(Wt,{className:"h-4 w-4"})}),t.jsx(Yt,{className:"h-6 w-6 shrink-0"}),t.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),t.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[t.jsx(je,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),t.jsxs(M,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[t.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&t.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),t.jsxs(M,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[t.jsx(Se,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),t.jsxs(M,{to:"/settings",className:"btn","aria-label":"Настройки",children:[t.jsx(ke,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]})]})]});return n.pathname.startsWith("/forum")?null:t.jsx("div",{className:o,children:e==="liquid"?t.jsx(te,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:i}):t.jsx("div",{className:a,children:i})})}const gs="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",he="notif:lastSeen",Oe="notifications-panel";function bs(){const[e,n]=c.useState(!1),[s,r]=c.useState([]),[a,o]=c.useState(0),[i,d]=c.useState(!1),[l,m]=c.useState(null),x=c.useRef(null),g=c.useCallback(async()=>{const y=new AbortController;d(!0),m(null);try{const w=await fetch(gs,{cache:"no-store",signal:y.signal});if(!w.ok)throw new Error(`HTTP ${w.status}`);const _=await w.json(),v=Array.isArray(_)?_:_.items||[],f=p=>p?new Date(p).getTime():0;v.sort((p,h)=>f(h.date)-f(p.date)),r(v);const u=typeof localStorage<"u"&&localStorage.getItem(he)||"",b=u?v.findIndex(p=>p.id===u):-1,S=b===-1?v.length:b;o(Math.max(0,S))}catch(w){(w==null?void 0:w.name)!=="AbortError"&&m("Не удалось загрузить уведомления")}finally{d(!1)}return()=>y.abort()},[]);c.useEffect(()=>{g()},[g]),c.useEffect(()=>{if(e&&s.length)try{localStorage.setItem(he,s[0].id),o(0)}catch{}},[e,s]),c.useEffect(()=>{if(!e)return;const y=_=>{x.current&&(x.current.contains(_.target)||n(!1))},w=_=>{_.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",y),document.addEventListener("keydown",w),()=>{document.removeEventListener("mousedown",y),document.removeEventListener("keydown",w)}},[e]);const I=()=>n(y=>!y),z=y=>y?new Date(y).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return t.jsxs("div",{ref:x,className:"relative",children:[t.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:I,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":e,"aria-controls":Oe,children:[t.jsx(Gt,{className:"h-4 w-4"}),a>0&&t.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&t.jsxs(te,{id:Oe,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[t.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),i?t.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):l?t.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:l}):s.length?t.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(y=>t.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:t.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:y.url||"#",target:y.url?"_blank":void 0,rel:y.url?"noreferrer":void 0,onClick:()=>{var w;try{(w=s[0])!=null&&w.id&&localStorage.setItem(he,s[0].id),o(0)}catch{}},children:[y.title&&t.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:y.title}),t.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:y.text}),y.date&&t.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:z(y.date)})]})},y.id))}):t.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function xs(){const[e,n]=c.useState(!1),s=ee(),a=!zt();c.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),c.useEffect(()=>{if(!e)return;const l=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=l}},[e]);const o=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),i=l=>{const m=new URLSearchParams(s.search||"");m.set("tab",l);const x=`?${m.toString()}`;return o?{pathname:"/",search:x}:{pathname:"/",search:x,hash:`#${l}`}};function d(){const l=window.openCommandPalette;if(typeof l=="function")try{l()}catch{}n(!1)}return e?t.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[t.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),t.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[t.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:d,"aria-label":"РџРѕРёСЃРє",children:[t.jsx(je,{className:"h-4 w-4"})," ",t.jsx("span",{children:"РџРѕРёСЃРє"})]}),t.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),t.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:t.jsx(Fe,{className:"h-4 w-4"})})]}),t.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[t.jsx("ul",{className:"grid gap-2",children:Lt.map(l=>{const m=l.type==="route"?l.to:i(l.id);return t.jsx("li",{children:t.jsxs(M,{to:m,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[l.icon,t.jsx("span",{className:"truncate",children:l.label}),l.key==="forum"&&a&&t.jsx(Ue,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},l.key)})}),t.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[t.jsxs(M,{to:"/favorites",className:"btn btn-secondary",children:[t.jsx(Se,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),t.jsxs(M,{to:"/settings",className:"btn btn-secondary",children:[t.jsx(ke,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const ge=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!","Я ❤️ Катю"];function ys(){const[e,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),e}function ws(){const[e,n]=c.useState(null),[s,r]=c.useState(!0),a=c.useRef(Math.floor(Math.random()*ge.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches||!s)return null;const o=ys(),i=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),d=!o&&!i,l=c.useRef(null),m=c.useRef(null),x=c.useRef(!1);c.useEffect(()=>{const v=l.current;if(!v)return;let f=0,u=performance.now(),b=Math.random()*(window.innerWidth-64)+16,S=Math.random()*(window.innerHeight-120)+60,p=(Math.random()*60+30)*(Math.random()>.5?1:-1),h=(Math.random()*40+20)*(Math.random()>.5?1:-1);const W=T=>{const P=Math.min(.05,(T-u)/1e3);if(u=T,d){b+=p*P,S+=h*P;const A=16,q=window.innerWidth,R=window.innerHeight,K=48,k=48;b<A&&(b=A,p=Math.abs(p)),b>q-K-A&&(b=q-K-A,p=-Math.abs(p)),S<60&&(S=60,h=Math.abs(h)),S>R-k-A&&(S=R-k-A,h=-Math.abs(h)),p+=(Math.random()-.5)*4,h+=(Math.random()-.5)*4}v.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(S)}px, 0)`,f=requestAnimationFrame(W)};f=requestAnimationFrame(W);const $=()=>{u=performance.now()};return window.addEventListener("resize",$),()=>{cancelAnimationFrame(f),window.removeEventListener("resize",$)}},[d]),c.useEffect(()=>()=>{m.current&&window.clearTimeout(m.current)},[]);function g(v){const f=v??ge[a.current++%ge.length];n(f),window.clearTimeout(g._t),g._t=window.setTimeout(()=>n(null),3e3)}function I(v){if(x.current){x.current=!1,v.preventDefault();return}if(v.altKey){v.preventDefault(),z();return}g()}function z(){x.current=!0,n(null),r(!1);try{Cn(!1)}catch{}}function y(v){m.current&&window.clearTimeout(m.current),!v.altKey&&(m.current=window.setTimeout(()=>{z(),m.current=null},650))}function w(){m.current&&(window.clearTimeout(m.current),m.current=null,x.current=!1)}const _=On();return t.jsx("div",{ref:l,className:"buddy","aria-hidden":!0,children:t.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:I,onPointerDown:y,onPointerUp:w,onPointerLeave:w,children:[t.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[t.jsx("defs",{children:t.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[t.jsx("stop",{offset:"0%",stopColor:_.a,stopOpacity:"0.95"}),t.jsx("stop",{offset:"100%",stopColor:_.b,stopOpacity:"0.85"})]})}),t.jsxs("g",{children:[t.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),t.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),t.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),t.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),t.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),t.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),e&&t.jsx("div",{className:"buddy__bubble",role:"status",children:e})]})})}function vs(){const[e,n]=c.useState(()=>{try{return localStorage.getItem("site:closure_notice_v1")!=="1"}catch{return!0}});return c.useEffect(()=>{if(!e)return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=s}},[e]),e?t.jsxs("div",{className:"fixed inset-0 z-[120] flex items-start justify-center p-4",children:[t.jsx("div",{className:"absolute inset-0 bg-black/10 backdrop-blur-[2px]","aria-hidden":!0}),t.jsxs("div",{className:"relative z-10 w-[min(720px,96vw)] rounded-2xl border border-white/10 bg-white/80 p-5 text-zinc-900 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/85 dark:text-zinc-100",children:[t.jsx("div",{className:"mb-2 text-xs uppercase tracking-[0.28em] text-zinc-500 dark:text-zinc-400",children:"Важное объявление"}),t.jsx("h2",{className:"mb-2 text-2xl font-bold",children:"Проект закрыт"}),t.jsx("p",{className:"mb-3 text-sm opacity-90",children:"Разработка и поддержка проекта прекращены. Форум остаётся открытым для всех желающих: можно читать и участвовать в обсуждениях в рамках действующих правил."}),t.jsxs("ul",{className:"mb-4 ml-4 list-disc text-sm opacity-90",children:[t.jsx("li",{children:"Если вы готовы продолжить и дорабатывать форум — напишите Екатерине."}),t.jsx("li",{children:"Автор больше не имеет отношения к проекту; на сайте остаётся только одно упоминание его ника."})]}),t.jsx("div",{className:"flex flex-wrap gap-2",children:t.jsx("button",{type:"button",className:"btn btn-primary",onClick:()=>{try{localStorage.setItem("site:closure_notice_v1","1")}catch{}n(!1)},children:"Понятно"})})]})]}):null}const js=c.lazy(()=>E(()=>import("./GovCheatsheetSky-DrE2v8FX.js"),__vite__mapDeps([0,1,2,3]))),ks=c.lazy(()=>E(()=>import("./WhatsNew-BK_5jbK-.js"),__vite__mapDeps([4,2,1]))),Ss=c.lazy(()=>E(()=>import("./DiffPage-CeOWF2yX.js"),__vite__mapDeps([5,1,2]))),Es=c.lazy(()=>E(()=>import("./LiquidGlassShowcase-DsV5ofTZ.js"),__vite__mapDeps([6,1,2]))),Ns=c.lazy(()=>E(()=>import("./PrintSheet-BVOIg9oe.js"),__vite__mapDeps([7,1,2]))),_s=c.lazy(()=>E(()=>import("./RolePage-Can_doOz.js"),__vite__mapDeps([8,1,3,2,9]))),zs=c.lazy(()=>E(()=>import("./LawPage-BwCfNunZ.js"),__vite__mapDeps([10,1,9,2,11]))),Is=c.lazy(()=>E(()=>import("./VuPage-wYwRsums.js"),__vite__mapDeps([12,1,2]))),Ls=c.lazy(()=>E(()=>import("./HomePage-DejSP9YN.js"),__vite__mapDeps([13,1,2]))),Ps=c.lazy(()=>E(()=>import("./ForumPage-BCoa6OAb.js"),__vite__mapDeps([14,1,15,16,17,2,18]))),$e=c.lazy(()=>E(()=>import("./ProfilePage-BYbZx8m0.js"),__vite__mapDeps([19,1,15,20,2]))),As=c.lazy(()=>E(()=>import("./ForumMembers-BLijhiUl.js"),__vite__mapDeps([21,1,17,16,2,20,15]))),Ms=c.lazy(()=>E(()=>import("./SectionPage-CJ6LzrOy.js"),__vite__mapDeps([22,1,16,17,2,23,11,9]))),Cs=c.lazy(()=>E(()=>import("./TopicPage-DPktsxXy.js"),__vite__mapDeps([24,1,16,23,11,2,25,26]))),Rs=c.lazy(()=>E(()=>import("./TagPage-6CcA4Mq5.js"),__vite__mapDeps([27,1,16,17,2]))),Ts=c.lazy(()=>E(()=>import("./QuestionsPage-Be4MGVVO.js"),__vite__mapDeps([28,1,16,23,11,2,25]))),Os=c.lazy(()=>E(()=>import("./AdminPanel3-CzVF8Lka.js"),__vite__mapDeps([29,1,16,2]))),$s=c.lazy(()=>E(()=>import("./SettingsPage-Bm2krAaV.js"),__vite__mapDeps([30,1,2]))),Ds=c.lazy(()=>E(()=>import("./FavoritesPage-CUVenhP1.js"),__vite__mapDeps([31,1,9,2])));function Bs(){const e=ee();return re.useEffect(()=>{Zn("page_view");try{rs(location.pathname+location.search+location.hash,document.title||void 0)}catch{}(async()=>{try{const n=await Nt();n&&ss(n.id)}catch{}})()},[e.pathname,e.search,e.hash]),null}function Fs(){if((ee().pathname||"").startsWith("/buddy"))return null;try{if(!Rn())return null}catch{}return t.jsx(ws,{})}function Us(){const[e]=de();return t.jsxs("div",{className:"min-h-dvh w-full",children:[e==="liquid"&&t.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[t.jsx("div",{className:"absolute inset-0",style:{background:"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),t.jsx("div",{className:"absolute inset-0",style:{opacity:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),t.jsxs(Tt,{basename:"/pravo/",children:[t.jsx(Hn,{}),t.jsx(us,{}),t.jsx(hs,{}),t.jsx(xs,{}),t.jsx(vs,{}),t.jsx(Fs,{}),t.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:t.jsx(bs,{})}),t.jsx(Bs,{}),t.jsx(c.Suspense,{fallback:t.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:t.jsxs(Ot,{children:[t.jsx(j,{path:"/",element:t.jsx(js,{})}),t.jsx(j,{path:"/home",element:t.jsx(Ls,{})}),t.jsx(j,{path:"/forum/*",element:t.jsx(Ps,{})}),t.jsx(j,{path:"/forum/section/:id",element:t.jsx(Ms,{})}),t.jsx(j,{path:"/forum/topic/:id",element:t.jsx(Cs,{})}),t.jsx(j,{path:"/forum/questions",element:t.jsx(Ts,{})}),t.jsx(j,{path:"/forum/members",element:t.jsx(As,{})}),t.jsx(j,{path:"/forum/profile/:username",element:t.jsx($e,{})}),t.jsx(j,{path:"/u/:username",element:t.jsx($e,{})}),t.jsx(j,{path:"/forum/tag/:tag",element:t.jsx(Rs,{})}),t.jsx(j,{path:"/forum/admin",element:t.jsx(Os,{})}),t.jsx(j,{path:"/whats-new",element:t.jsx(ks,{})}),t.jsx(j,{path:"/diff/:id",element:t.jsx(Ss,{})}),t.jsx(j,{path:"/print",element:t.jsx(Ns,{})}),t.jsx(j,{path:"/roles/:id",element:t.jsx(_s,{})}),t.jsx(j,{path:"/laws/:slug",element:t.jsx(zs,{})}),t.jsx(j,{path:"/vu/:id",element:t.jsx(Is,{})}),t.jsx(j,{path:"/recorders/:id",element:t.jsx(an,{})}),t.jsx(j,{path:"/about",element:t.jsx(cn,{})}),t.jsx(j,{path:"/style/liquid",element:t.jsx(Es,{})}),t.jsx(j,{path:"/settings",element:t.jsx($s,{})}),t.jsx(j,{path:"/favorites",element:t.jsx(Ds,{})}),t.jsx(j,{path:"/forum/feeds",element:t.jsx(Ks,{})})]})})]})]})}const Ks=c.lazy(()=>E(()=>import("./ForumFeedsPage-BHKosiq8.js"),__vite__mapDeps([32,1,17,16,2,18,26])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1760652250628";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(o=>caches.delete(o)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();Yn();Pn();function At(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}At();window.addEventListener("resize",At,{passive:!0});xe.createRoot(document.getElementById("root")).render(t.jsx(c.StrictMode,{children:t.jsx(Us,{})}));export{bn as $,lr as A,dr as B,on as C,Qs as D,sr as E,tr as F,nr as G,Zs as H,er as I,Un as J,xt as K,te as L,xn as M,wn as N,Sn as O,Nn as P,zn as Q,Mn as R,qn as S,ft as T,Ee as U,wt as V,yt as W,An as X,Wn as Y,vt as Z,Ws as _,ln as a,kn as a0,En as a1,yn as a2,_n as a3,Nt as b,ie as c,gr as d,Gs as e,Ys as f,ps as g,ur as h,hr as i,t as j,or as k,Pe as l,mr as m,pr as n,ir as o,fr as p,Hs as q,sn as r,Js as s,Xs as t,de as u,un as v,ns as w,rr as x,ar as y,cr as z};
