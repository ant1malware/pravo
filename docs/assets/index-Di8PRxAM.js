const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-DAY0Z63T.js","assets/react-vendor-DTkXckhQ.js","assets/icons-BBDfh7CG.js","assets/VoteWidget-CmdGcLAb.js","assets/asset-ZvONeEnI.js","assets/WhatsNew-B3ydULsh.js","assets/DiffPage-D7bzyRhG.js","assets/LiquidGlassShowcase-CMEJjNCr.js","assets/PrintSheet-CMAOgAgf.js","assets/RolePage-YPLzx5RS.js","assets/FavStar-Dn4CWxG3.js","assets/LawPage-3TNJzLuY.js","assets/purify.es-DnfDK_hS.js","assets/VuPage-JetOe60n.js","assets/HomePage-BwQjL8iz.js","assets/ForumPage-BGdv3AL1.js","assets/forumRemote-D5s3MT8n.js","assets/ForumSubnav-Bvjb4B_u.js","assets/feedPrefs-C1EDgGZi.js","assets/ForumSearch-BBl5UrbZ.js","assets/socialStore-D4aUy79F.js","assets/ProfilePage-DjRl9fL9.js","assets/forumStore-CdrhNwfx.js","assets/Badge-DCWn8dg7.js","assets/ForumMembers-Cp7cXkfI.js","assets/SectionPage-BGw3O6s4.js","assets/MarkdownEditor-noRoKLgD.js","assets/TopicPage-CG8tEGmY.js","assets/ReactionBar-BaPnDv4k.js","assets/seo-Dt7ixYh-.js","assets/TagPage-USzGlfNW.js","assets/QuestionsPage-Ct7avboQ.js","assets/AdminPanel3-DLH2LH42.js","assets/SettingsPage-CrxRxB58.js","assets/FavoritesPage-Bpkktj32.js","assets/ForumFeedsPage-C-XW2aPC.js"])))=>i.map(i=>d[i]);
import{r as te,a as Nt,u as Et,L as A,R as c,b as X,B as _t,c as zt,d as j}from"./react-vendor-DTkXckhQ.js";import{A as It,E as Pt,I as Ae,C as Lt,Q as Mt,R as At,B as ne,S as he,H as Rt,U as fe,a as xe,X as Re,b as ge,c as be,L as Ce,G as Ct,M as ve,F as Tt,d as Ot,e as $t,f as Dt,g as Bt,h as Ft,i as Kt}from"./icons-BBDfh7CG.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();var Te={exports:{}},ae={};/**
 * @license React
...
`,rn=[{id:"gov",title:"Внутренний устав Правительства",text:sn,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],an=["#bcd3ff","#6a79ff"],on={pal_ocean:["#bcd3ff","#6a79ff"],pal_sunset:["#ffd7a1","#ff6a88"],pal_void:["#a7b0ff","#5a2cff"],pal_blossom:["#ffb3d2","#ff77a9"],pal_midnight:["#2b2d55","#141729"],pal_aurora:["#7de3ff","#8b5cf6"],pal_candy:["#ffe6f3","#ffc8de"],pal_celestial:["#8ad7ff","#b388ff"],pal_softnight:["#1f2448","#513d8a"]};function cn(t){return t?on[t]??null:null}const $e="ui:density",De="ui:font",ln="ui:features",Be="ui:shadow",Fe="ui:radius",Ke="ui:glass",Ve="ui:readw",Ue="ui:anim",qe="buddy:enabled",We="buddy:skin_a",Ye="buddy:skin_b",dn="buddy:save:v1";function R(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function O(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function un(t){document.documentElement.style.setProperty("--density",t==="compact"?"0.85":"1"),O($e,t)}function mn(){return R($e)==="compact"?"compact":"standard"}function pn(t){const n=Math.max(.9,Math.min(1.3,t)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),O(De,String(n))}function hn(){const t=R(De),n=parseFloat(t||"1");return isFinite(n)&&n>.6&&n<2?n:1}function fn(t,n=!0){const s=xn();return t in s?!!s[t]:n}function xn(){try{const t=R(ln);return t?JSON.parse(t):{}}catch{return{}}}function gn(t){let n="none";t==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),t==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),O(Be,t)}function bn(){const t=R(Be);return t==="none"||t==="soft"||t==="strong"?t:"soft"}function yn(t){let n=8,s=16,r=20;t==="subtle"&&(n=6,s=10,r=14),t==="rounded"&&(n=12,s=18,r=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",r+"px"),O(Fe,t)}function wn(){const t=R(Fe);return t==="subtle"||t==="rounded"?t:"standard"}function vn(t){const n=Math.max(0,Math.min(16,Math.round(t)));document.documentElement.style.setProperty("--glass-blur",n+"px"),O(Ke,String(n))}function jn(){const t=R(Ke),n=parseInt(t||"6",10);return isFinite(n)?n:6}function kn(t){const n=Math.max(60,Math.min(96,Math.round(t)));document.documentElement.style.setProperty("--reading-w",n+"ch"),O(Ve,String(n))}function Sn(){const t=R(Ve),n=parseInt(t||"78",10);return isFinite(n)?n:78}function Nn(){try{un(mn()),pn(hn()),gn(bn()),yn(wn()),vn(jn()),kn(Sn()),En(_n())}catch{}}function En(t){document.documentElement.classList.toggle("anim-off",!t),O(Ue,t?"1":"0")}function _n(){try{return R(Ue)!=="0"}catch{return!0}}function zn(t){O(qe,t?"1":"0")}function In(){try{return R(qe)!=="0"}catch{return!0}}function Pn(t,n){const s=/^#?[0-9a-fA-F]{6}$/.test(t)?t.startsWith("#")?t:"#"+t:"#bcd3ff",r=/^#?[0-9a-fA-F]{6}$/.test(n)?n.startsWith("#")?n:"#"+n:"#6a79ff";O(We,s),O(Ye,r)}function Ln(){const t=Mn();let n=R(We),s=R(Ye);if(t){const[o,i]=t;(!n||!s||n.toLowerCase()!==o.toLowerCase()||s.toLowerCase()!==i.toLowerCase())&&(Pn(o,i),n=o,s=i)}const[r,a]=an;return{a:n||r,b:s||a}}function Mn(){var t,n;try{const s=R(dn);if(!s)return null;const r=JSON.parse(s),a=(n=(t=r==null?void 0:r.cosm)==null?void 0:t.equipped)==null?void 0:n.palette,o=cn(typeof a=="string"?a:null);return o||null}catch{return null}}const Ge={midnight:"10 12 24",graphite:"18 20 26",ink:"16 20 38",obsidian:"6 8 16"},P={blur:24,tint:"10 12 24",opacity:.13,gloss:.88,border:.55,glints:!0,interactive:!0,animate:!1,elevation:1,accent:"88 140 255"};function He(...t){return t.filter(Boolean).join(" ")}function Je(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?(s.addEventListener("change",r),()=>s.removeEventListener("change",r)):typeof s.addListener=="function"?(s.addListener(r),()=>s.removeListener(r)):()=>{}},[]),t}function Xe(t,n){c.useEffect(()=>{const s=t.current;if(!s)return;if(!n){s.style.setProperty("--lg-x","72%"),s.style.setProperty("--lg-y","18%");return}let r=0,a=72,o=18;const i=()=>{r=0;const m=t.current;m&&(m.style.setProperty("--lg-x",`${a}%`),m.style.setProperty("--lg-y",`${o}%`))},l=m=>{const g=t.current;if(!g)return;const f=g.getBoundingClientRect(),I=(m.clientX-f.left)/f.width*100,z=(m.clientY-f.top)/f.height*100;a=Math.max(0,Math.min(100,I)),o=Math.max(0,Math.min(100,z)),r||(r=window.requestAnimationFrame(i))},d=()=>{a=72,o=18,r||(r=window.requestAnimationFrame(i))};return s.addEventListener("pointermove",l,{passive:!0}),s.addEventListener("pointerdown",l,{passive:!0}),s.addEventListener("pointerenter",l,{passive:!0}),s.addEventListener("pointerleave",d),()=>{r&&window.cancelAnimationFrame(r),s.removeEventListener("pointermove",l),s.removeEventListener("pointerdown",l),s.removeEventListener("pointerenter",l),s.removeEventListener("pointerleave",d)}},[t,n])}function Ne(t){if(!t)return[255,255,255];const n=t.split(/\s+/).map(s=>Math.max(0,Math.min(255,Number(s))));return[n[0]??255,n[1]??255,n[2]??255]}function ee(t){return`${t[0]} ${t[1]} ${t[2]}`}function ce(t,n,s){return Math.round(t+(n-t)*s)}function Ee(t,n){return[ce(t[0],n>=0?255:0,Math.abs(n)),ce(t[1],n>=0?255:0,Math.abs(n)),ce(t[2],n>=0?255:0,Math.abs(n))]}function An(t,n,s){const r=t?Ge[t]:n??P.tint,a=s??P.accent,o=Ne(r),i=Ne(a),l=Ee(i,.25),d=Ee(i,-.55);return{tintRgb:ee(o),accentRgb:ee(i),accentSoftRgb:ee(l),accentDeepRgb:ee(d)}}function Qe(t,n){const s={...t??{}},{tintRgb:r,accentRgb:a,accentSoftRgb:o,accentDeepRgb:i}=An(n.tone,n.tint,n.accent);return s["--lg-blur"]=`${n.blur}px`,s["--lg-tint"]=r,s["--lg-opacity"]=`${n.opacity}`,s["--lg-gloss"]=`${n.gloss}`,s["--lg-border"]=`${n.border}`,s["--lg-elev"]=`${n.elevation}`,s["--lg-glints"]=n.glints?"1":"0",s["--lg-accent"]=a,s["--lg-accent-soft"]=o,s["--lg-accent-deep"]=i,s}const Ze=c.forwardRef((t,n)=>{const{blur:s=P.blur,tint:r=P.tint,opacity:a=P.opacity,gloss:o=P.gloss,border:i=P.border,glints:l=P.glints,interactive:d=P.interactive,animate:m=P.animate,elevation:g=P.elevation,tone:f,accent:I=P.accent,className:z,style:y,children:w,...S}=t,h=Je(),v=d&&!h,u=c.useRef(null),b=c.useCallback(x=>{u.current=x,typeof n=="function"?n(x):n&&(n.current=x),x&&(x.style.setProperty("--lg-x","72%"),x.style.setProperty("--lg-y","18%"))},[n]);Xe(u,v);const N=c.useMemo(()=>Qe(y,{blur:s,tint:r,opacity:a,gloss:o,border:i,elevation:g,glints:l,tone:f,accent:I}),[y,s,r,a,o,i,g,l,f,I]),p={position:"relative",overflow:"hidden",borderRadius:22,backgroundColor:"rgba(var(--lg-tint), var(--lg-opacity))",backdropFilter:"blur(var(--lg-blur)) saturate(1.15)",WebkitBackdropFilter:"blur(var(--lg-blur)) saturate(1.15)",border:"1px solid rgba(255,255,255,0.12)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.28),
                0 ${18*g}px ${50*g}px rgba(0,0,0,0.45)`,color:"#fff",willChange:"transform"};return e.jsxs("div",{ref:b,className:He("liquid-glass",z),"data-animate":m?"true":"false","data-interactive":v?"true":"false",style:{...p,...N},...S,children:[e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:-2,borderRadius:26,filter:"blur(22px)",opacity:.45,background:"radial-gradient(1200px 320px at 50% -8%, rgba(var(--lg-accent-soft),0.16), transparent 65%),radial-gradient(900px 240px at -10% 20%, rgba(255,255,255,0.06), transparent 70%),radial-gradient(900px 240px at 110% 15%, rgba(255,255,255,0.06), transparent 70%)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"overlay",opacity:"var(--lg-gloss)",background:"linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.00) 42%),conic-gradient(from 248deg at 30% -12%, rgba(var(--lg-accent-soft),0.20), rgba(255,255,255,0.00) 130deg, rgba(var(--lg-accent-soft),0.18) 350deg)",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(130% 150% at 50% 8%, rgba(0,0,0,0.00) 38%, rgba(0,0,0,0.18) 92%)",mixBlendMode:"multiply",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,padding:1,WebkitMask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",mask:"radial-gradient(100% 100% at 50% 50%, transparent 0, #000 1px, #000 calc(100% - 1px), transparent 100%)",background:"linear-gradient(180deg, rgba(var(--lg-accent),0.14), rgba(var(--lg-accent-deep),0.10))",opacity:.65,mixBlendMode:"screen",pointerEvents:"none"}}),l&&e.jsxs("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,mixBlendMode:"screen",opacity:.6,pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:"22%",top:"14%",width:220,height:120,background:"radial-gradient(closest-side, rgba(255,255,255,0.55), rgba(255,255,255,0.0) 70%)",filter:"blur(10px)"}}),e.jsx("div",{style:{position:"absolute",right:"34%",top:"54%",width:160,height:90,background:"radial-gradient(closest-side, rgba(255,255,255,0.40), rgba(255,255,255,0.0) 70%)",filter:"blur(12px)"}})]}),v&&e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,background:"radial-gradient(240px 170px at var(--lg-x) var(--lg-y), rgba(255,255,255,0.22), rgba(255,255,255,0.0) 68%),radial-gradient(360px 240px at var(--lg-x) calc(var(--lg-y) + 12%), rgba(var(--lg-accent-soft),0.12), transparent 70%)",opacity:"calc(var(--lg-gloss) * 0.92)",maskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",WebkitMaskImage:"radial-gradient(280px 210px at var(--lg-x) var(--lg-y), #000, transparent 70%)",mixBlendMode:"soft-light",pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,opacity:.34,backgroundImage:"radial-gradient(rgba(255,255,255,0.065) 1px, transparent 1.25px),linear-gradient(135deg, rgba(255,255,255,0.08), rgba(255,255,255,0.00) 48%),linear-gradient(90deg, rgba(255,255,255,0.035) 1px, transparent 1px)",backgroundSize:"3px 3px, 100% 100%, 6px 100%",mixBlendMode:"overlay",pointerEvents:"none"}}),e.jsx("div",{style:{position:"relative",zIndex:10},children:w}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"inset 0 0 0 1px rgba(255,255,255,0.20)",opacity:i,pointerEvents:"none"}}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,borderRadius:22,boxShadow:"0 1px 0 rgba(255,255,255,0.10) inset",pointerEvents:"none"}})]})});Ze.displayName="LiquidGlass";const et=c.forwardRef((t,n)=>{const{className:s,style:r,children:a,type:o,blur:i,tint:l,opacity:d,gloss:m,border:g,glints:f,interactive:I,animate:z,elevation:y,tone:w,accent:S=P.accent,...h}=t,v=i??P.blur,u=w?Ge[w]:l??P.tint,b=d??.16,N=m??.9,p=g??.6,x=f??!1,W=I??!0,$=y??1,T=Je(),L=W&&!T,M=c.useRef(null),U=c.useCallback(k=>{M.current=k,typeof n=="function"?n(k):n&&(n.current=k),k&&(k.style.setProperty("--lg-x","70%"),k.style.setProperty("--lg-y","16%"))},[n]);Xe(M,L);const C=c.useMemo(()=>Qe(r,{blur:v,tint:u,opacity:b,gloss:N,border:p,glints:x,elevation:$,tone:w,accent:S}),[r,v,u,b,N,p,x,$,w,S]),K={position:"relative",overflow:"hidden",borderRadius:16,backgroundColor:"rgba(var(--lg-tint), calc(var(--lg-opacity) * 0.95))",backdropFilter:"blur(10px) saturate(1.15)",WebkitBackdropFilter:"blur(10px) saturate(1.15)",border:"1px solid rgba(255,255,255,0.14)",boxShadow:`inset 0 1px 0 rgba(255,255,255,0.34),
                0 ${6*$}px ${18*$}px rgba(0,0,0,0.45)`,color:"#fff",padding:"10px 16px",transition:"box-shadow 180ms ease, transform 120ms ease, background-color 180ms ease",WebkitTapHighlightColor:"transparent"};return e.jsxs("button",{ref:U,type:o??"button",className:He("liquid-glass liquid-glass__button",s),style:{...K,...C},...h,onMouseDown:k=>{k.currentTarget.style.transform="scale(0.985)"},onMouseUp:k=>{k.currentTarget.style.transform=""},onMouseLeave:k=>{k.currentTarget.style.transform=""},children:[e.jsxs("span",{style:{position:"absolute",inset:0,borderRadius:16,pointerEvents:"none"},children:[e.jsx("span",{className:"__btnRim",style:{position:"absolute",inset:0,borderRadius:16,opacity:0,boxShadow:"inset 0 0 0 1px rgba(var(--lg-accent),0.38)",transition:"opacity 220ms ease"}}),e.jsx("span",{className:"__btnSheen",style:{position:"absolute",inset:-1,opacity:0,background:"linear-gradient(120deg, transparent 30%, rgba(255,255,255,0.45) 50%, transparent 70%)",transition:"opacity 300ms ease",borderRadius:16}})]}),e.jsx("span",{style:{position:"relative",zIndex:1},children:a}),e.jsx("style",{children:`
      ...
      `})]})});et.displayName="LiquidGlass.Button";const Q=Ze;Q.Button=et;const tt="theme",nt="accent",st="accent_custom",rt="bg",Rn="bg_custom",at="ui:style-mode",le="ui:liquid:prev-theme",ot="ui:liquid:tone";function F(t){try{return typeof window<"u"?window.localStorage.getItem(t):null}catch{return null}}function V(t,n){try{typeof window<"u"&&window.localStorage.setItem(t,n)}catch{}}function Cn(t){try{typeof window<"u"&&window.localStorage.removeItem(t)}catch{}}const it={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var Le,Me;const de=((Me=(Le=import.meta)==null?void 0:Le.env)==null?void 0:Me.BASE_URL)??"/",G=t=>{const n=t.replace(/^\/+/,"");return(de.endsWith("/")?de:de+"/")+n},ct={bg1:G("img/bg1.png"),bg2:G("img/bg2.png"),bg3:G("img/bg3.png"),bg4:G("img/bg4.png"),bg5:G("img/bg5.png")};function lt(){const t=F(tt);return t==="light"||t==="dark"?t:null}function Tn(){const t=F(nt);return t?t==="custom"?"custom":t in it?t:null:null}function On(){return F(st)}function dt(){const t=F(rt);return t&&(t==="none"||t==="custom"||t in ct)?t:null}function $n(){return F(Rn)}function ut(){const t=F(at);return t==="classic"||t==="liquid"?t:null}function Dn(){return(F(ot)||"dark")==="light"?"light":"dark"}function Bn(t){V(ot,t);const n=document.documentElement;if(n.classList.toggle("liquid-light",t==="light"),n.classList.toggle("liquid-dark",t!=="light"),n.classList.contains("theme-liquid"))try{ye(t==="light"?"light":"dark")}catch{}}function mt(t){const n=document.documentElement;if(n.classList.toggle("theme-liquid",t==="liquid"),n.dataset.styleMode=t,t==="liquid"){try{const s=lt()??(pt()?"dark":"light");V(le,s);const r=Dn();Bn(r)}catch{}try{const s=document.body;s.style.removeProperty("background"),s.style.removeProperty("background-size"),s.style.removeProperty("background-repeat"),s.style.removeProperty("background-attachment"),s.style.removeProperty("background-position")}catch{}}else{try{const s=F(le);(s==="light"||s==="dark")&&ye(s),Cn(le)}catch{}try{const s=dt()??"none";ft(s)}catch{}}try{window.dispatchEvent(new CustomEvent("stylemodechange",{detail:t}))}catch{}V(at,t)}function pt(){try{return typeof window<"u"&&!!window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}function ye(t){const n=document.documentElement;t==="dark"?n.classList.add("dark"):n.classList.remove("dark"),V(tt,t);const s=t==="dark"?"#0a0a0a":"#fafafa";let r=document.querySelector('meta[name="theme-color"]');r||(r=document.createElement("meta"),r.name="theme-color",document.head.appendChild(r)),r.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function ht(t){if(t==="custom"){const n=On()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Kn(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=it[t];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}V(nt,t)}function Cs(t){V(st,xt(t)),ht("custom")}function ft(t){const n=document.body,r=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(t==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(t==="custom"){const a=$n();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=ct[t];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=r,n.style.backgroundPosition="center"}V(rt,t)}function Fn(){const n=lt()??(pt()?"dark":"light");ye(n);const s=Tn()??"indigo";ht(s);const r=dt()??"none";ft(r);const a=ut()??"classic";mt(a)}function xt(t){let n=t.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],r=n[2],a=n[3];n=`#${s}${s}${r}${r}${a}${a}`}return n}function Kn(t,n){const s=xt(t).slice(1),r=parseInt(s,16);let a=r>>16&255,o=r>>8&255,i=r&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),o=Math.max(0,Math.min(255,Math.round(o+255*n))),i=Math.max(0,Math.min(255,Math.round(i+255*n)));const l=d=>d.toString(16).padStart(2,"0");return`#${l(a)}${l(o)}${l(i)}`}function _e(){if(typeof document<"u"){const t=document.documentElement.dataset.styleMode;if(t==="classic"||t==="liquid")return t}try{return ut()??"classic"}catch{return"classic"}}function oe(){const[t,n]=c.useState(()=>_e());c.useEffect(()=>{const r=()=>{const i=_e();n(l=>l===i?l:i)},a=i=>{const l=i.detail;l==="classic"||l==="liquid"?n(l):r()};window.addEventListener("stylemodechange",a);const o=new MutationObserver(r);return o.observe(document.documentElement,{attributes:!0,attributeFilter:["data-style-mode"]}),()=>{window.removeEventListener("stylemodechange",a),o.disconnect()}},[]);const s=c.useCallback(r=>{mt(r),n(r)},[]);return[t,s]}function B(t){return`${"/pravo/".replace(/\/$/,"")}${t}`}function Vn(){if(!fn("cmd_palette",!0))return null;const[n]=oe(),[s,r]=c.useState(!1),[a,o]=c.useState(""),[i,l]=c.useState(0),[d,m]=c.useState(()=>localStorage.getItem("cp_filter")||"all");c.useEffect(()=>{try{localStorage.setItem("cp_filter",d)}catch{}},[d]);const[g,f]=c.useState(null);c.useEffect(()=>{(async()=>{try{const N=(await(await E(()=>import("./forumRemote-D5s3MT8n.js"),[])).listSections()).find(p=>String(p.title||"").toLowerCase()==="workshop");f((N==null?void 0:N.id)||null)}catch{}})()},[]);const z=c.useMemo(()=>{const u=[];u.push({kind:"page",id:"forum",title:"�����",subtitle:"���������",url:B("/forum")}),u.push({kind:"page",id:"favorites",title:"���������",subtitle:"��������",url:B("/favorites")}),u.push({kind:"page",id:"settings",title:"���������",subtitle:"��������",url:B("/settings")});for(const p of nn)u.push({kind:"role",id:p.id,title:p.role,subtitle:"������",url:B(`/roles/${p.id}`)});for(const p of Se)u.push({kind:"law",id:p.slug,title:p.title,subtitle:"�����",url:B(`/laws/${p.slug}`)});for(const p of rn)u.push({kind:"vu",id:p.id,title:p.title,subtitle:"��",url:B(`/vu/${p.id}`)});const b=a.trim().toLowerCase();return b&&u.push(...w(b).slice(0,60)),b?(d==="all"?u:u.filter(p=>p.kind===d)).map(p=>({r:p,score:y(`${p.title} ${p.subtitle||""}`.toLowerCase(),b)+(p.__boost||0)})).filter(p=>p.score>0).sort((p,x)=>x.score-p.score).slice(0,30).map(p=>p.r):u.slice(0,20)},[a,d]);function y(u,b){return b.split(/\s+/).filter(Boolean).reduce((p,x)=>p+(u.includes(x)?1:0),0)}function w(u){const b=[],N=x=>x.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);for(const x of Se){const $=(x.content||"").replace(/\r\n?/g,`
`).split(`
`);let T="",L="";const M=new Set;for(const U of $){const C=U.trim(),K=/^(#{2,6})\s*(.+)$/.exec(C);if(K){T=K[2].trim(),L=N(T)||"";const k=T.toLowerCase();if(L&&k.includes(u)){const Y=`${x.slug}#${L}`;if(!M.has(Y)){const Z={kind:"law",id:Y,title:`${x.title} � ${T}`,subtitle:"���������",url:B(`/laws/${x.slug}?q=${encodeURIComponent(u)}#${L}`)};Z.__boost=k.startsWith(u)?8:6,b.push(Z),M.add(Y)}}continue}if(C&&C.toLowerCase().includes(u)){const k=L?`${x.slug}#${L}`:x.slug;if(!M.has(k)){const Y=C.length>140?C.slice(0,137)+"�":C,Z=L?`${x.title} � ${T}`:x.title,St=B(L?`/laws/${x.slug}?q=${encodeURIComponent(u)}#${L}`:`/laws/${x.slug}?q=${encodeURIComponent(u)}`),we={kind:"law",id:k,title:Z,subtitle:Y||"��������",url:St};we.__boost=5,b.push(we),M.add(k)}}}}const p=new Set;return b.filter(x=>p.has(x.id)?!1:(p.add(x.id),!0))}function S(u){r(!1);try{window.location.href=u}catch{location.assign(u)}}function h(u){z.length&&(u.key==="ArrowDown"&&(u.preventDefault(),l(b=>Math.min(b+1,z.length-1))),u.key==="ArrowUp"&&(u.preventDefault(),l(b=>Math.max(b-1,0))),u.key==="Enter"&&(u.preventDefault(),S(z[i].url)))}const v=({children:u})=>n==="liquid"?e.jsx(Q,{className:"w-full max-w-2xl p-3 text-white",blur:26,tint:"16 18 34",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,children:u}):e.jsx("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:u});return e.jsx(e.Fragment,{children:s?e.jsx("div",{className:"fixed inset-0 z-[70] flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"�����",children:e.jsxs(v,{children:[e.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[e.jsx(xe,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),e.jsx("input",{autoFocus:!0,value:a,onChange:u=>{o(u.target.value),l(0)},onKeyDown:h,placeholder:"�����: �����, ����, ��...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),e.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>r(!1),"aria-label":"�������",children:e.jsx(Re,{className:"h-4 w-4"})})]}),e.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"���"},{k:"role",label:"����"},{k:"law",label:"������"},{k:"vu",label:"��"}].map(u=>e.jsx("button",{onClick:()=>{m(u.k),l(0)},className:`chip ${d===u.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:u.label},u.k))}),e.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!z.length&&e.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"������ �� �������"}),z.map((u,b)=>e.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${b===i?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>l(b),onClick:()=>S(u.url),children:[e.jsxs("span",{className:"inline-flex items-center gap-2",children:[u.kind==="law"&&e.jsx(ne,{className:"h-4 w-4"}),u.kind==="role"&&e.jsx(fe,{className:"h-4 w-4"}),u.kind==="vu"&&e.jsx(he,{className:"h-4 w-4"}),u.kind==="page"&&(u.id==="settings"?e.jsx(ge,{className:"h-4 w-4"}):e.jsx(be,{className:"h-4 w-4"})),e.jsx("span",{className:"font-medium",children:u.title})]}),u.subtitle&&e.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:u.subtitle})]},`${u.kind}:${u.id}`))]})]})}):null})}const Un="https://notifications-worker.wizardiowhy.workers.dev/skyapi";function qn(){try{const t="anon_uid";let n=localStorage.getItem(t);return n||(n=crypto.randomUUID(),localStorage.setItem(t,n)),n}catch{return"na"}}function Wn(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:qn()}}function Yn(t,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:t,...Wn(),data:n}),r=`${Un}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(r,a))return}catch{}try{fetch(r,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}function Gn(){try{const n=new URL(window.location.href),s=n.searchParams.get("api");if(s){localStorage.setItem("forum:api_base",s);try{n.searchParams.delete("api"),history.replaceState({},"",n.toString())}catch{}}const r=localStorage.getItem("forum:api_base");if(r)return r}catch{}return"https://notifications-worker.wizardiowhy.workers.dev/skyapi"}const Hn=Gn(),J="forum:token",se="forum:session";function gt(t,n=!0){(n?localStorage:sessionStorage).setItem(J,t)}function bt(){return localStorage.getItem(J)??sessionStorage.getItem(J)}function Jn(){try{localStorage.removeItem(J),sessionStorage.removeItem(J),localStorage.removeItem(se),sessionStorage.removeItem(se)}finally{window.dispatchEvent(new Event("forum:session"))}}async function _(t,n={}){const s=bt(),r={"Content-Type":"application/json",...n.headers||{}};s&&(r.Authorization=`Bearer ${s}`);const a=await fetch(`${Hn}${t}`,{...n,headers:r}),o=await a.text();let i={};try{i=o?JSON.parse(o):{}}catch{i={error:o||a.statusText}}if(!a.ok)throw new Error((i==null?void 0:i.error)||`${a.status} ${a.statusText}`);return i}async function Ts(t){const n=JSON.stringify({username:t.username,email:t.email,password:t.password||"1234",inviteCode:t.inviteCode||"",captchaToken:t.captchaToken||void 0}),{token:s,user:r}=await _("/register",{method:"POST",body:n});gt(s,t.remember!==!1);const a={userId:r.id,remember:t.remember!==!1,lastLogin:new Date().toISOString()};return localStorage.setItem(se,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session")),r}async function Os(t){const n=JSON.stringify({usernameOrEmail:t.usernameOrEmail,password:t.password||"1234",otp:t.otp||void 0,captchaToken:t.captchaToken||void 0}),{token:s,user:r}=await _("/login",{method:"POST",body:n});gt(s,t.remember!==!1);const a={userId:r.id,remember:t.remember!==!1,lastLogin:new Date().toISOString()};return localStorage.setItem(se,JSON.stringify(a)),window.dispatchEvent(new Event("forum:session")),r}async function Xn(){if(!bt())return null;try{const{user:n}=await _("/me");return n}catch{return Jn(),null}}async function $s(){const{users:t}=await _("/users");return t}async function Ds(t,n){const{user:s}=await _(`/users/${t}/role`,{method:"PATCH",body:JSON.stringify({role:n})});return s}async function Bs(){const{invites:t}=await _("/invites");return t}async function Fs(t=5,n){const{invites:s}=await _("/invites",{method:"POST",body:JSON.stringify({count:t,note:n})});return s}async function Ks(t,n){const s=JSON.stringify(n?{until:n}:{days:7}),{user:r}=await _("/users/"+encodeURIComponent(t)+"/ban",{method:"POST",body:s});return r}async function Vs(t){const{user:n}=await _("/users/"+encodeURIComponent(t)+"/unban",{method:"POST"});return n}async function Us(t,n){const s=JSON.stringify(n?{until:n}:{minutes:60}),{user:r}=await _("/users/"+encodeURIComponent(t)+"/mute",{method:"POST",body:s});return r}async function qs(t){const{user:n}=await _("/users/"+encodeURIComponent(t)+"/unmute",{method:"POST"});return n}async function Ws(t){await _(`/invites/${encodeURIComponent(t)}`,{method:"DELETE"})}async function Ys(){const{settings:t}=await _("/settings");return t}async function Gs(t){const{settings:n}=await _("/settings",{method:"PATCH",body:JSON.stringify(t)});return n}async function Hs(t){try{const n=await _(`/profiles/by-username/${encodeURIComponent(t)}`);return{user:n.user,profile:n.profile||null,stats:n.stats||null}}catch{return null}}async function Js(t){const{profile:n}=await _("/profiles/me",{method:"PATCH",body:JSON.stringify(t)});return n}async function Xs(t){try{const{profile:n}=await _(`/profiles/${encodeURIComponent(t)}`);return n}catch{return null}}async function Qs(t,n){const s={labels:Array.isArray(n)?n:[]},{profile:r}=await _(`/profiles/${encodeURIComponent(t)}/labels`,{method:"PATCH",body:JSON.stringify(s)});return r}async function Zs(t,n=30){const{user:s}=await _(`/users/${encodeURIComponent(t)}/vip`,{method:"POST",body:JSON.stringify({days:n})});return s}async function er(t){const{user:n}=await _(`/users/${encodeURIComponent(t)}/unvip`,{method:"POST"});return n}async function tr(){const{members:t}=await _("/members");return t}const yt="forum:lastActive:";function Qn(t){try{localStorage.setItem(yt+t,new Date().toISOString())}catch{}}function nr(t){try{return localStorage.getItem(yt+t)}catch{return null}}function sr(t){if(!t)return"";const n=new Date(t);if(Number.isNaN(n.getTime()))return"";try{const s=new Intl.RelativeTimeFormat("ru",{numeric:"auto"}),r=n.getTime()-Date.now(),a=1e3,o=60*a,i=60*o,l=24*i,d=30*l,m=365*l;return Math.abs(r)<o?s.format(Math.round(r/a),"second"):Math.abs(r)<i?s.format(Math.round(r/o),"minute"):Math.abs(r)<l?s.format(Math.round(r/i),"hour"):Math.abs(r)<d?s.format(Math.round(r/l),"day"):Math.abs(r)<m?s.format(Math.round(r/d),"month"):s.format(Math.round(r/m),"year")}catch{return n.toLocaleString()}}const ze="recent:items";function Zn(t,n){try{const s=localStorage.getItem(ze),r=s?JSON.parse(s):[],a={url:t,title:n,ts:Date.now()};if(r.length&&r[0].url===t)return;const o=r.filter(d=>d.url!==t);o.unshift(a);const i=[],l=new Set;for(const d of o)l.has(d.url)||(l.add(d.url),i.push(d));for(;i.length>15;)i.pop();localStorage.setItem(ze,JSON.stringify(i))}catch{}}const re="forum:session";function rr(){try{const t=sessionStorage.getItem(re)??localStorage.getItem(re);return t?JSON.parse(t):null}catch{return null}}function ar(t){try{window.dispatchEvent(new Event("forum:session"))}catch{}}function wt(){const t=()=>{try{const r=sessionStorage.getItem(re)??localStorage.getItem(re);return r?JSON.parse(r):null}catch{return null}},[n,s]=te.useState(t());return te.useEffect(()=>{const r=()=>s(t());return window.addEventListener("storage",r),window.addEventListener("forum:session",r),window.addEventListener("forum:changed",r),()=>{window.removeEventListener("storage",r),window.removeEventListener("forum:session",r),window.removeEventListener("forum:changed",r)}},[]),n}const vt=[{key:"forum",type:"route",label:"Форум",icon:e.jsx(ve,{className:"h-4 w-4"}),to:"/forum"},{key:"roles",type:"tab",label:"Повышения",icon:e.jsx(fe,{className:"h-4 w-4"}),id:"roles"},{key:"templates",type:"tab",label:"Шаблоны",icon:e.jsx(Tt,{className:"h-4 w-4"}),id:"templates"},{key:"posts",type:"tab",label:"Посты",icon:e.jsx(Ot,{className:"h-4 w-4"}),id:"posts"},{key:"procedures",type:"tab",label:"Процедуры",icon:e.jsx($t,{className:"h-4 w-4"}),id:"procedures"},{key:"interactions",type:"tab",label:"Взаимодействия",icon:e.jsx(ve,{className:"h-4 w-4"}),id:"interactions"},{key:"checks",type:"tab",label:"Проверки",icon:e.jsx(Dt,{className:"h-4 w-4"}),id:"checks"},{key:"lectures",type:"tab",label:"Лекции",icon:e.jsx(ne,{className:"h-4 w-4"}),id:"lectures"},{key:"vu",type:"tab",label:"ВУ",icon:e.jsx(he,{className:"h-4 w-4"}),id:"vu"},{key:"laws",type:"tab",label:"Законы",icon:e.jsx(ne,{className:"h-4 w-4"}),id:"laws"}];function es(){const[t,n]=c.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=X(),[r]=oe(),o=!wt(),i=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),l=c.useMemo(()=>{const v=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),u=(s.hash||"").replace(/^#/,"").toLowerCase();return v||u||""},[s.search,s.hash]),d=c.useCallback(h=>l===h,[l]);c.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&t){const v=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=v}}},[t]),c.useEffect(()=>{function h(){typeof window>"u"||n(window.innerWidth>=1024)}return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),c.useEffect(()=>{const h=document.documentElement;t?h.classList.add("has-sidebar"):h.classList.remove("has-sidebar")},[t]);const m=c.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[]),g=m?"⌘ K":"Ctrl K",f=r==="liquid"?"glass-nav-link flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40":"flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-400 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",I=r==="liquid"?"glass-nav-link--active":"bg-zinc-100 dark:bg-zinc-800",z=r==="liquid"?"mt-4 rounded-2xl border border-white/10 bg-white/8 p-2 text-xs text-white/70 shadow-[0_24px_60px_-45px_rgba(80,120,255,0.65)] backdrop-blur":"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",y=r==="liquid"?"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[260px] px-3 py-5 text-sm text-white overscroll-contain":"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",w=h=>{const v=`?tab=${encodeURIComponent(h)}`;return i?{pathname:"/",search:v}:{pathname:"/",search:v,hash:`#${h}`}},S=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb-4 flex items-center justify-start",children:e.jsx(A,{to:"/forum",className:"text-sm font-semibold tracking-tight text-[color:var(--text-1)] no-underline focus:outline-none focus:ring-2 focus:ring-[color:var(--accent-600)]/60 hover:opacity-90","aria-label":"Справочник SKY",children:"Справочник SKY"})}),e.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-160px)] gap-1 overflow-y-auto pr-1",children:e.jsxs("ul",{className:"flex flex-col gap-1",children:[vt.map(h=>{const v=h.type==="route"?s.pathname===h.to:d(h.id),u=h.type==="route"?h.to:w(h.id);return e.jsx("li",{children:e.jsxs(A,{to:u,className:[f,v?I:""].filter(Boolean).join(" "),"aria-current":v?"page":void 0,"aria-label":h.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[h.icon,e.jsx("span",{className:"truncate",children:h.label}),h.key==="forum"&&o&&e.jsx(Ce,{className:"h-3.5 w-3.5 text-amber-400","aria-hidden":!0})]})},h.key)}),e.jsx("li",{children:e.jsxs(A,{to:"/about",className:f,"aria-label":"О нас",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Ae,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"О нас"})]})}),e.jsx("li",{children:e.jsxs(A,{to:"/buddy",className:f,"aria-label":"Чебзик",onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[e.jsx(Ct,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:"Чебзик"})]})})]})}),e.jsxs("div",{className:z,children:["Подсказка: нажмите ",e.jsx("kbd",{className:"inline-block rounded border border-white/30 bg-white/10 px-1",children:g}),", чтобы открыть быстрый поиск"]})]});return e.jsxs(e.Fragment,{children:[e.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(h=>!h),"aria-label":"Меню","aria-expanded":t,"aria-controls":"app-sidebar",children:"Меню"}),e.jsx("aside",{id:"app-sidebar","aria-label":"Боковая панель",className:y,children:r==="liquid"?e.jsx(Q,{className:"flex h-full flex-col gap-4 p-4 text-white/90",blur:28,tint:"16 18 36",opacity:.24,gloss:.7,elevation:1.2,interactive:!1,animate:!0,children:S}):S})]})}const ts={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},jt={entities:ts};function ns(t){var s;return((s=jt.entities)==null?void 0:s[t])||null}function or(t,n=30){const s=ns(t);if(!(s!=null&&s.updated_at))return{recent:!1};const r=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-r.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function ir(t,n){const s=t.split(/\r?\n/),r=n.split(/\r?\n/),a=s.length,o=r.length,i=Array.from({length:a+1},()=>Array(o+1).fill(0));for(let g=a-1;g>=0;g--)for(let f=o-1;f>=0;f--)i[g][f]=s[g]===r[f]?i[g+1][f+1]+1:Math.max(i[g+1][f],i[g][f+1]);const l=[];let d=0,m=0;for(;d<a&&m<o;)s[d]===r[m]?(l.push(H(s[d])),d++,m++):i[d+1][m]>=i[d][m+1]?(l.push(`<del>${H(s[d])}</del>`),d++):(l.push(`<ins>${H(r[m])}</ins>`),m++);for(;d<a;)l.push(`<del>${H(s[d++])}</del>`);for(;m<o;)l.push(`<ins>${H(r[m++])}</ins>`);return l.join(`
`)}function H(t){return t.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function ss(){var s;const t=[],n=jt.entities||{};for(const[r,a]of Object.entries(n)){const o=(s=a.changelog)==null?void 0:s[0];o&&t.push({id:r,version:o.version,date:o.date,summary:o.summary,details:o.details})}return t.sort((r,a)=>r.date<a.date?1:-1),t}function rs(){const[t]=oe(),n=X(),s=c.useMemo(()=>{try{const l=ss()[0];if(!l)return!1;const d=new Date(l.date+"T00:00:00Z");return(Date.now()-d.getTime())/(1e3*60*60*24)<=14}catch{return!1}},[]);function r(){const l=window.openCommandPalette;if(typeof l=="function")try{l();return}catch{}const d=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!d,metaKey:d}))}const a="global-topbar__inner mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",o=t==="liquid"?"global-topbar-shell sticky top-0 z-50 border-transparent bg-transparent px-2 sm:px-4":"global-topbar-shell sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",i=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[e.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var l;return(l=window.openMobileMenu)==null?void 0:l.call(window)},"aria-label":"Меню",children:e.jsx(Bt,{className:"h-4 w-4"})}),e.jsx(Ft,{className:"h-6 w-6 shrink-0"}),e.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),e.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:r,"aria-label":"Поиск",children:[e.jsx(xe,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),e.jsxs(A,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[e.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),s&&e.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),e.jsxs(A,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[e.jsx(be,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),e.jsxs(A,{to:"/settings",className:"btn","aria-label":"Настройки",children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]})]})]});return n.pathname.startsWith("/forum")?null:e.jsx("div",{className:o,children:t==="liquid"?e.jsx(Q,{className:`${a} global-topbar__glass`,blur:26,tint:"16 18 34",opacity:.24,gloss:.65,elevation:1.2,interactive:!1,animate:!0,children:i}):e.jsx("div",{className:a,children:i})})}const as="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",ue="notif:lastSeen",Ie="notifications-panel";function os(){const[t,n]=c.useState(!1),[s,r]=c.useState([]),[a,o]=c.useState(0),[i,l]=c.useState(!1),[d,m]=c.useState(null),g=c.useRef(null),f=c.useCallback(async()=>{const y=new AbortController;l(!0),m(null);try{const w=await fetch(as,{cache:"no-store",signal:y.signal});if(!w.ok)throw new Error(`HTTP ${w.status}`);const S=await w.json(),h=Array.isArray(S)?S:S.items||[],v=p=>p?new Date(p).getTime():0;h.sort((p,x)=>v(x.date)-v(p.date)),r(h);const u=typeof localStorage<"u"&&localStorage.getItem(ue)||"",b=u?h.findIndex(p=>p.id===u):-1,N=b===-1?h.length:b;o(Math.max(0,N))}catch(w){(w==null?void 0:w.name)!=="AbortError"&&m("Не удалось загрузить уведомления")}finally{l(!1)}return()=>y.abort()},[]);c.useEffect(()=>{f()},[f]),c.useEffect(()=>{if(t&&s.length)try{localStorage.setItem(ue,s[0].id),o(0)}catch{}},[t,s]),c.useEffect(()=>{if(!t)return;const y=S=>{g.current&&(g.current.contains(S.target)||n(!1))},w=S=>{S.key==="Escape"&&n(!1)};return document.addEventListener("mousedown",y),document.addEventListener("keydown",w),()=>{document.removeEventListener("mousedown",y),document.removeEventListener("keydown",w)}},[t]);const I=()=>n(y=>!y),z=y=>y?new Date(y).toLocaleString(void 0,{dateStyle:"short",timeStyle:"short"}):"";return e.jsxs("div",{ref:g,className:"relative",children:[e.jsxs("button",{type:"button",className:"btn btn-secondary relative",onClick:I,"aria-label":"Уведомления","aria-haspopup":"dialog","aria-expanded":t,"aria-controls":Ie,children:[e.jsx(Kt,{className:"h-4 w-4"}),a>0&&e.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),t&&e.jsxs(Q,{id:Ie,className:"absolute right-0 mt-2 w-80 p-2 text-sm z-[80]",blur:22,tint:"16 18 36",opacity:.22,gloss:.7,elevation:1.1,interactive:!1,animate:!0,role:"dialog","aria-label":"Список уведомлений",children:[e.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),i?e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Загрузка…"}):d?e.jsx("div",{className:"px-2 py-3 text-xs text-red-500",children:d}):s.length?e.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(y=>e.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:e.jsxs("a",{className:"block focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-md",href:y.url||"#",target:y.url?"_blank":void 0,rel:y.url?"noreferrer":void 0,onClick:()=>{var w;try{(w=s[0])!=null&&w.id&&localStorage.setItem(ue,s[0].id),o(0)}catch{}},children:[y.title&&e.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:y.title}),e.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:y.text}),y.date&&e.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:z(y.date)})]})},y.id))}):e.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function is(){const[t,n]=c.useState(!1),s=X(),a=!wt();c.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),c.useEffect(()=>{if(!t)return;const d=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=d}},[t]);const o=c.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),i=d=>{const m=new URLSearchParams(s.search||"");m.set("tab",d);const g=`?${m.toString()}`;return o?{pathname:"/",search:g}:{pathname:"/",search:g,hash:`#${d}`}};function l(){const d=window.openCommandPalette;if(typeof d=="function")try{d()}catch{}n(!1)}return t?e.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),e.jsxs("div",{className:"mobile-menu-panel absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[e.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[e.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"РџРѕРёСЃРє",children:[e.jsx(xe,{className:"h-4 w-4"})," ",e.jsx("span",{children:"РџРѕРёСЃРє"})]}),e.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"РњРµРЅСЋ"}),e.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Р—Р°РєСЂС‹С‚СЊ",children:e.jsx(Re,{className:"h-4 w-4"})})]}),e.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[e.jsx("ul",{className:"grid gap-2",children:vt.map(d=>{const m=d.type==="route"?d.to:i(d.id);return e.jsx("li",{children:e.jsxs(A,{to:m,className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[d.icon,e.jsx("span",{className:"truncate",children:d.label}),d.key==="forum"&&a&&e.jsx(Ce,{className:"h-4 w-4 text-amber-400","aria-hidden":!0})]})},d.key)})}),e.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[e.jsxs(A,{to:"/favorites",className:"btn btn-secondary",children:[e.jsx(be,{className:"h-4 w-4"})," РР·Р±СЂР°РЅРЅРѕРµ"]}),e.jsxs(A,{to:"/settings",className:"btn btn-secondary",children:[e.jsx(ge,{className:"h-4 w-4"})," РќР°СЃС‚СЂРѕР№РєРё"]})]})]})]})]}):null}const me=["Я здесь! 👻","Как дела? ✨","Нажми Ctrl K — откроется поиск!","Люблю стекло и печеньки 🍪","Сегодня отличный день!","Хочешь поиграть? → вкладка Чебзик","Сияю и не мешаю ✨","Кликни ещё!","Я ❤️ Катю"];function cs(){const[t,n]=c.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches);return c.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const s=window.matchMedia("(prefers-reduced-motion: reduce)"),r=a=>n(a.matches);return n(s.matches),typeof s.addEventListener=="function"?s.addEventListener("change",r):s.addListener&&s.addListener(r),()=>{typeof s.removeEventListener=="function"?s.removeEventListener("change",r):s.removeListener&&s.removeListener(r)}},[]),t}function ls(){const[t,n]=c.useState(null),[s,r]=c.useState(!0),a=c.useRef(Math.floor(Math.random()*me.length));if(typeof window<"u"&&window.matchMedia&&window.matchMedia("print").matches||!s)return null;const o=cs(),i=typeof document<"u"&&document.documentElement.classList.contains("anim-off"),l=!o&&!i,d=c.useRef(null),m=c.useRef(null),g=c.useRef(!1);c.useEffect(()=>{const h=d.current;if(!h)return;let v=0,u=performance.now(),b=Math.random()*(window.innerWidth-64)+16,N=Math.random()*(window.innerHeight-120)+60,p=(Math.random()*60+30)*(Math.random()>.5?1:-1),x=(Math.random()*40+20)*(Math.random()>.5?1:-1);const W=T=>{const L=Math.min(.05,(T-u)/1e3);if(u=T,l){b+=p*L,N+=x*L;const M=16,U=window.innerWidth,C=window.innerHeight,K=48,k=48;b<M&&(b=M,p=Math.abs(p)),b>U-K-M&&(b=U-K-M,p=-Math.abs(p)),N<60&&(N=60,x=Math.abs(x)),N>C-k-M&&(N=C-k-M,x=-Math.abs(x)),p+=(Math.random()-.5)*4,x+=(Math.random()-.5)*4}h.style.transform=`translate3d(${Math.round(b)}px, ${Math.round(N)}px, 0)`,v=requestAnimationFrame(W)};v=requestAnimationFrame(W);const $=()=>{u=performance.now()};return window.addEventListener("resize",$),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",$)}},[l]),c.useEffect(()=>()=>{m.current&&window.clearTimeout(m.current)},[]);function f(h){const v=h??me[a.current++%me.length];n(v),window.clearTimeout(f._t),f._t=window.setTimeout(()=>n(null),3e3)}function I(h){if(g.current){g.current=!1,h.preventDefault();return}if(h.altKey){h.preventDefault(),z();return}f()}function z(){g.current=!0,n(null),r(!1);try{zn(!1)}catch{}}function y(h){m.current&&window.clearTimeout(m.current),!h.altKey&&(m.current=window.setTimeout(()=>{z(),m.current=null},650))}function w(){m.current&&(window.clearTimeout(m.current),m.current=null,g.current=!1)}const S=Ln();return e.jsx("div",{ref:d,className:"buddy","aria-hidden":!0,children:e.jsxs("button",{className:"buddy__hit",title:"Чебзик (клик — сказать, Alt+клик или удержание — скрыть)",onClick:I,onPointerDown:y,onPointerUp:w,onPointerLeave:w,children:[e.jsxs("svg",{width:"36",height:"36",viewBox:"0 0 36 36",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("defs",{children:e.jsxs("radialGradient",{id:"g",cx:"50%",cy:"30%",r:"70%",children:[e.jsx("stop",{offset:"0%",stopColor:S.a,stopOpacity:"0.95"}),e.jsx("stop",{offset:"100%",stopColor:S.b,stopOpacity:"0.85"})]})}),e.jsxs("g",{children:[e.jsx("path",{d:"M18 2c6.2 0 11 4.8 11 11v8.5c0 2-1.7 3.7-3.7 3.7-1.3 0-2.6-.7-3.3-1.8-.6 1.1-1.8 1.8-3 1.8s-2.4-.7-3-1.8c-.7 1.1-2 1.8-3.3 1.8-2 0-3.7-1.7-3.7-3.7V13C5 6.8 10 2 16.2 2H18z",fill:"url(#g)"}),e.jsx("circle",{cx:"13.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"22.5",cy:"13.5",r:"2.2",fill:"#0b1020"}),e.jsx("circle",{cx:"13",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("circle",{cx:"22",cy:"13.2",r:".7",fill:"#fff"}),e.jsx("path",{d:"M12 19c1.8 2.2 6.2 2.2 8 0",stroke:"#0b1020",strokeWidth:"1.3",strokeLinecap:"round",fill:"none"})]})]}),t&&e.jsx("div",{className:"buddy__bubble",role:"status",children:t})]})})}function ds(){const[t,n]=c.useState(()=>{try{return localStorage.getItem("site:closure_notice_v1")!=="1"}catch{return!0}});return c.useEffect(()=>{if(!t)return;const s=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=s}},[t]),t?e.jsxs("div",{className:"fixed inset-0 z-[120] flex items-start justify-center p-4",children:[e.jsx("div",{className:"absolute inset-0 bg-black/10 backdrop-blur-[2px]","aria-hidden":!0}),e.jsxs("div",{className:"relative z-10 w-[min(720px,96vw)] rounded-2xl border border-white/10 bg-white/80 p-5 text-zinc-900 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/85 dark:text-zinc-100",children:[e.jsx("div",{className:"mb-2 text-xs uppercase tracking-[0.28em] text-zinc-500 dark:text-zinc-400",children:"Важное объявление"}),e.jsx("h2",{className:"mb-2 text-2xl font-bold",children:"Проект закрыт"}),e.jsx("p",{className:"mb-3 text-sm opacity-90",children:"Разработка и поддержка проекта прекращены. Форум остаётся открытым для всех желающих: можно читать и участвовать в обсуждениях в рамках действующих правил."}),e.jsxs("ul",{className:"mb-4 ml-4 list-disc text-sm opacity-90",children:[e.jsx("li",{children:"Если вы готовы продолжить и дорабатывать форум — напишите Екатерине."}),e.jsx("li",{children:"Автор больше не имеет отношения к проекту; на сайте остаётся только одно упоминание его ника."})]}),e.jsx("div",{className:"flex flex-wrap gap-2",children:e.jsx("button",{type:"button",className:"btn btn-primary",onClick:()=>{try{localStorage.setItem("site:closure_notice_v1","1")}catch{}n(!1)},children:"Понятно"})})]})]}):null}const us=c.lazy(()=>E(()=>import("./GovCheatsheetSky-DAY0Z63T.js"),__vite__mapDeps([0,1,2,3,4]))),ms=c.lazy(()=>E(()=>import("./WhatsNew-B3ydULsh.js"),__vite__mapDeps([5,1,2]))),ps=c.lazy(()=>E(()=>import("./DiffPage-D7bzyRhG.js"),__vite__mapDeps([6,1,2]))),hs=c.lazy(()=>E(()=>import("./LiquidGlassShowcase-CMEJjNCr.js"),__vite__mapDeps([7,1,2]))),fs=c.lazy(()=>E(()=>import("./PrintSheet-CMAOgAgf.js"),__vite__mapDeps([8,1,2]))),xs=c.lazy(()=>E(()=>import("./RolePage-YPLzx5RS.js"),__vite__mapDeps([9,1,3,2,10]))),gs=c.lazy(()=>E(()=>import("./LawPage-3TNJzLuY.js"),__vite__mapDeps([11,1,10,2,12]))),bs=c.lazy(()=>E(()=>import("./VuPage-JetOe60n.js"),__vite__mapDeps([13,1,2]))),ys=c.lazy(()=>E(()=>import("./HomePage-BwQjL8iz.js"),__vite__mapDeps([14,1,2]))),ws=c.lazy(()=>E(()=>import("./ForumPage-BGdv3AL1.js"),__vite__mapDeps([15,1,16,17,18,2,19,20]))),Pe=c.lazy(()=>E(()=>import("./ProfilePage-DjRl9fL9.js"),__vite__mapDeps([21,1,22,20,23,2]))),vs=c.lazy(()=>E(()=>import("./ForumMembers-Cp7cXkfI.js"),__vite__mapDeps([24,1,17,16,18,2,23,22]))),js=c.lazy(()=>E(()=>import("./SectionPage-BGw3O6s4.js"),__vite__mapDeps([25,1,16,17,18,2,26,12,10]))),ks=c.lazy(()=>E(()=>import("./TopicPage-CG8tEGmY.js"),__vite__mapDeps([27,1,16,26,12,2,28,29]))),Ss=c.lazy(()=>E(()=>import("./TagPage-USzGlfNW.js"),__vite__mapDeps([30,1,16,17,18,2]))),Ns=c.lazy(()=>E(()=>import("./QuestionsPage-Ct7avboQ.js"),__vite__mapDeps([31,1,16,26,12,2,28]))),Es=c.lazy(()=>E(()=>import("./AdminPanel3-DLH2LH42.js"),__vite__mapDeps([32,1,22,16,2]))),_s=c.lazy(()=>E(()=>import("./SettingsPage-CrxRxB58.js"),__vite__mapDeps([33,1,4,18,2]))),zs=c.lazy(()=>E(()=>import("./FavoritesPage-Bpkktj32.js"),__vite__mapDeps([34,1,10,2])));function Is(){const t=X();return te.useEffect(()=>{Yn("page_view");try{Zn(location.pathname+location.search+location.hash,document.title||void 0)}catch{}(async()=>{try{const n=await Xn();n&&Qn(n.id)}catch{}})()},[t.pathname,t.search,t.hash]),null}function Ps(){if((X().pathname||"").startsWith("/buddy"))return null;try{if(!In())return null}catch{}return e.jsx(ls,{})}function Ls(){const[t]=oe();return e.jsxs("div",{className:"min-h-dvh w-full",children:[t==="liquid"&&e.jsxs("div",{className:"pointer-events-none fixed inset-0 -z-10","aria-hidden":!0,children:[e.jsx("div",{className:"absolute inset-0",style:{background:"radial-gradient(800px 540px at 8% 0%, rgba(90,110,180,.10), transparent 60%),radial-gradient(900px 560px at 85% 10%, rgba(160,110,200,.08), transparent 65%),linear-gradient(180deg, rgba(0,0,0,.60), rgba(0,0,0,.88))"}}),e.jsx("div",{className:"absolute inset-0",style:{opacity:.015,backgroundSize:"32px 32px",backgroundImage:"linear-gradient(to right, rgba(255,255,255,.7) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,.7) 1px, transparent 1px)"}})]}),e.jsxs(_t,{basename:"/pravo/",children:[e.jsx(Vn,{}),e.jsx(es,{}),e.jsx(rs,{}),e.jsx(is,{}),e.jsx(ds,{}),e.jsx(Ps,{}),e.jsx("div",{className:"fixed right-2 top-14 z-[60] sm:top-2",children:e.jsx(os,{})}),e.jsx(Is,{}),e.jsx(c.Suspense,{fallback:e.jsx("div",{className:"p-4 text-sm text-zinc-300",children:"Р—Р°РіСЂСѓР·РєР°вЂ¦"}),children:e.jsxs(zt,{children:[e.jsx(j,{path:"/",element:e.jsx(us,{})}),e.jsx(j,{path:"/home",element:e.jsx(ys,{})}),e.jsx(j,{path:"/forum/*",element:e.jsx(ws,{})}),e.jsx(j,{path:"/forum/section/:id",element:e.jsx(js,{})}),e.jsx(j,{path:"/forum/topic/:id",element:e.jsx(ks,{})}),e.jsx(j,{path:"/forum/questions",element:e.jsx(Ns,{})}),e.jsx(j,{path:"/forum/members",element:e.jsx(vs,{})}),e.jsx(j,{path:"/forum/profile/:username",element:e.jsx(Pe,{})}),e.jsx(j,{path:"/u/:username",element:e.jsx(Pe,{})}),e.jsx(j,{path:"/forum/tag/:tag",element:e.jsx(Ss,{})}),e.jsx(j,{path:"/forum/admin",element:e.jsx(Es,{})}),e.jsx(j,{path:"/whats-new",element:e.jsx(ms,{})}),e.jsx(j,{path:"/diff/:id",element:e.jsx(ps,{})}),e.jsx(j,{path:"/print",element:e.jsx(fs,{})}),e.jsx(j,{path:"/roles/:id",element:e.jsx(xs,{})}),e.jsx(j,{path:"/laws/:slug",element:e.jsx(gs,{})}),e.jsx(j,{path:"/vu/:id",element:e.jsx(bs,{})}),e.jsx(j,{path:"/recorders/:id",element:e.jsx(Zt,{})}),e.jsx(j,{path:"/about",element:e.jsx(tn,{})}),e.jsx(j,{path:"/style/liquid",element:e.jsx(hs,{})}),e.jsx(j,{path:"/settings",element:e.jsx(_s,{})}),e.jsx(j,{path:"/favorites",element:e.jsx(zs,{})}),e.jsx(j,{path:"/forum/feeds",element:e.jsx(Ms,{})})]})})]})]})}const Ms=c.lazy(()=>E(()=>import("./ForumFeedsPage-C-XW2aPC.js"),__vite__mapDeps([35,1,17,16,18,2,19,29])));(function(){try{const n="app:version",s=localStorage.getItem(n),r="1759945892770";if(s&&s!==r){"caches"in window?caches.keys().then(a=>Promise.all(a.map(o=>caches.delete(o)))).finally(()=>{localStorage.setItem(n,r),location.reload()}):(localStorage.setItem(n,r),location.reload());return}localStorage.setItem(n,r)}catch{}})();Fn();Nn();function kt(){const t=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${t}px`)}kt();window.addEventListener("resize",kt,{passive:!0});pe.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(Ls,{})}));export{mt as $,Zs as A,er as B,en as C,Fs as D,Ws as E,Us as F,qs as G,Ks as H,Vs as I,rr as J,ar as K,Q as L,Tn as M,ut as N,mn as O,hn as P,bn as Q,wn as R,jn as S,_n as T,Dn as U,it as V,zn as W,In as X,Ln as Y,ye as Z,pt as _,nn as a,En as a0,Bn as a1,ht as a2,Cs as a3,un as a4,gn as a5,yn as a6,ct as a7,pn as a8,vn as a9,ns as b,Xn as c,ir as d,Jn as e,Ys as f,ss as g,Os as h,or as i,e as j,Ts as k,Se as l,tr as m,Hs as n,nr as o,sr as p,Js as q,Xt as r,Ds as s,$s as t,oe as u,rn as v,Bs as w,Gs as x,Xs as y,Qs as z};
