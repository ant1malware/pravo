const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-Dok_gOdj.js","assets/react-vendor-DStf8yZ1.js","assets/icons-plczHfNq.js","assets/VoteWidget-CExbn6bj.js","assets/ContextText-DqhnGtWM.js","assets/WhatsNew-2ymeESWR.js","assets/DiffPage-CcLqE4xY.js","assets/PrintSheet-CpJ2XHyr.js","assets/RolePage-D4qNu64X.js","assets/FavStar-B8kmvJoh.js","assets/LawPage-qCn-pAlW.js","assets/VuPage-r10vAiZt.js","assets/SettingsPage-BLeNv6a9.js","assets/FavoritesPage-IHnn9mgf.js"])))=>i.map(i=>d[i]);
import{r as ne,a as Ie,R as m,u as F,L as z,B as _e,b as $e,c as w}from"./react-vendor-DStf8yZ1.js";import{S as V,X as se,B,U as oe,a as ae,b as U,c as W,F as Pe,L as Ae,C as Ce,M as re,d as Re,e as Le,f as Me,g as De}from"./icons-plczHfNq.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(a){if(a.ep)return;a.ep=!0;const l=s(a);fetch(a.href,l)}})();var ie={exports:{}},T={};/**
 * @license React
...
![Территория красной зоны воинской части](${x}img/red-zone.png)
Территория КПП-1
![Территория КПП-1](${x}img/cpp.png)
Территория КПП-2
![Территория КПП-2](${x}img/cpp2.png)
...
![Территория военного грузового поезда](${x}img/poezd.jpg)
![Территория военного грузового поезда](${x}/img/poezd.jpg)
...
Служебные территории:
Правительство
![Правительство2](${x}img/pravo2.png)
![Правительство](${x}img/pravo.png)
...
`,He=[{id:"gov",title:"Внутренний устав Правительства",text:Ge,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
4.4. При обнаружении пострадавшего оповестить руководящего о наличии пострадавшего`}],le="ui:density",de="ui:font",Xe="ui:features",ue="ui:shadow",me="ui:radius",pe="ui:glass",he="ui:readw";function Je(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),localStorage.setItem(le,e)}function qe(){return localStorage.getItem(le)==="compact"?"compact":"standard"}function Qe(e){const n=Math.max(.9,Math.min(1.3,e)),s=16*n;document.documentElement.style.setProperty("--font-size",`${s}px`),localStorage.setItem(de,String(n))}function Ze(){const e=parseFloat(localStorage.getItem(de)||"1");return isFinite(e)&&e>.6&&e<2?e:1}function et(e,n=!0){const s=tt();return e in s?!!s[e]:n}function tt(){try{const e=localStorage.getItem(Xe);return e?JSON.parse(e):{}}catch{return{}}}function nt(e){let n="none";e==="soft"&&(n="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(n="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",n),localStorage.setItem(ue,e)}function st(){const e=localStorage.getItem(ue);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function ot(e){let n=8,s=16,o=20;e==="subtle"&&(n=6,s=10,o=14),e==="rounded"&&(n=12,s=18,o=24),document.documentElement.style.setProperty("--radius-lg",n+"px"),document.documentElement.style.setProperty("--radius-2xl",s+"px"),document.documentElement.style.setProperty("--radius-3xl",o+"px"),localStorage.setItem(me,e)}function at(){const e=localStorage.getItem(me);return e==="subtle"||e==="rounded"?e:"standard"}function rt(e){const n=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",n+"px"),localStorage.setItem(pe,String(n))}function it(){const e=parseInt(localStorage.getItem(pe)||"6",10);return isFinite(e)?e:6}function ct(e){const n=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",n+"ch"),localStorage.setItem(he,String(n))}function lt(){const e=parseInt(localStorage.getItem(he)||"78",10);return isFinite(e)?e:78}function dt(){try{Je(qe()),Qe(Ze()),nt(st()),ot(at()),rt(it()),ct(lt())}catch{}}function j(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function ut(){if(!et("cmd_palette",!0))return null;const[n,s]=m.useState(!1),[o,a]=m.useState(""),[l,r]=m.useState(0),[u,c]=m.useState(()=>localStorage.getItem("cp_filter")||"all");m.useEffect(()=>{try{localStorage.setItem("cp_filter",u)}catch{}},[u]),m.useEffect(()=>{function i(f){(f.ctrlKey||f.metaKey)&&f.key.toLowerCase()==="k"&&(f.preventDefault(),s(!0),a(""),r(0)),n&&f.key==="Escape"&&s(!1)}return window.addEventListener("keydown",i),window.openCommandPalette=()=>{s(!0),a(""),r(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",i)}},[n]);const d=m.useMemo(()=>{const i=[];i.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:j("/favorites")}),i.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:j("/settings")});for(const h of Ye)i.push({kind:"role",id:h.id,title:h.role,subtitle:"Роль",url:j(`/roles/${h.id}`)});for(const h of q)i.push({kind:"law",id:h.slug,title:h.title,subtitle:"Закон",url:j(`/laws/${h.slug}`)});for(const h of He)i.push({kind:"vu",id:h.id,title:h.title,subtitle:"ВУ",url:j(`/vu/${h.id}`)});const f=o.trim().toLowerCase();return f&&i.push(...k(f).slice(0,60)),f?(u==="all"?i:i.filter(h=>h.kind===u)).map(h=>({r:h,score:p(`${h.title} ${h.subtitle||""}`.toLowerCase(),f)+(h.__boost||0)})).filter(h=>h.score>0).sort((h,E)=>E.score-h.score).slice(0,30).map(h=>h.r):i.slice(0,20)},[o,u]);function p(i,f){return f.split(/\s+/).filter(Boolean).reduce((h,E)=>h+(i.includes(E)?1:0),0)}function k(i){const f=[],L=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),h=(()=>{const b=i.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return b?b[2]:null})();for(const b of q){const Ne=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let P="",y="";const M=new Set;for(const Ee of Ne){const I=Ee.trim(),Y=/^(#{2,6})\s*(.+)$/.exec(I);if(Y){P=Y[2].trim(),y=L(P)||"";const S=P.toLowerCase();if(y&&(S.includes(i)||h&&S.match(new RegExp(`(^|s)ст(атья|.)?s*${h}\b`)))){const A=`${b.slug}#${y}`;if(!M.has(A)){const D={kind:"law",id:A,title:`${b.title} — ${P}`,subtitle:"Раздел закона",url:j(`/laws/${b.slug}?q=${encodeURIComponent(i)}#${y}`)};D.__boost=S.startsWith(i)?8:6,f.push(D),M.add(A)}}continue}if(I&&I.toLowerCase().includes(i)){const S=y?`${b.slug}#${y}`:b.slug;if(!M.has(S)){const G=I.length>140?I.slice(0,137)+"…":I,A=y?`${b.title} — ${P}`:b.title,D=j(y?`/laws/${b.slug}?q=${encodeURIComponent(i)}#${y}`:`/laws/${b.slug}?q=${encodeURIComponent(i)}`),H={kind:"law",id:S,title:A,subtitle:G||"Совпадение в тексте",url:D};H.__boost=5,f.push(H),M.add(S)}}}}const E=new Set;return f.filter(b=>E.has(b.id)?!1:(E.add(b.id),!0))}function N(i){s(!1);try{window.location.href=i}catch{location.assign(i)}}function $(i){d.length&&(i.key==="ArrowDown"&&(i.preventDefault(),r(f=>Math.min(f+1,d.length-1))),i.key==="ArrowUp"&&(i.preventDefault(),r(f=>Math.max(f-1,0))),i.key==="Enter"&&(i.preventDefault(),N(d[l].url)))}return t.jsx(t.Fragment,{children:n?t.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:t.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[t.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[t.jsx(V,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),t.jsx("input",{autoFocus:!0,value:o,onChange:i=>{a(i.target.value),r(0)},onKeyDown:$,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),t.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>s(!1),"aria-label":"Закрыть палитру",children:t.jsx(se,{className:"h-4 w-4"})})]}),t.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(i=>t.jsx("button",{onClick:()=>{c(i.k),r(0)},className:`chip ${u===i.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:i.label},i.k))}),t.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!d.length&&t.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),d.map((i,f)=>t.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${f===l?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>r(f),onClick:()=>N(i.url),children:[t.jsxs("span",{className:"inline-flex items-center gap-2",children:[i.kind==="law"&&t.jsx(B,{className:"h-4 w-4"}),i.kind==="role"&&t.jsx(oe,{className:"h-4 w-4"}),i.kind==="vu"&&t.jsx(ae,{className:"h-4 w-4"}),i.kind==="page"&&(i.id==="settings"?t.jsx(U,{className:"h-4 w-4"}):t.jsx(W,{className:"h-4 w-4"})),t.jsx("span",{className:"font-medium",children:i.title})]}),i.subtitle&&t.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:i.subtitle})]},`${i.kind}:${i.id}`))]})]})}):null})}const _={},mt=(_==null?void 0:_.VITE_API_BASE)||(_==null?void 0:_.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function pt(){try{const e="anon_uid";let n=localStorage.getItem(e);return n||(n=crypto.randomUUID(),localStorage.setItem(e,n)),n}catch{return"na"}}function ht(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:pt()}}function ft(e,n){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const s=JSON.stringify({event:e,...ht(),data:n}),o=`${mt}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([s],{type:"application/json"});if(navigator.sendBeacon(o,a))return}catch{}try{fetch(o,{method:"POST",headers:{"content-type":"application/json"},body:s})}catch{}}const Q="recent:items";function gt(e,n){try{const s=localStorage.getItem(Q),o=s?JSON.parse(s):[],a={url:e,title:n,ts:Date.now()};if(o.length&&o[0].url===e)return;const l=o.filter(c=>c.url!==e);l.unshift(a);const r=[],u=new Set;for(const c of l)u.has(c.url)||(u.add(c.url),r.push(c));for(;r.length>15;)r.pop();localStorage.setItem(Q,JSON.stringify(r))}catch{}}const fe=[{label:"Роли",icon:t.jsx(oe,{className:"h-4 w-4"}),id:"roles"},{label:"Шаблоны",icon:t.jsx(Pe,{className:"h-4 w-4"}),id:"templates"},{label:"Посты",icon:t.jsx(Ae,{className:"h-4 w-4"}),id:"posts"},{label:"Процедуры",icon:t.jsx(Ce,{className:"h-4 w-4"}),id:"procedures"},{label:"Взаимодействия",icon:t.jsx(re,{className:"h-4 w-4"}),id:"interactions"},{label:"Проверки",icon:t.jsx(Re,{className:"h-4 w-4"}),id:"checks"},{label:"Лекции",icon:t.jsx(B,{className:"h-4 w-4"}),id:"lectures"},{label:"ВУ",icon:t.jsx(ae,{className:"h-4 w-4"}),id:"vu"},{label:"Законы",icon:t.jsx(B,{className:"h-4 w-4"}),id:"laws"}];function bt(){const[e,n]=m.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),s=F(),o=m.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=m.useMemo(()=>{const p=(new URLSearchParams(s.search||"").get("tab")||"").toLowerCase(),k=(s.hash||"").replace(/^#/,"").toLowerCase();return p||k||""},[s.search,s.hash]),l=d=>a===d;m.useEffect(()=>{if(typeof window<"u"&&window.innerWidth<1024&&e){const p=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=p}}},[e]),m.useEffect(()=>{function d(){typeof window<"u"&&n(window.innerWidth>=1024)}return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),m.useEffect(()=>{const d=document.documentElement;e?d.classList.add("has-sidebar"):d.classList.remove("has-sidebar")},[e]);const u=m.useMemo(()=>typeof navigator<"u"?/Mac|iPhone|iPad|iPod/i.test(navigator.platform):!1,[])?"⌘ K":"Ctrl K",c="inline-flex items-center rounded-md border px-1.5 py-0.5 text-[10px] font-medium shadow-sm border-zinc-300 bg-white/90 text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-100 dark:shadow-none",g=d=>{const p=`?tab=${encodeURIComponent(d)}`;return o?{pathname:"/",search:p}:{pathname:"/",search:p,hash:`#${d}`}};return t.jsxs(t.Fragment,{children:[t.jsx("button",{hidden:!0,className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>n(d=>!d),"aria-label":"Открыть меню","aria-expanded":e,"aria-controls":"app-sidebar",children:"Меню"}),t.jsxs("aside",{id:"app-sidebar","aria-label":"Навигация",className:"app-sidebar hidden lg:block fixed inset-y-0 left-0 z-[60] w-[240px] border-r border-zinc-200 bg-white/85 backdrop-blur text-sm shadow-sm overscroll-contain dark:border-zinc-800 dark:bg-zinc-900/80",children:[t.jsx("div",{className:"mb-3 flex items-center justify-start",children:t.jsx(z,{to:"/",className:`rounded font-semibold no-underline focus:outline-none focus:ring-2 focus:ring-zinc-400\r
                       text-zinc-900 hover:underline hover:text-zinc-900\r
                       dark:text-zinc-100 dark:hover:text-white`,"aria-label":"Главная",children:"Главная"})}),t.jsx("nav",{role:"navigation",className:"grid max-h-[calc(100vh-140px)] gap-1 overflow-y-auto pr-1",children:t.jsx("ul",{className:"flex flex-col gap-1",children:fe.map(d=>{const p=l(d.id);return t.jsx("li",{children:t.jsxs(z,{to:g(d.id),className:["flex items-center gap-2 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-zinc-400","text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800",p?"bg-zinc-100 dark:bg-zinc-800":""].join(" "),"aria-current":p?"page":void 0,"aria-label":d.label,onClick:()=>{typeof window<"u"&&window.innerWidth<1024&&n(!1)},children:[d.icon,t.jsx("span",{className:"truncate",children:d.label})]})},d.id)})})}),t.jsxs("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:["Подсказка: нажмите ",t.jsx("kbd",{className:c,children:u})," для быстрого поиска"]})]})]})}const xt={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},ge={entities:xt};function yt(e){var s;return((s=ge.entities)==null?void 0:s[e])||null}function Jt(e,n=30){const s=yt(e);if(!(s!=null&&s.updated_at))return{recent:!1};const o=new Date(s.updated_at+"T00:00:00Z");return{recent:(Date.now()-o.getTime())/(1e3*60*60*24)<=n,date:s.updated_at}}function qt(e,n){const s=e.split(/\r?\n/),o=n.split(/\r?\n/),a=s.length,l=o.length,r=Array.from({length:a+1},()=>Array(l+1).fill(0));for(let d=a-1;d>=0;d--)for(let p=l-1;p>=0;p--)r[d][p]=s[d]===o[p]?r[d+1][p+1]+1:Math.max(r[d+1][p],r[d][p+1]);const u=[];let c=0,g=0;for(;c<a&&g<l;)s[c]===o[g]?(u.push(C(s[c])),c++,g++):r[c+1][g]>=r[c][g+1]?(u.push(`<del>${C(s[c])}</del>`),c++):(u.push(`<ins>${C(o[g])}</ins>`),g++);for(;c<a;)u.push(`<del>${C(s[c++])}</del>`);for(;g<l;)u.push(`<ins>${C(o[g++])}</ins>`);return u.join(`
`)}function C(e){return e.replace(/[&<>]/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[n])}function wt(){var s;const e=[],n=ge.entities||{};for(const[o,a]of Object.entries(n)){const l=(s=a.changelog)==null?void 0:s[0];l&&e.push({id:o,version:l.version,date:l.date,summary:l.summary,details:l.details})}return e.sort((o,a)=>o.date<a.date?1:-1),e}function vt(){const e=m.useMemo(()=>{try{const s=wt()[0];if(!s)return!1;const o=new Date(s.date+"T00:00:00Z");return(Date.now()-o.getTime())/864e5<=14}catch{return!1}},[]);function n(){const s=window.openCommandPalette;if(typeof s=="function")try{s();return}catch{}const o=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!o,metaKey:o}))}return t.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:t.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 px-4 py-3 sm:gap-3",children:[t.jsxs("div",{className:"flex min-w-0 items-center gap-3",children:[t.jsx("button",{className:"btn btn-secondary sm:hidden",onClick:()=>{var s;return(s=window.openMobileMenu)==null?void 0:s.call(window)},"aria-label":"Меню",children:t.jsx(Le,{className:"h-4 w-4"})}),t.jsx(Me,{className:"h-6 w-6 shrink-0"}),t.jsx("div",{className:"truncate text-base font-bold leading-tight sm:text-lg",children:"Справочник SKY"})]}),t.jsxs("div",{className:"flex flex-wrap items-center justify-end gap-1 sm:gap-2",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:n,"aria-label":"Поиск",children:[t.jsx(V,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Поиск"})]}),t.jsxs(z,{to:"/whats-new",className:"btn","aria-label":"Что нового",children:[t.jsx("span",{className:"hidden sm:inline",children:"Что нового"}),e&&t.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),t.jsxs(z,{to:"/favorites",className:"btn","aria-label":"Избранное",children:[t.jsx(W,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Избранное"})]}),t.jsxs(z,{to:"/settings",className:"btn","aria-label":"Настройки",children:[t.jsx(U,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Настройки"})]}),t.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn","aria-label":"Связаться в Telegram",children:[t.jsx(re,{className:"h-4 w-4"}),t.jsx("span",{className:"hidden sm:inline",children:"Связаться"})]})]})]})})}const kt="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",Z="notif:lastSeen";function jt(){const[e,n]=m.useState(!1),[s,o]=m.useState([]),[a,l]=m.useState(0);async function r(){try{const c=await fetch(kt,{cache:"no-store"});if(!c.ok)return;const g=await c.json(),d=Array.isArray(g)?g:g.items||[];d.sort(($,i)=>new Date(i.date||0).getTime()-new Date($.date||0).getTime()),o(d);const p=localStorage.getItem(Z)||"",k=p?d.findIndex($=>$.id===p):-1,N=k===-1?d.length:k;l(Math.max(0,N))}catch{}}m.useEffect(()=>{r()},[]);function u(){if(n(c=>!c),!e&&s.length)try{localStorage.setItem(Z,s[0].id),l(0)}catch{}}return t.jsxs("div",{className:"relative",children:[t.jsxs("button",{className:"btn btn-secondary relative",onClick:u,"aria-label":"Уведомления",children:[t.jsx(De,{className:"h-4 w-4"}),a>0&&t.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&t.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[t.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),s.length?t.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:s.map(c=>t.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:t.jsxs("a",{className:"block",href:c.url||"#",target:c.url?"_blank":void 0,rel:c.url?"noreferrer":void 0,children:[c.title&&t.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:c.title}),t.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:c.text}),c.date&&t.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(c.date).toLocaleString()})]})},c.id))}):t.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}function zt(){const[e,n]=m.useState(!1),s=F();m.useEffect(()=>(window.openMobileMenu=()=>n(!0),()=>{try{delete window.openMobileMenu}catch{}}),[]),m.useEffect(()=>{if(!e)return;const r=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=r}},[e]);const o=m.useMemo(()=>typeof window<"u"&&window.location.hash.startsWith("#/"),[]),a=r=>{const u=new URLSearchParams(s.search||"");u.set("tab",r);const c=`?${u.toString()}`;return o?{pathname:"/",search:c}:{pathname:"/",search:c,hash:`#${r}`}};function l(){const r=window.openCommandPalette;if(typeof r=="function")try{r()}catch{}n(!1)}return e?t.jsxs("div",{className:"fixed inset-0 z-[70] lg:hidden",children:[t.jsx("div",{className:"absolute inset-0 bg-black/55",onClick:()=>n(!1),"aria-hidden":!0}),t.jsxs("div",{className:"absolute inset-0 flex flex-col bg-[color:var(--surface)]/98 backdrop-blur pt-[var(--safe-top)] pb-[var(--safe-bot)] text-zinc-900 dark:text-zinc-100",children:[t.jsxs("header",{className:"flex items-center justify-between gap-2 px-4 py-3 border-b border-zinc-200/80 dark:border-zinc-800/80",children:[t.jsxs("button",{className:"btn btn-secondary",onClick:l,"aria-label":"Поиск",children:[t.jsx(V,{className:"h-4 w-4"})," ",t.jsx("span",{children:"Поиск"})]}),t.jsx("div",{className:"text-sm font-medium text-zinc-600 dark:text-zinc-300",children:"Меню"}),t.jsx("button",{className:"btn btn-secondary",onClick:()=>n(!1),"aria-label":"Закрыть",children:t.jsx(se,{className:"h-4 w-4"})})]}),t.jsxs("nav",{className:"flex-1 overflow-y-auto px-2 py-2",children:[t.jsx("ul",{className:"grid gap-2",children:fe.map(r=>t.jsx("li",{children:t.jsxs(z,{to:a(r.id),className:"flex items-center gap-3 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white/95 dark:bg-zinc-900/90 px-3 py-3 text-base text-zinc-900 dark:text-zinc-100 hover:bg-zinc-100/70 dark:hover:bg-zinc-800/70 transition active:scale-[0.99]",onClick:()=>n(!1),children:[r.icon,t.jsx("span",{className:"truncate",children:r.label})]})},r.id))}),t.jsxs("div",{className:"mt-3 grid grid-cols-2 gap-2",children:[t.jsxs(z,{to:"/favorites",className:"btn btn-secondary",children:[t.jsx(W,{className:"h-4 w-4"})," Избранное"]}),t.jsxs(z,{to:"/settings",className:"btn btn-secondary",children:[t.jsx(U,{className:"h-4 w-4"})," Настройки"]})]})]})]})]}):null}const St=m.lazy(()=>v(()=>import("./GovCheatsheetSky-Dok_gOdj.js"),__vite__mapDeps([0,1,2,3,4]))),Nt=m.lazy(()=>v(()=>import("./WhatsNew-2ymeESWR.js"),__vite__mapDeps([5,1,2]))),Et=m.lazy(()=>v(()=>import("./DiffPage-CcLqE4xY.js"),__vite__mapDeps([6,1,2]))),It=m.lazy(()=>v(()=>import("./PrintSheet-CpJ2XHyr.js"),__vite__mapDeps([7,1,2]))),_t=m.lazy(()=>v(()=>import("./RolePage-D4qNu64X.js"),__vite__mapDeps([8,1,3,2,9,4]))),$t=m.lazy(()=>v(()=>import("./LawPage-qCn-pAlW.js"),__vite__mapDeps([10,1,9,2,4]))),Pt=m.lazy(()=>v(()=>import("./VuPage-r10vAiZt.js"),__vite__mapDeps([11,1,4,2]))),At=m.lazy(()=>v(()=>import("./SettingsPage-BLeNv6a9.js"),__vite__mapDeps([12,1,2]))),Ct=m.lazy(()=>v(()=>import("./FavoritesPage-IHnn9mgf.js"),__vite__mapDeps([13,1,9,2,4])));function Rt(){const e=F();return ne.useEffect(()=>{ft("page_view");try{gt(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[e.pathname,e.search,e.hash]),null}function Lt(){return t.jsxs(_e,{basename:"/pravo/",children:[t.jsx(ut,{}),t.jsx(bt,{}),t.jsx(vt,{}),t.jsx(zt,{}),t.jsx("div",{className:"fixed right-2 top-16 z-40 sm:top-2",children:t.jsx(jt,{})}),t.jsx(Rt,{}),t.jsx(m.Suspense,{fallback:t.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:t.jsxs($e,{children:[t.jsx(w,{path:"/",element:t.jsx(St,{})}),t.jsx(w,{path:"/whats-new",element:t.jsx(Nt,{})}),t.jsx(w,{path:"/diff/:id",element:t.jsx(Et,{})}),t.jsx(w,{path:"/print",element:t.jsx(It,{})}),t.jsx(w,{path:"/roles/:id",element:t.jsx(_t,{})}),t.jsx(w,{path:"/laws/:slug",element:t.jsx($t,{})}),t.jsx(w,{path:"/vu/:id",element:t.jsx(Pt,{})}),t.jsx(w,{path:"/settings",element:t.jsx(At,{})}),t.jsx(w,{path:"/favorites",element:t.jsx(Ct,{})})]})})]})}const be="theme",xe="accent",ye="accent_custom",we="bg",Mt="bg_custom",ve={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}};var ee,te;const O=((te=(ee=import.meta)==null?void 0:ee.env)==null?void 0:te.BASE_URL)??"/",R=e=>{const n=e.replace(/^\/+/,"");return(O.endsWith("/")?O:O+"/")+n},ke={bg1:R("img/bg1.png"),bg2:R("img/bg2.png"),bg3:R("img/bg3.png"),bg4:R("img/bg4.png"),bg5:R("img/bg5.png")};function Dt(){const e=localStorage.getItem(be);return e==="light"||e==="dark"?e:null}function Tt(){const e=localStorage.getItem(xe);return e?e==="custom"?"custom":e in ve?e:null:null}function Ot(){return localStorage.getItem(ye)}function Bt(){const e=localStorage.getItem(we);return e&&(e==="none"||e==="custom"||e in ke)?e:null}function Kt(){return localStorage.getItem(Mt)}function Ft(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Vt(e){const n=document.documentElement;e==="dark"?n.classList.add("dark"):n.classList.remove("dark"),localStorage.setItem(be,e);const s=e==="dark"?"#0a0a0a":"#fafafa";let o=document.querySelector('meta[name="theme-color"]');o||(o=document.createElement("meta"),o.name="theme-color",document.head.appendChild(o)),o.setAttribute("content",s);try{n.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function je(e){if(e==="custom"){const n=Ot()||"#6366F1";document.documentElement.style.setProperty("--accent",n);const s=Yt(n,-.15);document.documentElement.style.setProperty("--accent-600",s)}else{const n=ve[e];document.documentElement.style.setProperty("--accent",n[500]),document.documentElement.style.setProperty("--accent-600",n[600])}localStorage.setItem(xe,e)}function Qt(e){localStorage.setItem(ye,ze(e)),je("custom")}function Ut(e){const n=document.body,o=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)?"scroll":"fixed";if(e==="none")n.style.backgroundImage="",n.style.backgroundSize="",n.style.backgroundRepeat="",n.style.backgroundAttachment="",n.style.backgroundPosition="";else if(e==="custom"){const a=Kt();a?(n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=o,n.style.backgroundPosition="center"):n.style.backgroundImage=""}else{const a=ke[e];n.style.backgroundImage=`url(${a})`,n.style.backgroundSize="cover",n.style.backgroundRepeat="no-repeat",n.style.backgroundAttachment=o,n.style.backgroundPosition="center"}localStorage.setItem(we,e)}function Wt(){const n=Dt()??(Ft()?"dark":"light");Vt(n);const s=Tt()??"indigo";je(s);const o=Bt()??"none";Ut(o)}function ze(e){let n=e.trim();if(n.startsWith("#")||(n=`#${n}`),n.length===4){const s=n[1],o=n[2],a=n[3];n=`#${s}${s}${o}${o}${a}${a}`}return n}function Yt(e,n){const s=ze(e).slice(1),o=parseInt(s,16);let a=o>>16&255,l=o>>8&255,r=o&255;a=Math.max(0,Math.min(255,Math.round(a+255*n))),l=Math.max(0,Math.min(255,Math.round(l+255*n))),r=Math.max(0,Math.min(255,Math.round(r+255*n)));const u=c=>c.toString(16).padStart(2,"0");return`#${u(a)}${u(l)}${u(r)}`}(function(){try{const n="app:version",s=localStorage.getItem(n),o="1757655170586";if(s&&s!==o){"caches"in window?caches.keys().then(a=>Promise.all(a.map(l=>caches.delete(l)))).finally(()=>{localStorage.setItem(n,o),location.reload()}):(localStorage.setItem(n,o),location.reload());return}localStorage.setItem(n,o)}catch{}})();Wt();dt();function Se(){const e=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${e}px`)}Se();window.addEventListener("resize",Se,{passive:!0});K.createRoot(document.getElementById("root")).render(t.jsx(m.StrictMode,{children:t.jsx(Lt,{})}));export{ve as A,ke as B,yt as a,Tt as b,qe as c,qt as d,Ze as e,st as f,wt as g,at as h,Jt as i,t as j,it as k,q as l,Vt as m,je as n,Qt as o,nt as p,ot as q,Ye as r,Ft as s,rt as t,Je as u,He as v,Qe as w};
