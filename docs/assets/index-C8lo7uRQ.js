const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-aA0dKB_m.js","assets/react-vendor-DStf8yZ1.js","assets/icons-CWwV2OkG.js","assets/VoteWidget-DsJy7fZP.js","assets/ContextText-LsknEsaH.js","assets/WhatsNew-DqT3RRVG.js","assets/DiffPage-Cv8uLj4B.js","assets/PrintSheet-DXQW_YBP.js","assets/RolePage-BfjJKkp7.js","assets/FavStar-DkPSvY48.js","assets/LawPage-Da35wwoo.js","assets/VuPage-DITCDpps.js","assets/SettingsPage-BI_tsX7u.js","assets/FavoritesPage-CMgu04Di.js"])))=>i.map(i=>d[i]);
import{r as Z,a as Ie,R as p,u as ee,L,B as Ee,b as Ne,c as w}from"./react-vendor-DStf8yZ1.js";import{S as te,X as _e,B,U as ne,a as se,b as oe,c as ae,F as $e,L as Pe,C as Ae,M as re,d as Ce,e as Le,f as Re}from"./icons-CWwV2OkG.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();var ie={exports:{}},O={};/**
 * @license React
