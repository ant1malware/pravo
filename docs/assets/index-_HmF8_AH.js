const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-WtuAfGzb.js","assets/react-vendor-DStf8yZ1.js","assets/icons-CWwV2OkG.js","assets/VoteWidget-R04e7Aba.js","assets/ContextText-BJwzrMEq.js","assets/WhatsNew-BigEAZKs.js","assets/DiffPage-Q_jcRCay.js","assets/PrintSheet-BpTPOABY.js","assets/RolePage-Bl9tWSPR.js","assets/FavStar-B9mu6ude.js","assets/LawPage-BztQvzH7.js","assets/VuPage-BBRcdmPj.js","assets/SettingsPage-Bzx3LnR3.js","assets/FavoritesPage-B61-SzVs.js"])))=>i.map(i=>d[i]);
import{r as X,a as ke,R as p,u as J,L as C,B as je,b as ze,c as w}from"./react-vendor-DStf8yZ1.js";import{S as q,X as Se,B as O,U as Q,a as Z,b as ee,c as te,F as Ie,L as Ee,C as Ne,M as ne,d as _e,e as $e,f as Pe}from"./icons-CWwV2OkG.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function o(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=o(a);fetch(a.href,i)}})();var oe={exports:{}},T={};/**
 * @license React
