...
`;function y0(e){return e.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80)}function x0(e){const t=(e||"").trim();if(!t)return[];const n=t.split(/\n{2,}/),r=[];let l=null,i=[];const o=()=>{if(l||i.length){const u=(l||"Учебные материалы").trim(),c=i.join(`

`).trim();r.push({id:y0(u)||`sec-${r.length+1}`,title:u,text:c||u,source:"https://forum.amazing-online.com/threads/uchebnye-materialy-dlja-sotrudnikov-pravitelstvennogo-apparata.1065800/"})}l=null,i=[]},s=/^(##\s+.+|Лекция\s*(на\s+тему)?\s*[:«"].+|Тема[\.:]\s*.+|Раздел[\.:]\s*.+|Глава[\.:]\s*.+|Инструкция[\.:]\s*.+|Порядок[\.:]\s*.+)$/i;for(const u of n){const c=u.trim();if(!c)continue;const p=(c.match(/^[^\n]+/)||[""])[0].trim();if(s.test(p)){o(),l=p.replace(/^##\s+/,"").trim();const m=c.slice(p.length).trim();m&&i.push(m)}else if(!l&&r.length===0){l=p;const a=c.slice(p.length).trim();a&&i.push(a)}else i.push(c)}return o(),r.length===0?[{id:"lectures",title:"Учебные материалы",text:t,source:"https://forum.amazing-online.com/threads/uchebnye-materialy-dlja-sotrudnikov-pravitelstvennogo-apparata.1065800/"}]:r}const w0=x0(g0),k0=[{id:"lawyer",role:"Адвокат",tips:["Всегда выходи через рацию департамента: представление по форме «Адвокат Фамилия».","Перед визитом в ИК — запросить допуск и сопровождение КПП: «/d [УФСИН] Адвокат Иванов. Разрешите прибытие к КПП-1 для оказания юр. помощи?»","Вход и передвижение на территории ИК — только с удостоверением и под сопровождением сотрудника ИК.","Работай в установленные окна посещений ИК; по завершении — краткий рапорт в /d: результат (консультация/КС/УДО).","Никаких обсуждений «торга», сумм и персональных данных в общей рации — только служебные формулировки."],source:"Учебные материалы: порядок работы адвоката в ИК, формы общения и запреты в рации."},{id:"inspector",role:"Инспектор",tips:["Проверки/ревизии — только с разрешения руководства и составом ≥ 2 чел.","На объекте представиться старшему, запросить режимный допуск (архив, склад, КПП).","Старт/продолжение/завершение — докладывай в /d: «/d [Орг] Инспектор Петров. Прибыл на проверку, приступаю».","Нарушения фиксируй фактами; решения — через руководителя департамента.","Плановые/внеплановые проверки — по основаниям и регламенту; итог — оценка (1–5) и доклад в /d."],source:"Порядок плановых/внеплановых проверок; инфо-раздел Правительства."},{id:"advisor",role:"Советник",tips:["Координируй собеседования и методическую помощь отделам; план согласовывай с руководством.","На совместных выездах — будь точкой коммуникации: «/d [Орг] Советник Сидоров. Координирую проверку, состав N».","В рации — только по делу, кратко, без оффтопа; спорные вопросы поднимай руководителю.","Собирай сводку и передавай руководителю департамента."]},{id:"deputy-minister",role:"Заместитель министра",tips:["Организует и принимает отчётность подразделений; назначает ответственных за связь.","Снятие судимостей — строго в здании Правительства и по регламенту, доклад в /d о факте оказания услуги.","Для гос-волны /gov: предварительно уточни в /d свободный слот и забронируй (пример ниже).","Шаблон брони гос-волны: «/d [Орг] Волна гос. новостей свободна на 18:10?», затем «Занимаю волну на 18:10»."],source:"Правила бронирования гос-волны; учебные материалы Правительства."},{id:"minister",role:"Министр",tips:["Утверждает плановые проверки/маршруты; формирует состав комиссии.","Связь: единый стандарт докладов, короткие формулы, дисциплина рации.","Совместные мероприятия с МВД/ВЧ/ЕСС согласовывает с руководителями организаций.","Итоги проверок — сводный доклад Губернатору/Вице-губернатору."]},{id:"admin-chief",role:"Глава администрации",tips:["Операционное управление аппаратом: расписания, приоритеты, контроль исполнения.","Объединяет коммуникацию департаментов при сложных кейсах.","Принимает сводные отчёты по проверкам/ревизиям и направляет резолюции.","Требует строгого соблюдения субординации и форм радиодокладов."]},{id:"vice-governor",role:"Вице-губернатор",tips:["Межведомственное взаимодействие на уровне руководителей: ФСБ/ВЧ/ЕСС/МВД.","Утверждает внеплановые проверки по установленным основаниям.","Назначает кураторов и сроки устранения нарушений; в экстренных случаях формирует единый штаб связи.","Итоги докладывает Губернатору и доводит решения до департаментов."],source:"Основания внеплановых проверок; общие регламенты взаимодействия."},{id:"governor",role:"Губернатор",tips:["Общее руководство, постановления, указы; стратегические решения.","Утверждает графики проверок и составы комиссий (не менее 3 членов для аттестаций).","Решает межведомственные споры и принимает финальные отчёты.","Награждения и меры воздействия — по итогам проверок/ревизий."],source:"Областной закон о Правительстве: порядок проверок и аттестаций."},{id:"templates-regimes",role:"Шаблоны: режимные объекты (ИК, ВЧ)",tips:["ИК (въезд/допуск): «/d [УФСИН] Должность Фамилия. Прибыл к КПП-1 ИК для [цель]. Просьба о допуске/сопровождении».","ВЧ (проезд через КПП при отсутствии дежурного): короткий доклад авто и цель въезда; дождись подтверждения и следуй указаниям КПП.","Всегда имей при себе служебное удостоверение; на территории действуй только по законным требованиям дежурного персонала."],source:"Правила КПП ВЧ, федеральный закон о режимных территориях; лекционные материалы."}],ud="theme";function S0(){const e=localStorage.getItem(ud);return e==="light"||e==="dark"?e:null}function E0(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function ad(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(ud,e)}function N0(){const t=S0()??(E0()?"dark":"light");ad(t)}function C0(){const e=document.documentElement.classList.contains("dark")?"light":"dark";return ad(e),e}function z0(){const[e,t]=go.useState(()=>document.documentElement.classList.contains("dark"));function n(){const r=C0();t(r==="dark")}return d.jsxs("button",{onClick:n,title:e?"Светлая тема":"Тёмная тема",className:"flex items-center gap-2 rounded-xl border px-3 py-1 text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800",children:[e?d.jsx(p0,{className:"h-4 w-4"}):d.jsx(u0,{className:"h-4 w-4"}),d.jsx("span",{className:"hidden sm:inline",children:e?"Светлая":"Тёмная"})]})}const ci=e=>`/pravo/${e.replace(/^\/+/,"")}`;function j0(){return new Promise((e,t)=>{if(window.FlexSearch)return e();const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/flexsearch@0.7.31/dist/flexsearch.bundle.js",n.onload=()=>e(),n.onerror=()=>t(),document.head.appendChild(n)})}function Pu(e){return e.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80)}const _0=({text:e})=>d.jsxs("button",{onClick:()=>navigator.clipboard.writeText(e),className:"flex items-center gap-2 rounded-xl border border-zinc-200 px-3 py-1 text-sm hover:bg-zinc-100 active:scale-[0.98] dark:border-zinc-700 dark:hover:bg-zinc-800",title:"Скопировать",children:[d.jsx(qp,{className:"h-4 w-4"})," Копировать"]}),Ve=({title:e,children:t,footer:n})=>d.jsxs("div",{className:"rounded-2xl border border-zinc-200 bg-white/80 p-4 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/60",children:[d.jsx("div",{className:"mb-2 flex items-center justify-between",children:d.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}),d.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:t}),n&&d.jsx("div",{className:"mt-3 border-t border-zinc-200 pt-3 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400",children:n})]}),At=({href:e,label:t})=>d.jsx("a",{href:e,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 underline decoration-dotted hover:no-underline",children:t||e}),Lu=({children:e})=>d.jsx("span",{className:"rounded-full border px-2 py-0.5 text-[11px] font-medium",children:e}),Tu=[{id:"roles",label:"Роли",icon:d.jsx(m0,{className:"h-4 w-4"})},{id:"templates",label:"Доклады",icon:d.jsx(od,{className:"h-4 w-4"})},{id:"posts",label:"Посты",icon:d.jsx(o0,{className:"h-4 w-4"})},{id:"procedures",label:"Процедуры",icon:d.jsx(so,{className:"h-4 w-4"})},{id:"interactions",label:"Взаимодействие",icon:d.jsx(co,{className:"h-4 w-4"})},{id:"lectures",label:"Лекции",icon:d.jsx(uo,{className:"h-4 w-4"})},{id:"vu",label:"ВУ",icon:d.jsx(so,{className:"h-4 w-4"})},{id:"laws",label:"Законы",icon:d.jsx(cs,{className:"h-4 w-4"})}],P0={Охрана:["Докладывает: (Фамилия). Заступил на пост (номер поста).","Докладывает: (Фамилия). Продолжаю дежурство на посту (номер поста).","Докладывает: (Фамилия). Покинул пост (номер поста).","Докладывает: (Фамилия). Начал охранять (Должность) (Фамилия).","Докладывает: (Фамилия). Продолжаю охранять (Должность) (Фамилия).","Докладывает: (Фамилия). Закончил охранять (Должность) (Фамилия)."],Адвокат:["Докладывает: (Фамилия), начал дежурство в комнате свиданий.","Докладывает: (Фамилия), продолжаю дежурство в комнате свиданий.","Докладывает: (Фамилия), закончил дежурство в комнате свиданий."],Инспектор:["Докладывает: (Фамилия), выехал на проверку постов ГАИ/УМВД.","Докладывает: (Фамилия), пост: (Название поста), сотрудники: (отсутствуют/присутствуют).","Докладывает: (Фамилия), закончил проверку постов ГАИ/УМВД.","Докладывает: (Фамилия), начал дежурство за стойкой регистрации.","Докладывает: (Фамилия), продолжаю дежурство за стойкой регистрации.","Докладывает: (Фамилия), закончил дежурство за стойкой регистрации."],"Зам. Министра":["Докладывает: (Фамилия), начал контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС.","Докладывает: (Фамилия), продолжил контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС.","Докладывает: (Фамилия), закончил контроль работы сотрудников ГАИ/УМВД/ВЧ/ЕСС."],Советник:["Докладывает: (Фамилия), начал контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает: (Фамилия), продолжил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ.","Докладывает: (Фамилия), закончил контролировать собеседование в ЕСС/ВЧ/УМВД/ГАИ."]},L0=[{code:"A1-A2",where:"Вход в здание Правительства",img:"/img/a1.png"},{code:"B1-B2",where:"Холл здания Правительства",img:"/img/b1.png"},{code:"C1-C2",where:"Задний вход, парковка",img:"/img/c1.png"},{code:"D1-D2",where:"Ворота на парковку",img:"/img/d1.png"},{code:"E1-E2",where:"Возле кабинета Губернатора",img:"/img/e1.png"}],T0=()=>{const[e,t]=S.useState(!1),[n,r]=S.useState(""),[l,i]=S.useState([]);S.useEffect(()=>{(async()=>{await j0();const{Document:p}=window.FlexSearch,a=new p({cache:!0,tokenize:"forward",document:{id:"id",index:[{field:"title"},{field:"abbr"},{field:"text"}],store:["slug","title","excerpt"]}}),m=[];An.forEach(g=>{const w=g.content.split(/\n(?=##\s+)/g);w.length===1?m.push({id:`${g.slug}`,slug:`${g.slug}`,title:g.title,abbr:g.abbr,text:g.content,excerpt:g.notes||""}):w.forEach(y=>{var f;const E=((f=y.match(/^##\s+(.+)$/m))==null?void 0:f[1])||g.title,h=Pu(E);m.push({id:`${g.slug}#${h}`,slug:`${g.slug}#${h}`,title:`${g.title} — ${E}`,abbr:g.abbr,text:y,excerpt:E})})}),m.forEach(g=>a.add(g)),window.__LAW_INDEX__=a,window.__LAW_DOCS__=m,t(!0)})()},[]);function o(p){let a=p.trim().toLowerCase();return a=a.replace(/\bу\s*к\b/g,"ук").replace(/\bко\s*ап\b/g,"коап").replace(/\s+/g," "),a}function s(p){var v;const a=p.match(/(?:ст\.?|статья)?\s*(\d{1,3})\s*(ук|коап)/i);if(!a)return null;const[,m,g]=a,w=g.toLowerCase()==="ук"?An.find(x=>x.slug==="uk"):An.find(x=>x.slug==="koap");if(!w)return null;const y=new RegExp(`^###\\s*Статья\\s*${m}\\b`,"mi"),E=w.content.split(/\n(?=###\s+)/g).find(x=>y.test(x));if(!E)return`/laws/${w.slug}`;const h=((v=E.match(/^###\s*(.+)$/m))==null?void 0:v[1])||`Статья ${m}`,f=Pu(h);return`/laws/${w.slug}#${f}`}function u(p,a){const m=p.trim().toLowerCase();if(!m)return[];const g=m.split(" ").filter(Boolean),w=[];for(const y of a){const E=`${y.title} ${y.abbr||""} ${y.text}`.toLowerCase(),h=g.reduce((f,v)=>f+(E.includes(v)?1:0),0);h>0&&w.push({url:`/laws/${y.slug}`,title:y.title,excerpt:y.excerpt||y.title,_score:h})}return w.sort((y,E)=>E._score-y._score).slice(0,20)}async function c(p){const a=window.__LAW_INDEX__,m=window.__LAW_DOCS__;if(!a||!m)return;const g=s(p);if(g){i([{url:g,title:"Перейти к статье",excerpt:p.toUpperCase()}]);return}const w=o(p);let y=[];try{const E=a.search(w,{enrich:!0,limit:20}),h=new Set;for(const f of E)for(const v of f.result){if(h.has(v.id))continue;h.add(v.id);const x=m.find(N=>N.id===v.id);x&&y.push({url:`/laws/${x.slug}`,title:x.title,excerpt:x.excerpt||x.title})}}catch{}y.length||(y=u(w,m)),i(y)}return S.useEffect(()=>{if(!e)return;if(!n.trim()){i([]);return}const p=setTimeout(()=>c(n),120);return()=>clearTimeout(p)},[n,e]),d.jsxs("div",{className:"rounded-2xl border border-zinc-200 bg-white/80 p-3 dark:border-zinc-800 dark:bg-zinc-900/50",children:[d.jsxs("div",{className:"mb-2 text-xs text-zinc-600",children:["Примеры: ",d.jsx("code",{children:"ук 105"}),", ",d.jsx("code",{children:"ст 12 коап"}),", ",d.jsx("code",{children:"обязанности водителя"})]}),d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(sd,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),d.jsx("input",{value:n,onChange:p=>r(p.target.value),placeholder:"Поиск по всем законам (фразы, статьи, номера)…",className:"w-full rounded-xl border border-zinc-200 px-3 py-1.5 text-sm focus:outline-none focus:ring dark:border-zinc-700 dark:bg-zinc-900/50"})]}),!!l.length&&d.jsx("div",{className:"mt-3 grid gap-2",children:l.map((p,a)=>d.jsxs($t,{to:p.url,className:"block rounded-xl border border-zinc-200 p-3 hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800",children:[d.jsx("div",{className:"text-sm font-semibold",children:p.title}),d.jsx("div",{className:"mt-1 line-clamp-2 text-xs text-zinc-500 dark:text-zinc-400",children:p.excerpt})]},a))})]})};function R0(){const[e,t]=S.useState(Tu[0].id),[n,r]=S.useState("roles"),[l,i]=S.useState("Все"),o=["Все","ДЗ","ДВД","ДВС","ЮД"],s=["Все","УК","КоАП","ПДД","ФП","ФЗоП","ФЗоТОД","ФЗоВС","ФЗоФСБ","УПК","КАС","Гостайна"],[u,c]=S.useState("Все"),p=S.useMemo(()=>An.filter(a=>u==="Все"||a.abbr.toLowerCase()===u.toLowerCase()),[u]);return d.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[d.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:d.jsxs("div",{className:"mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3",children:[d.jsxs("div",{className:"flex items-center gap-3",children:[d.jsx(Gp,{className:"h-6 w-6"}),d.jsxs("div",{children:[d.jsx("div",{className:"text-lg font-bold leading-tight",children:"Правительство — Памятка (SKY)"}),d.jsx("div",{className:"text-xs text-zinc-500",children:"Локальные тексты • быстрый поиск • мобильный UI"})]})]}),d.jsx("nav",{className:"flex w-full gap-2 overflow-x-auto md:w-auto",children:Tu.map(a=>d.jsxs("button",{onClick:()=>t(a.id),className:`flex items-center gap-2 rounded-xl border px-3 py-1.5 text-sm ${e===a.id?"border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100":"border-zinc-200 bg-white hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"}`,children:[a.icon," ",a.label]},a.id))}),d.jsx("div",{className:"flex items-center gap-2 md:ml-auto",children:d.jsx(z0,{})})]})}),d.jsxs("main",{className:"mx-auto max-w-6xl px-4 py-6",children:[e==="roles"&&d.jsxs(d.Fragment,{children:[d.jsxs("div",{className:"mb-3 flex flex-col gap-2 md:flex-row md:items-center md:justify-between",children:[d.jsx("h2",{className:"text-lg font-bold",children:"Роли"}),d.jsxs("div",{className:"flex flex-wrap gap-2",children:[d.jsxs("div",{className:"inline-flex rounded-full border border-zinc-200 bg-white/70 p-0.5 text-sm backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/50",children:[d.jsx("button",{onClick:()=>r("roles"),className:"px-3 py-1 rounded-full transition "+(n==="roles"?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"hover:bg-zinc-100 dark:hover:bg-zinc-800"),children:"Роли"}),d.jsx("button",{onClick:()=>r("promotion"),className:"px-3 py-1 rounded-full transition "+(n==="promotion"?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"hover:bg-zinc-100 dark:hover:bg-zinc-800"),children:"Повышение"})]}),d.jsx("div",{className:"inline-flex rounded-full border border-zinc-200 bg-white/70 p-0.5 text-sm backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/50",children:o.map(a=>d.jsx("button",{onClick:()=>i(a),className:"px-3 py-1 rounded-full transition "+(l===a?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white hover:bg-zinc-100 dark:bg-zinc-900 dark:hover:bg-zinc-800"),children:a},a))})]})]}),n==="roles"&&d.jsxs("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:[fo.filter(a=>{if(l==="Все")return!0;const m=a.dept;return Array.isArray(m)?m.includes(l):m===l}).map(a=>d.jsx($t,{to:`/roles/${a.id}`,className:"block",children:d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(ao,{className:"h-4 w-4"}),d.jsx("span",{children:a.role}),d.jsx(Lu,{children:a.salary})]}),footer:d.jsxs("div",{children:["Источник: ",d.jsx(At,{href:a.source||"#"})]}),children:d.jsx("ul",{className:"ml-4 list-disc",children:a.duties.map((m,g)=>d.jsx("li",{children:m},g))})})},a.id)),d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(uo,{className:"h-4 w-4"})," График, критерии, структура"]}),footer:d.jsxs("div",{children:["Инфо-раздел: ",d.jsx(At,{href:"https://forum.amazing-online.com/threads/informacionnyj-razdel-organizacii-pravitelstvo.1027737/"})]}),children:d.jsxs("ul",{className:"ml-4 list-disc",children:[d.jsx("li",{children:"Рабочие дни: пн–пт 10:00–18:00; сб–вс 10:00–15:00; перерыв 13:00–14:00"}),d.jsx("li",{children:"Критерии: 8+ лет стажа, 75+ законопослушности, юр-образование"}),d.jsx("li",{children:"Отделы: ДВД (МВД), ДВС (ВЧ), ДЗ (ЕСС), ЮД (юридический)"})]})})]}),n==="promotion"&&d.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:fo.filter(a=>{if(l==="Все")return!0;const m=a.dept;return Array.isArray(m)?m.includes(l):m===l}).map(a=>{var g;const m=a.promotionByDept&&l!=="Все"?((g=a.promotionByDept)==null?void 0:g[l])??[]:a.promotion??[];return d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(ao,{className:"h-4 w-4"}),d.jsx("span",{children:a.role}),d.jsx(Lu,{children:a.salary})]}),footer:d.jsxs("div",{children:["Источник: ",d.jsx(At,{href:a.sourcePromotion||a.source||"#"})]}),children:m.length?d.jsx("ol",{className:"ml-4 list-decimal",children:m.map((w,y)=>d.jsx("li",{children:w},y))}):d.jsx("p",{children:"Критерии повышения для этой роли пока не добавлены."})},a.id)})})]}),e==="templates"&&d.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:Object.entries(P0).map(([a,m])=>d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(od,{className:"h-4 w-4"}),"Доклады — ",a]}),children:d.jsx("div",{className:"flex flex-col gap-2",children:m.map((g,w)=>d.jsxs("div",{className:"flex items-center justify-between gap-2 rounded-xl border px-3 py-2",children:[d.jsx("div",{className:"text-sm",children:g}),d.jsx(_0,{text:g})]},w))})},a))}),e==="posts"&&d.jsx("section",{className:"grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5",children:L0.map(a=>d.jsxs("div",{className:"flex flex-col items-center gap-2 rounded-2xl border border-zinc-200 bg-white p-3 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900",children:[d.jsx("img",{src:ci(a.img),alt:a.code,className:"h-24 w-full rounded-xl border border-zinc-200 object-cover dark:border-zinc-700",onError:m=>{m.currentTarget.style.display="none"}}),d.jsx("div",{className:"text-2xl font-extrabold leading-none",children:a.code}),d.jsx("div",{className:"text-xs text-zinc-500 dark:text-zinc-400",children:a.where})]},a.code))}),e==="posts"&&d.jsxs("section",{className:"mt-6 grid gap-5",children:[d.jsxs("div",{children:[d.jsx("h2",{className:"mb-3 text-lg font-bold",children:"Стационарные посты для несения наружной службы подразделениями Госавтоинспекции"}),d.jsx("div",{className:"grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-4",children:[{caption:"A1 — Вход в здание",img:"/img/a1.png"},{caption:"B1 — Холл здания",img:"/img/b1.png"},{caption:"C1 — Задний вход",img:"/img/c1.png"},{caption:"D1 — Ворота парковки",img:"/img/d1.png"}].map((a,m)=>d.jsxs("figure",{className:"rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm dark:border-zinc-800 dark:bg-zinc-900",children:[d.jsx("img",{src:ci(a.img),alt:a.caption,className:"h-40 w-full rounded-xl border border-zinc-200 object-cover dark:border-zinc-700"}),d.jsx("figcaption",{className:"mt-2 text-center text-xs text-zinc-600 dark:text-zinc-400",children:a.caption})]},m))})]}),d.jsxs("div",{children:[d.jsx("h2",{className:"mb-3 text-lg font-bold",children:"ECC"}),d.jsx("div",{className:"grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-4",children:[{caption:"ECC — схема 1",img:"/img/ess.png"},{caption:"ECC — схема 2",img:"/img/ess2.png"},{caption:"Красная зона",img:"/img/red-zone.png"},{caption:"YFSB",img:"/img/yfsb.png"}].map((a,m)=>d.jsxs("figure",{className:"rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm dark:border-zinc-800 dark:bg-zinc-900",children:[d.jsx("img",{src:ci(a.img),alt:a.caption,className:"h-40 w-full rounded-xl border border-zinc-200 object-cover dark:border-zinc-700"}),d.jsx("figcaption",{className:"mt-2 text-center text-xs text-zinc-600 dark:text-zinc-400",children:a.caption})]},m))})]})]}),e==="procedures"&&d.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2",children:d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(so,{className:"h-4 w-4"}),"Выдача лицензий"]}),children:d.jsxs("ol",{className:"ml-4 list-decimal",children:[d.jsx("li",{children:"Попросить паспорт гражданина ((/pass))."}),d.jsx("li",{children:"Оформить лицензию, проверить данные и подпись."}),d.jsx("li",{children:"Вернуть паспорт вместе с лицензией."})]})})}),e==="interactions"&&d.jsx("section",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:k0.map(a=>d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(co,{className:"h-4 w-4"}),a.role]}),footer:a.source?d.jsxs("div",{className:"text-xs",children:["Источник: ",d.jsx(At,{href:a.source})]}):void 0,children:d.jsx("ul",{className:"ml-4 list-disc",children:a.tips.map((m,g)=>d.jsx("li",{children:m},g))})},a.id))}),e==="lectures"&&d.jsx("section",{className:"grid gap-4",children:d.jsx("div",{className:"grid grid-cols-1 gap-4",children:w0.map(a=>d.jsx(Ve,{title:d.jsx("div",{id:`lec-${a.id}`,className:"w-full scroll-mt-24",children:d.jsxs("div",{className:"flex items-center justify-center gap-2 text-center font-bold",children:[d.jsx(uo,{className:"h-4 w-4"}),d.jsx("span",{children:a.title})]})}),footer:d.jsxs("div",{className:"flex justify-between text-xs text-zinc-500",children:[d.jsx("div",{children:a.updated?`Актуально: ${a.updated}`:""}),a.source&&d.jsxs(d.Fragment,{children:["Источник: ",d.jsx(At,{href:a.source})]})]}),children:d.jsx("div",{className:"not-prose whitespace-pre-wrap text-sm leading-relaxed",children:a.text})},a.id))})}),e==="vu"&&d.jsx("section",{className:"grid gap-4",children:d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(co,{className:"h-4 w-4"}),"Внутренний устав Правительства"]}),footer:d.jsxs("div",{children:["Источник:"," ",d.jsx(At,{href:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"})]}),children:d.jsx("pre",{className:"whitespace-pre-wrap text-sm leading-relaxed rounded-xl border border-zinc-200 bg-white p-3 text-zinc-900 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-100",children:v0})})}),e==="laws"&&d.jsxs("section",{className:"grid gap-4",children:[d.jsx(T0,{}),d.jsx("div",{className:"flex flex-wrap gap-2",children:s.map(a=>d.jsx("button",{onClick:()=>c(a),className:`rounded-full border px-3 py-1 text-sm ${u===a?"border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100":"border-zinc-200 bg-white hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:hover:bg-zinc-800"}`,children:a},a))}),d.jsx("div",{className:"grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3",children:p.map(a=>d.jsx($t,{to:`/laws/${a.slug}`,className:"block",children:d.jsx(Ve,{title:d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(cs,{className:"h-4 w-4"}),a.title]}),footer:d.jsx("div",{children:a.updated?`Актуально: ${a.updated}`:""}),children:d.jsx("p",{className:"text-sm",children:a.notes||"Открыть →"})})},a.slug))})]}),d.jsx("div",{className:"mt-8 grid gap-3 rounded-2xl border border-zinc-200 bg-white/70 p-4 text-xs text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900/50 dark:text-zinc-400",children:d.jsx("div",{children:"UI для ПК и телефонов • Создатель: Pavel_Bolshoy."})})]})]})}const M0=({title:e,children:t,footer:n})=>d.jsxs("div",{className:"rounded-2xl border border-zinc-200 bg-white/80 p-4 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/60",children:[d.jsx("div",{className:"mb-2 flex items-center justify-between",children:d.jsx("h3",{className:"text-base font-semibold leading-tight",children:e})}),d.jsx("div",{className:"prose prose-zinc max-w-none text-sm leading-relaxed dark:prose-invert",children:t}),n&&d.jsx("div",{className:"mt-3 border-t border-zinc-200 pt-3 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400",children:n})]}),I0=({href:e,label:t})=>d.jsxs("a",{href:e,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 underline decoration-dotted hover:no-underline",children:[t||e," ",d.jsx(e0,{className:"h-3.5 w-3.5"})]}),O0=({children:e})=>d.jsx("span",{className:"rounded-full border px-2 py-0.5 text-[11px] font-medium",children:e});function $0(){const{id:e}=bc(),t=fo.find(n=>n.id===e);return t?d.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[d.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:d.jsxs("div",{className:"mx-auto flex max-w-3xl items-center gap-3 px-4 py-3",children:[d.jsxs($t,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[d.jsx(id,{className:"h-4 w-4"})," Назад"]}),d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(ao,{className:"h-4 w-4"}),d.jsx("h1",{className:"text-lg font-bold leading-tight",children:t.role}),d.jsx(O0,{children:t.salary})]})]})}),d.jsx("main",{className:"mx-auto max-w-3xl px-4 py-6",children:d.jsx(M0,{title:"Обязанности",footer:d.jsxs("div",{children:["Источник: ",d.jsx(I0,{href:t.source})]}),children:d.jsx("ul",{className:"ml-4 list-disc",children:t.duties.map((n,r)=>d.jsx("li",{children:n},r))})})})]}):d.jsxs("div",{className:"p-4",children:["Роль не найдена."," ",d.jsx($t,{to:"/",className:"text-blue-600 underline",children:"На главную"})]})}function Ru(e){return new Promise((t,n)=>{const r=document.createElement("script");r.src=e,r.async=!0,r.onload=()=>t(),r.onerror=()=>n(),document.head.appendChild(r)})}async function D0(){window.marked||await Ru("https://cdn.jsdelivr.net/npm/marked@12.0.2/marked.min.js"),window.DOMPurify||await Ru("https://cdn.jsdelivr.net/npm/dompurify@3.1.6/dist/purify.min.js")}function F0(e){const t=new DOMParser().parseFromString(e,"text/html"),n=Array.from(t.querySelectorAll("h2, h3, h4")),r=[],l=i=>i.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80);return n.forEach((i,o)=>{const s=i.textContent||"",u=l(s)||`h-${o+1}`;i.id=u;const c=i.tagName==="H2"?2:i.tagName==="H3"?3:4;r.push({id:u,text:s,level:c})}),{html:t.body.innerHTML,toc:r}}function U0(e){let t=e.replace(/\r\n?/g,`
`);return t=t.replace(/^(#{2,6})([^\s#])/gm,"$1 $2"),t=t.replace(/^(?!#+\s*)\s*Глава\s+([^\n]+)$/gmi,"## Глава $1"),t=t.replace(/^(?!#+\s*)\s*Статья\s+(\d+(?:\.\d+)?(?:[–-]\d+)?)\.?\s*(.*)$/gmi,(n,r,l)=>`### Статья ${r}${l?" — "+l:""}`),t=t.replace(/^\s*(\d+)\)\s+/gm,"$1. "),t}function B0(){const{slug:e}=bc(),t=An.find(p=>p.slug===e),[n,r]=S.useState(""),[l,i]=S.useState([]),[o,s]=S.useState("");if(S.useEffect(()=>{(async()=>{if(!t)return;await D0();const p=U0(t.content),a=window.marked.parse(p,{gfm:!0,breaks:!0}),m=window.DOMPurify.sanitize(a,{USE_PROFILES:{html:!0}}),{html:g,toc:w}=F0(m);r(g),i(w)})()},[e]),!t)return d.jsxs("div",{className:"p-4",children:["Закон не найден. ",d.jsx($t,{to:"/",className:"text-blue-600 underline",children:"На главную"})]});const u=S.useMemo(()=>{if(!o.trim()||!n)return n;const p=new RegExp(`(${o.replace(/[.*+?^${}()|[\\]\\\\]/g,"\\$&")})`,"gi");return n.replace(p,"<mark>$1</mark>")},[o,n]),c=p=>p===2?"pl-0":p===3?"pl-3":"pl-6";return d.jsxs("div",{className:"min-h-screen bg-gradient-to-b from-zinc-50 to-zinc-100 text-zinc-900 dark:from-zinc-900 dark:to-zinc-950 dark:text-zinc-100",children:[d.jsx("header",{className:"sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/70",children:d.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3",children:[d.jsxs($t,{to:"/",className:"flex items-center gap-1 text-sm hover:underline",children:[d.jsx(id,{className:"h-4 w-4"})," Назад"]}),d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx(cs,{className:"h-5 w-5"}),d.jsx("h1",{className:"text-lg font-bold leading-tight",children:t.title})]}),d.jsx("div",{className:"text-xs text-zinc-500",children:t.updated?`Актуально: ${t.updated}`:""})]})}),d.jsxs("main",{className:"mx-auto grid max-w-6xl grid-cols-1 gap-5 px-4 py-5 md:grid-cols-[260px,1fr]",children:[d.jsx("aside",{className:"hidden md:block",children:d.jsxs("div",{className:"sticky top-16 rounded-2xl border border-zinc-200 bg-white/70 p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900/50",children:[d.jsxs("div",{className:"mb-2 flex items-center gap-2 font-semibold",children:[d.jsx(l0,{className:"h-4 w-4"})," Оглавление"]}),l.length?d.jsx("ul",{className:"space-y-1",children:l.map(p=>d.jsx("li",{className:c(p.level),children:d.jsx("a",{className:"underline decoration-dotted hover:no-underline",href:`#${p.id}`,children:p.text})},p.id))}):d.jsx("div",{className:"text-xs text-zinc-500",children:"Добавь подзаголовки (##/###) в тексте закона — они появятся здесь."})]})}),d.jsxs("section",{children:[d.jsxs("div",{className:"mb-4 flex items-center gap-2",children:[d.jsx(sd,{className:"h-4 w-4 text-zinc-500"}),d.jsx("input",{className:"w-full rounded-xl border px-3 py-1.5 text-sm focus:outline-none focus:ring",placeholder:"Быстрый поиск по открытому закону…",value:o,onChange:p=>s(p.target.value)})]}),d.jsx("div",{className:"law prose prose-zinc max-w-none rounded-2xl border border-zinc-200 bg-white p-4 list-inside dark:prose-invert dark:border-zinc-800 dark:bg-zinc-900",dangerouslySetInnerHTML:{__html:u}})]})]})]})}function A0(){return d.jsx(Up,{basename:"/pravo/",children:d.jsxs(Rp,{children:[d.jsx(Hr,{path:"/",element:d.jsx(R0,{})}),d.jsx(Hr,{path:"/roles/:id",element:d.jsx($0,{})}),d.jsx(Hr,{path:"/laws/:slug",element:d.jsx(B0,{})})]})})}N0();di.createRoot(document.getElementById("root")).render(d.jsx(go.StrictMode,{children:d.jsx(A0,{})}));
