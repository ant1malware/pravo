const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-D5lEgg1g.js","assets/react-vendor-DStf8yZ1.js","assets/icons-plczHfNq.js","assets/VoteWidget-CyZ0wnUL.js","assets/ContextText-oI5GCNHz.js","assets/WhatsNew-Bs6DqLxA.js","assets/DiffPage-CPX5itsD.js","assets/PrintSheet-A171ABVX.js","assets/RolePage-CYUqdK9c.js","assets/FavStar-cR9nEBL3.js","assets/LawPage-C2wg6gNo.js","assets/VuPage-ByUZ4S3a.js","assets/SettingsPage-BJ7OjwGQ.js","assets/FavoritesPage-BgJbaLYb.js"])))=>i.map(i=>d[i]);
import{r as ne,a as Ie,R as m,u as F,L as z,B as _e,b as $e,c as w}from"./react-vendor-DStf8yZ1.js";import{S as V,X as se,B,U as oe,a as ae,b as U,c as W,F as Pe,L as Ce,C as Ae,M as re,d as Re,e as Le,f as Me,g as De}from"./icons-plczHfNq.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(a){if(a.ep)return;a.ep=!0;const l=s(a);fetch(a.href,l)}})();var ie={exports:{}},T={};/**
 * @license React
