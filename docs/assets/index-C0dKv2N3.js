const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/GovCheatsheetSky-BvXBA1jk.js","assets/react-vendor-DStf8yZ1.js","assets/icons-BNdGo32w.js","assets/VoteWidget-fs1r54ir.js","assets/ContextText-1QIvC590.js","assets/WhatsNew-Dpsk2AF7.js","assets/DiffPage-HEz3ePsu.js","assets/PrintSheet-BtCQLLCi.js","assets/RolePage-LqDawhAC.js","assets/FavStar-DKELuQzZ.js","assets/LawPage-CmdqrMOQ.js","assets/VuPage-CcX8tJbH.js","assets/SettingsPage-DpBD6NB6.js","assets/FavoritesPage-hsatl3-l.js"])))=>i.map(i=>d[i]);
import{r as H,a as ke,R as m,u as X,L as $,B as je,b as ze,c as y}from"./react-vendor-DStf8yZ1.js";import{S as J,X as Se,B as T,U as q,a as Z,b as Q,c as ee,F as Ie,L as Ee,C as _e,M as te,d as Ne,e as Ae}from"./icons-BNdGo32w.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const i of l.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function o(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=o(a);fetch(a.href,l)}})();var ne={exports:{}},D={};/**
 * @license React
...
`,Me=[{id:"gov",title:"Внутренний устав Правительства",text:Ke,source:"https://forum.amazing-online.com/threads/vnutrennij-ustav.1027735/"},{id:"army",title:"Внутренний устав Воинской части",text:`
    Глава 1. Общие положения
...
наказывается выговором`}],oe="ui:density",ae="ui:font",Fe="ui:features",re="ui:shadow",ie="ui:radius",ce="ui:glass",le="ui:readw";function Ve(e){document.documentElement.style.setProperty("--density",e==="compact"?"0.85":"1"),localStorage.setItem(oe,e)}function Ue(){return localStorage.getItem(oe)==="compact"?"compact":"standard"}function Ye(e){const t=Math.max(.9,Math.min(1.3,e)),o=16*t;document.documentElement.style.setProperty("--font-size",`${o}px`),localStorage.setItem(ae,String(t))}function We(){const e=parseFloat(localStorage.getItem(ae)||"1");return isFinite(e)&&e>.6&&e<2?e:1}function Ge(e,t=!0){const o=He();return e in o?!!o[e]:t}function He(){try{const e=localStorage.getItem(Fe);return e?JSON.parse(e):{}}catch{return{}}}function Xe(e){let t="none";e==="soft"&&(t="0 10px 30px -12px rgba(0,0,0,0.25)"),e==="strong"&&(t="0 20px 60px -24px rgba(0,0,0,0.35)"),document.documentElement.style.setProperty("--card-shadow",t),localStorage.setItem(re,e)}function Je(){const e=localStorage.getItem(re);return e==="none"||e==="soft"||e==="strong"?e:"soft"}function qe(e){let t=8,o=16,s=20;e==="subtle"&&(t=6,o=10,s=14),e==="rounded"&&(t=12,o=18,s=24),document.documentElement.style.setProperty("--radius-lg",t+"px"),document.documentElement.style.setProperty("--radius-2xl",o+"px"),document.documentElement.style.setProperty("--radius-3xl",s+"px"),localStorage.setItem(ie,e)}function Ze(){const e=localStorage.getItem(ie);return e==="subtle"||e==="rounded"?e:"standard"}function Qe(e){const t=Math.max(0,Math.min(16,Math.round(e)));document.documentElement.style.setProperty("--glass-blur",t+"px"),localStorage.setItem(ce,String(t))}function et(){const e=parseInt(localStorage.getItem(ce)||"6",10);return isFinite(e)?e:6}function tt(e){const t=Math.max(60,Math.min(96,Math.round(e)));document.documentElement.style.setProperty("--reading-w",t+"ch"),localStorage.setItem(le,String(t))}function nt(){const e=parseInt(localStorage.getItem(le)||"78",10);return isFinite(e)?e:78}function st(){try{Ve(Ue()),Ye(We()),Xe(Je()),qe(Ze()),Qe(et()),tt(nt())}catch{}}function w(e){return`${"/pravo/".replace(/\/$/,"")}${e}`}function ot(){if(!Ge("cmd_palette",!0))return null;const[t,o]=m.useState(!1),[s,a]=m.useState(""),[l,i]=m.useState(0),[d,c]=m.useState(()=>localStorage.getItem("cp_filter")||"all");m.useEffect(()=>{try{localStorage.setItem("cp_filter",d)}catch{}},[d]),m.useEffect(()=>{function r(p){(p.ctrlKey||p.metaKey)&&p.key.toLowerCase()==="k"&&(p.preventDefault(),o(!0),a(""),i(0)),t&&p.key==="Escape"&&o(!1)}return window.addEventListener("keydown",r),window.openCommandPalette=()=>{o(!0),a(""),i(0)},()=>{try{delete window.openCommandPalette}catch{}window.removeEventListener("keydown",r)}},[t]);const g=m.useMemo(()=>{const r=[];r.push({kind:"page",id:"favorites",title:"Избранное",subtitle:"Сервис",url:w("/favorites")}),r.push({kind:"page",id:"settings",title:"Настройки",subtitle:"Сервис",url:w("/settings")});for(const u of Be)r.push({kind:"role",id:u.id,title:u.role,subtitle:"Роль",url:w(`/roles/${u.id}`)});for(const u of Y)r.push({kind:"law",id:u.slug,title:u.title,subtitle:"Закон",url:w(`/laws/${u.slug}`)});for(const u of Me)r.push({kind:"vu",id:u.id,title:u.title,subtitle:"ВУ",url:w(`/vu/${u.id}`)});const p=s.trim().toLowerCase();return p&&r.push(...j(p).slice(0,60)),p?(d==="all"?r:r.filter(u=>u.kind===d)).map(u=>({r:u,score:h(`${u.title} ${u.subtitle||""}`.toLowerCase(),p)+(u.__boost||0)})).filter(u=>u.score>0).sort((u,S)=>S.score-u.score).slice(0,30).map(u=>u.r):r.slice(0,20)},[s,d]);function h(r,p){return p.split(/\s+/).filter(Boolean).reduce((u,S)=>u+(r.includes(S)?1:0),0)}function j(r){const p=[],P=b=>b.toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").trim().replace(/\s+/g,"-").slice(0,80),u=(()=>{const b=r.match(/\bст(атья|\.)?\s*(\d{1,3})\b/i);return b?b[2]:null})();for(const b of Y){const ve=(b.content||"").replace(/\r\n?/g,`
`).split(`
`);let N="",x="";const L=new Set;for(const we of ve){const I=we.trim(),K=/^(#{2,6})\s*(.+)$/.exec(I);if(K){N=K[2].trim(),x=P(N)||"";const k=N.toLowerCase();if(x&&(k.includes(r)||u&&k.match(new RegExp(`(^|s)ст(атья|.)?s*${u}\b`)))){const A=`${b.slug}#${x}`;if(!L.has(A)){const R={kind:"law",id:A,title:`${b.title} — ${N}`,subtitle:"Раздел закона",url:w(`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`)};R.__boost=k.startsWith(r)?8:6,p.push(R),L.add(A)}}continue}if(I&&I.toLowerCase().includes(r)){const k=x?`${b.slug}#${x}`:b.slug;if(!L.has(k)){const M=I.length>140?I.slice(0,137)+"…":I,A=x?`${b.title} — ${N}`:b.title,R=w(x?`/laws/${b.slug}?q=${encodeURIComponent(r)}#${x}`:`/laws/${b.slug}?q=${encodeURIComponent(r)}`),F={kind:"law",id:k,title:A,subtitle:M||"Совпадение в тексте",url:R};F.__boost=5,p.push(F),L.add(k)}}}}const S=new Set;return p.filter(b=>S.has(b.id)?!1:(S.add(b.id),!0))}function z(r){o(!1);try{window.location.href=r}catch{location.assign(r)}}function _(r){g.length&&(r.key==="ArrowDown"&&(r.preventDefault(),i(p=>Math.min(p+1,g.length-1))),r.key==="ArrowUp"&&(r.preventDefault(),i(p=>Math.max(p-1,0))),r.key==="Enter"&&(r.preventDefault(),z(g[l].url)))}return n.jsx(n.Fragment,{children:t?n.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4",role:"dialog","aria-modal":"true","aria-label":"Палитра команд",children:n.jsxs("div",{className:"w-full max-w-2xl rounded-2xl border border-zinc-200 bg-white p-3 text-zinc-900 shadow-softLg dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100",children:[n.jsxs("div",{className:"mb-2 flex items-center gap-2",children:[n.jsx(J,{className:"h-4 w-4 text-zinc-500 dark:text-zinc-400"}),n.jsx("input",{autoFocus:!0,value:s,onChange:r=>{a(r.target.value),i(0)},onKeyDown:_,placeholder:"Роль, закон, ВУ...",className:"w-full rounded-xl border border-zinc-200 px-3 py-2 text-sm focus:outline-none focus:ring text-zinc-900 placeholder-zinc-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder-zinc-500"}),n.jsx("button",{className:"btn text-zinc-600 dark:text-zinc-300",onClick:()=>o(!1),"aria-label":"Закрыть палитру",children:n.jsx(Se,{className:"h-4 w-4"})})]}),n.jsx("div",{className:"mb-2 flex items-center gap-2",children:[{k:"all",label:"Все"},{k:"role",label:"Роли"},{k:"law",label:"Законы"},{k:"vu",label:"ВУ"}].map(r=>n.jsx("button",{onClick:()=>{c(r.k),i(0)},className:`chip ${d===r.k?"bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900":"bg-white dark:bg-zinc-900"}`,children:r.label},r.k))}),n.jsxs("div",{className:"max-h-80 overflow-y-auto rounded-xl border border-zinc-200 dark:border-zinc-700",children:[!g.length&&n.jsx("div",{className:"p-3 text-sm text-zinc-500 dark:text-zinc-400",children:"Ничего не найдено"}),g.map((r,p)=>n.jsxs("button",{className:`flex w-full items-center justify-between gap-3 px-3 py-2 text-left text-sm text-zinc-900 hover:bg-zinc-50 dark:text-zinc-100 dark:hover:bg-zinc-800 ${p===l?"bg-indigo-500/15 dark:bg-indigo-500/20":""}`,onMouseEnter:()=>i(p),onClick:()=>z(r.url),children:[n.jsxs("span",{className:"inline-flex items-center gap-2",children:[r.kind==="law"&&n.jsx(T,{className:"h-4 w-4"}),r.kind==="role"&&n.jsx(q,{className:"h-4 w-4"}),r.kind==="vu"&&n.jsx(Z,{className:"h-4 w-4"}),r.kind==="page"&&(r.id==="settings"?n.jsx(Q,{className:"h-4 w-4"}):n.jsx(ee,{className:"h-4 w-4"})),n.jsx("span",{className:"font-medium",children:r.title})]}),r.subtitle&&n.jsx("span",{className:"rounded-full border border-zinc-300 px-2 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300",children:r.subtitle})]},`${r.kind}:${r.id}`))]})]})}):null})}const E={},at=(E==null?void 0:E.VITE_API_BASE)||(E==null?void 0:E.VITE_VOTE_API_BASE)||"https://sky-api.wizardiowhy.workers.dev";function rt(){try{const e="anon_uid";let t=localStorage.getItem(e);return t||(t=crypto.randomUUID(),localStorage.setItem(e,t)),t}catch{return"na"}}function it(){return{site:typeof location<"u"?location.host:"",path:typeof location<"u"?location.pathname+location.search+location.hash:"",ua:typeof navigator<"u"?navigator.userAgent:"",uid:rt()}}function ct(e,t){try{if(typeof localStorage<"u"&&localStorage.getItem("telemetry_disabled")==="1")return}catch{}try{const a=(navigator==null?void 0:navigator.doNotTrack)||(window==null?void 0:window.doNotTrack)||(navigator==null?void 0:navigator.msDoNotTrack);if(String(a)==="1"||String(a)==="yes")return}catch{}const o=JSON.stringify({event:e,...it(),data:t}),s=`${at}/api/track`;if(typeof navigator<"u"&&"sendBeacon"in navigator)try{const a=new Blob([o],{type:"application/json"});if(navigator.sendBeacon(s,a))return}catch{}try{fetch(s,{method:"POST",headers:{"content-type":"application/json"},body:o})}catch{}}const W="recent:items";function lt(e,t){try{const o=localStorage.getItem(W),s=o?JSON.parse(o):[],a={url:e,title:t,ts:Date.now()};if(s.length&&s[0].url===e)return;const l=s.filter(c=>c.url!==e);l.unshift(a);const i=[],d=new Set;for(const c of l)d.has(c.url)||(d.add(c.url),i.push(c));for(;i.length>15;)i.pop();localStorage.setItem(W,JSON.stringify(i))}catch{}}const dt=[{label:"Роли",icon:n.jsx(q,{className:"h-4 w-4"}),hash:"#roles"},{label:"Шаблоны",icon:n.jsx(Ie,{className:"h-4 w-4"}),hash:"#templates"},{label:"Посты",icon:n.jsx(Ee,{className:"h-4 w-4"}),hash:"#posts"},{label:"Процедуры",icon:n.jsx(_e,{className:"h-4 w-4"}),hash:"#procedures"},{label:"Взаимодействия",icon:n.jsx(te,{className:"h-4 w-4"}),hash:"#interactions"},{label:"Лекции",icon:n.jsx(T,{className:"h-4 w-4"}),hash:"#lectures"},{label:"ВУ",icon:n.jsx(Z,{className:"h-4 w-4"}),hash:"#vu"},{label:"Законы",icon:n.jsx(T,{className:"h-4 w-4"}),hash:"#laws"}];function ut(){const[e,t]=m.useState(()=>typeof window<"u"?window.innerWidth>=1024:!0),o=X();return m.useEffect(()=>{function s(){t(window.innerWidth>=1024)}return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),m.useEffect(()=>{const s=document.documentElement;e?s.classList.add("has-sidebar"):s.classList.remove("has-sidebar")},[e]),n.jsxs(n.Fragment,{children:[n.jsx("button",{className:"fixed left-3 top-3 z-50 rounded-lg border border-zinc-300 bg-white/90 px-2 py-1 text-xs shadow-sm backdrop-blur hover:bg-white dark:border-zinc-700 dark:bg-zinc-900/80 lg:hidden",onClick:()=>t(s=>!s),"aria-label":"Открыть меню",children:"Меню"}),n.jsxs("aside",{"aria-label":"Навигация",className:`app-sidebar fixed inset-y-0 left-0 z-40 w-[240px] transform border-r border-zinc-200 bg-white/80 px-3 py-4 text-sm shadow-sm backdrop-blur transition-transform duration-200 ease-out dark:border-zinc-800 dark:bg-zinc-900/70 ${e?"translate-x-0":"-translate-x-full lg:translate-x-0"}`,children:[n.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[n.jsx($,{to:"/",className:"font-semibold no-underline hover:underline",children:"Главная"}),n.jsx("span",{className:"hidden rounded border border-zinc-300 px-1.5 py-0.5 text-[10px] text-zinc-600 dark:border-zinc-600 dark:text-zinc-300 lg:inline",children:navigator.platform.includes("Mac")?"Cmd K":"Ctrl K"})]}),n.jsx("nav",{className:"grid gap-1",children:dt.map(s=>{const a=o.pathname==="/"&&(o.hash||"").toLowerCase()===s.hash.toLowerCase();return n.jsxs($,{to:{pathname:"/",hash:s.hash},className:`flex items-center gap-2 rounded-lg px-2 py-1.5 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-800 ${a?"bg-zinc-100 dark:bg-zinc-800":""}`,onClick:()=>{window.innerWidth<1024&&t(!1)},children:[s.icon,n.jsx("span",{children:s.label})]},s.label)})}),n.jsxs("div",{className:"mt-4 rounded-xl border border-zinc-200 bg-white/70 p-2 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300",children:["Подсказка: нажмите ",navigator.platform.includes("Mac")?"Cmd":"Ctrl"," + K для быстрого поиска"]})]})]})}const mt={"role:guard":{version:"1.2.0",updated_at:"2025-08-26",updated_by:"editor",changelog:[{version:"1.2.0",date:"2025-08-26",author:"editor",summary:"Уточнены обязанности на постах и добавлена ссылка на лекцию."},{version:"1.1.0",date:"2025-06-10",author:"editor",summary:"Дополнены формулировки и исправлены неточности."}]},"procedure:int-basic":{version:"0.9.1",updated_at:"2025-08-25",updated_by:"admin",changelog:[{version:"0.9.1",date:"2025-08-25",author:"admin",summary:"Небольшие правки формулировок."}]},"app:site":{version:"1.3.0",updated_at:"2025-08-29",updated_by:"maintainer",changelog:[{version:"1.3.0",date:"2025-08-29",author:"maintainer",summary:"Обновление интерфейса и телеметрии сайта.",details:["Добавлена телеметрия через Cloudflare Workers: события просмотров страниц отправляются в Telegram.","Кнопка ‘отключить телеметрию’ хранит настройку в LocalStorage и уважается при отправке.","Переработана страница ‘Что нового’: иконки, контраст, бейджи сущностей, кнопка ‘Сравнить версии’.","Улучшена страница ‘Сравнение версий’: читабельные цвета diff в светлой/тёмной теме, горизонтальный скролл, понятный заголовок.","Исправлен контраст кнопок и карточек в тёмной теме (текст видим).","Фронтенд по умолчанию использует API воркера (GH Pages + Workers), добавлен пример .env."]}]},"details:site":{version:"1.9.0 beta",updated_at:"2025-09-06",updated_by:"creater",changelog:[{version:"1.9.0 beta",date:"2025-09-06",author:"creater",summary:"Обновление интерфейса, функций и дополнение сайта.",details:["Добавлены посты УМВД, ГАИ.","Полностью переработан интерфейс сайта.","Доработаны настройки кастомизации сайта."]}]}},de={entities:mt};function pt(e){var o;return((o=de.entities)==null?void 0:o[e])||null}function Mt(e,t=30){const o=pt(e);if(!(o!=null&&o.updated_at))return{recent:!1};const s=new Date(o.updated_at+"T00:00:00Z");return{recent:(Date.now()-s.getTime())/(1e3*60*60*24)<=t,date:o.updated_at}}function Ft(e,t){const o=e.split(/\r?\n/),s=t.split(/\r?\n/),a=o.length,l=s.length,i=Array.from({length:a+1},()=>Array(l+1).fill(0));for(let g=a-1;g>=0;g--)for(let h=l-1;h>=0;h--)i[g][h]=o[g]===s[h]?i[g+1][h+1]+1:Math.max(i[g+1][h],i[g][h+1]);const d=[];let c=0,f=0;for(;c<a&&f<l;)o[c]===s[f]?(d.push(C(o[c])),c++,f++):i[c+1][f]>=i[c][f+1]?(d.push(`<del>${C(o[c])}</del>`),c++):(d.push(`<ins>${C(s[f])}</ins>`),f++);for(;c<a;)d.push(`<del>${C(o[c++])}</del>`);for(;f<l;)d.push(`<ins>${C(s[f++])}</ins>`);return d.join(`
`)}function C(e){return e.replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function ht(){var o;const e=[],t=de.entities||{};for(const[s,a]of Object.entries(t)){const l=(o=a.changelog)==null?void 0:o[0];l&&e.push({id:s,version:l.version,date:l.date,summary:l.summary,details:l.details})}return e.sort((s,a)=>s.date<a.date?1:-1),e}function gt(){const e=m.useMemo(()=>{try{const o=ht()[0];if(!o)return!1;const s=new Date(o.date+"T00:00:00Z");return(Date.now()-s.getTime())/864e5<=14}catch{return!1}},[]);function t(){const o=window.openCommandPalette;if(typeof o=="function")try{o();return}catch{}const s=navigator.platform.includes("Mac");window.dispatchEvent(new KeyboardEvent("keydown",{key:"k",ctrlKey:!s,metaKey:s}))}return n.jsx("div",{className:"sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-zinc-800 dark:bg-[color:var(--surface)]/90 dark:supports-[backdrop-filter]:bg-[color:var(--surface)]/70",children:n.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between gap-1 sm:gap-3 px-4 py-3",children:[n.jsxs("div",{className:"flex items-center gap-3",children:[n.jsx(Ne,{className:"h-6 w-6"}),n.jsx("div",{className:"text-base sm:text-lg font-bold truncate leading-tight",children:"Правительство — Памятка (SKY)"})]}),n.jsxs("div",{className:"flex items-center gap-1 sm:gap-2",children:[n.jsxs("button",{className:"btn btn-secondary",onClick:t,children:[n.jsx(J,{className:"h-4 w-4"})," Поиск"]}),n.jsxs($,{to:"/whats-new",className:"btn",children:["Что нового",e&&n.jsx("span",{className:"ml-2 inline-block h-2 w-2 rounded-full bg-amber-500"})]}),n.jsxs($,{to:"/favorites",className:"btn",children:[n.jsx(ee,{className:"h-4 w-4"})," Избранное"]}),n.jsxs($,{to:"/settings",className:"btn",children:[n.jsx(Q,{className:"h-4 w-4"})," Настройки"]}),n.jsxs("a",{href:"https://t.me/pasha_bolshoi",target:"_blank",rel:"noreferrer",className:"btn",children:[n.jsx(te,{className:"h-4 w-4"})," Фидбек"]})]})]})})}const ft="https://notifications-worker.wizardiowhy.workers.dev/api/notifications",G="notif:lastSeen";function bt(){const[e,t]=m.useState(!1),[o,s]=m.useState([]),[a,l]=m.useState(0);async function i(){try{const c=await fetch(ft,{cache:"no-store"});if(!c.ok)return;const f=await c.json(),g=Array.isArray(f)?f:f.items||[];g.sort((_,r)=>new Date(r.date||0).getTime()-new Date(_.date||0).getTime()),s(g);const h=localStorage.getItem(G)||"",j=h?g.findIndex(_=>_.id===h):-1,z=j===-1?g.length:j;l(Math.max(0,z))}catch{}}m.useEffect(()=>{i()},[]);function d(){if(t(c=>!c),!e&&o.length)try{localStorage.setItem(G,o[0].id),l(0)}catch{}}return n.jsxs("div",{className:"relative",children:[n.jsxs("button",{className:"btn btn-secondary relative",onClick:d,"aria-label":"Уведомления",children:[n.jsx(Ae,{className:"h-4 w-4"}),a>0&&n.jsx("span",{className:"absolute -right-1 -top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-amber-500 px-1 text-[10px] font-semibold text-white",children:a})]}),e&&n.jsxs("div",{className:"absolute right-0 mt-2 w-80 rounded-2xl border border-zinc-200 bg-white p-2 text-sm shadow-soft dark:border-zinc-700 dark:bg-zinc-900",children:[n.jsx("div",{className:"mb-1 px-1 text-xs text-zinc-500",children:"Уведомления"}),o.length?n.jsx("ul",{className:"max-h-80 space-y-1 overflow-y-auto",children:o.map(c=>n.jsx("li",{className:"rounded-lg px-2 py-1.5 hover:bg-zinc-50 dark:hover:bg-zinc-800",children:n.jsxs("a",{className:"block",href:c.url||"#",target:c.url?"_blank":void 0,rel:c.url?"noreferrer":void 0,children:[c.title&&n.jsx("div",{className:"font-semibold leading-snug text-zinc-900 dark:text-zinc-100",children:c.title}),n.jsx("div",{className:"mt-1 whitespace-pre-line text-[13px] leading-relaxed text-zinc-700 dark:text-zinc-300",children:c.text}),c.date&&n.jsx("div",{className:"mt-1 text-[10px] text-zinc-500",children:new Date(c.date).toLocaleString()})]})},c.id))}):n.jsx("div",{className:"px-2 py-3 text-xs text-zinc-500",children:"Пока нет уведомлений"})]})]})}const xt=m.lazy(()=>v(()=>import("./GovCheatsheetSky-BvXBA1jk.js"),__vite__mapDeps([0,1,2,3,4]))),yt=m.lazy(()=>v(()=>import("./WhatsNew-Dpsk2AF7.js"),__vite__mapDeps([5,1,2]))),vt=m.lazy(()=>v(()=>import("./DiffPage-HEz3ePsu.js"),__vite__mapDeps([6,1,2]))),wt=m.lazy(()=>v(()=>import("./PrintSheet-BtCQLLCi.js"),__vite__mapDeps([7,1,2]))),kt=m.lazy(()=>v(()=>import("./RolePage-LqDawhAC.js"),__vite__mapDeps([8,1,3,2,9,4]))),jt=m.lazy(()=>v(()=>import("./LawPage-CmdqrMOQ.js"),__vite__mapDeps([10,1,9,2,4]))),zt=m.lazy(()=>v(()=>import("./VuPage-CcX8tJbH.js"),__vite__mapDeps([11,1,4,2]))),St=m.lazy(()=>v(()=>import("./SettingsPage-DpBD6NB6.js"),__vite__mapDeps([12,1,2]))),It=m.lazy(()=>v(()=>import("./FavoritesPage-hsatl3-l.js"),__vite__mapDeps([13,1,9,2,4])));function Et(){const e=X();return H.useEffect(()=>{ct("page_view");try{lt(location.pathname+location.search+location.hash,document.title||void 0)}catch{}},[e.pathname,e.search,e.hash]),null}function _t(){return n.jsxs(je,{basename:"/pravo/",children:[n.jsx(ot,{}),n.jsx(ut,{}),n.jsx(gt,{}),n.jsx("div",{className:"fixed right-2 top-2 z-50",children:n.jsx(bt,{})}),n.jsx(Et,{}),n.jsx(m.Suspense,{fallback:n.jsx("div",{className:"p-4 text-sm text-zinc-500",children:"Загрузка…"}),children:n.jsxs(ze,{children:[n.jsx(y,{path:"/",element:n.jsx(xt,{})}),n.jsx(y,{path:"/whats-new",element:n.jsx(yt,{})}),n.jsx(y,{path:"/diff/:id",element:n.jsx(vt,{})}),n.jsx(y,{path:"/print",element:n.jsx(wt,{})}),n.jsx(y,{path:"/roles/:id",element:n.jsx(kt,{})}),n.jsx(y,{path:"/laws/:slug",element:n.jsx(jt,{})}),n.jsx(y,{path:"/vu/:id",element:n.jsx(zt,{})}),n.jsx(y,{path:"/settings",element:n.jsx(St,{})}),n.jsx(y,{path:"/favorites",element:n.jsx(It,{})})]})})]})}const ue="theme",me="accent",pe="accent_custom",B="bg",he="bg_custom",ge={indigo:{500:"#6366F1",600:"#4F46E5"},violet:{500:"#8B5CF6",600:"#7C3AED"},blue:{500:"#3B82F6",600:"#2563EB"}},fe={bg1:"img/bg1.png",bg2:"img/bg2.png",bg3:"img/bg3.png"};function Nt(){const e=localStorage.getItem(ue);return e==="light"||e==="dark"?e:null}function At(){const e=localStorage.getItem(me);return e?e==="custom"?"custom":e in ge?e:null:null}function Ct(){return localStorage.getItem(pe)}function $t(){const e=localStorage.getItem(B);return e&&(e==="none"||e==="custom"||e in fe)?e:null}function Pt(){return localStorage.getItem(he)}function Lt(){return window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches}function Rt(e){const t=document.documentElement;e==="dark"?t.classList.add("dark"):t.classList.remove("dark"),localStorage.setItem(ue,e);const o=e==="dark"?"#0a0a0a":"#fafafa";let s=document.querySelector('meta[name="theme-color"]');s||(s=document.createElement("meta"),s.name="theme-color",document.head.appendChild(s)),s.setAttribute("content",o);try{t.style.backgroundColor="var(--bg-1)",document.body.style.backgroundColor="var(--bg-1)"}catch{}}function be(e){if(e==="custom"){const t=Ct()||"#6366F1";document.documentElement.style.setProperty("--accent",t);const o=Tt(t,-.15);document.documentElement.style.setProperty("--accent-600",o)}else{const t=ge[e];document.documentElement.style.setProperty("--accent",t[500]),document.documentElement.style.setProperty("--accent-600",t[600])}localStorage.setItem(me,e)}function Vt(e){localStorage.setItem(pe,ye(e)),be("custom")}function xe(e){const t=document.body;if(document.documentElement.classList.contains("dark")){t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="",localStorage.setItem(B,e);return}if(e==="none")t.style.backgroundImage="",t.style.backgroundSize="",t.style.backgroundRepeat="",t.style.backgroundAttachment="",t.style.backgroundPosition="";else if(e==="custom"){const s=Pt();s?(t.style.backgroundImage=`url(${s})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"):t.style.backgroundImage=""}else{const s=`/pravo/${fe[e]}`;t.style.backgroundImage=`url(${s})`,t.style.backgroundSize="cover",t.style.backgroundRepeat="no-repeat",t.style.backgroundAttachment="fixed",t.style.backgroundPosition="center"}localStorage.setItem(B,e)}function Ut(e){localStorage.setItem(he,e),xe("custom")}function Dt(){const t=Nt()??(Lt()?"dark":"light");Rt(t);const o=At()??"indigo";be(o);const s=$t()??"none";xe(s)}function ye(e){let t=e.trim();if(t.startsWith("#")||(t=`#${t}`),t.length===4){const o=t[1],s=t[2],a=t[3];t=`#${o}${o}${s}${s}${a}${a}`}return t}function Tt(e,t){const o=ye(e).slice(1),s=parseInt(o,16);let a=s>>16&255,l=s>>8&255,i=s&255;a=Math.max(0,Math.min(255,Math.round(a+255*t))),l=Math.max(0,Math.min(255,Math.round(l+255*t))),i=Math.max(0,Math.min(255,Math.round(i+255*t)));const d=c=>c.toString(16).padStart(2,"0");return`#${d(a)}${d(l)}${d(i)}`}Dt();st();O.createRoot(document.getElementById("root")).render(n.jsx(m.StrictMode,{children:n.jsx(_t,{})}));export{pt as a,At as b,Ue as c,Ft as d,We as e,Ge as f,ht as g,Je as h,Mt as i,n as j,Ze as k,Y as l,et as m,nt as n,Rt as o,Ve as p,Xe as q,Be as r,Lt as s,qe as t,Vt as u,Me as v,xe as w,Ut as x,be as y};
